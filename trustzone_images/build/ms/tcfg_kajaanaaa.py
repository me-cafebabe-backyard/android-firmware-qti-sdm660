...
def exists(env):
   return env.Detect('tcfg_KAJAANAAA_data')
...
def generate(env):
   ...
   env.AddUsesFlags('USES_SEC_POLICY_STEP2_OEM_SIGN', from_builds_file = True)
   ...
   env.AddUsesFlags('USES_SEC_POLICY_STEP1_QC_SIGN', from_builds_file = True)
