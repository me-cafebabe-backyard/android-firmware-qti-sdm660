...
#----------------------------------------------------------------------------
#
#  $Header: //components/rel/scons.tz/1.0.7.1/build/scons/scripts/version_builder.py#1 $
...
def qc_version_builder(target, source, env):
   ...
   qc_version_str = "".join([  
      ...
      XmlImageTreeName.text.upper().strip(), "-", XmlImageTreeRevision.text.upper().strip(), "\";\n"])
