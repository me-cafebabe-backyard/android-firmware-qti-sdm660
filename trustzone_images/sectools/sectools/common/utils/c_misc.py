...
def create_mismatch_table(mismatches, error_str, operation=None, data_type_to_compare="Attribute", image_region="Attestation Cert"):
    if mismatches:
        tp = TablePrinter()
...
def add_check_output_to_subprocess():
...
add_check_output_to_subprocess()
...
def obj_repr(self, ignore_attr=None):
    retval = []
