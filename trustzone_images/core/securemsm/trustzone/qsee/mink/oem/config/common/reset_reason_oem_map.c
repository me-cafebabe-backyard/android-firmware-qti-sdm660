...
static tzbsp_reset_reason_pair_t rst_reason_list[] =
{
  ...
  {TZBSP_ERR_FATAL_QSEE_PREFETCH_ABT     , 55},
  {TZBSP_ERR_FATAL_QSEE_DATA_ABT         , 56},
  {TZBSP_ERR_FATAL_QSEE_UNDEF_ABT        , 57},

  {TZBSP_ERR_FATAL_QSEE_STACK_CHK_FAILED , 58},
  {TZBSP_ERR_FATAL_MON_STACK_CHK_FAILED  , 59},

  {TZBSP_ERR_FATAL_MON_ASSERT_FAILED     , 60},
