...
/*=========================================================================
  ...
  $Header: //components/rel/core.tz/1.0.7.1/securemsm/trustzone/qsee/include/qsee_cppf.h#1 $
...
--------   ---     ---------------------------------------------------------------
03/13/17   sw      Define new enums for DSI-0/1
...
/*
   Handle the request of getting CHIPSET-FAMILY information

   Parameters:
       chipset_family      - (in/out) chipset_family

   Return: 
       CPPFErrNoType;

*/
CPPFErrNoType qsee_get_chipset_family( uint32_t *chipset_family );
