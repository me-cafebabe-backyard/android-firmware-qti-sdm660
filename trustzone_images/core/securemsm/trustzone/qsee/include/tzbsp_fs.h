...
/*===========================================================================
  ...
  $Header: //components/rel/core.tz/1.0.7.1/securemsm/trustzone/qsee/include/tzbsp_fs.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
09/29/15   aw      Fixed CR900655 - Remove link API as it is no longer supported
04/02/15   cz      Changed "struct tzStat" the same as HLOS, work for 32bit and 64bit Apps
...
#ifndef AT_FDCWD
#define	AT_FDCWD	-100	/* get file status flags */
#endif
