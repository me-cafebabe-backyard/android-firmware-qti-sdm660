...
******************************************************************************/
#define inp(port)         (*((volatile uint8  *)(port)))
#define inpw(port)        (*((volatile uint16 *)(port)))
#define inpdw(port)       (*((volatile uint32 *)(port)))
#define inp64(port)       (*((volatile uint64 *)(port)))

#define outp(port, val)   (*((volatile uint8  *)(port)) = ((uint8)  (val)))
#define outpw(port, val)  (*((volatile uint16 *)(port)) = ((uint16) (val)))
