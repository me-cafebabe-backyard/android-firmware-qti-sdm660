# 1 "/local/mnt/workspace/CRMBuilds/TZ.BF.4.0.7.1-00006-S660AAAAANAZT-2_20200329_233006/b/HK11/trustzone_images/core/securemsm/trustzone/qsapps/teetest/teetest/src/teetest_entry.s"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 337 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/local/mnt/workspace/CRMBuilds/TZ.BF.4.0.7.1-00006-S660AAAAANAZT-2_20200329_233006/b/HK11/trustzone_images/core/securemsm/trustzone/qsapps/teetest/teetest/src/teetest_entry.s" 2
;*====*====*====*====*====*====*====*====*====*====*====*====*====*====
...
tee_test_fiq:
  mrs r9, spsr
  orr r8, r9, #(1<<6)|(1<<7)|(1<<8) ; Set A/I/F bits.
  msr spsr_cxsf, r8
