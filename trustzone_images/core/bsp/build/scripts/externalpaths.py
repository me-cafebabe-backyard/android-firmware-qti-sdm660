...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/core.tz/1.0.7.1/bsp/build/scripts/externalpaths.py#1 $
...
def generate(env):
   ...
   env.Replace(MODEM_DATA_EXTERNAL = [
      "${MODEM_DATACOMMON_API}",
      '${BUILD_ROOT}/modem/datamodem/api',
      "${AU_MODEM_API}/datamodem",
