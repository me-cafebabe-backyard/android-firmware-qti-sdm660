...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/core.tz/1.0.7.1/bsp/build/scripts/pil_splitter_builder.py#1 $
...
def splitter_builder(target, source, env):
   ...
   cmds = ["python ${BUILD_ROOT}/core/bsp/build/scripts/pil_splitter.py %s %s" % (source_str, target_prefix)]
