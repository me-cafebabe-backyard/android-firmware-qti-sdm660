...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/core.tz/1.0.7.1/bsp/build/scripts/mbn_tools.py#1 $
...
image_id_table = {
   ...
   # Do not add any additional images!
}
...
#      for j in range(elf_header.e_phnum):
#         phdr_table[i].printValues()
      print elf_in_file_name
...
def generate_code_hash(env, elf_in_file_name):
   ...
   for i in range(elf_header.e_phnum):
      ...
      if ((curr_phdr.p_flags & PH_PERM_MASK) == PH_PERM_RW and
