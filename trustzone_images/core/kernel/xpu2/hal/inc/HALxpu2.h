...
$Header: //components/rel/core.tz/1.0.7.1/kernel/xpu2/hal/inc/HALxpu2.h#1 $
...
typedef enum
{
  ...
  HAL_XPU2_BLSP_BAM = HAL_XPU2_BAM_BLSP1_DMA, /**< Peripheral BLSP BAM */
  ...
  HAL_XPU2_MSS_Q6_MPU,
  HAL_XPU2_BIMC_S_APP,
  HAL_XPU2_SDC1_SDCC,              /**< SDC1_SDCC5_TOP.XPU2 */
  HAL_XPU2_SDC2_SDCC,              /**< SDC2_SDCC5_TOP.XPU2*/
  HAL_XPU2_IPA_BAM_NDP,             /**< IPA BAM*/
  HAL_XPU2_CFG_DSA,
...
typedef struct
{
  ...
  boolean bAMTMSAClientROEn : 1;
    /**< TRUE permits read-only accesses by MSA client accesses to AMT regions.
     *   This is for revision 2.6 or later. */
  boolean bAMTMSAClientRWEn : 1;
    /**< TRUE permits read-write accesses by MSA client accesses to AMT regions.
     *   This is for revision 2.6 or later. */
  ...
  boolean bMSAUnmapMemoryClientRWEn : 1;
    /**< TRUE permits read-write accesses by MSA client accesses to unmapped
     *   non-secure regions.  This is for revision 2.6 or later. */
...
typedef struct
{
  ...
  uint32  uResourceGroupResMax;/**< Maximum RG size (for MPUs) */
