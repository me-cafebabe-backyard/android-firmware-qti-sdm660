...
$Header: //components/rel/core.tz/1.0.7.1/systemdrivers/pmic/config/sdm660_pm660/src/pm_hyp_config.c#1 $
...
SpmiCfg_ChannelCfg pm_hyp_spmi_cfg [] =
{
 /* PM660 */
...
const uint32 pm_hyp_spmi_cfg_sz = sizeof(pm_hyp_spmi_cfg) / sizeof(SpmiCfg_ChannelCfg);
