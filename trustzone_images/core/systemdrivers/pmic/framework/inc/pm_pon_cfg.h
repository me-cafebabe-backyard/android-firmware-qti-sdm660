 ...
 * \n &copy; Copyright 2015-2016 QUALCOMM Technolgoies Incorporated, All Rights Reserved
 */
...
$Header: //components/rel/core.tz/1.0.7.1/systemdrivers/pmic/framework/inc/pm_pon_cfg.h#1 $
$Author: pwbldsvc $
