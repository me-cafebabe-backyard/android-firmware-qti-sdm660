...
$Header: //components/rel/core.tz/1.0.7.1/api/services/IxErrno.h#1 $
...
typedef enum
{
  ...
  E_INVALID_STORE_PSWD  = 121,   /* Invalid Secure Store Password */
  E_MACHINE_ID_MISMATCH = 122,  /* Machine ID Mismatch */
