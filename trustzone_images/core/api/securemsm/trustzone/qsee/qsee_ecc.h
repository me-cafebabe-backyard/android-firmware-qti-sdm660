...
typedef enum {
	...
	QSEE_ECIES_DIGEST_MD5 = 1, /* Optional, may not be implemented in hardware, will be handled in software
                        * if needed. */
...
int qsee_SW_ECIES_init(QSEE_ecies_ctx_t *ctx, QSEE_ecies_params_t *params);
 ...
 *
 */
bool qsee_SW_GENERIC_ECC_affine_point_on_curve(QSEE_qrlbn_ecc_affine_point_t const *Q, QSEE_qrlbn_ecc_domain_t *dp);
#endif /*QSEE_ECC_H*/
