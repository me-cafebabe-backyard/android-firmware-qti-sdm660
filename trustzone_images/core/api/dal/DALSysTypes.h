...
$Header: //components/rel/core.tz/1.0.7.1/api/dal/DALSysTypes.h#1 $

when       who     description
--------   ---     ----------------------------------------------------------
11/24/15   sg      Add support for multi device config
06/03/15   ap      Add support for returning size of StructPtrs
...
------------------------------------------------------------------------------*/
#define DALSYS_BASE_OBJ_SIZE_BYTES           16
...
#define DALSYS_MEM_OBJ_SIZE_BYTES            64
