...
Alias_List_9x55=['mdm9650','mdm9655','mdm9x55','mdm9655']
...
Alias_List_sdm660=['sdm660']
Alias_List_sdm630=['sdm630']
...
TargetNameSearchList_dict={
	...
	'sdm660.ts2':     Alias_List_sdm660,
	'sdm630.ts2':     Alias_List_sdm630
}
...
def set_t32_environment(t32directory=None):
...
def t32select():
        ...
        if 'mdm9655' in options.targetname:
        ...
        if 'T32_VER' in xmldict.keys():
                ...
                SD_t32_server=str(xmldict['T32_VER_PATH_SD'])
                QIPL_t32_server=str(xmldict['T32_VER_PATH_QIPL'])
                #TEX_t32_server=str(xmldict['T32_VER_PATH_TEX'])
