...
try:
	...
	dict_txt=os.path.join(args.tz,'trustzone_images', 'core','bsp','qsee','errorCodesDict.txt') 
				...
				for line in args.log:
					...
					if line[:1]=='(' and line[-1]==')' :
						...
						if errorCodeInLog in errCodeDict :
							...
							args.output.write('('+errCodeDict[errorCodeInLog][0]+stringValue +')'+'\n')
							if args.stdout==True :
								print('('+errCodeDict[errorCodeInLog][0]+stringValue +')'+'\n')			
						else :
