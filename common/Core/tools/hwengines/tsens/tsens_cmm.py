...
# FILE:         tsens_cmm.py
#
# OVERVIEW:     CMMBuilder configurations for TSENS scripts.
#
...
#
# $Header: //components/rel/core.glue/1.2.1/tools/tools/hwengines/tsens/tsens_cmm.py#1 $$DateTime: 2016/11/23 22:06:41 $$Author: pwbldsvc $
#
...
def CreateDictionary(targetconfigs):
   ...
   {
      "TSENS Temps" :                                      #Script Entry Identifier. This must be unique to every script entry
      {
         'dropdown menu name'  : "TSENS Temperatures",     #What appears in the T32 menu
         'description'         : "TSENS Temperatures",
         'scriptname'          : "tsens_read.cmm",         #Actual name of script that is called.
         ...
         'abspath'             : os.path.join(targetconfigs['RootDir'],"hwengines","tsens",targetconfigs['Target']), #Needs to be the path to your script
         'submenu'             : 'TSENS',                  #Not implemented yet
         'user-interactive?'   : False,                    #If this script doesn't require user interaction, put False, else True.
         ...
         'tags'                : "TSENSCMM", #For  future implementation
         'menubutton'          : None,     #Use SPARINGLY! This will put a menu button on T32 GUI. Only so much room available.
         'target'              : ['MSM8996', 'MSM8998'],    #target specific or not. You can put 'all', or, say 'MSM8996' and it will show up only on that target.
