...
def targetconfigs():
    ...
    targetconfigs.update({'Target':'SDM660'})
    ...
    CoreNames   = { 'RPM' : 'RPM', 'APPS0' : 'APPS0', 'APPS1' : 'APPS1', 'APPS2' : 'APPS2', 'APPS3' : 'APPS3', 'MPSS' : 'MPSS', 'ADSP' : 'ADSP', 'SLPI' : 'SLPI', 'CDSP':'CDSP', 'ARM32Sim' : 'ARM32Sim', 'ARM64Sim' : 'ARM64Sim', 'QDSP6Sim' : 'QDSPSim' }
    targetconfigs.update({'corenames':CoreNames})
    
    Cores = ['RPM-CORTEXM3','MSS-Q6','LPASS-Q6','SSC-Q6','APPS-ARMV8','CDSP-Q6']
    targetconfigs.update({'cores':Cores})

    #Scripts will be made from each of these
    subsystems = ['RPM-CORTEXM3','MSS-Q6','LPASS-Q6','SSC-Q6','APPS-ARMV8','CDSP-Q6']
