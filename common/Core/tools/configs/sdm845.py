...
-------------------------------------------------------------------------------
 ...
 --------   ---         ---------------------------------------------------------
 11/16/2016 JBILLIN     Created for SDM845
==============================================================================
"""
import os, sys
...
def targetconfigs():
    ...
    targetconfigs.update({'Target':'SDM845'})
    ...
    CoreNames   = { 'RPM' : 'RPM', 'APPS0' : 'APPS0', 'APPS1' : 'APPS1', 'APPS2' : 'APPS2', 'APPS3' : 'APPS3', 'MPSS' : 'MPSS', 'ADSP' : 'ADSP','CDSP' : 'CDSP', 'SLPI' : 'SLPI', 'ARM32Sim' : 'ARM32Sim', 'ARM64Sim' : 'ARM64Sim', 'QDSP6Sim' : 'QDSPSim' }
    targetconfigs.update({'corenames':CoreNames})
    
    Cores = ['RPM-CORTEXM3','MSS-Q6','LPASS-Q6','SSC-Q6','CDSP-Q6','APPS-ARMV8']
    targetconfigs.update({'cores':Cores})

    #Scripts will be made from each of these
    subsystems = ['RPM-CORTEXM3','MSS-Q6','LPASS-Q6','SSC-Q6','CDSP-Q6','APPS-ARMV8']
    ...
    software_images=['RPM','MPSS','LA','WP','SLPI','ADSP','CDSP','TZ','XBL','VSS','WLAN']
