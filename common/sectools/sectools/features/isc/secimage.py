...
class SecImageParser(CoreOptionParser):
    ...
    def c_validate(self):
        ...
        if not (args.integrity_check or args.sign or args.encrypt or args.decrypt or args.validate or args.verify_inputs):
        ...
        # Check sign_attr is not set for QTI authority
        if args.sign_attr and args.qti_signing:
            err.append('sign_attr operation can only be performed by OEM.')
