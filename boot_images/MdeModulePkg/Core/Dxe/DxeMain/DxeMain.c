...
#if defined (QCOM_EDK2_PATCH)
  CoreNotifySignalList (&gEfiEventFBPTExitBootServicesEntryGuid);
#endif
...
#if defined (QCOM_EDK2_PATCH)
  // this is added for notify the ExitBootServices() success
  // Measure boot needs to log on this event.
  CoreNotifySignalList (&gEfiEventExitBootServicesSuccessGuid);

  CoreNotifySignalList (&gEfiEventFBPTExitBootServicesExitGuid);
#endif
  //
