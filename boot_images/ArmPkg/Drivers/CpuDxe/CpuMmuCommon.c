  ...
  )
{
  ...
  if (EfiAttributes & EFI_MEMORY_CACHETYPE_MASK) {
...
#if defined (QCOM_EDK2_PATCH)
#if ENABLE_XN  
    //Update GCD saying XP, skip if trying to change XN or Shareability 
    if ( (RegionArmAttributes - ArmAttributes == 0x0060000000000000) ||
         (RegionArmAttributes - ArmAttributes == 0x0060000000000300) )
      return EFI_SUCCESS;
#endif
#endif
