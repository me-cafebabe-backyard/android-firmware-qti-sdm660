...
#define TT_DESCRIPTOR_PAGE_TYPE_MASK         (2UL << 0)
#else
...
#if defined (QCOM_EDK2_PATCH)
#define TT_DESCRIPTOR_SECTION_PXN                               (1UL << 0)
#endif 
...
#define TT_DESCRIPTOR_SECTION_XN                                (1UL << 4)
#define TT_DESCRIPTOR_SECTION_PXN                               (1UL << 0)

#define TT_DESCRIPTOR_PAGE_XN_MASK                              (0x1UL << 0)
#define TT_DESCRIPTOR_PAGE_XN                                   (1UL << 0)
...
#if defined (QCOM_EDK2_PATCH)
/* PXN bit used to indicate user code that should not be executed by Kernel which is not a usecase for UEFI
 * However, current ArmPkg implementation doesn't correctly check for PXN bit 
 * DEP requirements can be met as long as XN bit is set
