...
/**
  ...
  @param  SourceBuffer     This is a pointer to the buffer where
			   the File referenced has already been
			   loaded.  This eliminates need to
			   reload, as well as the associated
			   security risk.
  @param  FileSize         This is the size of the File and
			   SourceBuffer.
#endif
