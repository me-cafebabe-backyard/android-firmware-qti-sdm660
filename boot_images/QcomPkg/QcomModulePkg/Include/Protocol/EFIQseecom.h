...
/*=============================================================================
 ...
 --------   ---       -----------------------------------------------------------
 04/21/17   ysreekan  Moved QseecomStartAppByGuid to end of Protocol structure  
 02/20/17   ysreekan  Added new API to load App by Guid
 11/23/15   bmuthuku  Initial version
=============================================================================*/
 
/*=============================================================================
         QSEE COMMUNICATION PROTOCOL REVISION  HISTORY
Revision #               Updates
---------                -----------------------------------------
0x10002                  Added new API to load applications by Guid
0x10001                  Initial Version
=============================================================================*/
