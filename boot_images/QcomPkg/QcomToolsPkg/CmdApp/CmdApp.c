...
ProcessCommand (UINTN Argc, CHAR8** Argv)
{
  ...
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "DisableChgApp") == 0)
    DisableChgApp((CHAR8*) ArgStr);

  else if (AsciiStriCmp ((CHAR8*)CmdStr, "ConfigRsense") == 0)
    ConfigRsense((CHAR8*) ArgStr);
  ...
  else if (AsciiStriCmp ((CHAR8*)CmdStr, "RunQcomChgrApp") == 0)
	  RunQcomChgrApp((CHAR8*) ArgStr);

  else if (AsciiStriCmp ((CHAR8*)CmdStr, "EnableFactoryMode") == 0)
    EnableFactoryMode((CHAR8*) ArgStr);
