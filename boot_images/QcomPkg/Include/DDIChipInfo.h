 ...
 */
#define DALCHIPINFO_MAX_NAME_LENGTH 16
...
#define DALCHIPINFO_VERSION_UNKNOWN 0
/**
...
typedef enum
{
  ...
  DALCHIPINFO_ID_SDM660      = 317,
  DALCHIPINFO_ID_SDM630      = 318,
  DALCHIPINFO_ID_APQ8098     = 319,
  DALCHIPINFO_ID_MSM8920     = 320,
  DALCHIPINFO_ID_SDM845	     = 321,
  DALCHIPINFO_ID_MDM9206     = 322,
  DALCHIPINFO_ID_IPQ8074     = 323,
  DALCHIPINFO_ID_SDA660	     = 324,
  DALCHIPINFO_ID_SDM658	     = 325,
  DALCHIPINFO_ID_SDA658	     = 326,
  DALCHIPINFO_ID_SDA630	     = 327,
  DALCHIPINFO_ID_SDM830      = 328,
  DALCHIPINFO_ID_SDX50M      = 329,
  DALCHIPINFO_ID_QCA6290     = 330,
  DALCHIPINFO_ID_MSM8905     = 331,
  DALCHIPINFO_ID_SDC830      = 332,
  DALCHIPINFO_ID_MDM9660     = 333,
  DALCHIPINFO_ID_SDX24       = 334,
  DALCHIPINFO_ID_SDX24M      = 335,
  DALCHIPINFO_ID_SDM670      = 336,
  DALCHIPINFO_ID_SDC670      = 337,
  DALCHIPINFO_ID_SDM450      = 338,
  DALCHIPINFO_ID_SDM855      = 339,
  DALCHIPINFO_ID_SDM1000     = 340,
  DALCHIPINFO_ID_SDC845      = 341,
  DALCHIPINFO_ID_IPQ8072     = 342,
  DALCHIPINFO_ID_IPQ8076     = 343,
  DALCHIPINFO_ID_IPQ8078     = 344,
  DALCHIPINFO_ID_SDA845      = DALCHIPINFO_ID_SDC845,
  DALCHIPINFO_ID_SDX20M      = DALCHIPINFO_ID_MDM9665,
  DALCHIPINFO_ID_SDM636      = 345,
  DALCHIPINFO_ID_SDA636      = 346,
  DALCHIPINFO_ID_QCS605      = 347,
  DALCHIPINFO_ID_SDM850      = 348,
  DALCHIPINFO_ID_SDM632      = 349,
  DALCHIPINFO_ID_SDA632      = 350,
  DALCHIPINFO_ID_SDA450      = 351,
  DALCHIPINFO_ID_QCS6200     = 352,
  DALCHIPINFO_ID_SDM439      = 353,
  DALCHIPINFO_ID_SDM429      = 354,
  DALCHIPINFO_ID_SDM640      = 355,
  DALCHIPINFO_ID_QCS405      = DALCHIPINFO_ID_QCS6200,
  DALCHIPINFO_ID_SDA865      = 356,
  DALCHIPINFO_ID_SDX55       = 357,
  DALCHIPINFO_ID_QCA6390     = 358,
  DALCHIPINFO_ID_MDM9150     = 359,
  DALCHIPINFO_ID_SDM710      = 360,
  DALCHIPINFO_ID_SDA855      = 361,
  DALCHIPINFO_ID_SDM855A     = 362,
  DALCHIPINFO_ID_SM8150      = DALCHIPINFO_ID_SDM855,
  DALCHIPINFO_ID_SM8150P     = DALCHIPINFO_ID_SDA855,
  DALCHIPINFO_ID_SM8250      = DALCHIPINFO_ID_SDA865,
  DALCHIPINFO_ID_SCX8180     = DALCHIPINFO_ID_SDM1000,
  DALCHIPINFO_ID_SDA439      = 363,
  DALCHIPINFO_ID_SDA429      = 364,
  DALCHIPINFO_ID_SM7150      = 365,
  DALCHIPINFO_ID_SM7150P     = 366,
  DALCHIPINFO_ID_SDA855A     = 367,
  DALCHIPINFO_ID_SA8150      = DALCHIPINFO_ID_SDM855A,
  DALCHIPINFO_ID_SA8150P     = DALCHIPINFO_ID_SDA855A,
  DALCHIPINFO_ID_SDX55M      = 368,
  DALCHIPINFO_ID_SM6150      = DALCHIPINFO_ID_SDM640,
  DALCHIPINFO_ID_SM6150P     = 369,
  DALCHIPINFO_ID_SXR1120     = 370,
  DALCHIPINFO_ID_SXR1130     = 371,
  DALCHIPINFO_ID_QCS401      = 372,
  DALCHIPINFO_ID_QCS403      = 373,
  DALCHIPINFO_ID_SA8155      = 374,
  DALCHIPINFO_ID_IPQ8070     = 375,
  DALCHIPINFO_ID_IPQ8071     = 376,
  DALCHIPINFO_ID_SA6155P     = 377,
  DALCHIPINFO_ID_SA6150P     = DALCHIPINFO_ID_SA6155P,
  DALCHIPINFO_ID_SA6145P     = DALCHIPINFO_ID_SA6155P,
  DALCHIPINFO_ID_SA4155P     = 380,
  DALCHIPINFO_ID_QCA6595     = 381,
  DALCHIPINFO_ID_QCN7605     = 382,
  DALCHIPINFO_ID_QCN7606     = 383,
  DALCHIPINFO_ID_SC8180X     = DALCHIPINFO_ID_SCX8180,
  DALCHIPINFO_ID_SA6155      = 384,
  DALCHIPINFO_ID_SDM455      = 385,
...
typedef enum
{
  ...
  DALCHIPINFO_FAMILY_MSM8940    = 74,
  DALCHIPINFO_FAMILY_MDM9x65    = 75,
  DALCHIPINFO_FAMILY_SDM660     = 76,
  DALCHIPINFO_FAMILY_SDM630     = 77,
  DALCHIPINFO_FAMILY_MSM8920    = 78,

  DALCHIPINFO_NUM_FAMILIES,
...
typedef uint32 DalChipInfoQFPROMChipIdType;
...
struct DalChipInfo
{
   ...
   DALResult (*GetProcessorNameString)(DalDeviceHandle * _h,  char * szNameString,  uint32  nMaxLength);
   ...
   DALResult (*GetRawDeviceFamily)(DalDeviceHandle * _h,  uint32  nNotUsed,  uint32 * pnId);   
   DALResult (*GetRawDeviceNumber)(DalDeviceHandle * _h,  uint32  nNotUsed,  uint32 * pnId);
   DALResult (*GetQFPROMChipId)(DalDeviceHandle * _h,  uint32  nNotUsed, DalChipInfoQFPROMChipIdType * pnChipId);
...
/**
  ...
  DALCHIPINFO_VERSION_UNKNOWN  -- Version detection failed because of 
...
DalChipInfo_ChipVersion(void)
{
  ...
  if (phChipInfo == NULL)
  {
    ...
    {
      return DALCHIPINFO_VERSION_UNKNOWN;
    }
  }
...
/* ============================================================================
**  Function : DalChipInfo_GetProcessorNameString
** ============================================================================
*/
/**
  Returns the string representing the processor name.

  @param[in,out]  _h             Dal Device Handle given by the caller.
  @param[in,out]  szNameString   Pointer passed by the caller that
                                 will be populated by the driver.
  @param[in]    nMaxLength       Length of the string  to be passed by
...
*/
static __inline DALResult
DalChipInfo_GetProcessorNameString(DalDeviceHandle * _h,  char * szNameString,  uint32  nMaxLength)
{
   if(DALISREMOTEHANDLE(_h))
   {
      DalRemoteHandle *hRemote = (DalRemoteHandle *)DALPREPREMOTEHANDLE(_h);
      return hRemote->pVtbl->FCN_9(DALVTBLIDX(((DalChipInfoHandle *)_h)->pVtbl, GetProcessorNameString ), _h, (char * )szNameString, nMaxLength);
   }
   return ((DalChipInfoHandle *)_h)->pVtbl->GetProcessorNameString( _h, szNameString, nMaxLength);
}
...
{
      DalRemoteHandle *hRemote = (DalRemoteHandle *)DALPREPREMOTEHANDLE(_h);
      return hRemote->pVtbl->FCN_2(DALVTBLIDX(((DalChipInfoHandle *)_h)->pVtbl, GetSerialNumber ), _h, (uint32 )0, (uint32 *)pnSerialNum);
   }
...
{
      DalRemoteHandle *hRemote = (DalRemoteHandle *)DALPREPREMOTEHANDLE(_h);
      return hRemote->pVtbl->FCN_2(DALVTBLIDX(((DalChipInfoHandle *)_h)->pVtbl, GetRawDeviceFamily ), _h, (uint32 )0, (uint32 *)pnId);
   }
   return ((DalChipInfoHandle *)_h)->pVtbl->GetRawDeviceFamily( _h, 0, pnId);
}
...
{
      DalRemoteHandle *hRemote = (DalRemoteHandle *)DALPREPREMOTEHANDLE(_h);
      return hRemote->pVtbl->FCN_2(DALVTBLIDX(((DalChipInfoHandle *)_h)->pVtbl, GetRawDeviceNumber ), _h, (uint32 )0, (uint32 *)pnId);
   }
   return ((DalChipInfoHandle *)_h)->pVtbl->GetRawDeviceNumber( _h, 0, pnId);
}
...
*/
static __inline DALResult
DalChipInfo_GetQFPROMChipId(DalDeviceHandle * _h,  DalChipInfoQFPROMChipIdType * pnQFPROMChipId)
{
   if(DALISREMOTEHANDLE(_h))
{
      DalRemoteHandle *hRemote = (DalRemoteHandle *)DALPREPREMOTEHANDLE(_h);
      return hRemote->pVtbl->FCN_2(DALVTBLIDX(((DalChipInfoHandle *)_h)->pVtbl, GetQFPROMChipId ), _h, (uint32 )0, (uint32 *)pnQFPROMChipId);
   }
   return ((DalChipInfoHandle *)_h)->pVtbl->GetQFPROMChipId( _h, 0, pnQFPROMChipId);
}
