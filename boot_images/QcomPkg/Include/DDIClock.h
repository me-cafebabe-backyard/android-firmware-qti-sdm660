...
struct DalClock
{
   ...
   DALResult (*SelectExternalSource)(DalDeviceHandle * _h,  ClockIdType  nClock,  uint32 nFreqHz, uint32 nSource, uint32  nDivider,  uint32  nM,  uint32  nN,  uint32  n2D);
   ...
   DALResult (*SetExternalSourceDiv)(DalDeviceHandle * _h,  const char * szClock,  uint32  nDivider);
...
** =========================================================================*/
/**
  Set a clock external source Divider given a clock name and a divider.
...
static __inline DALResult
DalClock_SelectExternalSource(DalDeviceHandle * _h, ClockIdType nClock, uint32 nFreqHz, uint32 nSource, uint32  nDivider,  uint32  nM,  uint32  nN,  uint32  n2D)
{
   return ((DalClockHandle *)_h)->pVtbl->SelectExternalSource( _h, nClock, nFreqHz, nSource, nDivider, nM, nN, n2D);
}
