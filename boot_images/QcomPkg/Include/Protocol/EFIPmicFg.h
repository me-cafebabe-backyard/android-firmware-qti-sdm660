...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
02/02/17    cs      add battIdTh in batt_missing_cfg
...
/**
  Protocol version.
*/
#define PMIC_FG_REVISION 0x0000000000010015
...
typedef struct 
{
  ...
  /**<  Battery Aux therm Range Ration in C*/
...
typedef struct
{
  ...
  EFI_PM_FG_SRAM_DEBUG_CFGS         FgSramDbgCfgs;
  /**<  SRAM Debug configs */
...
/** @ingroup efi_pmicFgInit
  ...
  @param[in] BattIdCfgData: BattId config data (EFI_PM_BATTID_CFGDATA_TYPE )
...
EFI_STATUS(EFIAPI *EFI_PMIC_FG_BASIC_INIT) (
    ...
    IN EFI_FG_DEBUG_CFGDATA_TYPE    *pDbgCfgData,
    IN EFI_PM_BATTID_CFGDATA_TYPE   *BattIdCfgData
    );
