...
/** @ingroup efi_tsens_get_temp
  @par Summary
  Gets the temperature in deci degrees Celsius of the requested sensor. The number
...
(EFIAPI *EFI_TSENS_GET_TEMP)(
  IN UINT32 uSensor,
  OUT INT32 *pnTempDeciDegC
);

/* EFI_TSENS_GET_MAX_TEMP */
/** @ingroup efi_tsens_get_max_temp
  @par Summary
  Gets the maximum temperature of all the sensors, in deci degrees Celsius, during
