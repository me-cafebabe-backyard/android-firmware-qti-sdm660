/** @file EFIPmicWled.h
  ...
  Copyright (c) 2012 - 2016, Qualcomm Technologies Inc. All 
  rights reserved. 
...
/* EFI_PM_WLED_SET_DELAY */
/** @ingroup efi_pm_wled_set_delay
  @par Summary
  Sets the delay for after the LED sync write.
  
  @param[in]  PmicDeviceIndex  Primary: 0.
  @param[in]  IledType         ILED type; see #EFI_PM_WLED_ILED_TYPE for 
                               details.
  @param[in]  DelayUSec        Time to delay in microseconds.
 ...
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_WLED_SET_DELAY)(
  IN UINT32 PmicDeviceIndex,
  IN EFI_PM_WLED_LED_TYPE   LedType,
  IN UINT32  DelayUSec
);
...
/* EFI_PM_WLED_SET_SLOPE_COMP */
/** @ingroup efi_pm_wled_set_slope_comp
  @par Summary
  Sets the slope compensation adjustment for the inductor component.
  
  @param[in]  PmicDeviceIndex  Primary: 0.
  @param[in]  ResourceIndex    Resource index. 
  @param[in]  SlopeComp        Slope compensation adjustment.
 ...
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_WLED_SET_SLOPE_COMP)(
  IN UINT32 PmicDeviceIndex, 
  IN UINT32 ResourceIndex,
  IN UINT32 SlopeComp
);
...
/* EFI_PM_WLED_SELECT_PWM_MODE */
/** @ingroup efi_pm_wled_select_pwm_mode
  @par Summary
  Selects the internal digital modulator type.
  
  @param[in]  PmicDeviceIndex  Primary: 0.
  @param[in]  ResourceIndex    Resource index. 
  @param[in]  PwmModeType      Internal digital modulator type; see 
                               #EFI_PM_WLED_PWM_MODE_TYPE for details.
 ...
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_WLED_SELECT_PWM_MODE)(
  IN UINT32                     PmicDeviceIndex, 
  IN UINT32                     ResourceIndex,
  IN EFI_PM_WLED_PWM_MODE_TYPE  PwmModeType
);

/* EFI_PM_WLED_SET_BOOST_MAX_DUTY */
/** @ingroup efi_pm_wled_set_boost_max_duty
  @par Summary
  Selects the maximum duty cycle control for boost.
 
  @param[in]  PmicDeviceIndex  Primary: 0.
  @param[in]  ResourceIndex    Resource index. 
  @param[in]  BstMaxDutyType   Maximum duty cycle control for boost; see 
                               #EFI_PM_WLED_BST_MAX_DUTY_TYPE for details. 
 ...
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_WLED_SET_BOOST_MAX_DUTY)(
  IN UINT32                         PmicDeviceIndex, 
  IN UINT32                         ResourceIndex,
...
/* EFI_PM_WLED_SET_MOD_CLK_CTRL */
/** @ingroup efi_pm_wled_set_mod_clk_ctrl
  @par Summary
  Selects the digital modulator input clock frequency control.
 
  @param[in]  PmicDeviceIndex  Primary: 0.
  @param[in]  ResourceIndex    Resource index. 
  @param[in]  ModClkType       Digital modulator input clock frequency control; 
                               see #EFI_PM_WLED_MOD_CLK_TYPE for details.
 ...
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_WLED_SET_MOD_CLK_CTRL)(
  IN UINT32                    PmicDeviceIndex, 
  IN UINT32                    ResourceIndex,
  IN EFI_PM_WLED_MOD_CLK_TYPE  ModClkType
);

/* EFI_PM_WLED_SET_MOD_DIM_MODE */
/** @ingroup efi_pm_wled_set_mod_dim_mode
  @par Summary
  Selects the modulator dimming mode control.
 
  @param[in]  PmicDeviceIndex  Primary: 0.
  @param[in]  ResourceIndex    Resource index. 
  @param[in]  ModDimModeType   Modulator dimming mode control; see 
                               #EFI_PM_WLED_MOD_DIM_MODE_TYPE for details.
 ...
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_WLED_SET_MOD_DIM_MODE)(
  IN UINT32                         PmicDeviceIndex, 
  IN UINT32                         ResourceIndex,
  IN EFI_PM_WLED_MOD_DIM_MODE_TYPE  ModDimModeType
);

/* EFI_PM_WLED_SET_WARMUP_DELAY */
/** @ingroup efi_pm_wled_set_warmup_delay
  @par Summary
  Controls the WLED bias generator warm-up time.
 
  @param[in]  PmicDeviceIndex  Primary: 0.
  @param[in]  ResourceIndex    Resource index. 
  @param[in]  WarmupDlyType    Warm-up time delay; see 
                               #EFI_PM_WLED_WARMUP_DLY_TYPE for details.
 ...
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_WLED_SET_WARMUP_DELAY)(
  IN UINT32                      PmicDeviceIndex, 
  IN UINT32                      ResourceIndex,
...
/* EFI_PM_WLED_SET_RAMP_TIME */
/** @ingroup efi_pm_wled_set_ramp_time
  @par Summary
  Sets the time to ramp Ilim from 0 to 100% of the Ilim threshold during a 
  soft start.
 
  @param[in]  PmicDeviceIndex  Primary: 0.
  @param[in]  ResourceIndex    Resource index. 
  @param[in]  TimeMicroSec     Ramp time in microseconds. 
 ...
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_WLED_SET_RAMP_TIME)(
  IN UINT32 PmicDeviceIndex, 
  IN UINT32 ResourceIndex,
  IN UINT32 TimeMicroSec
);

/* EFI_PM_WLED_ENABLE_SOFT_START */
/** @ingroup efi_pm_wled_enable_soft_start
  @par Summary
  Enables/disables a soft-start Ilim ramp after the WLED module is enabled.
 
  @param[in]  PmicDeviceIndex  Primary: 0.
  @param[in]  ResourceIndex    Resource index. 
  @param[in]  Enable           If TRUE, enable the soft-start Ilim ramp; 
                               if FALSE, disable the soft-start Ilim ramp.
 ...
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_WLED_ENABLE_SOFT_START)(
  IN UINT32  PmicDeviceIndex, 
  IN UINT32  ResourceIndex,
  IN BOOLEAN Enable
);
...
/* EFI_PM_WLED_FORCE_VMIN */
/** @ingroup efi_pm_wled_force_vmin
  @par Summary
  Forces the selection of an LED output as a feedback node for the boost.
 ...
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_WLED_FORCE_VMIN)(
  IN UINT32                PmicDeviceIndex,
  IN EFI_PM_WLED_LED_TYPE  LedType
);
...
/* EFI_PM_WLED_SELECT_RZ */
/** @ingroup efi_pm_wled_select_rz
  @par Summary
  Selects the compensation resistor.

  @param[in]  PmicDeviceIndex  Primary: 0.
  @param[in]  RzKOhm           Compensation resistor in kiloohms.
 ...
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_WLED_SELECT_RZ)(
  IN UINT32 PmicDeviceIndex, 
  IN UINT32 RzKOhm
);

/* EFI_PM_WLED_SELECT_GM */
/** @ingroup efi_pm_wled_select_gm
  @par Summary
  Selects the GM for the GM stage.

  @param[in]  PmicDeviceIndex  Primary: 0.
  @param[in]  GmSel            GM selection for the GM stage. Following are valid values
                     WLED                         AMOLED
               0:     1/136k,                      1/8k
               1:     1/(136k + 40k),              1/(8k+16k)
               2:     1/(136k + 2*40k)             1/(8k+2*16k)
               3:     1/(136k + 3*40k)             1(8k+3*16k)W
               .....................
              15:      1/(136k + 15*40k)=1/736k    1/(8k+15*16k)=1/248k
 ...
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_WLED_SELECT_GM)(
  IN UINT32 PmicDeviceIndex, 
  IN UINT32 GmSel
);

/* EFI_PM_WLED_ENABLE_SLEEPB */
/** @ingroup efi_pm_wled_enable_sleepb
  @par Summary
  Enables sleep.
 
  @param[in]  PmicDeviceIndex  Primary: 0.
  @param[in]  ResourceIndex    Resource index. 
  @param[in]  Enable           Whether or not sleep is enabled.
 ...
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_WLED_ENABLE_SLEEPB)(
  IN UINT32   PmicDeviceIndex, 
  IN UINT32   ResourceIndex,
  IN BOOLEAN  Enable
);

/* EFI_PM_WLED_SELECT_VREF_CTRL */
/** @ingroup efi_pm_wled_select_vref_ctrl
  @par Summary
  Selects the reference voltage for boost feedback.
 
  @param[in]  PmicDeviceIndex  Primary: 0.
  @param[in]  ResourceIndex    Resource index. 
  @param[in]  MicroVolt        Reference voltage for boost feedback in 
                               millivolts. 
 ...
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_WLED_SELECT_VREF_CTRL)(
  IN UINT32 PmicDeviceIndex, 
  IN UINT32 ResourceIndex,
  IN UINT32 MicroVolt
);
...
/* EFI_PM_WLED_SELECT_HIGH_POLE_CAP */
/** @ingroup efi_pm_wled_select_high_pole_cap
  @par Summary
  Selects the high-pole capacitance.

  @param[in]  PmicDeviceIndex  Primary: 0.
  @param[in]  CpPicoFarad      High-pole capacitance in picofarads.
 ...
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_WLED_SELECT_HIGH_POLE_CAP)(
  IN UINT32 PmicDeviceIndex, 
 ...
 * @param[in] IsHystLvlHigh   : Hysterisis level. High is 50mv and low is 25mv
 * @param[in] RefVoltageMv    : PSM reference voltage in milli volt. Range is 400 to 750mv
 * @param[in] PsmEn           : enable/disable pulse skipping mode 
 * 
 * @return
 *       EFI_SUCCESS        -- Function completed successfully. 
 *       EFI_PROTOCOL_ERROR -- Error occurred during the operation.
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_WLED_CONFIG_PSM)(
  IN UINT32  PmicDeviceIndex,
 ...
 * 
 * @param[in] PmicDeviceIndex : PMIC device index. 0 for primary and 1 for secondary
 * @param[in] IsHystLvlHigh   : Hysterisis level. High is 50mv(WLED) and 12.5mV (AMOLED) and low is 50mv(WLED) and 6.25mv(AMOLED)
 * @param[in] NfetOffTimeNs   : PFM NFET off time in nano seconds. Valid range is 110ns to 480ns. 
 * @param[in] ILimitMa        : PFM current limit in milli amp. Valid range is 130 to 340 milli amp. 
 * @param[in] PsmEn           : enable/disable pulse frequency mode
 * 
 * @return
 *       EFI_SUCCESS        -- Function completed successfully. 
 *       EFI_PROTOCOL_ERROR -- Error occurred during the operation.
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_WLED_CONFIG_PFM)(
  IN UINT32  PmicDeviceIndex,
  IN BOOLEAN IsHystLvlHigh,
...
/**
 * @brief This function configures short circuit protection parameter
 * 
 * @param[in] PmicDeviceIndex      : PMIC device index. 0 for primary and 1 for secondary
 * @param[in] ShortCktConfig  : Short circuit configuration. Refer #EFI_PM_WLED_SHORT_CKT_CONFIG_TYPE for more info
 * 
 * @return
 *       EFI_SUCCESS        -- Function completed successfully. 
 *       EFI_PROTOCOL_ERROR -- Error occurred during the operation.
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_WLED_CONFIG_SHORT_CKT_PROTECT)(
  IN UINT32                            PmicDeviceIndex, 
 ...
 /**
 * @brief This function configures SH, soft start and other various test parameters
 * 
 * @param[in] PmicDeviceIndex : PMIC device index. 0 for primary and 1 for secondary
 * @param[in] ShType          : Different type SH and soft start type. Refer #EFI_PM_WLED_SH_CONFIG_TYPE for more info
 ...
 */
typedef
EFI_STATUS (EFIAPI *EFI_PM_WLED_CONFIG_SH_SOFT_START)(
   IN UINT32                     PmicDeviceIndex, 
...
struct _EFI_QCOM_PMIC_WLED_PROTOCOL {
  ...
  EFI_PM_WLED_SET_DELAY                   SetDelay;
  ...
  EFI_PM_WLED_SET_SLOPE_COMP              SetSlopeComp;
  EFI_PM_WLED_ENABLE_CABC                 EnableCabc;
  EFI_PM_WLED_ENABLE_SYNC                 EnableSync;
  EFI_PM_WLED_SELECT_PWM_MODE             SelectPwmMode;
  EFI_PM_WLED_SET_BOOST_MAX_DUTY          SetBoostMaxDuty;
  EFI_PM_WLED_SET_FSW_CTRL                SetFswCtrl;
  EFI_PM_WLED_SET_MOD_CLK_CTRL            SetModClkCtrl;
  EFI_PM_WLED_SET_MOD_DIM_MODE            SetModDimMode;
  EFI_PM_WLED_SET_WARMUP_DELAY            SetWarmupDelay;
  EFI_PM_WLED_SET_OVP_THRESHOLD           SetOvpThreshold;
  EFI_PM_WLED_SET_RAMP_TIME               SetRampTime;
  EFI_PM_WLED_ENABLE_SOFT_START           EnableSoftStart;
  EFI_PM_WLED_SET_BOOST_ILIMIT            SetBoostIlimit;
  EFI_PM_WLED_FORCE_VMIN                  ForceVmin;
  EFI_PM_WLED_SELECT_SLEW_RATE            SelectSlewRate;
  EFI_PM_WLED_SET_AMOLED_VOUT             SetAmoledVout;
  EFI_PM_WLED_SELECT_RZ                   SelectRz;
  EFI_PM_WLED_SELECT_GM                   SelectGm;
  EFI_PM_WLED_ENABLE_SLEEPB               EnableSleepb;
  EFI_PM_WLED_SELECT_VREF_CTRL            SelectVrefCtrl;
  EFI_PM_WLED_SELECT_HIGH_POLE_CAP        SelectHighPoleCap;
  EFI_PM_WLED_EN_AMOLED                   EnAmoled;
  EFI_PM_WLED_CONFIG_PSM                  ConfigPsm;
  EFI_PM_WLED_CONFIG_PFM                  ConfigPfm;
  EFI_PM_WLED_GET_STATUS                  GetStatus;               
  EFI_PM_WLED_CONFIG_SHORT_CKT_PROTECT    ConfigShortCktProtect; 
  EFI_PM_WLED_CONFIG_SH_SOFT_START        ConfigShSoftStart;     
