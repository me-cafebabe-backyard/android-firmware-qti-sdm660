...
--------   ---     -----------------------------------------------------------
05/24/17   pbitra  Updated invalid port type enum
04/03/17   pbitra  Add re run APSD 
...
#define PMIC_SCHG_REVISION 0x0000000000010009
...
/* EFI_PMIC_SCHG_CONFIG_APSD */
/** @ingroup EFI_PmicSchgConfigApsd
@par Summary
...
/** @ingroup EFI_PmicSchgConfigHvdcp
@par Summary
Sets value for charger HVDCP enable bit
