...
#ifndef __EFI_WIN_DSDT_UPDATE_H__
#define __EFI_WIN_DSDT_UPDATE_H__
...
MACRO DECLARATIONS
===========================================================================*/
/** @ingroup efi_WIN_DSDT_UPDATE_constants
Protocol version. */
#define EFI_WIN_DSDT_UPDATE_PROTOCOL_REVISION 0x0000000000010000

/* Protocol GUID definition */
#define EFI_WIN_DSDT_UPDATE_PROTOCOL_GUID \
...
===========================================================================*/
/** @cond */
/* External reference to the WinDsdtUpdate Protocol GUID. */
extern EFI_GUID gEfiWinDsdtUpdateProtocolGuid;

/*===========================================================================
TYPE DEFINITIONS
===========================================================================*/
/* Protocol declaration */
typedef struct _EFI_WIN_DSDT_UPDATE_PROTOCOL EFI_WIN_DSDT_UPDATE_PROTOCOL;
/** @endcond */

/** @cond */
/** Type definition for the #EFI_WIN_DSDT_TYPE enumeration. */
...
@param[in]  This              Pointer to the WIN_DSDT_UPDATE_PROTOCOL instance.
...
PROTOCOL INTERFACE
===========================================================================*/
/** @ingroup efi_win_dsdt_update_protocol
@par Summary
EFI_WIN_DSDT_UPDATE_PROTOCOL Protocol interface.
*/
struct _EFI_WIN_DSDT_UPDATE_PROTOCOL {
	UINT64							Revision;
...
#endif	/* __EFI_WIN_DSDT_UPDATE_H__ */
