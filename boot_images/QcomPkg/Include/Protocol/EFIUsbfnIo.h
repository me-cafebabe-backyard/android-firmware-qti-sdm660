/**
  @file  EFIUsbfnIo.h
  @brief EFI USB Function Protocol.
*/
/*
  UEFI USB Function Protocol Draft Version 0.9
  (UEFI_USBfn_Protocol_Draft_v0.9.pdf)

  UEFI environment requires a generic and lightweight
  transport over USB to be able to update the phone, download memory captures,
  and develop various utilities that need bidirectional communication
  capability between device and host computer. UEFI specification version 2.3
  lacks an USB function protocol.

  This document contains the proposed definition of the USB function protocol
  which allows a driver implementing the protocol to enable communication
  between device and host computer in a pre-boot environment.

  References:
  [1] Unified EFI Forum, "UEFI Extensible Firmware Interface Specification,
      Version 2.3 Errata B," February 25, 2010. http://www.uefi.org.
  [2] "Battery Charging Specification, Revision 1.1", April 15, 2009.
      http://www.usb.org
...
*/
/*===========================================================================
NOTE: The @brief description and any detailed description above are not
      generated from the header file.

      The EFI_Proto_Spec_Snapdragon_mainpage.dox file contains all file/group
      descriptions that are in the output PDF generated using Doxygen and
      LaTeX. To edit or update any of the file/group text in the PDF, edit the
      EFI_Proto_Spec_Snapdragon_mainpage.dox file or contact Tech Pubs.

      The above description for this file is part of the "efi_UsbfnIo"
      group description in the EFI_Proto_Spec_Snapdragon_mainpage.dox file.

===========================================================================*/
/*=============================================================================
  Copyright (c) 2011-2012,2014-2016 Qualcomm Technologies, Incorporated.
  All rights reserved.
...
/*=============================================================================
 ...
 11/20/14   ml      Add SuperSpeed support
 08/21/14   ck      Include QC version of EFIUsbIo.h
 ...
 06/24/11   cching  Port UsbfnIo to UEFI
=============================================================================*/
...
typedef enum _EFI_USBFN_MESSAGE
{
  ...
  /**< Bus Speed event was signaled. The payload is #_EFI_USB_BUS_SPEED. @newpage */
...
typedef EFI_USB_SS_ENDPOINT_COMPANION_DESCRIPTOR    EFI_USB_SUPERSPEED_ENDPOINT_COMPANION_DESCRIPTOR;
...
(EFIAPI *EFI_USBFN_IO_TRANSFER)(
  ...
  IN UINT8                         EndpointIndex,
  IN EFI_USBFN_ENDPOINT_DIRECTION  Direction,
  IN UINTN                         *BufferSize, // TODO: should defined as IN in draft
  IN VOID                          *Buffer // TODO: should be defined as OPTIONAL IN
                                           // in draft.
  );
