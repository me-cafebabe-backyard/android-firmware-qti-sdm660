...
typedef enum
{
    PM_SCHG_USB_CONNECTOR_TYPEC,
    PM_SCHG_USB_CONNECTOR_MICRO_USB,
    PM_SCHG_USB_CONNECTOR_INVALID
...
/**
* @brief This function sets the USB connector configuration
*
* @param[in]   device_index. Primary: 0. Secondary: 1
* @param[in]  usb_connector: see pm_schg_usb_connector_type for details
*
* @return  pm_err_flag_type
*          PM_ERR_FLAG__FEATURE_NOT_SUPPORTED = Feature not available on this
*          version of the PMIC.
