...
--------   ---     ---------------------------------------------------------- 
05/02/17   sv      add API to get sysok reason status
...
typedef struct {
  ...
  boolean buck_oc;                   /* 0 = Buck not in OC State, 1 = Buck in OC State */
...
typedef struct {
  ...
  boolean icl_override_latch;        /* ICL Override in effect */
...
typedef struct {
  boolean sysok_reason_status_7;         /* TBD - Reads 0*/
  boolean sysok_reason_status_6;         /* TBD - Reads 0*/
  boolean sysok_reason_status_5;         /* TBD - Reads 0*/
  boolean sysok_reason_status_4;         /* TBD - Reads 0*/
  boolean sysok_reason_status_3;         /* TBD - Reads 0*/
  boolean sysok_reason_status_2;         /* TBD - Reads 0*/
  boolean sysok_reason_dcin;             /* DCIN plugin generated SYSOK */
  boolean sysok_reason_usbin;            /* USBIN plugin generated SYSOK */
}pm_schg_misc_sysok_reason_status; 
...
/**
* @brief This function reads the schg misc sysok reason status
* 
* @details
*  This function returns reads the schg misc sysok reason status
* 
* @param[in] pmic_device_index.   Primary: 0 Secondary: 1
* @param[out] misc_sysok_rsn_sts refer pm_schg_misc_sysok_reason_status
*                                
*
* @return  pm_err_flag_type 
*          PM_ERR_FLAG__FEATURE_NOT_SUPPORTED = Feature not available on this
