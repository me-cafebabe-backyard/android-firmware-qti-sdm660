 ...
 *  \n
 *  \n &copy; Copyright 2003-2013 QUALCOMM Technologies Incorporated, All Rights Reserved
 */
/* ======================================================================= */
...
--------   ---     ---------------------------------------------------------- 
10/10/15   aab     Added PM_ERR_FLAG__PAR_OUT_OF_RANGE
...
typedef enum
{
   ...
   PM_ERR_FLAG__INVALID_RESOURCE_ACCESS_ATTEMPTED,
    ...
    PM_ERR_FALG__SBL_WEAK_BATT_CHG_FORCE_EDL_DETECTED,
