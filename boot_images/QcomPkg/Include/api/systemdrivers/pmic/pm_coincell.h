 ...
 *
 *  \n &copy; Copyright (c) 2009-2015 QUALCOMM Technologies Incorporated. All Rights Reserved.
 */
...
/*===========================================================================
  ...
  $Header: //components/rel/boot.xf/1.4/QcomPkg/Include/api/systemdrivers/pmic/pm_coincell.h#2 $
