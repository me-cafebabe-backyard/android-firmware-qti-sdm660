...
--------    ----    ---------------------------------------------------------
12/12/16    mr      Added Stuct type 'pm_peripheral_revision_type'
11/14/16    mr      Added ENUM type 'peripheral_reg_info_type'
...
typedef enum
{
    ...
    PM_SW_MODE_BYPASS = 1,         /* Bypass mode */
    PM_SW_MODE_AUTO = 2,           /* Auto mode */
    PM_SW_MODE_RETENTION = 3,      /* Retention mode. */
    PM_SW_MODE_NPM = 4,            /* Normal Power mode */
    PM_SW_MODE_INVALID
