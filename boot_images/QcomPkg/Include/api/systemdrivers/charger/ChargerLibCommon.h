...
11/28/16    mr      Added PmicIndex in ChargerHW and BatteryGaugeHW Info data
...
typedef enum
{
  ...
  CHARGERLIB_ERROR_ACTION_SHUTDOWN_USB_DC_PON_DISABLED,
  /**< Action required for shutdown error */
...
typedef struct
{
  UINT32   battery_id_tolerance;
  /**< Battery ID Tolerance Percentage */

  UINT32  debug_board_battery_id_min;
  /**<  Debug board Battery ID Range Min */

  UINT32  debug_board_battery_id_max;
  /**<  Debug board Battery ID Range Max */

  UINT32 regular_battery_id_min;
  /**< Regular Battery ID Range Min */

  UINT32 regular_battery_id_max;
  /**<  Regular Battery ID Range Max */

  UINT32 smart_battery_id_min;
  /**< Smart Battery ID Range Min */

  UINT32 smart_battery_id_max;
  /**<  Smart Battery ID Range Max */
}chargerlib_battid_cfgdata_type;
...
typedef struct
{
  ...
  UINT32   disp_sign_of_life_max_threshold_mv;
  ...
  chargerlib_battid_cfgdata_type batt_id_cfg_data;
  chargerlib_thermal_configs     thermal_configs;
  chargerlib_wipower_configs     wipower_configs;
...
===========================================================================*/
EFI_STATUS ChargerLibCommon_InitConfiguration(chargerlib_cfgdata_type *ChargerLibConfig);

EFI_STATUS ChargerLibCommon_Init( void);
