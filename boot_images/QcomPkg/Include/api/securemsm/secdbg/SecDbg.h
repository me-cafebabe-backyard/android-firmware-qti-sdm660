...
* Copyright (c) 2014-2015 by QUALCOMM, Technology Inc.  All Rights Reserved.
*/
...
#define SEC_DBG_REVISION_NUMBER                 3 
...
typedef struct __attribute__((__packed__))  
{
        ...
        uint8  root_cert_hash_array_qc[SEC_DBG_CERT_ARRAY_SIZE][CEML_HASH_DIGEST_SIZE_SHA256]; /* Hash Array*/
} sec_dbg_t;
