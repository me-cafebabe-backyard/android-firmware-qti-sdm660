...
/* This will later be defined by compiler as the just the filename
   without full path */
#ifndef __FILE_BASENAME__ 
#define __FILE_BASENAME__ __FILE__
//#else
//#define __FILE_BASENAME__ "LineNum"
#endif
...
**/
#define _ASSERT(Expression)  DebugAssert (__FILE_BASENAME__, __LINE__, #Expression)
...
/**  
  ...
  If MDEPKG_NASSERT is not defined and the DEBUG_PROPERTY_DEBUG_ASSERT_ENABLED 
...
#if !defined(PRODMODE)
  #define ERROR_LEVEL_MASK (EFI_D_ERROR | EFI_D_WARN)
#else
  #define ERROR_LEVEL_MASK (EFI_D_ERROR)
#endif

#define EXTRACT_LEVEL(ErrorLevel, Ignore, ...) (ErrorLevel & ERROR_LEVEL_MASK)
/**  
...
/**  
  ...
  If MDEPKG_NASSERT is defined or the DEBUG_PROPERTY_DEBUG_ASSERT_ENABLED bit 
...
/**
  ...
  If MDEPKG_NASSERT is not defined and the DEBUG_PROPERTY_DEBUG_ASSERT_ENABLED bit
...
**/
  ...
  #define CR(Record, TYPE, Field, TestSignature)                                              \
    (TRUE && (BASE_CR (Record, TYPE, Field)->Signature != TestSignature)) ?  \
