...
$Header: //components/rel/boot.xf/1.4/QcomPkg/Include/Library/HALclkInternal.h#3 $
...
/*
 * HAL_CLK_MAX_MAPPED_SOURCES
 *
 * Define a max sources used to decode mapping to/from HW
 */
#define HAL_CLK_MAX_MAPPED_SOURCES   8
...
typedef struct HAL_Clk_ExtDividerNodeType  HAL_Clk_ExtDividerNodeType;
 ...
 * eConfigType - (optional) Clock configuration value.
 *
 */
struct HAL_clk_ClockDescType
{
  ...
  uint32                         nTestClock;
  HAL_clk_ClockConfigType        eConfigType;
};
...
typedef enum
{
  ...
  HAL_CLK_PLL_SPARK_HMSS,
  HAL_CLK_PLL_FABIA,
  HAL_CLK_PLL_BRAMMO_BEAR,
  HAL_CLK_PLL_PIPPO,
  HAL_CLK_PLL_AGERA,
...
/**
 * HAL_Clk_ExtDividerNodeType
 * Description of Clock external Divider node type.
 */
struct HAL_Clk_ExtDividerNodeType
{
  const char                    *szName;            /**< Clock name string */
  size_t                         nExtDivAddr;       /**< Htandle o HAL data */
};
...
void HAL_clk_InstallClockDomain  ( HAL_clk_ClockDomainDescType * pmClockDomainDesc, size_t nBaseAddress );
void HAL_clk_InstallClockDomains ( HAL_clk_ClockDomainDescType ** pmClockDomainDesc, size_t nBaseAddress );
void HAL_clk_InstallSource       ( HAL_clk_SourceType eSource, HAL_clk_SourceControlType *pControl, void *pContext);
void HAL_clk_InstallPowerDomain  ( HAL_clk_PowerDomainDescType * pmPowerDomainDesc, size_t nBaseAddress );
void HAL_clk_InstallPowerDomains ( HAL_clk_PowerDomainDescType ** pmPowerDomainDesc, size_t nBaseAddress );
...
HAL_clk_ClockControlSetResetMask

Description:
   Sets reset mask for the given clock.

==============================================================================

HAL_clk_ClockControlSetInvertMask

Description:
   Sets invert mask for the given clock.

==============================================================================

HAL_clk_ClockControlSetEnableMask

Description:
   Sets enable mask for the given clock.

==============================================================================

HAL_clk_ClockControlClearEnableMask

Description:
   Clears enable mask for the given clock.

==============================================================================

HAL_clk_ClockControlCheckIsEnabledMask

Description:
   Checks if enable mask is set for the given clock.

==============================================================================

HAL_clk_ClockControlCheckInvIsEnabledMask

Description:
   Checks if enable mask is not set for the given clock.

==============================================================================

HAL_clk_ClockControlCheckIsOnMask

Description:
   Checks if ON mask is set for the given clock.

==============================================================================

HAL_clk_ClockControlCheckInvIsOnMask

Description:
   Checks if ON mask is not set for the given clock.
...
Description:
   Sets source to TCXO for the given clock.
...
Description:
   Sets source to EXTERNAL for the given clock.
...
Description:
   Sets source to SLEEPCLK for the given clock.
