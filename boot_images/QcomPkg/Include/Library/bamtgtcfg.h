...
*/
const bam_target_config_type* bam_tgt_getcfg(uint64 bam_pa);
...
*/
uint32 bam_tgt_getpipelockgroup(uint64 bam_pa, uint32 pipe_num);
...
*/
uint64 bam_tgt_getpipememstartaddr(void);
...
*/
uint64 bam_tgt_getpipememendaddr(void);
