...
/**
   ...
   Returns the temperature for a given sensor in deci degrees C.
   The number of sensors can be obtained by calling
   Tsens_GetNumSensors.

   @param uSensor: [in] sensor index (zero-based).
   @param pnDeciDegC: [out] temperature in deci degrees C.
...
/**
   ...
   measurement in deci degrees C.

   @param pnMaxDeciDegC: [out] maximum temperature in deci degrees C.
