...
#define JTAG_DEBUG_DISABLED (JTAGDebugDisableFusesBlown())
#define JTAG_DEBUG_ENABLED  (JTAG_DEBUG_DISABLED == FALSE)

#define RETAIL ((PRODMODE_ENABLED) || (JTAG_DEBUG_DISABLED))
