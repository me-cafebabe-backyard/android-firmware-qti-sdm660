...
typedef enum
{
  ...
  DALPLATFORMINFO_TYPE_CDP          = 0x01,  /**< Target is a CDP device. */
  ...
  DALPLATFORMINFO_TYPE_MTP          = 0x08,  /**< Target is a MTP device. */
  ...
  DALPLATFORMINFO_TYPE_CLS          = 0x1D,  /**< Target is a CLS device. */
