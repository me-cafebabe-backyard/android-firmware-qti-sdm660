...
void HAL_DSI_Init(DSI_Device_IDType  eDeviceID)
{
  ...
  out_dword(uOffset + HWIO_MMSS_DSI_0_CTRL_ADDR, 0);
...
void HAL_DSI_Reset(DSI_Device_IDType        eDeviceID)
{
  ...
  /*Reset DSI HW */
  out_dword(uOffset + HWIO_MMSS_DSI_0_SOFT_RESET_ADDR, HWIO_MMSS_DSI_0_SOFT_RESET_DSI_SOFT_RESET_BMSK);

  /* Clear Reset Bit */
  out_dword(uOffset + HWIO_MMSS_DSI_0_SOFT_RESET_ADDR, 0);
  ...
  uDsiHSTimerReg = in_dword(uOffset + HWIO_MMSS_DSI_0_HS_TIMER_CTRL_ADDR);
  ...
  out_dword(uOffset + HWIO_MMSS_DSI_0_HS_TIMER_CTRL_ADDR, uDsiHSTimerReg);

  /* Reset TPG FIFO*/
  out_dword(uOffset + HWIO_MMSS_DSI_0_TPG_DMA_FIFO_RESET_ADDR, HWIO_MMSS_DSI_0_TPG_DMA_FIFO_RESET_FIFO_RESET_BMSK); 
  out_dword(uOffset + HWIO_MMSS_DSI_0_TPG_DMA_FIFO_RESET_ADDR, 0); 
                           ...
                           uint32             *puDsiStatus)
{
  ...
  else
  {
    ...
    *puDsiStatus   =  0;
    ...
    uDsiHWLaneStatusReg = in_dword(uOffset + HWIO_MMSS_DSI_0_LANE_STATUS_ADDR);
                        ...
                        uint32             *puDsiStatus)
{
  ...
  else
  {
    *puDsiStatus = 0;
    ...
    /* Get the HW generated DSI Status. */
    uDsiHWStatusReg = in_dword(uOffset + HWIO_MMSS_DSI_0_STATUS_ADDR);
                         ...
                         uint32               uClockConfig)
{
  ...
  uClkCtrlReg  |= HWIO_MMSS_DSI_0_CLK_CTRL_DSI_FORCE_ON_DYN_AHBS_HCLK_BMSK;
  uClkCtrlReg  |= HWIO_MMSS_DSI_0_CLK_CTRL_DSI_FORCE_ON_DYN_DSICLK_BMSK;
  uClkCtrlReg  |= HWIO_MMSS_DSI_0_CLK_CTRL_DSI_FORCE_ON_DYN_BYTECLK_BMSK;  
  uClkCtrlReg  |= HWIO_MMSS_DSI_0_CLK_CTRL_DSI_AHBM_HCLK_HYSTERISIS1_CTRL_BMSK;
  uClkCtrlReg  |= HWIO_MMSS_DSI_0_CLK_CTRL_DSI_AHBS_HCLK_HYSTERISIS1_CTRL_BMSK;
  uClkCtrlReg  |= HWIO_MMSS_DSI_0_CLK_CTRL_DSI_DSICLK_HYSTERISIS1_CTRL_BMSK;
  */

  out_dword(uOffset + HWIO_MMSS_DSI_0_CLK_CTRL_ADDR, uClkCtrlReg);
...
{
  uintPtr uOffset  = HAL_DSI_GetRegBaseOffset(eDeviceID);
  uint32  uRegVal  = in_dword(uOffset + HWIO_MMSS_DSI_0_CTRL_ADDR);
  ...
  out_dword(uOffset + HWIO_MMSS_DSI_0_CTRL_ADDR, uRegVal);
}
...
void HAL_DSI_Init_LP11(DSI_Device_IDType    eDeviceID)
{
  ...
  iDsiCtrlReg = HWIO_MMSS_DSI_0_CTRL_DSI_EN_BMSK  |
                HWIO_MMSS_DSI_0_CTRL_DLN0_EN_BMSK |
                HWIO_MMSS_DSI_0_CTRL_DLN1_EN_BMSK |
                HWIO_MMSS_DSI_0_CTRL_DLN2_EN_BMSK |
                HWIO_MMSS_DSI_0_CTRL_DLN3_EN_BMSK |
                HWIO_MMSS_DSI_0_CTRL_CLKLN_EN_BMSK;
    
  out_dword(uOffset + HWIO_MMSS_DSI_0_CTRL_ADDR, iDsiCtrlReg);    
}
                        ...
                        HAL_DSI_WritePacketType  *psWritePacket)
{
  ...
  else
  {
    ...
    /* Register write */
    out_dword(uOffset + HWIO_MMSS_DSI_0_COMMAND_MODE_DMA_CTRL_ADDR, uCmdDmaCtrlReg);
    out_dword(uOffset + HWIO_MMSS_DSI_0_DMA_CMD_LENGTH_ADDR,        psWritePacket->uPayloadLen);
    
    /*Check the DSI command is sent via DMA VBIF or TPG FIFO */
    if (0 == (psWritePacket->uFlags & HAL_DSI_FLAG_DATA_FETCH_VIA_FIFO))
    {
      out_dword(uOffset + HWIO_MMSS_DSI_0_DMA_CMD_OFFSET_ADDR,        psWritePacket->uPhyAddress);

      /* Disable TPG FIFO */
      uRegVal = in_dword(uOffset + HWIO_MMSS_DSI_0_TEST_PATTERN_GEN_CTRL_ADDR);
      ...
      out_dword(uOffset + HWIO_MMSS_DSI_0_TEST_PATTERN_GEN_CTRL_ADDR, uRegVal);
    }
    else
    {
      ...
      for (i = 0; i< uPayloadLengthInWord; i++)
      {
        /* Write in to FIFO*/
        uRegVal = pPayLoad[i];
        out_dword(uOffset + HWIO_MMSS_DSI_0_TEST_PATTERN_GEN_CMD_DMA_INIT_VAL_ADDR, uRegVal);
        uNumWrites++;
      }
      ...
      if((uNumWrites %2 ) != 0)
      {
        out_dword(uOffset + HWIO_MMSS_DSI_0_TEST_PATTERN_GEN_CMD_DMA_INIT_VAL_ADDR, 0);
      }
    }
  }
}
    ...
    */
    ...
    else
    {
          ...
          (0 != (uErrorStatus & HAL_DSI_ACK_ERROR_SINGLE_ECC_ERR)))
      {
        ...
        *puReadDataReg32 = in_dword(uOffset + HWIO_MMSS_DSI_0_RDBK_DATA3_ADDR);
        SwapEndian(*puReadDataReg32 , *puReadDataReg32 );
        puReadDataReg32++;
        *puReadDataReg32 = in_dword(uOffset + HWIO_MMSS_DSI_0_RDBK_DATA2_ADDR);
        SwapEndian(*puReadDataReg32 , *puReadDataReg32 );
        puReadDataReg32++;
        *puReadDataReg32 = in_dword(uOffset + HWIO_MMSS_DSI_0_RDBK_DATA1_ADDR);
        SwapEndian(*puReadDataReg32 , *puReadDataReg32 );
        puReadDataReg32++;
        *puReadDataReg32 = in_dword(uOffset + HWIO_MMSS_DSI_0_RDBK_DATA0_ADDR);
        SwapEndian(*puReadDataReg32 , *puReadDataReg32 );
                     ...
                     HAL_DSI_TriggerFlagType   eFlag)
{
  ...
  switch(eFlag)
  {
    ...
    { 
      out_dword(uOffset + HWIO_MMSS_DSI_0_CMD_MODE_DMA_SW_TRIGGER_ADDR, 0x01);
      break;
    }
    case DSI_TriggerFlag_MDP_SW:
    { 
      out_dword(uOffset + HWIO_MMSS_DSI_0_CMD_MODE_MDP_SW_TRIGGER_ADDR, 0x01);
      break;
    }
    case DSI_TriggerFlag_BTA_SW:
    { 
      out_dword(uOffset + HWIO_MMSS_DSI_0_CMD_MODE_BTA_SW_TRIGGER_ADDR, 0x01);
      break;
    }
    case DSI_TriggerFlag_RESET_SW:
    { 
      out_dword(uOffset + HWIO_MMSS_DSI_0_RESET_SW_TRIGGER_ADDR,        0x01);
      break;
    }
    default:
    {
...
{
  uint32      uVersionInfo = in_dword(HWIO_MMSS_DSI_0_HW_VERSION_ADDR);
