...
typedef struct
{
  ...
  /* Reconfigures PHY to setup a different refresh rate */
  HAL_MDSS_ErrorType (*HAL_DSI_PhyReConfigure) (DSI_Device_IDType eDeviceID, uint32 uRefreshRate);
...
HAL_MDSS_ErrorType HAL_DSI_2_1_0_PhyPllPowerCtrl(DSI_Device_IDType eDeviceId, bool32 bPllPowerUp);
HAL_MDSS_ErrorType HAL_DSI_2_1_0_PhySetup(DSI_Device_IDType eDeviceId, HAL_DSI_PhyConfigType *psDsiPhyConfig);
HAL_MDSS_ErrorType HAL_DSI_2_1_0_PhyPllSetup(HAL_DSI_PhyConfigType *psDsiPhyConfig, HAL_DSI_PhyConfigInfoType *psDsiPhyConfigInfo);
