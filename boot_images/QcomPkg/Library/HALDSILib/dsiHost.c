    ...
    DSI_PropertyParamsType   *pPropertyData)
{
  ...
  switch(eProperty)
  {
    ...
    case DSI_DISPLAY_PROPERTYID_LANESTATE:
      {
        ...
        {
          sLaneConfig.eClockLaneOp = DSI_LANE_OP_ULPS_REQUEST;
          sLaneConfig.eDataLaneOp  = DSI_LANE_OP_ULPS_REQUEST;       
        ...
        {
          // (1) exit ULPS
          sLaneConfig.eClockLaneOp = DSI_LANE_OP_ULPS_EXIT;
          sLaneConfig.eDataLaneOp  = DSI_LANE_OP_ULPS_EXIT;
          HAL_DSI_LaneConfig(eDeviceId, &sLaneConfig);
          ...
          sLaneConfig.eClockLaneOp = DSI_LANE_OP_ULPS_REQUEST_CLEAR;
          sLaneConfig.eDataLaneOp  = DSI_LANE_OP_ULPS_REQUEST_CLEAR;          
          HAL_DSI_LaneConfig(eDeviceId, &sLaneConfig);          

          // (4) clear ULPS_EXIT
          // this has to be done after (3) to avoid metastability issues
          sLaneConfig.eClockLaneOp = DSI_LANE_OP_ULPS_EXIT_CLEAR;
          sLaneConfig.eDataLaneOp  = DSI_LANE_OP_ULPS_EXIT_CLEAR;
          HAL_DSI_LaneConfig(eDeviceId, &sLaneConfig); 
        }
    ...
    case DSI_DISPLAY_PROPERTYID_LANEMAP:
      {
        HAL_DSI_LaneMapConfig(eDeviceId, pPropertyData->aLaneMap);  
      }
      break;
    default:
