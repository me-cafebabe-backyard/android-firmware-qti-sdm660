                                   ...
                                   uint32               uInterruptSource)
{
  ...
  else
  {
    ...
    out_dword(uOffset + HWIO_MMSS_DSI_0_INT_CTRL_ADDR, uIntrEnableReg );
  }
                                  ...
                                  uint32             *puInterruptSource)
{
  ...
  else
  {
    ...
    uIntrEnableReg  = in_dword(uOffset + HWIO_MMSS_DSI_0_INT_CTRL_ADDR);
                                ...
                                uint32             *puErrorCode)
{
  ...
  else
  {
    *puErrorCode                      = 0;
    ...
    uIntrStatusReg  = in_dword(uOffset + HWIO_MMSS_DSI_0_INT_CTRL_ADDR);
...
{
  uintPtr uOffset            = HAL_DSI_GetRegBaseOffset(eDeviceID);
  uint32  uIntrStatusReg     = in_dword(uOffset + HWIO_MMSS_DSI_0_INT_CTRL_ADDR);
  ...
  /* Enable the HW interrupts. */
  out_dword(uOffset + HWIO_MMSS_DSI_0_INT_CTRL_ADDR, uIntrStatusReg);
                                  ...
                                  uint32                  uErrorSource)
{
  ...
  else
  {
    ...
    out_dword(uOffset + HWIO_MMSS_DSI_0_ERR_INT_MASK0_ADDR, uErrorIntrEnableReg);
  }
}
                                  ...
                                  uint32                 *puErrorSource)
{
  ...
  else
  {
    ...
    uErrorIntrEnableReg = in_dword(uOffset + HWIO_MMSS_DSI_0_ERR_INT_MASK0_ADDR);
                                ...
                                uint32             *puErrorCode)
{
  ...
  else
  {
    *puErrorCode                      = 0;
    ...
    /**************************************************/
    uDL0PhyErrorIntrStatusReg =  in_dword(uOffset + HWIO_MMSS_DSI_0_DLN0_PHY_ERR_ADDR);
    ...
    /**************************************************/
    uFifoErrorIntrStatusReg =  in_dword(uOffset + HWIO_MMSS_DSI_0_FIFO_STATUS_ADDR);
    ...
    /**************************************************/
    uTimeoutErrIntrStatusReg =  in_dword(uOffset + HWIO_MMSS_DSI_0_TIMEOUT_STATUS_ADDR);
    ...
    /**************************************************/
    uAckErrIntrStatusReg =  in_dword(uOffset + HWIO_MMSS_DSI_0_ACK_ERR_STATUS_ADDR);
                                ...
                                uint32                uErrorStatus)
{
  ...
  {
    out_dword(uOffset + HWIO_MMSS_DSI_0_DLN0_PHY_ERR_ADDR, uDL0PhyErrorIntrStatusReg );
  }

  if( uFifoErrorIntrStatusReg != 0)
  {
    out_dword(uOffset + HWIO_MMSS_DSI_0_FIFO_STATUS_ADDR, uFifoErrorIntrStatusReg );
  }

  if( uTimeoutErrIntrStatusReg != 0)
  {
    out_dword(uOffset + HWIO_MMSS_DSI_0_TIMEOUT_STATUS_ADDR, uTimeoutErrIntrStatusReg );
  }
  ...
  if( uAckErrIntrStatusReg != 0)
  {
    ...
    uAckErrIntrStatusReg &= in_dword(uOffset + HWIO_MMSS_DSI_0_ACK_ERR_STATUS_ADDR);
    out_dword(uOffset + HWIO_MMSS_DSI_0_ACK_ERR_STATUS_ADDR, uAckErrIntrStatusReg);
    out_dword(uOffset + HWIO_MMSS_DSI_0_ACK_ERR_STATUS_ADDR, 0);
  }
                                  ...
                                  uint32               *puErrorStatus)
{
  ...
  else
  {
    *puErrorStatus              = 0;
    ...
    uDsiAckErrorStatusReg = in_dword(uOffset + HWIO_MMSS_DSI_0_ACK_ERR_STATUS_ADDR);
                                 ...
                                 uint32               uErrorStatus)
{
  ...
  if(0 != uDsiAckErrorStatusReg )
  {
    /* need to write '1' and then '0' to clear the error */
    uDsiAckErrorStatusReg &= in_dword(uOffset + HWIO_MMSS_DSI_0_ACK_ERR_STATUS_ADDR);
    out_dword(uOffset + HWIO_MMSS_DSI_0_ACK_ERR_STATUS_ADDR, uDsiAckErrorStatusReg );
    out_dword(uOffset + HWIO_MMSS_DSI_0_ACK_ERR_STATUS_ADDR, 0);
  }
}
