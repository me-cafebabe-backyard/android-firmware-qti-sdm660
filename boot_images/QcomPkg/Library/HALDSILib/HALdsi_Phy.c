...
void HAL_DSI_PhyFxnsInit(void)
{
    ...
    if ((0x02 == sDSIVersionInfo.uMajorVersion) &&
        (0x01 == sDSIVersionInfo.uMinorVersion))
    {
        gDsiPhyFxnTbl.HAL_DSI_PhyPllInitialize     = HAL_DSI_2_1_0_PhyPllInitialize;
        gDsiPhyFxnTbl.HAL_DSI_PhyDisable           = HAL_DSI_2_1_0_PhyDisable;
        gDsiPhyFxnTbl.HAL_DSI_Phy_PllEnable        = HAL_DSI_2_1_0_PhyPllEnable;
        gDsiPhyFxnTbl.HAL_DSI_PhyPllPowerCtrl      = HAL_DSI_2_1_0_PhyPllPowerCtrl;
        gDsiPhyFxnTbl.HAL_DSI_PhyPllSetup          = HAL_DSI_2_1_0_PhyPllSetup;
        gDsiPhyFxnTbl.HAL_DSI_PhyReConfigure       = HAL_DSI_2_1_0_PhyReConfigure;
        gDsiPhyFxnTbl.HAL_DSI_PhySetup             = HAL_DSI_2_1_0_PhySetup;
        gDsiPhyFxnTbl.HAL_DSI_PhySetupTimingParams = HAL_DSI_2_1_0_PhySetupTimingParams;
        gDsiPhyFxnTbl.HAL_DSI_PhySetProperty       = HAL_DSI_2_1_0_PhySetProperty;
        gDsiPhyFxnTbl.HAL_DSI_PhyGetProperty       = HAL_DSI_2_1_0_PhyGetProperty;
        gDsiPhyFxnTbl.HAL_DSI_PhyGetPllCodes       = HAL_DSI_2_1_0_PhyGetPllCodes;
    }
    else
    {
