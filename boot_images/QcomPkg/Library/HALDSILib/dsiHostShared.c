...
{ 
  ...
  /* Commit to DSI lane mapping configuration to the DSI HW */
  HAL_DSI_LaneMapConfig(eDeviceID, psSharedData->eDevLane);
                                ...
                                HAL_DSI_PhyConfigType *psPhyConfig)
{
      ...
      (NULL != psPhyConfig))
  {
    ...
    psPhyConfig->ePLLConfigSource    = (TRUE == psDeviceConfig->bDualDsi) ? HAL_DSI_PLL_CONFIG_SPLIT_SOURCE: HAL_DSI_PLL_CONFIG_INDEPENDENT_SOURCE;
  }
}
