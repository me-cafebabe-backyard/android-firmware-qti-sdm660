...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 05/28/19   pv      return success if file system already mounted 
 12/22/16   lg      Update smbios processor name string (remove chip ID string)
                  ...
                  IN      UINTN    StrSize)
{
  ...
  pChipInfoProtocol->GetProcessorNameString (pChipInfoProtocol,
  ...
  IN UINT32 BufferSize)
{
  ...
  for (j = 0; j < NumberOfSdccHandles; j++)
  {
    ...
    {
      CopyMem(Buffer, &CardInfoData, BufferSize);
      Status = EFI_SUCCESS;
      break;
    }
  }
