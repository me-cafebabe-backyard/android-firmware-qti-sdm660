...
typedef enum
{
  ...
  FWENTRY_DISK_PARTITION_MAX       = 0x00000010,
...
FwUpdateGetPartitionHandle(
  IN OUT EFI_HANDLE                       *PartHandle,
    IN FWENTRY_DISK_PARTITION_TYPE EmmcType,
