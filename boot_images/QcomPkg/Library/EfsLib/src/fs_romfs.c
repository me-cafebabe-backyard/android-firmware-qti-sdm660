...
--------      ---     ------------------------------------------------------
2014-08-26    vm      Integrate string library for XBL compilation.
2014-03-19    vm      Add work-around for alignment issues (64-bit builds).
    ...
    fs_inode_t inum)
{
 ...
 /* Temporarily stub out this section until the alignment issue
  * is resolved in a cleaner way.
  */  
 #if 0
...
#endif
  (void) vp; (void) pos; (void) buf; (void) count;
  return 0;
//  return count;
}
