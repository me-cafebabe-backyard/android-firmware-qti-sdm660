...
/*============================================================================
  ...
  $Header: //components/rel/boot.xf/1.4/QcomPkg/Library/AdcLib/devices/fgadc/src/DalFgAdc.c#5 $$DateTime: 2017/03/27 05:11:19 $$Author: pwbldsvc $

  when        who  what, where, why
  ----------  ---  -----------------------------------------------------------
  2017-03-22  ks   Forced batt id workaround.
  2017-02-09  PC   Added support for new fab_ids for PM660
...
#define FGADC_FAB_ID_GF_PM660   0x00
#define FGADC_FAB_ID_SMIC_PM660 0x01
#define FGADC_FAB_ID_TSMC_PM660 0x02
#define FGADC_FAB_ID_MX_PM660   0x03
 ...
 * Scaling equation:
 *
 *    milliDegC = (1339518 - uV) / 3.598 + 25000
 *
 */
...
/*
 * Charger temperature sensor scaling table - PM660 GF7G
 *
 * The first column in the table is sensor voltage in millivolts and the
 * second column is the temperature in milli degrees C.
 *
 ...
 *
 */
static const AdcMapPtInt32toInt32Type gFgAdcMapChgTempSensorGF7G_PM660[] =
{
   { 1462, -20000 },
   { 1104,  85000 }
};
 ...
 *
 */
static const AdcMapPtInt32toInt32Type gFgAdcMapChgTempSensorTSMC_PM660[] =
{
   { 1458, -20000 },
   { 1080,  85000 }
};
...
/*
 * Charger temperature sensor scaling table - PM660 MX
 *
 * The first column in the table is sensor voltage in millivolts and the
 * second column is the temperature in milli degrees C.
 *
 ...
 *
 */
static const AdcMapPtInt32toInt32Type gFgAdcMapChgTempSensorMX_PM660[] =
{
   { 1472, -20000 },
   { 1105,  85000 }
};
   ...
   )
{
   ...
   {
      if (pDevCtxt->uFabID == FGADC_FAB_ID_GF_PM660)
      {
         *ppaPts = gFgAdcMapChgTempSensorGF7G_PM660;
         *puTableSize = ARRAY_LENGTH(gFgAdcMapChgTempSensorGF7G_PM660);
      }
      else if (pDevCtxt->uFabID == FGADC_FAB_ID_TSMC_PM660)
      {
         *ppaPts = gFgAdcMapChgTempSensorTSMC_PM660;
         *puTableSize = ARRAY_LENGTH(gFgAdcMapChgTempSensorTSMC_PM660);
      }
      else if (pDevCtxt->uFabID == FGADC_FAB_ID_MX_PM660)
      {
         *ppaPts = gFgAdcMapChgTempSensorMX_PM660;
         *puTableSize = ARRAY_LENGTH(gFgAdcMapChgTempSensorMX_PM660);
      }
   }
...
FgAdc_DeviceInit(FgAdcClientCtxt *pCtxt)
{
   ...
   /* Fab ID is needed for CHG_TEMP scaling on PMI8998 and PM660 */
   if (pDevCtxt->pmicDeviceInfo.ePmicModel == PMIC_IS_PMI8998 ||
       pDevCtxt->pmicDeviceInfo.ePmicModel == PMIC_IS_PM660)
   {
