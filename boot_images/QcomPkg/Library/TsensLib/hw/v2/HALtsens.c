...
/*============================================================================
  ...
  ----------  ---  -----------------------------------------------------------
  2017-02-10  PC   Added Watchdog, cycle monitoring realted functions
...
**
**  Description:
**    To disable or enable WD Bark interrupts
**
**  Parameters:
**    pucTsensTMAddr - address of controller's TM region
**    bEnable - Either True or False
**
**  Return: None
**
**  Dependencies: None
...
**
**  Description:
**    To disable or enable TM Cycle Monitor interrupts
**
**  Parameters:
**    pucTsensTMAddr - address of controller's TM region
**    bEnable - Either True or False
...
**
**  Description:
**    To clear TM Cycle Monitor interrupts
**
**  Parameters:
**    pucTsensTMAddr - address of controller's TM region
**
...
/* ============================================================================
**
**  HAL_tsens_tm_DisableWatchdogInterrupts
**
**  Description:
**    Disables the TSENS watchdog bark and cycle completion monitor interrupts
**
**  Parameters:
**    pucTsensTMAddr - address of controller's TM region
**
...
**
** ========================================================================= */
void HAL_tsens_tm_DisableWatchdogInterrupts(uint8 *pucTsensTMAddr)
{
   uint32 uReg;

   uReg = HWIO_INX(pucTsensTMAddr, TSENS_CRITICAL_INT_MASK);

   uReg |= HWIO_FVAL(TSENS_CRITICAL_INT_MASK, WATCHDOG_BARK, 0x1);
   uReg |= HWIO_FVAL(TSENS_CRITICAL_INT_MASK, CYCLE_COMPLETION_MONITOR, 0x1);

   HWIO_OUTX(pucTsensTMAddr, TSENS_CRITICAL_INT_MASK , uReg);
}
