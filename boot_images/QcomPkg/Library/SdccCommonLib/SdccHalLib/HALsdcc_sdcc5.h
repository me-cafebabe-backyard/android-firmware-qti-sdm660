...
#define HWIO_HC_CAPABILITIES_BASE_SDCLK_FREQ_BMSK       0xff00
#define HWIO_HC_CAPABILITIES_BASE_SDCLK_FREQ_SHFT          0x8

#define HWIO_MCI_DLL_CONFIG_DLL_RST_BMSK            0x40000000
#define HWIO_MCI_DLL_CONFIG_DLL_RST_SHFT            0x1e
#define HWIO_MCI_DLL_CONFIG_DLL_PDN_BMSK            0x20000000
#define HWIO_MCI_DLL_CONFIG_DLL_PDN_SHFT            0x1d
#define HWIO_MCI_DLL_CONFIG_MCLK_FREQ_BMSK          0x7000000
#define HWIO_MCI_DLL_CONFIG_MCLK_FREQ_SHFT          0x18
#define HWIO_MCI_DLL_CONFIG_CDR_SELEXT_BMSK         0xf00000
#define HWIO_MCI_DLL_CONFIG_CDR_SELEXT_SHFT         0x14
#define HWIO_MCI_DLL_CONFIG_CDR_EXT_EN_BMSK         0x80000
#define HWIO_MCI_DLL_CONFIG_CDR_EXT_EN_SHFT         0x13
#define HWIO_MCI_DLL_CONFIG_CK_OUT_EN_BMSK          0x40000
#define HWIO_MCI_DLL_CONFIG_CK_OUT_EN_SHFT          0x12
#define HWIO_MCI_DLL_CONFIG_CDR_EN_BMSK             0x20000
#define HWIO_MCI_DLL_CONFIG_CDR_EN_SHFT             0x11
#define HWIO_MCI_DLL_CONFIG_DLL_EN_BMSK             0x10000
#define HWIO_MCI_DLL_CONFIG_DLL_EN_SHFT             0x10

#define HWIO_MCI_DLL_STATUS_DLL_LOCK_BMSK           0x80
#define HWIO_MCI_DLL_STATUS_DLL_LOCK_SHFT           0x7
...
#define MCI_DLL_CONFIG_CK_OUT_EN_SET   (1UL << HWIO_MCI_DLL_CONFIG_CK_OUT_EN_SHFT)

/* Field enumeration for MCI_DLL_STATUS */
#define MCI_DLL_STATUS_DLL_LOCK       (1UL << HWIO_MCI_DLL_STATUS_DLL_LOCK_SHFT)

#define SDHCI_VENDOR_PWRSAVE_SET    (1UL << HWIO_HC_VENDOR_SPECIFIC_FUNC_PWRSAVE_SHIFT)
#define SDHCI_VENDOR_PWRSAVE_CLEAR  (0UL << HWIO_HC_VENDOR_SPECIFIC_FUNC_PWRSAVE_SHIFT)

#define SDHCI_VENDOR_FLOW_EN_SET    (1UL << HWIO_HC_VENDOR_SPECIFIC_FUNC_FLOW_EN_SHIFT)
#define SDHCI_VENDOR_FLOW_EN_CLEAR  (0UL << HWIO_HC_VENDOR_SPECIFIC_FUNC_FLOW_EN_SHIFT)
...
#define HWIO_SDC_HC_VENDOR_SPECIFIC_ADMA_ERR_OFFSET0_REG_IDX  (0x0214)
...
#define HWIO_SDC_HC_REG_DDR_CONFIG_REG_IDX                    (0x0258)
#define HWIO_SDC_HC_REG_DDR_CONFIG_V3_REG_IDX                 (0x025C)
#define HWIO_SDC_HC_VENDOR_SPECIFIC_FUNC4_REG_IDX             (0x0260)
#define HWIO_SDC_HC_VENDOR_SPECIFIC_AXI_AW_MON_REG_IDX        (0x02e4)
#define HWIO_SDC_HC_VENDOR_SPECIFIC_AXI_W_MON_REG_IDX         (0x02e8)
#define HWIO_SDC_HC_VENDOR_SPECIFIC_AXI_B_MON_REG_IDX         (0x02ec)
#define HWIO_SDC_HC_VENDOR_SPECIFIC_AXI_AR_MON_REG_IDX        (0x02f0)
#define HWIO_SDC_HC_VENDOR_SPECIFIC_AXI_R_MON_REG_IDX         (0x02f4)
#define HWIO_SDC_HC_VENDOR_SPECIFIC_INT_STS_REG_IDX           (0x02f8)
#define HWIO_SDC_HC_VENDOR_SPECIFIC_INT_STS_EN_REG_IDX        (0x02fc)
#define HWIO_SDC_HC_VENDOR_SPECIFIC_INT_SIG_EN_REG_IDX        (0x0300)
#define HWIO_SDC_HC_VENDOR_SPECIFIC_DEBUG_REG_IDX             (0x0304)
#define HWIO_SDC_FIFO_COUNT_REG_IDX                           (0x0308)
#define HWIO_SDC_SDCC_BOOT_REG_IDX                            (0x030c)
#define HWIO_SDC_SDCC_BOOT_ACK_TIMER_REG_IDX                  (0x0310)
#define HWIO_SDC_SDCC_BOOT_DATA_TIMER_REG_IDX                 (0x0314)
#define HWIO_SDC_SDCC_GENERICS_REG_IDX                        (0x0320)
#define HWIO_SDC_FIFO_STATUS_REG_IDX                          (0x0324)
#define HWIO_SDC_DATA_COUNT_REG_IDX                           (0x035c)
#define HWIO_SDC_HC_FIFO_ALTn_REG_IDX(n)                      (0x0400 + 0x4 * (n))

#define HWIO_HC_REG_DLL_CONFIG_DLL_RST_BMSK            0x40000000
#define HWIO_HC_REG_DLL_CONFIG_DLL_RST_SHFT            0x1e
#define HWIO_HC_REG_DLL_CONFIG_DLL_PDN_BMSK            0x20000000
#define HWIO_HC_REG_DLL_CONFIG_DLL_PDN_SHFT            0x1d
...
#define SDHCI_HC_SELECT_IN_EN     (1UL << HWIO_HC_VENDOR_SPECIFIC_FUNC_HC_SELECT_IN_EN_SHIFT)
...
#define HC_SELECT_IN_SDR104_HS200  (0x4 << HWIO_HC_VENDOR_SPECIFIC_FUNC_HC_SELECT_IN_SHIFT)

#define VENDOR_SPECIFIC_MCLK_SEL_FEEDBACK          0x1
#define VENDOR_SPECIFIC_MCLK_SEL_FREE_MCLK         0x2
#define VENDOR_SPECIFIC_MCLK_SEL_FREE_MCLK_DIV_2   0x3

#define HWIO_HC_REG_3E_HST_CTL2_UHS_MODE_SEL_BMSK 0x10000
#define HWIO_HC_REG_3E_HST_CTL2_UHS_MODE_SEL_SHFT 0x10
...
inline void
HAL_sdhci_FlowControl (const UINT32 nController, BOOLEAN flow_enable)
{
  UINT32 val = HWIO_SDC_REG_IN (HC_VENDOR_SPECIFIC_FUNC, (UINTN)sdcc_reg_hc[nController]);

  if (flow_enable)
  {
    /* Enable Flow Control */  
    val |= SDHCI_VENDOR_FLOW_EN_SET;
  }
  else
  {
  ...
  HWIO_SDC_REG_OUT (HC_VENDOR_SPECIFIC_FUNC, (UINTN)sdcc_reg_hc[nController], val);
}
                         ...
                         enum HAL_sdhci_reset ResetType)
{
  ...
  power_on = HWIO_SDC_BYTE_IN (HC_REG_29, (UINTN)sdcc_reg_hc[nControllerId]) & SDHCI_BUS_PWR_BMSK;
...
{
   UINT32 reg_value = 0;
   reg_value = HWIO_SDC_REG_IN(HC_REG_DLL_CONFIG, (UINTN)sdcc_reg_hc[nController]);

   reg_value &= ~HWIO_MCI_DLL_CONFIG_MCLK_FREQ_BMSK;
   reg_value |= (mclk_freq << HWIO_MCI_DLL_CONFIG_MCLK_FREQ_SHFT);

   HWIO_SDC_REG_OUT (HC_REG_DLL_CONFIG, (UINTN)sdcc_reg_hc[nController], reg_value);
}
...
HAL_sdhci_DllRstPdn (const UINT32 nController, BOOLEAN set_clr)
{
   ...
   if(set_clr)
   {
      reg_value |= HWIO_MCI_DLL_CONFIG_DLL_RST_BMSK;
      reg_value |= HWIO_MCI_DLL_CONFIG_DLL_PDN_BMSK;
   }
   else
   {
      reg_value &= ~HWIO_MCI_DLL_CONFIG_DLL_RST_BMSK;
...
HAL_sdhci_DllEnable (const UINT32 nController)
{
   ...
   UINT32 reg_value = 0;
   reg_value = HWIO_SDC_REG_IN(HC_REG_DLL_CONFIG, (UINTN)sdcc_reg_hc[nController]);
   reg_value |= HWIO_MCI_DLL_CONFIG_DLL_EN_BMSK;
   HWIO_SDC_REG_OUT (HC_REG_DLL_CONFIG, (UINTN)sdcc_reg_hc[nController], reg_value);
}
...
HAL_sdhci_DllCkOutEnable (const UINT32 nController)
{
   UINT32 reg_value = 0;
   reg_value = HWIO_SDC_REG_IN(HC_REG_DLL_CONFIG, (UINTN)sdcc_reg_hc[nController]);
   reg_value |= HWIO_MCI_DLL_CONFIG_CK_OUT_EN_BMSK;
   HWIO_SDC_REG_OUT (HC_REG_DLL_CONFIG, (UINTN)sdcc_reg_hc[nController], reg_value);
}
...
HAL_sdhci_CdrEnable (const UINT32 nController, BOOLEAN bEnable)
{
   ...
   if (bEnable)
   {
     reg_value |= HWIO_MCI_DLL_CONFIG_CDR_EN_BMSK;
   }
   else
   {
     reg_value &= ~HWIO_MCI_DLL_CONFIG_CDR_EN_BMSK;
...
inline int HAL_sdhci_DllPollCkOutEn(const UINT32 nController, BOOLEAN bEnable)   
{
   UINT32 wait_cnt = 50;
   UINT32 ck_out_en;
   ...
   do
   {
      ck_out_en = HWIO_SDC_REG_IN(HC_REG_DLL_CONFIG, (UINTN)sdcc_reg_hc[nController]);
      if(bEnable)
      {
         if(ck_out_en & MCI_DLL_CONFIG_CK_OUT_EN_SET)
            break;
      }
      else
      {
...
inline int HAL_sdhci_DllPollStatusLock(const UINT32 nController)
{
   UINT32 wait_cnt = 50;
   UINT32 val;
   ...
   do
   {
      val = HWIO_SDC_REG_IN(HC_REG_DLL_STATUS, (UINTN)sdcc_reg_hc[nController]);
      if(val & MCI_DLL_STATUS_DLL_LOCK)
      {
         //	DLL lock success
         break;
      }
...
int HAL_sdhci_ConfigCmDllPhase(const UINT32 nController, INT8 phase)
{
   ...
   config = HWIO_SDC_REG_IN(HC_REG_DLL_CONFIG, (UINTN)sdcc_reg_hc[nController]);
   ...
   HWIO_SDC_REG_OUT (HC_REG_DLL_CONFIG, (UINTN)sdcc_reg_hc[nController], config);

   /* Wait until CK_OUT_EN bit of HC_REG_DLL_CONFIG register becomes '0' */
   rc = HAL_sdhci_DllPollCkOutEn(nController, FALSE);
    ...
    */
   config = HWIO_SDC_REG_IN(HC_REG_DLL_CONFIG, (UINTN)sdcc_reg_hc[nController]);
   config &= ~HWIO_MCI_DLL_CONFIG_CDR_SELEXT_BMSK;
   config |= ((grey_coded_phase_table[phase]) << HWIO_MCI_DLL_CONFIG_CDR_SELEXT_SHFT);
   HWIO_SDC_REG_OUT (HC_REG_DLL_CONFIG, (UINTN)sdcc_reg_hc[nController], config);

   /* Set CK_OUT_EN bit of HC_REG_DLL_CONFIG register to 1. */
   HAL_sdhci_DllCkOutEnable(nController);
   
   /* Wait until CK_OUT_EN bit of HC_REG_DLL_CONFIG register becomes '1' */
   rc = HAL_sdhci_DllPollCkOutEn(nController, TRUE);
   if (rc != HAL_SDCC_SUCCESS)
   {
      goto Exit;
   }
...
{
  UINT16 command = 0;
  command = ((UINT16)(hal_cmd->cmd_idx) << SDHCI_CMD_INDEX_SHIFT) |
                       ...
                       enum HAL_sdcc_BusWidth BusWidth)
{
  ...
  case HAL_SDCC_BUS_WIDTH_1_BIT:
    HWIO_SDC_BYTE_OUT (HC_REG_28, (UINTN)sdcc_reg_hc[nControllerId],
       (reg_value & ~(SDHCI_DATA_TRANS_WIDTH_BMSK | SDHCI_EXT_DATA_TRANS_WIDTH_BMSK)) | 
  ...
  case HAL_SDCC_BUS_WIDTH_8_BIT:   	
    HWIO_SDC_BYTE_OUT (HC_REG_28, (UINTN)sdcc_reg_hc[nControllerId],
        (reg_value & ~SDHCI_EXT_DATA_TRANS_WIDTH_BMSK) |
...
HAL_sdhci_ADMAEnable (const UINT32 nControllerId, BOOLEAN bEnable)
{
  ...
  {
    /* 64-bit mode */
    adma_sel_bit = bEnable ? SDHCI_64_BIT_ADMA2_ENABLE_BMSK : 0;
  }
  else
  {
    /* 32-bit mode */
    adma_sel_bit = bEnable ? SDHCI_32_BIT_ADMA2_ENABLE_BMSK : 0;
  }

  HWIO_SDC_BYTE_OUT (HC_REG_28, (UINTN)sdcc_reg_hc[nControllerId],
                    ((reg_value & ~SDHCI_DMA_SEL_BMSK) | adma_sel_bit));                  
}
                         ...
                         HAL_sdhci_BusVolSelect cVoltage)
{
  ...
  val = (val & ~SDHCI_BUS_VOL_SEL_BMSK) | cVoltage;
...
HAL_sdhci_SetPower (UINT32 nControllerId, BOOLEAN bEnable)
{
  ...
  val = (val & ~SDHCI_BUS_PWR_BMSK) | (UINT8)bEnable;
  HWIO_SDC_BYTE_OUT (HC_REG_29, (UINTN)sdcc_reg_hc[nControllerId], val);
}
...
HAL_sdhci_EnableSDClk (UINT32 nControllerId, BOOLEAN bEnable)
{
  ...
  val = (val & ~SDHCI_SDCLK_EN_BMSK) | 
  	((UINT8)bEnable << SDHCI_SDCLK_EN_SHFT);
...
HAL_sdhci_SetUHSMode(UINT32 nControllerId, UINT16 mode)
{
  ...
  val = ((val & ~(UINT16)SDHCI_UHS_MODE_SEL_BMSK) | mode); 
...
HAL_sdhci_DisableDLLClock (const UINT32 nControllerId)
{
  ...
  HWIO_SDC_REG_OUT (HC_REG_DLL_CONFIG, (UINTN)sdcc_reg_hc[nControllerId],
                   (val | HC_REG_DLL_CONFIG_PDN_BMSK));

  HWIO_SDC_REG_OUT (HC_REG_DLL_CONFIG, (UINTN)sdcc_reg_hc[nControllerId],
                   (val | HC_REG_DLL_CONFIG_RST_BMSK | HC_REG_DLL_CONFIG_PDN_BMSK));
}
...
void HAL_sdhci_SetCapabilities (const UINT32 nControllerId)
{
  ...
  if (nControllerId == eMMCSlotNum)
  {
    ...
    caps0 |= HAL_SDHCI_CAPS_SYS_BUS_SUPPORT_64_BIT_ENABLE;
...
HAL_sdhci_EnableCmdLineTracking (const UINT32 nControllerId)
{
  ...
  HWIO_SDC_REG_OUT (HC_REG_DLL_CONFIG, (UINTN)sdcc_reg_hc[nControllerId],
                   (val | HC_REG_DLL_CONFIG_TRACK_SEL_BMSK));
}
...
#define HC_REG_DDR_CONFIG_VALUE       0x80040873
/**
 ...
 */
inline void
HAL_sdhci_ConfigDDR (const UINT32 nController)
{
   HWIO_SDC_REG_OUT (HC_REG_DDR_CONFIG, (UINTN)sdcc_reg_hc[nController], HC_REG_DDR_CONFIG_VALUE);
}
 ...
 */
inline void
HAL_sdhci_CalibrateDDR (const UINT32 nController, BOOLEAN calib_en)
{
   UINT32 val = HWIO_SDC_REG_IN(HC_REG_DLL_CONFIG_2, (UINTN)sdcc_reg_hc[nController]);

   HWIO_SDC_REG_OUT (HC_REG_DLL_CONFIG_2, (UINTN)sdcc_reg_hc[nController], 
 ...
 */
inline BOOLEAN
HAL_sdhci_DDRDllLock (const UINT32 nController)
{
   UINT32 val = HWIO_SDC_REG_IN(HC_REG_DLL_STATUS, (UINTN)sdcc_reg_hc[nController]);
 ...
 */
inline void
HAL_sdhci_PowerSaveDll (const UINT32 nController, BOOLEAN pwr_save)
{
   UINT32 val = HWIO_SDC_REG_IN(HC_VENDOR_SPECIFIC_FUNC3, (UINTN)sdcc_reg_hc[nController]);

   HWIO_SDC_REG_OUT (HC_VENDOR_SPECIFIC_FUNC3, (UINTN)sdcc_reg_hc[nController], 
 ...
 */
inline void
HAL_sdhci_ClearDLLRST (const UINT32 nController)
{
   UINT32 val = HWIO_SDC_REG_IN(HC_REG_DLL_CONFIG, (UINTN)sdcc_reg_hc[nController]);
   
   HWIO_SDC_REG_OUT (HC_REG_DLL_CONFIG, 
                    (UINTN)sdcc_reg_hc[nController], 
...
HAL_sdhci_DLLClockEnable (const UINT32 nController, BOOLEAN bEnable)
{
   ...
   HWIO_SDC_REG_OUT (HC_REG_DLL_CONFIG_2, (UINTN)sdcc_reg_hc[nController], val);
}
