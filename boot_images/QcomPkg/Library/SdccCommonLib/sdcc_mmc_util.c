...
---------------------------------------------------------------------- 
---------------------------------------------------------------------- 
2018-05-24   sb      Ignore end-bit, indx errors in HS200 tuning process
...
*
******************************************************************************/
SDCC_STATUS sdcc_config_buswidth (sdcc_dev_type *sdcc_pdev, BOOLEAN DDRSupport)
{
...
*
******************************************************************************/
SDCC_STATUS sdcc_configure_dll_hs400(sdcc_dev_type *sdcc_pdev)
{
   UINT32 timeout = 50;    
   UINT32 driveno = 0;
   ...
   /* Set PWRSAVE_DLL */
   HAL_sdhci_PowerSaveDll (driveno, TRUE); 
...
*
******************************************************************************/
SDCC_STATUS sdcc_enter_hs_mode (sdcc_dev_type *sdcc_pdev)
{
   SDCC_STATUS rc = SDCC_NO_ERROR;
...
*
******************************************************************************/
SDCC_STATUS sdcc_enter_hs200_mode (sdcc_dev_type *sdcc_pdev)
{
   SDCC_STATUS rc = SDCC_NO_ERROR;
...
*
******************************************************************************/
SDCC_STATUS sdcc_enter_hs400_mode (sdcc_dev_type *sdcc_pdev)
{
   SDCC_STATUS rc = SDCC_NO_ERROR;
...
sdcc_config_mmc_modes_segment( sdcc_dev_type *sdcc_pdev )
{
   ...
   int i; 
   UINT32 DDRModeEnable = 0; 
   UINT32 SpeedMode = PcdGet32(SDCCEmmcSpeedMode);
   ...
   if ((HS400_MODE == SpeedMode) && (ext_csd.card_type & SDCC_HS400_MMC_DDR_200MHZ_1_8V))
   {
   ...
   else if ((HS200_MODE == SpeedMode) && (ext_csd.card_type & SDCC_HS200_SDR_200MHZ_1_8V))
   {
