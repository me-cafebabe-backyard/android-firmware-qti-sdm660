...
11/08/16   pxm     Added pm_sbl_schg_wipower_specific_data_type 
 ...
 *        pm_driver_init()
 */
pm_err_flag_type pm_sbl_auto_power_on_check(uint32 device_index);
