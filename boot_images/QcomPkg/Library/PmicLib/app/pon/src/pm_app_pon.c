...
--------   ---     ---------------------------------------------------------- 
05/03/17   czq     Updated pm_app_pon_pshold_cfg() to support DVDD hard reset type.
...
pm_app_pon_pshold_cfg(pm_app_pon_reset_cfg_type app_pshold_cfg) 
{
   ...
   {
      return PM_ERR_FLAG__FEATURE_NOT_SUPPORTED;//HARD_RESET / SHUTDOWN configs are not supported at this time
   }
