                                    ...
                                    HAL_MDP_ScalarConfigType *psScalarConfig)
{
    ...
    || psScalarConfig->bUVSepWriteEnable )
  {
    ...
    { 
      ...
      {
        uQseed3CoefBase    = HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_COEF_LUT_COEF_Y_DIR_A_IDXi_DATAj_ADDR(0,0) + uScalarRegOffset + COEF_Y_DIR_INFO[uLUTRegionId][uFilterId][1];
  ...
  {
    uLutCtrl   = in_dword(HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_COEF_LUT_CTRL_ADDR + uScalarRegOffset);
    uLutCtrl   = HWIO_OUT_FLD(uLutCtrl, MDP_VP_0_VIG_0_QSEED3_COEF_LUT_CTRL, SWAP, 1);
    out_dword(HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_COEF_LUT_CTRL_ADDR + uScalarRegOffset, uLutCtrl); 
  }
}
                             ...
                             HAL_MDP_ScalarConfigType        *psScalarConfig)
{
  ...
  if (TRUE == psScalarConfig->sDetailEnhancer.bDetailEnhancerEnable)
  {
    ...
    out_dword(HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_DE_SHARPEN_ADDR       + uRegOffset, uDeSharpen);
    out_dword(HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_DE_SHARPEN_CTL_ADDR   + uRegOffset, uDeSharpenCtl);
    out_dword(HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_DE_SHAPE_CTL_ADDR     + uRegOffset, uDeShapeCtl);
    out_dword(HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_DE_THRESHOLD_ADDR     + uRegOffset, uDeThreshold);
    out_dword(HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_DE_ADJUST_DATA_0_ADDR + uRegOffset, uDeAdjustData0);
    out_dword(HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_DE_ADJUST_DATA_1_ADDR + uRegOffset, uDeAdjustData1);
    out_dword(HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_DE_ADJUST_DATA_2_ADDR + uRegOffset, uDeAdjustData2);
  }
}
                                 ...
                                 HAL_MDP_ScalarConfigType        *psScalarConfig)
{
  ...
  uint32        uDstSize            = 0;
    ...
    if (TRUE == psScalarConfig->bScalarEnable)
    {
      ...
      uPhaseInit = HWIO_OUT_FLD(uPhaseInit,
                             MDP_VP_0_VIG_0_QSEED3_PHASE_INIT,
                             Y_PHASE_INIT_H,
                             psScalarConfig->uC03HorizontalInitPhase);
      uPhaseInit = HWIO_OUT_FLD(uPhaseInit,
                             MDP_VP_0_VIG_0_QSEED3_PHASE_INIT,
                             Y_PHASE_INIT_V,
                             psScalarConfig->uC03VerticalInitPhase);
      uPhaseInit = HWIO_OUT_FLD(uPhaseInit,
                             MDP_VP_0_VIG_0_QSEED3_PHASE_INIT,
                             UV_PHASE_INIT_H,
                             psScalarConfig->uC12HorizontalInitPhase);
      uPhaseInit = HWIO_OUT_FLD(uPhaseInit,
                             MDP_VP_0_VIG_0_QSEED3_PHASE_INIT,
                             UV_PHASE_INIT_V,
                             psScalarConfig->uC12VerticalInitPhase);
      ...
      out_dword(HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_PHASE_INIT_ADDR       + uRegOffset, uPhaseInit);
      out_dword(HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_PHASE_STEP_Y_H_ADDR   + uRegOffset,psScalarConfig->uC03HorizontalPhaseStep);
      out_dword(HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_PHASE_STEP_Y_V_ADDR   + uRegOffset,psScalarConfig->uC03VerticalPhaseStep);
      out_dword(HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_PHASE_STEP_UV_H_ADDR  + uRegOffset,psScalarConfig->uC12HorizontalPhaseStep);
      out_dword(HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_PHASE_STEP_UV_V_ADDR  + uRegOffset,psScalarConfig->uC12VerticalPhaseStep);
      out_dword(HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_PRELOAD_ADDR          + uRegOffset,uPreload);
      out_dword(HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_SRC_SIZE_Y_RGB_A_ADDR + uRegOffset,uSrcSizeY);
      out_dword(HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_SRC_SIZE_UV_ADDR      + uRegOffset,uSrcSizeUV);
      out_dword(HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_DST_SIZE_ADDR         + uRegOffset,uDstSize);
    }
    out_dword(HWIO_MMSS_MDP_VP_0_VIG_0_QSEED3_OP_MODE_ADDR          + uRegOffset, uOpMode);
                               ...
                               HAL_MDP_ScalarConfigType        *psScalarConfig)
{
  ...
  if( (HAL_MDP_DESTINATION_PIPE_0 == eDestPipe) || (HAL_MDP_DESTINATION_PIPE_1 == eDestPipe))
  {
    ...
    //uOpMode  = in_dword(HWIO_MMSS_MDP_DEST_SCALER_0_OP_MODE_ADDR);
    ...
    out_dword(HWIO_MMSS_MDP_DEST_SCALER_0_OP_MODE_ADDR, uOpMode);
  }
