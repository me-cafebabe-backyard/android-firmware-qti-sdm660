                                          ...
                                          HAL_MDP_InterfaceStreamId        eStreamId)
{
   ...
   uRegValue  = in_dword(HWIO_MMSS_MDP_INTF_0_VIDEO_MISR_CTRL_ADDR + uRegOffset + uRegStreamOffset);
 
   // Read signature
   if(HAL_MDP_MISR_STATUS_READ_SIGNATURE == eMisrStatusId) 
   {
      uMisrSignatureRegValue = in_dword(HWIO_MMSS_MDP_INTF_0_VIDEO_MISR_SIGNATURE_ADDR + uRegOffset + uRegStreamOffset);
      ...
      out_dword(HWIO_MMSS_MDP_INTF_0_VIDEO_MISR_CTRL_ADDR + uRegOffset + uRegStreamOffset, uRegValue);
   ...
   else if(HAL_MDP_MISR_STATUS_READ_STATE == eMisrStatusId)
   {
      ...
      if(0x00 != (uRegValue & HWIO_MMSS_MDP_INTF_0_VIDEO_MISR_CTRL_STATUS_BMSK))
      {
                                          ...
                                          uint32                             uSetupFlags)
{
   ...
   if (TRUE == pIntfMisrConfig->bEnable)
   {
       ...
       /*
        * For pre-silicon test env QCRAFT matches this CRC with the software algorithm calculated CRC.
        * To allow both the CRC to match we configure the MISR to only consider active pixel data
        *
        */
       uMisrRegValue  = HWIO_OUT_FLD(uMisrRegValue,
                                     MDP_INTF_0_VIDEO_MISR_CTRL,
   ...
   out_dword(HWIO_MMSS_MDP_INTF_0_VIDEO_MISR_CTRL_ADDR + uRegOffset + uRegStreamOffset, uMisrRegValue);
}
                                               ...
                                               uint32                                uSetupFlags)
{
   ...
   if(HAL_MDP_INTERFACE_MODE_VIDEO == pInterfaceConfig->eInterfaceMode)
   {
      ...
      // Border Color
      out_dword(HWIO_MMSS_MDP_INTF_0_BORDER_COLOR_ADDR + uRegOffset, pInterfaceCfg->uBorderColorInRGB888);

      // Underflow color
      out_dword(HWIO_MMSS_MDP_INTF_0_UNDERFLOW_COLOR_ADDR + uRegOffset, pInterfaceCfg->uUnderflowColorInRGB888);

      // HSYNC SKEW
      out_dword(HWIO_MMSS_MDP_INTF_0_HSYNC_SKEW_ADDR + uRegOffset, pInterfaceCfg->uHysncSkewInPixels);
                                                                  ...
                                                                  uint32                                      uSetupFLags)
{
      ...
      (HAL_MDP_INTERFACE_WRITEBACK_TYPE_BASE > eInterfaceId))
  {
    ...
    out_dword(HWIO_MMSS_MDP_INTF_0_PROG_FETCH_START_ADDR + uRegOffset, uProgFetchStart);
  
    // Enable/Disable programmable fetch start
    uIntfConfig = in_dword(HWIO_MMSS_MDP_INTF_0_INTF_CONFIG_ADDR + uRegOffset);
    uIntfConfig = HWIO_OUT_FLD(uIntfConfig,
                               MDP_INTF_0_INTF_CONFIG,
                               PROG_FETCH_START_EN,
                               pIntfProgFetchStart->bProgFetchStartEnable);
    out_dword(HWIO_MMSS_MDP_INTF_0_INTF_CONFIG_ADDR + uRegOffset, uIntfConfig);
  }
...
*
****************************************************************************/
HAL_MDSS_ErrorType HAL_MDP_Interface_DualInterface_Config(HAL_MDP_Interface_DualInferfaceType *pDualInterfaceConfig,
                                                          uint32                               uSetupFlags)
{
  HAL_MDSS_ErrorType  eStatus       = HAL_MDSS_STATUS_SUCCESS;
  ...
  if(pDualInterfaceConfig->bEnableDualInterface)
  {
    if (HAL_MDP_INTERFACE_MODE_VIDEO == pDualInterfaceConfig->eInterfaceMode )
    {
      ...
      uSplitCTRLVal = HWIO_OUT_FLD(uSplitCTRLVal,MDP_SPLIT_DISPLAY_UPPER_PIPE_CTRL, INTF_1_SW_TRG_MUX,    0x1);
      uSplitCTRLVal = HWIO_OUT_FLD(uSplitCTRLVal,MDP_SPLIT_DISPLAY_UPPER_PIPE_CTRL, INTF_2_SW_TRG_MUX,    0x0);
    ...
    else
    {
      ...
      uSplitCTRLVal = HWIO_OUT_FLD(uSplitCTRLVal,MDP_SPLIT_DISPLAY_UPPER_PIPE_CTRL, SMART_PANEL_FREE_RUN, (pDualInterfaceConfig->bEnablePingPongSplit ? 0x1 : 0x0));
      ...
      uSplitCTRLVal = HWIO_OUT_FLD(uSplitCTRLVal,MDP_SPLIT_DISPLAY_LOWER_PIPE_CTRL, SMART_PANEL_FREE_RUN,       (pDualInterfaceConfig->bEnablePingPongSplit ? 0x1 : 0x0));
      uSplitCTRLVal = HWIO_OUT_FLD(uSplitCTRLVal,MDP_SPLIT_DISPLAY_LOWER_PIPE_CTRL, INTF_1_TIM_GEN_SYNC_MODE,   0x0);
      uSplitCTRLVal = HWIO_OUT_FLD(uSplitCTRLVal,MDP_SPLIT_DISPLAY_LOWER_PIPE_CTRL, INTF_2_TIM_GEN_SYNC_MODE,   0x1);
      uSplitCTRLVal = HWIO_OUT_FLD(uSplitCTRLVal,MDP_SPLIT_DISPLAY_LOWER_PIPE_CTRL, TE_LINE_INTERVAL_WATERMARK, 0x0);
      out_dword(HWIO_MMSS_MDP_SPLIT_DISPLAY_LOWER_PIPE_CTRL_ADDR, uSplitCTRLVal);
  ...
  HAL_MDSS_ErrorType   eStatus  = HAL_MDSS_STATUS_SUCCESS;
   ...
   if(NULL != pInterfaceInfoData->pMISR_Status_Info)
   {
      HAL_MDP_Interface_MISR_Status(eInterfaceId,
                                    ...
                                    pInterfaceInfoData->pMISR_Status_Info->eStreamId);
   }
   ...
   if(NULL != pInterfaceInfoData->pMISR_CRC_Info)
   {
      HAL_MDP_Interface_MISR_Status(eInterfaceId,
                                    ...
                                    pInterfaceInfoData->pMISR_CRC_Info->eStreamId);
   }    
                                            ...
                                            uint32                uEnableFlags)
{
   ...
   if(HAL_MDP_INTERFACE_WRITEBACK_TYPE_BASE > eInterfaceId) // Physical interface
   {
       ...
       */
      out_dword(HWIO_MMSS_MDP_INTF_0_DSI_CMD_MODE_TRIGGER_EN_ADDR + uRegOffset, 0);
   }
