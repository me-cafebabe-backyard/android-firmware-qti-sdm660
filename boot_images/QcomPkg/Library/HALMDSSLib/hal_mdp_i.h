...
#define HAL_MDP_PANIC_LUT0_INFO( PanicLut0, PanicLut1, PanicLut2, PanicLut3, PanicLut4, PanicLut5, PanicLut6, PanicLut7) \
                                                             (PanicLut0 << HWIO_MMSS_MDP_PANIC_LUT0_FL_0_SHFT | \
                                                              PanicLut1 << HWIO_MMSS_MDP_PANIC_LUT0_FL_1_SHFT | \
                                                              PanicLut2 << HWIO_MMSS_MDP_PANIC_LUT0_FL_2_SHFT | \
                                                              PanicLut3 << HWIO_MMSS_MDP_PANIC_LUT0_FL_3_SHFT | \
                                                              PanicLut4 << HWIO_MMSS_MDP_PANIC_LUT0_FL_4_SHFT | \
                                                              PanicLut5 << HWIO_MMSS_MDP_PANIC_LUT0_FL_5_SHFT | \
                                                              PanicLut6 << HWIO_MMSS_MDP_PANIC_LUT0_FL_6_SHFT | \
                                                              PanicLut7 << HWIO_MMSS_MDP_PANIC_LUT0_FL_7_SHFT)

#define HAL_MDP_PANIC_LUT1_INFO( PanicLut8, PanicLut9, PanicLut10, PanicLut11, PanicLut12, PanicLut13, PanicLut14, PanicLut15) \
                                                             (PanicLut8  << HWIO_MMSS_MDP_PANIC_LUT1_FL_8_SHFT  | \
                                                              PanicLut9  << HWIO_MMSS_MDP_PANIC_LUT1_FL_9_SHFT  | \
                                                              PanicLut10 << HWIO_MMSS_MDP_PANIC_LUT1_FL_10_SHFT | \
                                                              PanicLut11 << HWIO_MMSS_MDP_PANIC_LUT1_FL_11_SHFT | \
                                                              PanicLut12 << HWIO_MMSS_MDP_PANIC_LUT1_FL_12_SHFT | \
                                                              PanicLut13 << HWIO_MMSS_MDP_PANIC_LUT1_FL_13_SHFT | \
                                                              PanicLut14 << HWIO_MMSS_MDP_PANIC_LUT1_FL_14_SHFT | \
                                                              PanicLut15 << HWIO_MMSS_MDP_PANIC_LUT1_FL_15_SHFT)
...
#define HAL_MDP_ROBUST_LUT_INFO(RobustLut0, RobustLut1, RobustLut2,  RobustLut3,  RobustLut4,  RobustLut5,  RobustLut6,  RobustLut7, \
                                RobustLut8, RobustLut9, RobustLut10, RobustLut11, RobustLut12, RobustLut13, RobustLut14, RobustLut15) \
                                                             (RobustLut0  << HWIO_MMSS_MDP_ROBUST_LUT_FL_0_SHFT  | \
                                                              RobustLut1  << HWIO_MMSS_MDP_ROBUST_LUT_FL_1_SHFT  | \
                                                              RobustLut2  << HWIO_MMSS_MDP_ROBUST_LUT_FL_2_SHFT  | \
                                                              RobustLut3  << HWIO_MMSS_MDP_ROBUST_LUT_FL_3_SHFT  | \
                                                              RobustLut4  << HWIO_MMSS_MDP_ROBUST_LUT_FL_4_SHFT  | \
                                                              RobustLut5  << HWIO_MMSS_MDP_ROBUST_LUT_FL_5_SHFT  | \
                                                              RobustLut6  << HWIO_MMSS_MDP_ROBUST_LUT_FL_6_SHFT  | \
                                                              RobustLut7  << HWIO_MMSS_MDP_ROBUST_LUT_FL_7_SHFT  | \
                                                              RobustLut8  << HWIO_MMSS_MDP_ROBUST_LUT_FL_8_SHFT  | \
                                                              RobustLut9  << HWIO_MMSS_MDP_ROBUST_LUT_FL_9_SHFT  | \
                                                              RobustLut10 << HWIO_MMSS_MDP_ROBUST_LUT_FL_10_SHFT | \
                                                              RobustLut11 << HWIO_MMSS_MDP_ROBUST_LUT_FL_11_SHFT | \
                                                              RobustLut12 << HWIO_MMSS_MDP_ROBUST_LUT_FL_12_SHFT | \
                                                              RobustLut13 << HWIO_MMSS_MDP_ROBUST_LUT_FL_13_SHFT | \
                                                              RobustLut14 << HWIO_MMSS_MDP_ROBUST_LUT_FL_14_SHFT | \
                                                              RobustLut15 << HWIO_MMSS_MDP_ROBUST_LUT_FL_15_SHFT)
...
/****************************************************************************
*
** FUNCTION: HAL_MDP_ReadHardwareInfo_1_1_0()
*/
/*!
* \brief
*     Reads the hardware capabilities for the given MDP Version(1.1.0)
*
* \param [out]  psHwInfo            - Hardware information
* \param [out]  psMdpHwInfo         - MDP hardware information 
*
...
*
****************************************************************************/
void HAL_MDP_ReadHardwareInfo_1_1_0(HAL_MDP_HwInfo             *psHwInfo,
                                    HAL_MDP_Hw_Private_Info    *psMdpHwInfo);

/****************************************************************************
*
** FUNCTION: HAL_MDP_ReadHardwareInfo_1_2_0()
*/
/*!
* \brief
*     Reads the hardware capabilities for the given MDP Version(1.2.0)
*
* \param [out]  psHwInfo            - Hardware information
* \param [out]  psMdpHwInfo         - MDP hardware information 
*
...
*
****************************************************************************/
void HAL_MDP_ReadHardwareInfo_1_2_0(HAL_MDP_HwInfo             *psHwInfo,
                                    HAL_MDP_Hw_Private_Info    *psMdpHwInfo);
...
/****************************************************************************
*
** FUNCTION: HAL_MDP_ReadHardwareInfo_1_4_0()
*/
/*!
* \brief
*     Reads the hardware capabilities for the given MDP Version(1.4.0)
*
* \param [out]  psHwInfo            - Hardware information
* \param [out]  psMdpHwInfo         - MDP hardware information 
*
...
*
****************************************************************************/
void HAL_MDP_ReadHardwareInfo_1_4_0(HAL_MDP_HwInfo             *psHwInfo,
                                    HAL_MDP_Hw_Private_Info    *psMdpHwInfo);

/****************************************************************************
*
** FUNCTION: HAL_MDP_ReadHardwareInfo_1_5_0()
*/
/*!
* \brief
*     Reads the hardware capabilities for the given MDP Version(1.4.0)
...
*
****************************************************************************/
void HAL_MDP_ReadHardwareInfo_1_5_0(HAL_MDP_HwInfo             *psHwInfo,
                                    HAL_MDP_Hw_Private_Info    *psMdpHwInfo);
...
/****************************************************************************
*
** FUNCTION: HAL_MDP_ReadHardwareInfo_1_7_0()
*/
/*!
* \brief
*     Reads the hardware capabilities for the given MDP Version(1.7.0)
*
* \param [out]  psHwInfo            - Hardware information
* \param [out]  psMdpHwInfo         - MDP hardware information 
*
...
*
****************************************************************************/
void HAL_MDP_ReadHardwareInfo_1_7_0(HAL_MDP_HwInfo             *psHwInfo,
                                    HAL_MDP_Hw_Private_Info    *psMdpHwInfo);

/****************************************************************************
*
** FUNCTION: HAL_MDP_ReadHardwareInfo_1_9_0()
*/
/*!
* \brief
*     Reads the hardware capabilities for the given MDP Version(1.9.0)
*
* \param [out]  psHwInfo            - Hardware information
* \param [out]  psMdpHwInfo         - MDP hardware information 
*
...
*
****************************************************************************/
void HAL_MDP_ReadHardwareInfo_1_9_0(HAL_MDP_HwInfo             *psHwInfo,
                                    HAL_MDP_Hw_Private_Info    *psMdpHwInfo);

/****************************************************************************
*
** FUNCTION: HAL_MDP_ReadHardwareInfo_1_10_0()
*/
/*!
* \brief
*     Reads the hardware capabilities for the given MDP Version(1.10.0)
*
* \param [out]  psHwInfo            - Hardware information
* \param [out]  psMdpHwInfo         - MDP hardware information 
*
...
*
****************************************************************************/
void HAL_MDP_ReadHardwareInfo_1_10_0(HAL_MDP_HwInfo             *psHwInfo,
                                    HAL_MDP_Hw_Private_Info    *psMdpHwInfo);
...
/****************************************************************************
*
** FUNCTION: HAL_MDP_TrafficCtrl_SetClientWatermarkLvl_1_3_0()
*/
/*!
* \brief
*     Sets a read client's watermark levels based on client's latency need.
