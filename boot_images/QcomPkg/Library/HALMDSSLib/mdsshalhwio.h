...
/**
  ...
  The mdsshalhwio.h.h file is the public API interface to the HW I/O (HWIO)
...
/*  
  ...
  ====================================================================
*/ 
#ifndef _MDSS_HAL_HWIO_H_
#define _MDSS_HAL_HWIO_H_
...
#define HWIO_GETVAL(reg, val, field)                             ( (val & HWIO_FMSK(reg, field)) >> HWIO_SHFT(reg, field) )
/** @} */
...
*/
#define HWIO_OUT_FLD(regVal, io, field, fldVal)                  (uint32)((((uint32)(fldVal) << HWIO_MMSS_##io##_##field##_SHFT) & HWIO_MMSS_##io##_##field##_BMSK) | ((uint32)(regVal) & ~HWIO_MMSS_##io##_##field##_BMSK))
 ...
 */
#define __msmhwio_in(hwiosym)                                   HWIO_MMSS_##hwiosym##_IN
#define __msmhwio_ini(hwiosym, index)                           HWIO_MMSS_##hwiosym##_INI(index)
#define __msmhwio_ini2(hwiosym, index1, index2)                 HWIO_MMSS_##hwiosym##_INI2(index1, index2)
#define __msmhwio_ini3(hwiosym, index1, index2, index3)         HWIO_MMSS_##hwiosym##_INI3(index1, index2, index3)
#define __msmhwio_inm(hwiosym, mask)                            HWIO_MMSS_##hwiosym##_INM(mask)
#define __msmhwio_inmi(hwiosym, index, mask)                    HWIO_MMSS_##hwiosym##_INMI(index, mask)
#define __msmhwio_inmi2(hwiosym, index1, index2, mask)          HWIO_MMSS_##hwiosym##_INMI2(index1, index2, mask)
#define __msmhwio_inmi3(hwiosym, index1, index2, index3, mask)  HWIO_MMSS_##hwiosym##_INMI3(index1, index2, index3, mask)
#define __msmhwio_out(hwiosym, val)                             HWIO_MMSS_##hwiosym##_OUT(val)
#define __msmhwio_outi(hwiosym, index, val)                     HWIO_MMSS_##hwiosym##_OUTI(index,val)
#define __msmhwio_outi2(hwiosym, index1, index2, val)           HWIO_MMSS_##hwiosym##_OUTI2(index1, index2, val)
#define __msmhwio_outi3(hwiosym, index1, index2, index3, val)   HWIO_MMSS_##hwiosym##_OUTI2(index1, index2, index3, val)
#define __msmhwio_outm(hwiosym, mask, val)                      HWIO_MMSS_##hwiosym##_OUTM(mask, val)
#define __msmhwio_outmi(hwiosym, index, mask, val)              HWIO_MMSS_##hwiosym##_OUTMI(index, mask, val)
#define __msmhwio_outmi2(hwiosym, idx1, idx2, mask, val)        HWIO_MMSS_##hwiosym##_OUTMI2(idx1, idx2, mask, val)
#define __msmhwio_outmi3(hwiosym, idx1, idx2, idx3, mask, val)  HWIO_MMSS_##hwiosym##_OUTMI3(idx1, idx2, idx3, mask, val)
#define __msmhwio_addr(hwiosym)                                 HWIO_MMSS_##hwiosym##_ADDR
#define __msmhwio_addri(hwiosym, index)                         HWIO_MMSS_##hwiosym##_ADDR(index)
#define __msmhwio_addri2(hwiosym, idx1, idx2)                   HWIO_MMSS_##hwiosym##_ADDR(idx1, idx2)
#define __msmhwio_addri3(hwiosym, idx1, idx2, idx3)             HWIO_MMSS_##hwiosym##_ADDR(idx1, idx2, idx3)
#define __msmhwio_phys(hwiosym)                                 HWIO_MMSS_##hwiosym##_PHYS
#define __msmhwio_physi(hwiosym, index)                         HWIO_MMSS_##hwiosym##_PHYS(index)
#define __msmhwio_physi2(hwiosym, idx1, idx2)                   HWIO_MMSS_##hwiosym##_PHYS(idx1, idx2)
#define __msmhwio_physi3(hwiosym, idx1, idx2, idx3)             HWIO_MMSS_##hwiosym##_PHYS(idx1, idx2, idx3)
#define __msmhwio_offs(hwiosym)                                 HWIO_MMSS_##hwiosym##_OFFS 
#define __msmhwio_offsi(hwiosym, index)                         HWIO_MMSS_##hwiosym##_OFFS(index)
#define __msmhwio_offsi2(hwiosym, idx1, idx2)                   HWIO_MMSS_##hwiosym##_OFFS(idx1, idx2)
#define __msmhwio_offsi3(hwiosym, idx1, idx2, idx3)             HWIO_MMSS_##hwiosym##_OFFS(idx1, idx2, idx3)
#define __msmhwio_rmsk(hwiosym)                                 HWIO_MMSS_##hwiosym##_RMSK
#define __msmhwio_rmski(hwiosym, index)                         HWIO_MMSS_##hwiosym##_RMSK(index)
#define __msmhwio_fmsk(hwiosym, hwiofldsym)                     HWIO_MMSS_##hwiosym##_##hwiofldsym##_BMSK
#define __msmhwio_rshft(hwiosym)                                HWIO_MMSS_##hwiosym##_SHFT
#define __msmhwio_shft(hwiosym, hwiofldsym)                     HWIO_MMSS_##hwiosym##_##hwiofldsym##_SHFT
#define __msmhwio_shdw(hwiosym)                                 HWIO_MMSS_##hwiosym##_shadow
#define __msmhwio_shdwi(hwiosym, index)                         HWIO_MMSS_##hwiosym##_SHDW(index)
#define __msmhwio_val(hwiosym, hwiofld, hwioval)                HWIO_MMSS_##hwiosym##_##hwiofld##_##hwioval##_FVAL
 ...
 */
#ifdef ENVIRO_QSEMU // Software Only Emulation
   #define __inpdw(port)       (QSEMU_MDPRegRead(port))
   #define __outpdw(port, val) (QSEMU_MDPRegWrite(port, val))
...
extern uint8   __inp_extern      ( uintPtr nAddr );
extern uint16  __inpw_extern     ( uintPtr nAddr );
extern uint32  __inpdw_extern    ( uintPtr nAddr );
extern void    __outp_extern     ( uintPtr nAddr, uint8  nData );
extern void    __outpw_extern    ( uintPtr nAddr, uint16 nData );
extern void    __outpdw_extern   ( uintPtr nAddr, uint32 nData );
