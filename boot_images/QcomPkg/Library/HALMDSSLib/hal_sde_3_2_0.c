...
FILE:         hal_sde_3_2_0.c

DESCRIPTION:  SDE 3.2.0 hardware specifics
...
#define  HAL_MDP_3_2_0_NUM_OF_RGB_LAYERS                       0     /** RGB Source Surface Pixel Processors      */
#define  HAL_MDP_3_2_0_NUM_OF_VIG_LAYERS                       2     /** VIG Source Surface Pixel Processors      */
#define  HAL_MDP_3_2_0_NUM_OF_DMA_LAYERS                       3     /** DMA Source Surface Pixel Processors      */
#define  HAL_MDP_3_2_0_NUM_OF_CURSOR_LAYERS                    1     /** CURSOR Source Surface Pixel Processors   */
#define  HAL_MDP_3_2_0_NUM_OF_LAYER_MIXERS                     4     /** Layer Mixers */
#define  HAL_MDP_3_2_0_NUM_OF_DSPP                             2     /** Destination Surface Pixel Processor      */
#define  HAL_MDP_3_2_0_NUM_OF_PHYSICAL_INTERFACES              3     /** INTF_0, INTF_1, INTF_2 and INTF_3        */
#define  HAL_MDP_3_2_0_NUM_OF_WRITEBACK_INTERFACES             1     /** WB_0, WB_1 and WB_2                      */
#define  HAL_MDP_3_2_0_NUM_OF_CONTROL_PATHS                    4     /** MDP_CTL_x (x = 0, 1, 2, 3, and 4)        */
#define  HAL_MDP_3_2_0_NUM_OF_DATA_PATHS                       1     /** MDP_WB_x (x = 0, 1, 2, 3, and 4)         */
#define  HAL_MDP_3_2_0_NUM_OF_PINGPONGS                        5     /** Pingpong blocks                          */
#define  HAL_MDP_3_2_0_NUM_OF_WATCHDOGS                        0     /** Watch Dogs                               */
#define  HAL_MDP_3_2_0_NUM_OF_AXI_PORTS                        1     /** Number of AXI ports                      */
#define  HAL_MDP_3_2_0_NUM_OF_VBIF_CLIENTS                     10    /** Number of VBIF clients                   */

#define  HAL_MDP_3_2_0_NUM_OF_CHROMA_BLOCKS                    1     /** Number of Chroma blocks                  */

/** RGB and VG and DMA IGC LUT Size */
#define  HAL_MDP_3_2_0_SSPP_IGC_LUT_SIZE                       256
#define  HAL_MDP_3_2_0_SSPP_IGC_NUM_OF_COLOR_COMPONENTS        3     /** Color 0, 1 and 2                         */

/** DSPP IGC LUT Size */
#define  HAL_MDP_3_2_0_DSPP_IGC_LUT_SIZE                       256
#define  HAL_MDP_3_2_0_DSPP_IGC_NUM_OF_COLOR_COMPONENTS        3     /** Color 0, 1 and 2                         */

/** QSEED */

/** LAYER MIXER */
#define  HAL_MDP_3_2_0_LAYER_MIXER_MAX_BLEND_STAGES            7     /** Blend Stage #0, 1, 2 and 3               */

/** QOS */
#define HAL_MDP_3_2_0_QOS_REQPRI_WATERMARK_REGS_COUNT          3


/* QoS priority re-mapping for real time read clients; real time clients are ViG, RGB, and DMA in line mode;*/
#define HAL_MDP_3_2_0_QOS_REMAPPER_REALTIME_CLIENTS            HAL_MDP_QOS_REMAPPER_INFO(                \
...
#define HAL_MDP_3_2_0_QOS_REMAPPER_NONREALTIME_CLIENTS         HAL_MDP_QOS_REMAPPER_INFO(                \
...
#define HAL_MDP_3_2_0_VBIF_MAX_DDR_RD_BURST_SIZE               15
#define HAL_MDP_3_2_0_VBIF_MAX_DDR_WR_BURST_SIZE               15
#define HAL_MDP_3_2_0_VBIF_MAX_RD_OT_SIZE                      32
#define HAL_MDP_3_2_0_VBIF_MAX_WR_OT_SIZE                      32

#define HAL_MDP_3_2_0_VBIF_ROUND_ROBIN_QOS_ARB                 HWIO_MMSS_VBIF_VBIF_ROUND_ROBIN_QOS_ARB_RR_QOS_EN_BMSK

/** Clock control */
#define HAL_MDP_3_2_0_HYSTERISIS_DEFAULT                       3

/** HSIC register range */
#define HAL_MDP_3_2_0_PICTURE_ADJUST_MIN_HUE                  (-768)   // -180 degree
#define HAL_MDP_3_2_0_PICTURE_ADJUST_MAX_HUE                  (-768)   // 180 degree
#define HAL_MDP_3_2_0_PICTURE_ADJUST_MIN_UNCHANGE_HUE          0       // value for unchange hue going to the min hue direction
#define HAL_MDP_3_2_0_PICTURE_ADJUST_MAX_UNCHANGE_HUE         (-1536)  // value for unchange hue going to the max hue direction
#define HAL_MDP_3_2_0_PICTURE_ADJUST_MIN_SATURATION           (-128)   
#define HAL_MDP_3_2_0_PICTURE_ADJUST_MAX_SATURATION            127
#define HAL_MDP_3_2_0_PICTURE_ADJUST_UNCHANGE_SATURATION       0
#define HAL_MDP_3_2_0_PICTURE_ADJUST_MIN_INTENSITY            (-128) 
#define HAL_MDP_3_2_0_PICTURE_ADJUST_MAX_INTENSITY             127 
#define HAL_MDP_3_2_0_PICTURE_ADJUST_UNCHANGE_INTENSITY        0
#define HAL_MDP_3_2_0_PICTURE_ADJUST_MIN_CONTRAST             (-128)
#define HAL_MDP_3_2_0_PICTURE_ADJUST_MAX_CONTRAST              127
#define HAL_MDP_3_2_0_PICTURE_ADJUST_UNCHANGE_CONTRAST         0

/** Highest bank bit configuration */
#define HAL_MDP_3_2_0_HIGHEST_BANK_BIT_DEFAULT                 2
...
static uint32 gTwoDFilterA_LUT[HAL_MDP_QSEED_ENTRIE_SIZE_IN_REGISTERS*HAL_MDP_QSEED_COEFF_LUT_A_ENTRIES] = 
{
...
static uint32 gTwoDFilterB_LUT[HAL_MDP_QSEED_ENTRIE_SIZE_IN_REGISTERS*HAL_MDP_QSEED_COEFF_LUT_B_ENTRIES] = 
{
...
static uint32 gTwoDFilterC_LUT[HAL_MDP_QSEED_ENTRIE_SIZE_IN_REGISTERS*HAL_MDP_QSEED_COEFF_LUT_C_ENTRIES] = 
{
...
static uint32 gTwoDFilterD_LUT[HAL_MDP_QSEED_ENTRIE_SIZE_IN_REGISTERS*HAL_MDP_QSEED_COEFF_LUT_D_ENTRIES] = 
{
...
static HAL_MDP_VBIFQOSRemappersType gSVBIFQOSRemap_3_2_0[HAL_MDP_VBIF_CLIENT_MAX] =
{
...
*/
const HAL_MDP_VbifId gsVbifClientToHwIdMap_3_2_0[HAL_MDP_VBIF_CLIENT_MAX] =
{
  HAL_MDP_VBIF_0,      //   HAL_MDP_VBIF_CLIENT_VIG0 = 0x00000000,   // xin0  
  HAL_MDP_VBIF_0,      //   HAL_MDP_VBIF_CLIENT_DMA0,                // xin1  
  HAL_MDP_VBIF_0,      //   HAL_MDP_VBIF_CLIENT_CURSOR0,             // xin2  
  HAL_MDP_VBIF_0,      //   HAL_MDP_VBIF_CLIENT_NONE0,               // xin3  
  HAL_MDP_VBIF_0,      //   HAL_MDP_VBIF_CLIENT_VIG1,                // xin4  
  HAL_MDP_VBIF_0,      //   HAL_MDP_VBIF_CLIENT_DMA1,                // xin5  
  HAL_MDP_VBIF_0,      //   HAL_MDP_VBIF_CLIENT_WB2,                 // xin6  
  HAL_MDP_VBIF_0,      //   HAL_MDP_VBIF_CLIENT_DSIDMA,              // xin7  
  HAL_MDP_VBIF_0,      //   HAL_MDP_VBIF_CLIENT_VIG2,                // xin8  
  HAL_MDP_VBIF_0,      //   HAL_MDP_VBIF_CLIENT_DMA2,                // xin9  
  HAL_MDP_VBIF_0,      //   HAL_MDP_VBIF_CLIENT_CURSOR1,             // xin10 
  HAL_MDP_VBIF_0,      //   HAL_MDP_VBIF_CLIENT_NONE1,               // xin11  
  HAL_MDP_VBIF_0,      //   HAL_MDP_VBIF_CLIENT_VIG3,                // xin12 
  HAL_MDP_VBIF_0,      //   HAL_MDP_VBIF_CLIENT_DMA3,                // xin13 
  HAL_MDP_VBIF_0,      //   HAL_MDP_VBIF_CLIENT_ROT_RD,              // xin14 
  HAL_MDP_VBIF_0,      //   HAL_MDP_VBIF_CLIENT_ROT_WR,              // xin15 
};


/****************************************************************************
*
** FUNCTION: HAL_MDP_SetHWBlockRegOffsets_3_2_0()
*/
/*!
* \brief
...
*
****************************************************************************/
static void HAL_MDP_SetHWBlockRegOffsets_3_2_0(void)
{
  ...
  uMDPLayerMixerBlendStateRegBaseOffset[HAL_MDP_BLEND_STAGE_1]      = (HWIO_MDP_VP_0_LAYER_0_BLEND1_OP_OFFS - HWIO_MDP_VP_0_LAYER_0_BLEND0_OP_OFFS);
  uMDPLayerMixerBlendStateRegBaseOffset[HAL_MDP_BLEND_STAGE_2]      = (HWIO_MDP_VP_0_LAYER_0_BLEND2_OP_OFFS - HWIO_MDP_VP_0_LAYER_0_BLEND0_OP_OFFS);
  uMDPLayerMixerBlendStateRegBaseOffset[HAL_MDP_BLEND_STAGE_3]      = (HWIO_MDP_VP_0_LAYER_0_BLEND3_OP_OFFS - HWIO_MDP_VP_0_LAYER_0_BLEND0_OP_OFFS);
  uMDPLayerMixerBlendStateRegBaseOffset[HAL_MDP_BLEND_STAGE_4]      = (HWIO_MDP_VP_0_LAYER_0_BLEND4_OP_OFFS - HWIO_MDP_VP_0_LAYER_0_BLEND0_OP_OFFS);
  uMDPLayerMixerBlendStateRegBaseOffset[HAL_MDP_BLEND_STAGE_5]      = (HWIO_MDP_VP_0_LAYER_0_BLEND5_OP_OFFS - HWIO_MDP_VP_0_LAYER_0_BLEND0_OP_OFFS);
  uMDPLayerMixerBlendStateRegBaseOffset[HAL_MDP_BLEND_STAGE_6]      = (HWIO_MDP_VP_0_LAYER_0_BLEND6_OP_OFFS - HWIO_MDP_VP_0_LAYER_0_BLEND0_OP_OFFS);
  ...
  uMDPDSCRegBaseOffset[HAL_MDP_DSC_2]                               = 0x00000000;
...
/****************************************************************************
*
** FUNCTION: HAL_MDP_ReadHardwareInfo_3_2_0()
*/
/*!
* \brief
*     Reads the hardware capabilities for the given MDP Version(3.2.0)
*
...
*
****************************************************************************/
void HAL_MDP_ReadHardwareInfo_3_2_0(HAL_MDP_HwInfo             *psHwInfo,
                                    HAL_MDP_Hw_Private_Info    *psMdpHwInfo)
{
   // Assign HW block register base. Values come from auto-generated mdssreg.h
   MMSS_MDSS_HW_REG_BASE                             = (MMSS_MDSS_REG_BASE      + 0x00000000);
   ...
   MMSS_MDP_VP_0_CURSOR_0_REG_BASE                   = (MMSS_MDSS_REG_BASE      + 0x00035000);
   ...
   MMSS_MDP_VP_0_VIG_0_QSEED3_REG_BASE               = (MMSS_MDSS_REG_BASE      + 0x00005a00);
   MMSS_MDP_VP_0_VIG_0_QSEED3_COEF_LUT_REG_BASE      = (MMSS_MDSS_REG_BASE      + 0x00005b00);
   MMSS_MDP_VP_0_VIG_0_PA_HIST_REG_BASE              = (MMSS_MDSS_REG_BASE      + 0x00006200);
   MMSS_MDP_VP_0_VIG_0_PA_MEMCOL_REG_BASE            = (MMSS_MDSS_REG_BASE      + 0x00006280);
   MMSS_MDP_VP_0_VIG_0_PA_SZONE_REG_BASE             = (MMSS_MDSS_REG_BASE      + 0x00006300);
   MMSS_MDP_VP_0_VIG_0_LUTV_RAM_REG_BASE             = (MMSS_MDSS_REG_BASE      + 0x00006400);
   MMSS_MDP_VP_0_VIG_0_HIST_RAM_REG_BASE             = (MMSS_MDSS_REG_BASE      + 0x00006600);
   MMSS_MDP_VP_0_VIG_0_CSC_1_REG_BASE                = (MMSS_MDSS_REG_BASE      + 0x00006a00);
   MMSS_MDP_VP_0_VIG_0_PCC_REG_BASE                  = (MMSS_MDSS_REG_BASE      + 0x00006b00);
   ...
   MMSS_MDP_VP_0_DSPP_0_PA_HIST_REG_BASE             = (MMSS_MDSS_REG_BASE      + 0x00055800);
   MMSS_MDP_VP_0_DSPP_0_HIST_RAM_REG_BASE            = (MMSS_MDSS_REG_BASE      + 0x00055c00);
   MMSS_MDP_VP_0_DSPP_0_LUTV_RAM_REG_BASE            = (MMSS_MDSS_REG_BASE      + 0x00055a00);
   MMSS_MDP_VP_0_DSPP_0_PA_MEMCOL_REG_BASE           = (MMSS_MDSS_REG_BASE      + 0x00055880);
   MMSS_MDP_VP_0_DSPP_0_PA_SZONE_REG_BASE            = (MMSS_MDSS_REG_BASE      + 0x00055900);
   ...
   MMSS_MDP_DEST_SCALER_0_REG_BASE                   = (MMSS_MDSS_REG_BASE      + 0x00061000);
   MMSS_MDP_DEST_SCALER_0_DEST_SCL0_REG_BASE         = (MMSS_MDSS_REG_BASE      + 0x00061800);
   ...
   MMSS_MDP_PPB_0_REG_BASE                           = (MMSS_MDSS_REG_BASE      + 0x00074000);
   MMSS_MDP_PPB_0_DITHER_REG_BASE                    = (MMSS_MDSS_REG_BASE      + 0x000740e0);
   ...
   MMSS_MDP_QDSS_REG_BASE                            = (MMSS_MDSS_REG_BASE      + 0x00081a00);
   MMSS_ROT_REG_BASE                                 = (MMSS_MDSS_REG_BASE      + 0x000a8800);
   MMSS_ROT_ROTTOP_REG_BASE                          = (MMSS_MDSS_REG_BASE      + 0x000a8800);
   MMSS_ROT_SSPP_REG_BASE                            = (MMSS_MDSS_REG_BASE      + 0x000a8900);
   MMSS_ROT_QDSS_REG_BASE                            = (MMSS_MDSS_REG_BASE      + 0x000aaf00);
   MMSS_ROT_REGDMA_REG_BASE                          = (MMSS_MDSS_REG_BASE      + 0x000a8e00);
   MMSS_ROT_REGDMA_RAM_REG_BASE                      = (MMSS_MDSS_REG_BASE      + 0x000a8e00);
   MMSS_ROT_REGDMA_CSR_REG_BASE                      = (MMSS_MDSS_REG_BASE      + 0x000aae00);
   MMSS_ROT_WB_REG_BASE                              = (MMSS_MDSS_REG_BASE      + 0x000a8b00);
   MMSS_MDP_AADC_0_REG_BASE                          = (MMSS_MDSS_REG_BASE      + 0x00079000);
   MMSS_DP_REG_BASE                                  = (MMSS_MDSS_REG_BASE      + 0x00090000);
   MMSS_HDMI_REG_BASE                                = (MMSS_MDSS_REG_BASE      + 0x000a0000);
   HDMI_PHY_REG_BASE                                 = (MMSS_MDSS_REG_BASE      + 0x000a1200);
   VBIF_SDE_REG_BASE                                 = (MMSS_MDSS_REG_BASE      + 0x000b0000);
   VBIF_NRT_VBIF_ROT_REG_BASE                        = (MMSS_MDSS_REG_BASE      + 0x000b8000);
   
   DSI_0_DSI_REG_BASE                                         = (MMSS_MDSS_REG_BASE + 0x00094000);
   DSI_0_DSI_PHY_REG_BASE                                     = (MMSS_MDSS_REG_BASE + 0x00094400);
   ...
   DSI_1_DSI_REG_BASE                                         = (MMSS_MDSS_REG_BASE + 0x00096000);
   DSI_1_DSI_PHY_REG_BASE                                     = (MMSS_MDSS_REG_BASE + 0x00096400);
   ...
   MMSS_HDMI_REG_BASE                                         = (MMSS_MDSS_REG_BASE + 0x000a0000);
   MMSS_HDMI_PHY_QSERDES_COM_QSERDES_COM_HDMI_COM_REG_BASE    = (MMSS_MDSS_REG_BASE + 0x000a0600);
   MMSS_HDMI_PHY_QSERDES_TX_L0_QSERDES_TX_L0_HDMI_TX_REG_BASE = (MMSS_MDSS_REG_BASE + 0x000a0a00);
   MMSS_HDMI_PHY_QSERDES_TX_L1_QSERDES_TX_L1_HDMI_TX_REG_BASE = (MMSS_MDSS_REG_BASE + 0x000a0c00);
   MMSS_HDMI_PHY_QSERDES_TX_L2_QSERDES_TX_L2_HDMI_TX_REG_BASE = (MMSS_MDSS_REG_BASE + 0x000a0e00);
   MMSS_HDMI_PHY_QSERDES_TX_L3_QSERDES_TX_L3_HDMI_TX_REG_BASE = (MMSS_MDSS_REG_BASE + 0x000a1000);
   HDMI_PHY_REG_BASE                                          = (MMSS_MDSS_REG_BASE + 0x000a1200);
   ...
   HAL_MDP_SetHWBlockRegOffsets_3_2_0();

   if(NULL != psHwInfo)
   {
      psHwInfo->uNumOfRGBLayers             = HAL_MDP_3_2_0_NUM_OF_RGB_LAYERS;
      psHwInfo->uNumOfVIGLayers             = HAL_MDP_3_2_0_NUM_OF_VIG_LAYERS;
      psHwInfo->uNumOfDMALayers             = HAL_MDP_3_2_0_NUM_OF_DMA_LAYERS;
      psHwInfo->uNumOfCursorLayers          = HAL_MDP_3_2_0_NUM_OF_CURSOR_LAYERS;
      psHwInfo->uNumOfLayerMixers           = HAL_MDP_3_2_0_NUM_OF_LAYER_MIXERS;
      psHwInfo->uNumOfDSPPs                 = HAL_MDP_3_2_0_NUM_OF_DSPP;
      psHwInfo->uNumOfBltEngines            = HAL_MDP_3_2_0_NUM_OF_WRITEBACK_INTERFACES;
      psHwInfo->uNumOfControlPaths          = HAL_MDP_3_2_0_NUM_OF_CONTROL_PATHS;
      psHwInfo->uNumOfDataPaths             = HAL_MDP_3_2_0_NUM_OF_DATA_PATHS;
      psHwInfo->uNumOfLayerMixerBlendStages = HAL_MDP_3_2_0_LAYER_MIXER_MAX_BLEND_STAGES;
      psHwInfo->uNumOfPhyInterfaces         = HAL_MDP_3_2_0_NUM_OF_PHYSICAL_INTERFACES;
      psHwInfo->uNumOfPingPongs             = HAL_MDP_3_2_0_NUM_OF_PINGPONGS;
      psHwInfo->uNumOfWatchDogs             = HAL_MDP_3_2_0_NUM_OF_WATCHDOGS;
      psHwInfo->uNumOfAxiPorts              = HAL_MDP_3_2_0_NUM_OF_AXI_PORTS;
      psHwInfo->uNumOfVbifClients           = HAL_MDP_3_2_0_NUM_OF_VBIF_CLIENTS;       
      psHwInfo->eGamutType                  = HAL_MDP_GAMUT_8BITGAMUT_TYPE;
      psHwInfo->uNumOfChromaDownBlocks      = HAL_MDP_3_2_0_NUM_OF_CHROMA_BLOCKS;
   ...
   if(NULL != psMdpHwInfo)
   {
      ...
      // QOS & VBIF
      psMdpHwInfo->bConfigureVBIF                          = FALSE;       // Use HW defaults
      psMdpHwInfo->uVBIFMaxDdrRdBurstSize                  = HAL_MDP_3_2_0_VBIF_MAX_DDR_RD_BURST_SIZE;
      psMdpHwInfo->uVBIFMaxDdrWrBurstSize                  = HAL_MDP_3_2_0_VBIF_MAX_DDR_WR_BURST_SIZE;
      psMdpHwInfo->uVBIFMaxRdOT                            = HAL_MDP_3_2_0_VBIF_MAX_RD_OT_SIZE;
      psMdpHwInfo->uVBIFMaxWrOT                            = HAL_MDP_3_2_0_VBIF_MAX_WR_OT_SIZE;      
      
      psMdpHwInfo->uVBIFRoundRobinQosArb                   = HAL_MDP_3_2_0_VBIF_ROUND_ROBIN_QOS_ARB;
      psMdpHwInfo->pVBIFQOSRemappers                       = &gSVBIFQOSRemap_3_2_0[0];
      psMdpHwInfo->pVBIFClientToHWIDMap                    = &gsVbifClientToHwIdMap_3_2_0[0];

      //Picture adjustment(HSIC) 
      psMdpHwInfo->sPictureAdjustInfo.iMinHue              = HAL_MDP_3_2_0_PICTURE_ADJUST_MIN_HUE;
      psMdpHwInfo->sPictureAdjustInfo.iMaxHue              = HAL_MDP_3_2_0_PICTURE_ADJUST_MAX_HUE;
      psMdpHwInfo->sPictureAdjustInfo.iMinUnchangeHue      = HAL_MDP_3_2_0_PICTURE_ADJUST_MIN_UNCHANGE_HUE;
      psMdpHwInfo->sPictureAdjustInfo.iMaxUnchangeHue      = HAL_MDP_3_2_0_PICTURE_ADJUST_MAX_UNCHANGE_HUE;
      psMdpHwInfo->sPictureAdjustInfo.iMinSaturation       = HAL_MDP_3_2_0_PICTURE_ADJUST_MIN_SATURATION;
      psMdpHwInfo->sPictureAdjustInfo.iMaxSaturation       = HAL_MDP_3_2_0_PICTURE_ADJUST_MAX_SATURATION;
      psMdpHwInfo->sPictureAdjustInfo.iUnchangeSaturation  = HAL_MDP_3_2_0_PICTURE_ADJUST_UNCHANGE_SATURATION;
      psMdpHwInfo->sPictureAdjustInfo.iMinIntensity        = HAL_MDP_3_2_0_PICTURE_ADJUST_MIN_INTENSITY;
      psMdpHwInfo->sPictureAdjustInfo.iMaxIntensity        = HAL_MDP_3_2_0_PICTURE_ADJUST_MAX_INTENSITY;
      psMdpHwInfo->sPictureAdjustInfo.iUnchangeIntensity   = HAL_MDP_3_2_0_PICTURE_ADJUST_UNCHANGE_INTENSITY;
      psMdpHwInfo->sPictureAdjustInfo.iMinContrast         = HAL_MDP_3_2_0_PICTURE_ADJUST_MIN_CONTRAST;
      psMdpHwInfo->sPictureAdjustInfo.iMaxContrast         = HAL_MDP_3_2_0_PICTURE_ADJUST_MAX_CONTRAST;
      psMdpHwInfo->sPictureAdjustInfo.iUnchangeContrast    = HAL_MDP_3_2_0_PICTURE_ADJUST_UNCHANGE_CONTRAST;

      psMdpHwInfo->uHysterisisValue                        = HAL_MDP_3_2_0_HYSTERISIS_DEFAULT;
      ...
      psMdpHwInfo->uDefaultHighestBankBit             = HAL_MDP_3_2_0_HIGHEST_BANK_BIT_DEFAULT;
