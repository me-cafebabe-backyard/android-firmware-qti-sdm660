...
#define HAL_MDP_PREPARE_SRC_FORMAT_INFO(eFrameFormat,      \
                                        ...
                                        uDxFormat    \
                                          ...
                                          eFrameFormat   << HWIO_MMSS_MDP_VP_0_VIG_0_SSPP_SRC_FORMAT_FRAME_FORMAT_SHFT    |     \
                                          eChromaSample  << HWIO_MMSS_MDP_VP_0_VIG_0_SSPP_SRC_FORMAT_SRC_CHROMA_SAMP_SHFT |     \
                                          uNumOfPlanes   << HWIO_MMSS_MDP_VP_0_VIG_0_SSPP_SRC_FORMAT_FETCH_PLANES_SHFT    |     \
                                          bPackAlign     << HWIO_MMSS_MDP_VP_0_VIG_0_SSPP_SRC_FORMAT_UNPACK_ALIGN_SHFT    |     \
                                          bPackTight     << HWIO_MMSS_MDP_VP_0_VIG_0_SSPP_SRC_FORMAT_UNPACK_TIGHT_SHFT    |     \
                                          uUnPackCount   << HWIO_MMSS_MDP_VP_0_VIG_0_SSPP_SRC_FORMAT_UNPACK_COUNT_SHFT    |     \
                                          uBytesPerPixel << HWIO_MMSS_MDP_VP_0_VIG_0_SSPP_SRC_FORMAT_SRC_BPP_SHFT         |     \
                                          bAlphaPresent  << HWIO_MMSS_MDP_VP_0_VIG_0_SSPP_SRC_FORMAT_SRCC3_EN_SHFT        |     \
                                          uBitsPerColor3 << HWIO_MMSS_MDP_VP_0_VIG_0_SSPP_SRC_FORMAT_SRCC3_SHFT           |     \
                                          uBitsPerColor2 << HWIO_MMSS_MDP_VP_0_VIG_0_SSPP_SRC_FORMAT_SRCC2_SHFT           |     \
                                          uBitsPerColor1 << HWIO_MMSS_MDP_VP_0_VIG_0_SSPP_SRC_FORMAT_SRCC1_SHFT           |     \
                                          uBitsPerColor0 << HWIO_MMSS_MDP_VP_0_VIG_0_SSPP_SRC_FORMAT_SRCC0_SHFT           |     \
                                          uDxFormat      << HWIO_MMSS_MDP_VP_0_VIG_0_SSPP_SRC_FORMAT_UNPACK_DX_FORMAT_SHFT
...
uint32 HAL_MDP_GetSourceFormatInfo(HAL_MDP_SurfaceAttrType   *psSurface)
{
  ...
  if (psSurface->ePixelFormat < HAL_MDP_PIXEL_FORMAT_MAX)
  {
    ...
    {
      uSourceFormatInfo &=~(HWIO_MMSS_MDP_WB_2_DST_FORMAT_FRAME_FORMAT_BMSK);
      uSourceFormatInfo |= ((pgsMdpHwInfo->eMacroTileFormat)<< HWIO_MMSS_MDP_WB_2_DST_FORMAT_FRAME_FORMAT_SHFT);
    }
...
uint32 HAL_MDP_GetDestinationFormatInfo(HAL_MDP_SurfaceAttrType   *psSurface)
{
  ...
  if((1 << HWIO_MMSS_MDP_VP_0_VIG_0_SSPP_SRC_FORMAT_UNPACK_DX_FORMAT_SHFT) & uDestinationFormatInfo )
  {
    uDestinationFormatInfo &=~(HWIO_MMSS_MDP_VP_0_VIG_0_SSPP_SRC_FORMAT_UNPACK_DX_FORMAT_BMSK);
    uDestinationFormatInfo |= (HWIO_MMSS_MDP_WB_2_DST_FORMAT_PACK_DX_FORMAT_BMSK);
  }
