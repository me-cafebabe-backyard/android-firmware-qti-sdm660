...
FILE:         hal_sde_3_3_0.c

DESCRIPTION:  SDE 3.3.0 hardware specifics
...
#define  HAL_MDP_3_3_0_NUM_OF_RGB_LAYERS                       0     /** RGB Source Surface Pixel Processors      */
#define  HAL_MDP_3_3_0_NUM_OF_VIG_LAYERS                       1     /** VIG Source Surface Pixel Processors      */
#define  HAL_MDP_3_3_0_NUM_OF_DMA_LAYERS                       3     /** DMA Source Surface Pixel Processors      */
#define  HAL_MDP_3_3_0_NUM_OF_CURSOR_LAYERS                    1     /** CURSOR Source Surface Pixel Processors   */
#define  HAL_MDP_3_3_0_NUM_OF_LAYER_MIXERS                     2     /** Layer Mixers */
#define  HAL_MDP_3_3_0_NUM_OF_DSPP                             1     /** Destination Surface Pixel Processor      */
#define  HAL_MDP_3_3_0_NUM_OF_PHYSICAL_INTERFACES              2     /** INTF_0, INTF_1, INTF_2 and INTF_3        */
#define  HAL_MDP_3_3_0_NUM_OF_WRITEBACK_INTERFACES             1     /** WB_0, WB_1 and WB_2                      */
#define  HAL_MDP_3_3_0_NUM_OF_CONTROL_PATHS                    4     /** MDP_CTL_x (x = 0, 1, 2, 3, and 4)        */
#define  HAL_MDP_3_3_0_NUM_OF_DATA_PATHS                       1     /** MDP_WB_x (x = 0, 1, 2, 3, and 4)         */
#define  HAL_MDP_3_3_0_NUM_OF_PINGPONGS                        5     /** Pingpong blocks                          */
#define  HAL_MDP_3_3_0_NUM_OF_WATCHDOGS                        0     /** Watch Dogs                               */
#define  HAL_MDP_3_3_0_NUM_OF_AXI_PORTS                        1     /** Number of AXI ports                      */
#define  HAL_MDP_3_3_0_NUM_OF_VBIF_CLIENTS                     9     /** Number of VBIF clients                   */

#define  HAL_MDP_3_3_0_NUM_OF_CHROMA_BLOCKS                    1     /** Number of Chroma blocks                  */

/** RGB and VG and DMA IGC LUT Size */
#define  HAL_MDP_3_3_0_SSPP_IGC_LUT_SIZE                       256
#define  HAL_MDP_3_3_0_SSPP_IGC_NUM_OF_COLOR_COMPONENTS        3     /** Color 0, 1 and 2                         */

/** DSPP IGC LUT Size */
#define  HAL_MDP_3_3_0_DSPP_IGC_LUT_SIZE                       256
#define  HAL_MDP_3_3_0_DSPP_IGC_NUM_OF_COLOR_COMPONENTS        3     /** Color 0, 1 and 2                         */

/** QSEED */

/** LAYER MIXER */
#define  HAL_MDP_3_3_0_LAYER_MIXER_MAX_BLEND_STAGES            7     /** Blend Stage #0, 1, 2 and 3               */

/** QOS */
#define HAL_MDP_3_3_0_QOS_REQPRI_WATERMARK_REGS_COUNT          3


/* QoS priority re-mapping for real time read clients; real time clients are ViG, RGB, and DMA in line mode;*/
#define HAL_MDP_3_3_0_QOS_REMAPPER_REALTIME_CLIENTS            HAL_MDP_QOS_REMAPPER_INFO(                \
...
#define HAL_MDP_3_3_0_QOS_REMAPPER_NONREALTIME_CLIENTS         HAL_MDP_QOS_REMAPPER_INFO(                \
...
#define HAL_MDP_3_3_0_VBIF_MAX_DDR_RD_BURST_SIZE               15
#define HAL_MDP_3_3_0_VBIF_MAX_DDR_WR_BURST_SIZE               15
#define HAL_MDP_3_3_0_VBIF_MAX_RD_OT_SIZE                      32
#define HAL_MDP_3_3_0_VBIF_MAX_WR_OT_SIZE                      32

#define HAL_MDP_3_3_0_VBIF_ROUND_ROBIN_QOS_ARB                 HWIO_MMSS_VBIF_VBIF_ROUND_ROBIN_QOS_ARB_RR_QOS_EN_BMSK

/** Clock control */
#define HAL_MDP_3_3_0_HYSTERISIS_DEFAULT                       3

/** HSIC register range */
#define HAL_MDP_3_3_0_PICTURE_ADJUST_MIN_HUE                  (-768)   // -180 degree
#define HAL_MDP_3_3_0_PICTURE_ADJUST_MAX_HUE                  (-768)   // 180 degree
#define HAL_MDP_3_3_0_PICTURE_ADJUST_MIN_UNCHANGE_HUE          0       // value for unchange hue going to the min hue direction
#define HAL_MDP_3_3_0_PICTURE_ADJUST_MAX_UNCHANGE_HUE         (-1536)  // value for unchange hue going to the max hue direction
#define HAL_MDP_3_3_0_PICTURE_ADJUST_MIN_SATURATION           (-128)   
#define HAL_MDP_3_3_0_PICTURE_ADJUST_MAX_SATURATION            127
#define HAL_MDP_3_3_0_PICTURE_ADJUST_UNCHANGE_SATURATION       0
#define HAL_MDP_3_3_0_PICTURE_ADJUST_MIN_INTENSITY            (-128) 
#define HAL_MDP_3_3_0_PICTURE_ADJUST_MAX_INTENSITY             127 
#define HAL_MDP_3_3_0_PICTURE_ADJUST_UNCHANGE_INTENSITY        0
#define HAL_MDP_3_3_0_PICTURE_ADJUST_MIN_CONTRAST             (-128)
#define HAL_MDP_3_3_0_PICTURE_ADJUST_MAX_CONTRAST              127
#define HAL_MDP_3_3_0_PICTURE_ADJUST_UNCHANGE_CONTRAST         0

/** Highest bank bit configuration */
#define HAL_MDP_3_3_0_HIGHEST_BANK_BIT_DEFAULT                 2
...
static HAL_MDP_VBIFQOSRemappersType gSVBIFQOSRemap_3_3_0[HAL_MDP_VBIF_CLIENT_MAX] =
{
...
*/
const HAL_MDP_VbifId gsVbifClientToHwIdMap_3_3_0[HAL_MDP_VBIF_CLIENT_MAX] =
{
...
/****************************************************************************
*
** FUNCTION: HAL_MDP_SetHWBlockRegOffsets_3_3_0()
*/
/*!
* \brief
...
*
****************************************************************************/
static void HAL_MDP_SetHWBlockRegOffsets_3_3_0(void)
{
...
/****************************************************************************
*
** FUNCTION: HAL_MDP_ReadHardwareInfo_3_3_0()
*/
/*!
* \brief
*     Reads the hardware capabilities for the given MDP Version(3.3.0)
*
...
*
****************************************************************************/
void HAL_MDP_ReadHardwareInfo_3_3_0(HAL_MDP_HwInfo             *psHwInfo,
                                    HAL_MDP_Hw_Private_Info    *psMdpHwInfo)
{
   ...
   HAL_MDP_SetHWBlockRegOffsets_3_3_0();

   if(NULL != psHwInfo)
   {
      psHwInfo->uNumOfRGBLayers             = HAL_MDP_3_3_0_NUM_OF_RGB_LAYERS;
      psHwInfo->uNumOfVIGLayers             = HAL_MDP_3_3_0_NUM_OF_VIG_LAYERS;
      psHwInfo->uNumOfDMALayers             = HAL_MDP_3_3_0_NUM_OF_DMA_LAYERS;
      psHwInfo->uNumOfCursorLayers          = HAL_MDP_3_3_0_NUM_OF_CURSOR_LAYERS;
      psHwInfo->uNumOfLayerMixers           = HAL_MDP_3_3_0_NUM_OF_LAYER_MIXERS;
      psHwInfo->uNumOfDSPPs                 = HAL_MDP_3_3_0_NUM_OF_DSPP;
      psHwInfo->uNumOfBltEngines            = HAL_MDP_3_3_0_NUM_OF_WRITEBACK_INTERFACES;
      psHwInfo->uNumOfControlPaths          = HAL_MDP_3_3_0_NUM_OF_CONTROL_PATHS;
      psHwInfo->uNumOfDataPaths             = HAL_MDP_3_3_0_NUM_OF_DATA_PATHS;
      psHwInfo->uNumOfLayerMixerBlendStages = HAL_MDP_3_3_0_LAYER_MIXER_MAX_BLEND_STAGES;
      psHwInfo->uNumOfPhyInterfaces         = HAL_MDP_3_3_0_NUM_OF_PHYSICAL_INTERFACES;
      psHwInfo->uNumOfPingPongs             = HAL_MDP_3_3_0_NUM_OF_PINGPONGS;
      psHwInfo->uNumOfWatchDogs             = HAL_MDP_3_3_0_NUM_OF_WATCHDOGS;
      psHwInfo->uNumOfAxiPorts              = HAL_MDP_3_3_0_NUM_OF_AXI_PORTS;
      psHwInfo->uNumOfVbifClients           = HAL_MDP_3_3_0_NUM_OF_VBIF_CLIENTS;       
      psHwInfo->eGamutType                  = HAL_MDP_GAMUT_8BITGAMUT_TYPE;
      psHwInfo->uNumOfChromaDownBlocks      = HAL_MDP_3_3_0_NUM_OF_CHROMA_BLOCKS;
   ...
   if(NULL != psMdpHwInfo)
   {
      ...
      psMdpHwInfo->uVBIFMaxDdrRdBurstSize                  = HAL_MDP_3_3_0_VBIF_MAX_DDR_RD_BURST_SIZE;
      psMdpHwInfo->uVBIFMaxDdrWrBurstSize                  = HAL_MDP_3_3_0_VBIF_MAX_DDR_WR_BURST_SIZE;
      psMdpHwInfo->uVBIFMaxRdOT                            = HAL_MDP_3_3_0_VBIF_MAX_RD_OT_SIZE;
      psMdpHwInfo->uVBIFMaxWrOT                            = HAL_MDP_3_3_0_VBIF_MAX_WR_OT_SIZE;      
      
      psMdpHwInfo->uVBIFRoundRobinQosArb                   = HAL_MDP_3_3_0_VBIF_ROUND_ROBIN_QOS_ARB;
      psMdpHwInfo->pVBIFQOSRemappers                       = &gSVBIFQOSRemap_3_3_0[0];
      psMdpHwInfo->pVBIFClientToHWIDMap                    = &gsVbifClientToHwIdMap_3_3_0[0];

      //Picture adjustment(HSIC) 
      psMdpHwInfo->sPictureAdjustInfo.iMinHue              = HAL_MDP_3_3_0_PICTURE_ADJUST_MIN_HUE;
      psMdpHwInfo->sPictureAdjustInfo.iMaxHue              = HAL_MDP_3_3_0_PICTURE_ADJUST_MAX_HUE;
      psMdpHwInfo->sPictureAdjustInfo.iMinUnchangeHue      = HAL_MDP_3_3_0_PICTURE_ADJUST_MIN_UNCHANGE_HUE;
      psMdpHwInfo->sPictureAdjustInfo.iMaxUnchangeHue      = HAL_MDP_3_3_0_PICTURE_ADJUST_MAX_UNCHANGE_HUE;
      psMdpHwInfo->sPictureAdjustInfo.iMinSaturation       = HAL_MDP_3_3_0_PICTURE_ADJUST_MIN_SATURATION;
      psMdpHwInfo->sPictureAdjustInfo.iMaxSaturation       = HAL_MDP_3_3_0_PICTURE_ADJUST_MAX_SATURATION;
      psMdpHwInfo->sPictureAdjustInfo.iUnchangeSaturation  = HAL_MDP_3_3_0_PICTURE_ADJUST_UNCHANGE_SATURATION;
      psMdpHwInfo->sPictureAdjustInfo.iMinIntensity        = HAL_MDP_3_3_0_PICTURE_ADJUST_MIN_INTENSITY;
      psMdpHwInfo->sPictureAdjustInfo.iMaxIntensity        = HAL_MDP_3_3_0_PICTURE_ADJUST_MAX_INTENSITY;
      psMdpHwInfo->sPictureAdjustInfo.iUnchangeIntensity   = HAL_MDP_3_3_0_PICTURE_ADJUST_UNCHANGE_INTENSITY;
      psMdpHwInfo->sPictureAdjustInfo.iMinContrast         = HAL_MDP_3_3_0_PICTURE_ADJUST_MIN_CONTRAST;
      psMdpHwInfo->sPictureAdjustInfo.iMaxContrast         = HAL_MDP_3_3_0_PICTURE_ADJUST_MAX_CONTRAST;
      psMdpHwInfo->sPictureAdjustInfo.iUnchangeContrast    = HAL_MDP_3_3_0_PICTURE_ADJUST_UNCHANGE_CONTRAST;

      psMdpHwInfo->uHysterisisValue                        = HAL_MDP_3_3_0_HYSTERISIS_DEFAULT;
      ...
      psMdpHwInfo->uDefaultHighestBankBit             = HAL_MDP_3_3_0_HIGHEST_BANK_BIT_DEFAULT;
