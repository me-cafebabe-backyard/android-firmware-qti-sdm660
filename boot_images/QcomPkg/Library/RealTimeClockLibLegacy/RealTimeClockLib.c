/** @file
  ...
  Copyright (c) 2010-2016, Qualcomm Technologies Inc. All rights
...
/*=============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 09/26/16   sv      fixing klocwork issues
  ...
  )
{
  ...
  if (Status != EFI_SUCCESS ||
    ...
    DEBUG((EFI_D_WARN, "RealTimeClock_InitializeVariables: Detect Power loss to RTC! Status:0x%x pmicWasBatteryRemoved:0x%x \n",
           Status,
