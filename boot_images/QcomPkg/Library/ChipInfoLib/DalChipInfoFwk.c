...
DESCRIPTION: This file implements a ChipInfo DeviceDriver.

PUBLIC CLASSES:  Not Applicable

INITIALIZATION AND SEQUENCING REQUIREMENTS:  N/A

        Copyright (c) 2008-15 Qualcomm Technologies Incorporated.
               All Rights Reserved.
...
static DALResult 
ChipInfo_DalChipInfo_GetProcessorNameString( DalDeviceHandle * h,  char * szNameString,  uint32  nMaxLength) 
{
	return ChipInfo_GetProcessorNameString(((DalChipInfoHandle *)h)->pClientCtxt, szNameString, nMaxLength);
}
static DALResult 
ChipInfo_DalChipInfo_GetSerialNumber( DalDeviceHandle * h,  uint32  nNotUsed,  DalChipInfoSerialNumType* pnSerialNum) 
{
	return ChipInfo_GetSerialNumber(((DalChipInfoHandle *)h)->pClientCtxt, nNotUsed, pnSerialNum);
}
static DALResult 
ChipInfo_DalChipInfo_GetFoundryId( DalDeviceHandle * h,  uint32  nNotUsed,  DalChipInfoFoundryIdType * peId) 
{
	return ChipInfo_GetFoundryId(((DalChipInfoHandle *)h)->pClientCtxt, nNotUsed, peId);
}
static DALResult 
ChipInfo_DalChipInfo_GetRawDeviceFamily( DalDeviceHandle * h,  uint32  nNotUsed,  uint32 * pnId) 
{
	return ChipInfo_GetRawDeviceFamily(((DalChipInfoHandle *)h)->pClientCtxt, nNotUsed, pnId);
}
static DALResult 
ChipInfo_DalChipInfo_GetRawDeviceNumber( DalDeviceHandle * h,  uint32  nNotUsed,  uint32 * pnId) 
{
	return ChipInfo_GetRawDeviceNumber(((DalChipInfoHandle *)h)->pClientCtxt, nNotUsed, pnId);
}
static DALResult 
ChipInfo_DalChipInfo_GetQFPROMChipId( DalDeviceHandle * h,  uint32  nNotUsed,  DalChipInfoQFPROMChipIdType* pnQFPROMChipId) 
{
	return ChipInfo_GetQFPROMChipId(((DalChipInfoHandle *)h)->pClientCtxt, nNotUsed, pnQFPROMChipId);
}
    ...
    static const DalChipInfo vtbl = {
       {
		...
		ChipInfo_DalChipInfo_GetProcessorNameString,
