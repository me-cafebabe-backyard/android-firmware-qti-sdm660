...
struct ChipInfoDrvCtxt
{
  ...
  char                   szProcessorNameString[DALCHIPINFO_MAX_NAME_LENGTH];
  uint32                 nRawDeviceFamily;
  uint32                 nRawDeviceNumber;
  DalChipInfoQFPROMChipIdType  nQFPROMChipId;
  /*
...
DALResult ChipInfo_GetProcessorNameString( ChipInfoClientCtxt *,  char *,  uint32 );
...
DALResult ChipInfo_GetRawDeviceFamily( ChipInfoClientCtxt *,  uint32 ,  uint32 *);
DALResult ChipInfo_GetRawDeviceNumber( ChipInfoClientCtxt *,  uint32 ,  uint32 *);
DALResult ChipInfo_GetQFPROMChipId( ChipInfoClientCtxt *,uint32 ,  DalChipInfoQFPROMChipIdType *);
