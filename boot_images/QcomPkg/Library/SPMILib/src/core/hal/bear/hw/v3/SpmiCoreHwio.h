...
/*
  ...
  $Header: //components/rel/boot.xf/1.4/QcomPkg/Library/SPMILib/src/core/hal/bear/hw/v3/SpmiCoreHwio.h#2 $
...
#define SPMI_CFG_REG_BASE_OFFS                                                        0x0000a700

#define HWIO_SPMI_PERIPHm_2OWNER_TABLE_REG_ADDR(base,m)                               ((base) + SPMI_CFG_REG_BASE_OFFS + 0x00000000 + 0x4 * (m))
...
#define HWIO_SPMI_MAPPING_TABLE_REGk_ADDR(base,k)                                     ((base) + SPMI_CFG_REG_BASE_OFFS + 0x00000800 + 0x4 * (k))
#define HWIO_SPMI_MAPPING_TABLE_REGk_OFFS(base,k)                                     (0x00000800 + 0x4 * (k))
#define HWIO_SPMI_MAPPING_TABLE_REGk_RMSK                                               0xffffff
#define HWIO_SPMI_MAPPING_TABLE_REGk_INI(base,k)        \
        in_dword_masked(HWIO_SPMI_MAPPING_TABLE_REGk_ADDR(base,k), HWIO_SPMI_MAPPING_TABLE_REGk_RMSK)
#define HWIO_SPMI_MAPPING_TABLE_REGk_INMI(base,k,mask)    \
        in_dword_masked(HWIO_SPMI_MAPPING_TABLE_REGk_ADDR(base,k), mask)
#define HWIO_SPMI_MAPPING_TABLE_REGk_OUTI(base,k,val)    \
        out_dword(HWIO_SPMI_MAPPING_TABLE_REGk_ADDR(base,k),val)
#define HWIO_SPMI_MAPPING_TABLE_REGk_OUTMI(base,k,mask,val) \
        out_dword_masked_ns(HWIO_SPMI_MAPPING_TABLE_REGk_ADDR(base,k),mask,val,HWIO_SPMI_MAPPING_TABLE_REGk_INI(base,k))
#define HWIO_SPMI_MAPPING_TABLE_REGk_BIT_INDEX_BMSK                                     0xf00000
#define HWIO_SPMI_MAPPING_TABLE_REGk_BIT_INDEX_SHFT                                         0x14
#define HWIO_SPMI_MAPPING_TABLE_REGk_BRANCH_RESULT_0_FLAG_BMSK                           0x80000
#define HWIO_SPMI_MAPPING_TABLE_REGk_BRANCH_RESULT_0_FLAG_SHFT                              0x13
#define HWIO_SPMI_MAPPING_TABLE_REGk_BRANCH_RESULT_0_BMSK                                0x7fc00
#define HWIO_SPMI_MAPPING_TABLE_REGk_BRANCH_RESULT_0_SHFT                                    0xa
#define HWIO_SPMI_MAPPING_TABLE_REGk_BRANCH_RESULT_1_FLAG_BMSK                             0x200
#define HWIO_SPMI_MAPPING_TABLE_REGk_BRANCH_RESULT_1_FLAG_SHFT                               0x9
#define HWIO_SPMI_MAPPING_TABLE_REGk_BRANCH_RESULT_1_BMSK                                  0x1ff
#define HWIO_SPMI_MAPPING_TABLE_REGk_BRANCH_RESULT_1_SHFT                                    0x0

#define HWIO_SPMI_MID_REG_ADDR(x)                                                     ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00001000)
#define HWIO_SPMI_MID_REG_OFFS                                                        (0x00001000)
...
#define HWIO_SPMI_CFG_REG_ADDR(x)                                                     ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00001004)
#define HWIO_SPMI_CFG_REG_OFFS                                                        (0x00001004)
...
#define HWIO_SPMI_SEC_DISABLE_REG_ADDR(x)                                             ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00001008)
#define HWIO_SPMI_SEC_DISABLE_REG_OFFS                                                (0x00001008)
...
#define HWIO_SPMI_HW_VERSION_ADDR(x)                                                  ((x) + SPMI_CFG_REG_BASE_OFFS + 0x0000100c)
#define HWIO_SPMI_HW_VERSION_OFFS                                                     (0x0000100c)
...
#define HWIO_SPMI_CGC_CTRL_ADDR(x)                                                    ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00001010)
#define HWIO_SPMI_CGC_CTRL_OFFS                                                       (0x00001010)
...
#define HWIO_SPMI_MWB_ENABLE_REG_ADDR(x)                                              ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00001014)
#define HWIO_SPMI_MWB_ENABLE_REG_OFFS                                                 (0x00001014)
...
#define HWIO_SPMI_CHAR_CFG_ADDR(x)                                                    ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00001040)
#define HWIO_SPMI_CHAR_CFG_OFFS                                                       (0x00001040)
...
#define HWIO_SPMI_CHAR_DATA_n_ADDR(base,n)                                            ((base) + SPMI_CFG_REG_BASE_OFFS + 0x00001044 + 0x4 * (n))
#define HWIO_SPMI_CHAR_DATA_n_OFFS(base,n)                                            (0x00001044 + 0x4 * (n))
...
#define HWIO_SPMI_CMPR_EN_REG_ADDR(x)                                                 ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00001054)
#define HWIO_SPMI_CMPR_EN_REG_OFFS                                                    (0x00001054)
...
#define HWIO_SPMI_PROTOCOL_IRQ_STATUS_ADDR(x)                                         ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00001100)
#define HWIO_SPMI_PROTOCOL_IRQ_STATUS_OFFS                                            (0x00001100)
...
#define HWIO_SPMI_PROTOCOL_IRQ_ENABLE_ADDR(x)                                         ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00001104)
#define HWIO_SPMI_PROTOCOL_IRQ_ENABLE_OFFS                                            (0x00001104)
...
#define HWIO_SPMI_PROTOCOL_IRQ_CLEAR_ADDR(x)                                          ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00001108)
#define HWIO_SPMI_PROTOCOL_IRQ_CLEAR_OFFS                                             (0x00001108)
...
#define HWIO_SPMI_PROTOCOL_IRQ_EN_SET_ADDR(x)                                         ((x) + SPMI_CFG_REG_BASE_OFFS + 0x0000110c)
#define HWIO_SPMI_PROTOCOL_IRQ_EN_SET_OFFS                                            (0x0000110c)
...
#define HWIO_SPMI_PROTOCOL_IRQ_EN_CLEAR_ADDR(x)                                       ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00001110)
#define HWIO_SPMI_PROTOCOL_IRQ_EN_CLEAR_OFFS                                          (0x00001110)
...
#define HWIO_SPMI_TEST_BUS_CTRL_ADDR(x)                                               ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00001900)
#define HWIO_SPMI_TEST_BUS_CTRL_OFFS                                                  (0x00001900)
...
#define HWIO_SPMI_HW_SW_EVENTS_CTRL_ADDR(x)                                           ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00001904)
#define HWIO_SPMI_HW_SW_EVENTS_CTRL_OFFS                                              (0x00001904)
...
#define HWIO_SPMI_HW_SW_EVENTS_BITWISE_REGj_ADDR(base,j)                              ((base) + SPMI_CFG_REG_BASE_OFFS + 0x00001908 + 0x4 * (j))
#define HWIO_SPMI_HW_SW_EVENTS_BITWISE_REGj_OFFS(base,j)                              (0x00001908 + 0x4 * (j))
...
#define HWIO_SPMI_DEBUG_REG_ADDR(x)                                                   ((x) + SPMI_CFG_REG_BASE_OFFS + 0x00001928)
#define HWIO_SPMI_DEBUG_REG_OFFS                                                      (0x00001928)
...
#define SPMI_CFG_TOP_REG_BASE (PMIC_ARB_BASE      + 0x00000000)
#define SPMI_CFG_TOP_REG_BASE_OFFS 0x00000000
...
#define SPMI_GENI_CFG_REG_BASE_OFFS                                        0x0000a000

#define HWIO_SPMI_GENI_CLK_CTRL_ADDR(x)                                    ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000000)
...
#define HWIO_SPMI_GENI_HW_VERSION_ADDR(x)                                  ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000004)
...
#define HWIO_SPMI_GENI_FW_REVISION_ADDR(x)                                 ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000008)
...
#define HWIO_SPMI_GENI_S_FW_REVISION_ADDR(x)                               ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x0000000c)
...
#define HWIO_SPMI_GENI_FORCE_DEFAULT_REG_ADDR(x)                           ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000010)
...
#define HWIO_SPMI_GENI_OUTPUT_CTRL_ADDR(x)                                 ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000014)
...
#define HWIO_SPMI_GENI_CGC_CTRL_ADDR(x)                                    ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000018)
...
#define HWIO_SPMI_GENI_CHAR_CFG_ADDR(x)                                    ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x0000001c)
...
#define HWIO_SPMI_GENI_CHAR_DATA_n_ADDR(base,n)                            ((base) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000020 + 0x4 * (n))
...
#define HWIO_SPMI_GENI_CTRL_ADDR(x)                                        ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000028)
...
#define HWIO_SPMI_GENI_STATUS_ADDR(x)                                      ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x0000002c)
...
#define HWIO_SPMI_GENI_TEST_BUS_CTRL_ADDR(x)                               ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000030)
...
#define HWIO_SPMI_GENI_SER_CLK_CFG_ADDR(x)                                 ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000034)
...
#define HWIO_SPMI_GENI_TX_WATERMARK_REG_ADDR(x)                            ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000038)
...
#define HWIO_SPMI_GENI_RX_WATERMARK_REG_ADDR(x)                            ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x0000003c)
...
#define HWIO_SPMI_GENI_STOP_REG_ADDR(x)                                    ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000040)
...
#define HWIO_SPMI_GENI_SW_COMP_REG_ADDR(x)                                 ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000044)
...
#define HWIO_SPMI_GENI_PROG_ROM_CTRL_REG_ADDR(x)                           ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000048)
...
#define HWIO_SPMI_GENI_CFG_REG0_ADDR(x)                                    ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000100)
...
#define HWIO_SPMI_GENI_CFG_REG1_ADDR(x)                                    ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000104)
...
#define HWIO_SPMI_GENI_CFG_REG2_ADDR(x)                                    ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000108)
...
#define HWIO_SPMI_GENI_CFG_REG3_ADDR(x)                                    ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x0000010c)
...
#define HWIO_SPMI_GENI_CFG_REG4_ADDR(x)                                    ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000110)
...
#define HWIO_SPMI_GENI_CFG_REG5_ADDR(x)                                    ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000114)
...
#define HWIO_SPMI_GENI_CFG_REG6_ADDR(x)                                    ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000118)
...
#define HWIO_SPMI_GENI_CFG_REG7_ADDR(x)                                    ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x0000011c)
...
#define HWIO_SPMI_GENI_CFG_REG8_ADDR(x)                                    ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000120)
...
#define HWIO_SPMI_GENI_CFG_REG9_ADDR(x)                                    ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000124)
...
#define HWIO_SPMI_GENI_CFG_REG10_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000128)
...
#define HWIO_SPMI_GENI_CFG_REG11_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x0000012c)
...
#define HWIO_SPMI_GENI_CFG_REG12_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000130)
...
#define HWIO_SPMI_GENI_CFG_REG13_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000134)
...
#define HWIO_SPMI_GENI_CFG_REG14_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000138)
...
#define HWIO_SPMI_GENI_CFG_REG15_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x0000013c)
...
#define HWIO_SPMI_GENI_CFG_REG16_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000140)
...
#define HWIO_SPMI_GENI_CFG_REG17_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000144)
...
#define HWIO_SPMI_GENI_CFG_REG18_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000148)
...
#define HWIO_SPMI_GENI_CFG_REG19_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x0000014c)
...
#define HWIO_SPMI_GENI_CFG_REG20_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000150)
...
#define HWIO_SPMI_GENI_CFG_REG21_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000154)
...
#define HWIO_SPMI_GENI_CFG_REG22_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000158)
...
#define HWIO_SPMI_GENI_CFG_REG23_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x0000015c)
...
#define HWIO_SPMI_GENI_CFG_REG24_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000160)
...
#define HWIO_SPMI_GENI_CFG_REG25_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000164)
...
#define HWIO_SPMI_GENI_CFG_REG26_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000168)
...
#define HWIO_SPMI_GENI_CFG_REG27_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x0000016c)
...
#define HWIO_SPMI_GENI_CFG_REG28_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000170)
...
#define HWIO_SPMI_GENI_CFG_REG29_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000174)
...
#define HWIO_SPMI_GENI_CFG_REG30_ADDR(x)                                   ((x) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000178)
...
#define HWIO_SPMI_GENI_CFG_RAMn_ADDR(base,n)                               ((base) + SPMI_GENI_CFG_REG_BASE_OFFS + 0x00000200 + 0x4 * (n))
...
#define SPMI_PIC_REG_BASE                                             (PMIC_ARB_BASE      + 0x02400000)
#define SPMI_PIC_REG_BASE_OFFS                                        0x02400000

#define HWIO_SPMI_PIC_OWNERm_ACC_STATUSn_ADDR(base,m,n)               ((base) + SPMI_PIC_REG_BASE_OFFS + 0x00200000 + 0x1000 * (m) + 0x4 * (n))
#define HWIO_SPMI_PIC_OWNERm_ACC_STATUSn_OFFS(base,m,n)               (0x00200000 + 0x1000 * (m) + 0x4 * (n))
#define HWIO_SPMI_PIC_OWNERm_ACC_STATUSn_RMSK                         0xffffffff
#define HWIO_SPMI_PIC_OWNERm_ACC_STATUSn_INI2(base,m,n)        \
        in_dword_masked(HWIO_SPMI_PIC_OWNERm_ACC_STATUSn_ADDR(base,m,n), HWIO_SPMI_PIC_OWNERm_ACC_STATUSn_RMSK)
#define HWIO_SPMI_PIC_OWNERm_ACC_STATUSn_INMI2(base,m,n,mask)    \
        in_dword_masked(HWIO_SPMI_PIC_OWNERm_ACC_STATUSn_ADDR(base,m,n), mask)
...
#define HWIO_SPMI_PIC_ACC_ENABLEn_ADDR(base,n)                        ((base) + SPMI_PIC_REG_BASE_OFFS + 0x00000000 + 0x1000 * (n))
#define HWIO_SPMI_PIC_ACC_ENABLEn_OFFS(base,n)                        (0x00000000 + 0x1000 * (n))
...
#define HWIO_SPMI_PIC_IRQ_STATUSn_ADDR(base,n)                        ((base) + SPMI_PIC_REG_BASE_OFFS + 0x00000004 + 0x1000 * (n))
#define HWIO_SPMI_PIC_IRQ_STATUSn_OFFS(base,n)                        (0x00000004 + 0x1000 * (n))
...
#define HWIO_SPMI_PIC_IRQ_CLEARn_ADDR(base,n)                         ((base) + SPMI_PIC_REG_BASE_OFFS + 0x00000008 + 0x1000 * (n))
#define HWIO_SPMI_PIC_IRQ_CLEARn_OFFS(base,n)                         (0x00000008 + 0x1000 * (n))
