...
/*=============================================================================
 ...
 10/13/16   pr		Added Rx break on detection API
                  ...
                  IN  UINT32   BufferSize    OPTIONAL)
{
  ...
  EnQPtr = DeQPtr = PrependLogsToBuffer((UINT64**)(UINTN)PcdGet64(PcdBootLogAddrPtr), 
                                        (UINT64*)(UINTN)PcdGet64(PcdBootLogSizePtr),
...
BOOLEAN
EFIAPI
SerialPortBreakOnCondition (VOID)
{
   return uart_rxBreakonDetected();
}
