...
Copyright 2016, 2017 by Qualcomm Technologies, Incorporated.  All Rights Reserved.
===========================================================================*/
...
static boolean boot_is_special_character (font_info_type *font_ptr, uint8* character)
{
  ...
  {
    // Ensure current row can accommodate glyph within display buffer bounds 
 ...
 )
{
  ...
  DisplayInitialize(&(font_ptr->gframe_buffer_info), uflags);
