...
static int blockdev_sd_cprm_set_power_on_write_protection(struct block_device*,
                                                       void *, uint32, uint32);
static int blockdev_sd_cprm_set_bootable_partition (struct block_device *,
                                                    void*, void*);
static int blockdev_sd_cprm_configure_device (struct block_device *, void*,
                                                void*, void*);
static int blockdev_sd_cprm_get_lun_numbers (struct block_device *, void *,
                                             uint32, uint32 *, uint32 *);
...
static blockdev_ops sd_cprm_ops =
{
  ...
  blockdev_sd_cprm_set_bootable_partition,
  blockdev_sd_cprm_configure_device,
  blockdev_sd_cprm_get_lun_numbers
};
...
static int
blockdev_sd_cprm_set_bootable_partition (struct block_device *bdev,
...
static int
blockdev_sd_cprm_configure_device (struct block_device *bdev, void *handle,
...
static int
blockdev_sd_cprm_get_lun_numbers (struct block_device *bdev, void *handle,
