...
static int blockdev_usb_erase_fail (struct block_device*, void*,uint32,uint32);
...
static int blockdev_usb_set_power_on_write_protection (struct block_device *,
                                                      void*, uint32, uint32);
static int blockdev_usb_set_bootable_partition (struct block_device *, void*,
                                                void*);
static int blockdev_usb_configure_device (struct block_device *, void*, void*,
                                            void*);
static int blockdev_usb_get_lun_numbers (struct block_device *, void *,
                                         uint32, uint32 *, uint32 *);
...
static blockdev_ops usb_ops =
{
  ...
  blockdev_usb_set_bootable_partition,
  blockdev_usb_configure_device,
  blockdev_usb_get_lun_numbers
};
...
static int
blockdev_usb_set_bootable_partition (struct block_device *bdev, void *handle,
...
static int
blockdev_usb_configure_device (struct block_device *bdev, void *handle,
                    void *whole_device_handle, void *config_data)
{
  (void) bdev; (void) handle; (void) config_data; (void) whole_device_handle;
  return -1;
}

static int
blockdev_usb_get_lun_numbers (struct block_device *bdev, void *handle,
