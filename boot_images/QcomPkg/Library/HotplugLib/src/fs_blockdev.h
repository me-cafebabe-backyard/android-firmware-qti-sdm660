 ...
 * Copyright (C) 2009-2010,2013,2014-2016 QUALCOMM Technologies, Inc.
 *
...
2014-08-06   kh    Added functions needed by deviceprogrammer
...
typedef enum
  {
    ...
    BLOCKDEV_TYPE_SPI_NOR = 8, /**< SPI_NOR */
    BLOCKDEV_TYPE_ALL     = 9, /**< All the above devices */
  } block_device_type;
...
int blockdev_set_bootable_partition (struct block_device *bdev, void *handle,
                        void *whole_device_handle);
int blockdev_configure_device (struct block_device *bdev, void *handle,
                        void *whole_device_handle, void *config_data);
int blockdev_get_lun_numbers (struct block_device *bdev, void *handle,
                              uint32 count, uint32 *lun_numbers,
                              uint32 *actual_count);
int blockdev_get_internal_handle(struct block_device *bdev, void *handle,
                        void **out_handle);
