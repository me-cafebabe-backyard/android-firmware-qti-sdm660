...
static int
blockdev_ftl_set_bootable_partition (struct block_device *bdev, void *handle,
...
static int
blockdev_ftl_configure_device (struct block_device *bdev, void *handle,
...
static int
blockdev_ftl_get_lun_numbers (struct block_device *bdev, void *handle,
...
static blockdev_ops ftl_ops =
{
  ...
  blockdev_ftl_set_bootable_partition,
  blockdev_ftl_configure_device,
  blockdev_ftl_get_lun_numbers
};
