...
typedef struct
{
  ...
  int    (*erase)(struct block_device*, void*, uint32, uint32);
  ...
  int    (*set_power_on_write_protection)(struct block_device*, void*, uint32,
                                          uint32);
  int    (*set_bootable_partition)(struct block_device*, void*, void *);
  int    (*configure_device)(struct block_device*, void *, void *, void *);
  int    (*get_lun_numbers)(struct block_device*, void *, uint32, uint32 *,
                            uint32 *);
} blockdev_ops;
