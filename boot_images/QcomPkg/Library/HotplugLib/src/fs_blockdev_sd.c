 ...
 *
 * Blockdev SD device.
 * Copyright (C) 2009-2010,2012-2014,2016 QUALCOMM Technologies, Inc.
 *
...
2014-08-06   kh    Add erase, set_bootable_partition, configure_device
...
static int blockdev_sd_erase (struct block_device*, void*, uint32,uint32);
...
static int blockdev_sd_set_power_on_write_protection (struct block_device*,
                                                    void*, uint32, uint32);
static int blockdev_sd_set_bootable_partition (struct block_device *, void *,
                                                void *);
static int blockdev_sd_configure_device (struct block_device *, void *,
                                                void *, void *);
static int blockdev_sd_get_lun_numbers (struct block_device *, void *,
...
static blockdev_ops sd_ops =
{
  ...
  blockdev_sd_set_bootable_partition,
  blockdev_sd_configure_device,
  blockdev_sd_get_lun_numbers
};
...
static int
blockdev_sd_erase (struct block_device *bdev, void *handle, uint32 lba,
                        uint32 erase_len)
{
  struct sdcc_device *sdcc_handle = (struct sdcc_device *)handle;
  int result;
  ...
  sdcc_result = sdcc_handle_erase (sdcc_handle, lba, erase_len);
...
static int
blockdev_sd_set_bootable_partition (struct block_device *bdev,
                void *handle, void *whole_device_handle)
{
    ...
    sdcc_res = sdcc_handle_set_active_bootable_partition(sdcc_handle);
    result = (sdcc_res == SDCC_NO_ERROR) ? 0 : -1;
    return result;
}

static int
blockdev_sd_configure_device (struct block_device *bdev, void *handle,
                void *whole_device_handle, void *config_data)
{
    (void) whole_device_handle;
    struct sdcc_device *sdcc_handle = (struct sdcc_device *)handle;
    sdcc_emmc_gpp_enh_desc_type *sdcc_data = config_data;
    SDCC_STATUS sdcc_res;
    int result;
    ...
    sdcc_res = sdcc_config_emmc_gpp_enh(sdcc_handle, sdcc_data);
    result = (sdcc_res == SDCC_NO_ERROR) ? 0 : -1;
    return result;
}

static int
blockdev_sd_get_lun_numbers (struct block_device *bdev, void *handle,
