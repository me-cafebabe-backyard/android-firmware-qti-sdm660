 ...
 * $Header: //components/rel/boot.xf/1.4/QcomPkg/Library/CPRLib/common/inc/cpr_utils.h#2 $
 * $Change: 11185940 $
 */
#ifndef CPR_UTILS_H
#define	CPR_UTILS_H
...
const cpr_margin_data* cpr_utils_get_margins(const cpr_margin_cfg* marginList);
