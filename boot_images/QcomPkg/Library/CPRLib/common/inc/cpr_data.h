 ...
 * $Header: //components/rel/boot.xf/1.4/QcomPkg/Library/CPRLib/common/inc/cpr_data.h#2 $
 * $Change: 11185940 $
 */
#ifndef CPR_DATA_H
#define	CPR_DATA_H
...
typedef struct
{
    ...
    const cpr_versioned_voltage_plan **railVVPs;
    cpr_hal_controller               **controllers;
    cpr_rail                         **rails;
    const cpr_enablement             **enablements;
    const cpr_misc_cfg                *miscCfg;
} cpr_settings;
