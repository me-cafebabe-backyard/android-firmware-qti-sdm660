...
--------   ---     ----------------------------------------------------------
11/29/16   digant  increased the MAX_RAW_DUMP_SECTION_NUM
 ...
 * size is 56 bytes
 */
struct PACK (boot_raw_parition_dump_header)
{
...
#define MAX_RAW_DUMP_SECTION_NUM 200
#else
#define MAX_RAW_DUMP_SECTION_NUM 26
#endif
