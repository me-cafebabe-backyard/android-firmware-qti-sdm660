  ...
  )
{
  ...
  /* When buffers are a multiple of, and aligned to sector size, bypass
     all logic and send the buffer directly to the storage driver */
  Lba  = DivU64x32Remainder (Offset, BlockSize, &UnderRun);
  OverRunLba  = DivU64x32Remainder (BufferSize, BlockSize, &OverRun);
  ...
  Lba = 0; UnderRun = 0; OverRunLba = 0; OverRun = 0;
