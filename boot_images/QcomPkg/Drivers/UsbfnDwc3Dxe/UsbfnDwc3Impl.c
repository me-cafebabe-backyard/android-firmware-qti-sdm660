...
/*==============================================================================
 ...
 --------   ---     -----------------------------------------------------------
 01/18/17	pm		Init SW Xfer resources when driver is loaded and Fix KW issue
 11/25/16   pm      Port from BOOT.XF.1.2
  ...
  case DWC_EVT_DEV_USB_LINK_STATE_CHANGE:
    {
      ...
      USB_LINK_STATE LinkState = (USB_LINK_STATE)(Evt->Device.EventInfo & 0x7);
