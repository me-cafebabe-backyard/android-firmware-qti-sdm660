...
Portion Copyright (c) 2011 - 2015, Intel Corporation. All rights reserved.<BR>
...
#include "XhciReg.h"
#include "XhciSched.h"
#include "XhciPortTest.h"
#include "ComponentName.h"
#include "UsbHcMem.h"

#define USB30_BCDUSB                 (0x0300)
...
#define XHC_100_NANOSECOND            1
#define XHC_1_MILLISECOND_100NS      (1000 * 10 * XHC_100_NANOSECOND)
...
//
// XHC async bulk transfer timeout
//
#define XHC_ASYNC_BULK_TIMEOUT       (500 * 1000)
//
// XHC async control transfer timeout
//
#define XHC_ASYNC_CONTROL_TIMEOUT     (50 * 1000)
//
...
//
// XHC raises TPL to TPL_CALLBACK to serialize all its operations
// to protect shared data structures.
//
#define XHC_TPL                      TPL_CALLBACK
...
//
#define XHC_PORT_TEST_IDENTITY_LEN   64
...
struct _USB_XHCI_INSTANCE {
  ...
  EFI_EVENT                 ControlPollTimer;
  UINTN                     ControlPollInterval;
  LIST_ENTRY                AsyncControlTransfers;

  EFI_EVENT                 BulkPollTimer;
  UINTN                     BulkPollInterval;
  LIST_ENTRY                AsyncBulkTransfers;
  ...
  LIST_ENTRY                  SavedAsyncTransfers;
  CHAR16                      UsbPortTestIdentity[XHC_PORT_TEST_IDENTITY_LEN];

  // EFI_QCOM_PMIC_USB_PROTOCOL
  EFI_QCOM_PMIC_USB_PROTOCOL    *PmicUsbProtocol;
};
