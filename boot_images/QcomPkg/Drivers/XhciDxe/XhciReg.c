  ...
  )
{
  ...
  USB_ASSERT_GOTO_SETSTS ((Xhc->CapLength != 0), Exit, EFI_INVALID_PARAMETER, Status);
  Status = Xhc->PciIo->Mem.Read (
                             Xhc->PciIo,
                             EfiPciIoWidthUint32,
                             XHC_BAR_INDEX,
  ...
  )
{
  ...
  USB_ASSERT_GOTO_SETSTS ((Xhc->DBOff != 0), Exit, EFI_INVALID_PARAMETER, Status);
  ...
  )
{
  ...
  USB_ASSERT_GOTO_SETSTS ((Xhc->RTSOff != 0), Exit, EFI_INVALID_PARAMETER, Status);
  Status = Xhc->PciIo->Mem.Read (
                             Xhc->PciIo,
                             EfiPciIoWidthUint32,
                             XHC_BAR_INDEX,
  ...
  )
{
  ...
  USB_ASSERT_GOTO_SETSTS ((Xhc->ExtCapRegBase != 0), Exit, EFI_INVALID_PARAMETER, Status);
