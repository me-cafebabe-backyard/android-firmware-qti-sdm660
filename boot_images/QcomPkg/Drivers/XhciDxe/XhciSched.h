...
#define XHC_BULK_TRANSFER_SYNC                0x02
#define XHC_BULK_TRANSFER_ASYNC               0x04
#define XHC_INT_TRANSFER_SYNC                 0x08
#define XHC_INT_TRANSFER_ASYNC                0x10
#define XHC_INT_ONLY_TRANSFER_ASYNC           0x20
...
#define TRB_COMPLETION_SPLIT_TRANSACTION_ERROR 36
...
typedef struct _URB {
  ...
  VOID                                      *DataPhy;
  VOID                                      *DataMap;
  EFI_ASYNC_USB_TRANSFER_CALLBACK_INT_BULK  Callback;
  VOID                                      *Context;
  //
  // Execute result
  //
...
/**
  Delete a single asynchronous bulk transfer for
  the device and endpoint.

  @param  Xhc               The XHCI Instance.
  @param  BusAddr           The device address assigned by UsbBus.
  @param  EpNum             The target endpoint.

  @retval EFI_SUCCESS       The asynchronous transfer was removed.
  @retval EFI_NOT_FOUND     No transfer for given device endpoint was found.

**/
EFI_STATUS
XhcDelAsyncBulkTransfer (
  IN  USB_XHCI_INSTANCE   *Xhc,
  IN  UINT8               BusAddr,
  IN  UINT8               EpNum
  );
