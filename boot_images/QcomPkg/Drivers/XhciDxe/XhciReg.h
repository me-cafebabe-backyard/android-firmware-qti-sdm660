...
Portions Copyright (c) 2011 - 2013, Intel Corporation. All rights reserved.<BR>
...
#define XHC_PORTPMSC_OFFSET                0x0404 // Port PM Status and Control Register Offset
...
// PORTPMSC bit definitions for a USB2.0 port
#define XHC_PORTPMSC2_L1S                  (BIT0|BIT1|BIT2)          // L1 Status
#define XHC_PORTPMSC2_RWE                  BIT3                      // Remote Wake Enable
#define XHC_PORTPMSC2_HIRD                 (BIT4|BIT5|BIT6|BIT7)     // Host Initialted Resume Duration
#define XHC_PORTPMSC2_L1DS                 (BIT8|BIT9|BIT10|BIT11|BIT12|BIT13|BIT14|BIT15) // L1 Device Slot
#define XHC_PORTPMSC2_HLE                  BIT16                     // Hardware LPM Enable
#define XHC_PORTPMSC2_PTC                  (BIT28|BIT29|BIT30|BIT31) // Port Test Control
#define XHC_PORTPMSC2_PTC_SHFT             28
