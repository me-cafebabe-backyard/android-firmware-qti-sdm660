...
EFI_STATUS
EFIAPI
  EFI_GetResourceInfo(EFI_PMIC_NPATEST_RESOURCEINFO *PamResourceInfo)
{
  EFI_STATUS Status = EFI_SUCCESS;

  PMIC_NPATEST_RESOURCEINFO pam_resource_info;
  ...
  Status = pm_npa_get_resource_info(&pam_resource_info);
  ...
  PamResourceInfo->NodeRsrcArr = (EFI_PM_NPA_NODE_RESOURCE_INFO*)(pam_resource_info.node_rsrc_arr);
