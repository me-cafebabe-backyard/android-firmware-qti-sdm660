...
#include <Drivers/PmicDxe/Test/PmicTestMPP.h>
...
)
{
    ...
    switch(DriverTypeFunction.MPPTypeFunction)
    {
       case EFI_PM_TEST_MPP_CONFIG_ATEST:
       {
           EFI_PM_TEST_MPP_CONFIG_ATEST_PARAM ConfigATest = DriverParam->u.MPPFunctionType.MppConfigATest;
           errFlag = pm_mpp_config_atest(ConfigATest.DeviceIndex, (pm_mpp_perph_index)ConfigATest.MppIndex,(pm_mpp_ch_atest_type)ConfigATest.Atest_select);
           break;
       }
       case EFI_PM_TEST_MPP_SET_LIST_SHUNT_CAP:
       {
           EFI_PM_TEST_MPP_SET_GET_LIST_SHUNT_CAP_PARAM SetShuntCap = DriverParam->u.MPPFunctionType.MppShuntCap;
           errFlag = pm_mpp_set_list_mpp_with_shunt_cap(SetShuntCap.DeviceIndex, (pm_mpp_perph_index)SetShuntCap.MppIndex);
           break;
       }
       case EFI_PM_TEST_MPP_GET_LIST_SHUNT_CAP:
       {
           EFI_PM_TEST_MPP_SET_GET_LIST_SHUNT_CAP_PARAM GetShuntCap = DriverParam->u.MPPFunctionType.MppShuntCap;
           errFlag = pm_mpp_get_mpp_with_shunt_cap_list_status_for_device(GetShuntCap.DeviceIndex,(pm_mpp_perph_index)GetShuntCap.MppIndex,GetShuntCap.ShuntList);
           break;
       }
       case EFI_PM_TEST_MPP_ENABLE:
       {
           EFI_PM_TEST_MPP_ENABLE_PARAM EnableParam = DriverParam->u.MPPFunctionType.MppEnable;
           errFlag = pm_mpp_enable(EnableParam.DeviceIndex,(pm_mpp_perph_index)EnableParam.MppIndex,EnableParam.Enable);
           break;
       }
       default:
       break;
...
)
{
    ...
    switch(DriverType)
    {
       ...
       case EFI_PM_MPP:
       {
           errFlag = TestMPPDriver(DriverTypeFunction,DriverParam,DriverOut);
           break;
       }
       case EFI_PM_AC:
        {
	   ...
	   case EFI_PM_COINCELL:
       {
        ...
        {
            DriverOut->Status = EFI_PM_TEST_DRIVER_FAILURE;
            DriverOut->ErrorType = PM_ERR_FLAG__INVALID;
