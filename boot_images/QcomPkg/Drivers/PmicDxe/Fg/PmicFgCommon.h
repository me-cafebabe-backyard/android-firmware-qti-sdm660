...
EFI_STATUS EFIAPI EFI_PmicFgBasicInit(IN UINT32 PmicDeviceIndex, IN EFI_PM_FG_CFGDATA_TYPE *pFgCfgData,
                                                 IN EFI_FG_DEBUG_CFGDATA_TYPE *pDbgCfgData, IN EFI_PM_BATTID_CFGDATA_TYPE *pFgBattIdCfgData);

EFI_STATUS EFIAPI EFI_PmicFgExtendedInit( IN UINT32 PmicDeviceIndex, IN EFI_PM_BATTID_CFGDATA_TYPE *pBattIdCfgDa, IN EFI_PM_FG_BATT_PROFILE_DATA *pBattProfileData);
...
EFI_STATUS EFIAPI EFI_PmicFgDumpPeripheral(IN UINT32 PmicDeviceIndex);
...
EFI_STATUS PmicFgCommon_Init(UINT32 PmicDeviceIndex, EFI_FG_DEBUG_CFGDATA_TYPE *DbgCfgData);
