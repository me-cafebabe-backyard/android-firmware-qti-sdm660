/** @file
  ...
  Portions copyright (c) 2010 - 2011, 2014-2015 Qualcomm Technologies, Inc. All rights reserved.
...
#define EHC_BULK_TRANSFER_ASYNC 0x10
#define EHC_CTRL_TRANSFER_ASYNC 0x12
...
// 0 means to try unlimited times.
// Since timeout has been implemented for transfers,
// we can rely on timeout to terminate the transfers
#define QTD_MAX_ERR             0
...
struct _URB {
  ...
  VOID                                            *DataMap;
  EFI_ASYNC_USB_TRANSFER_CALLBACK_INT_BULK        Callback;     // Callback for the Async Interrupt/Bulk transfer/ Control Transfer
  VOID                                            *Context;
