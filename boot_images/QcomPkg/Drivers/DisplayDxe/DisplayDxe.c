...
/* Display ABL protocol definition */
extern EFI_QCOM_DISPLAY_ABL_PROTOCOL  gQcomDisplayABLProtocolImplementation;
  ...
  else
  {
        ...
        else
        {
           ...
           if (EFI_SUCCESS != (eStatus = gBS->InstallMultipleProtocolInterfaces (&hUEFIDisplayHandle,
                                                                                 ...
                                                                                 &gQcomDisplayABLProtocolImplementation,
                                                                                 NULL)))
           {
       ...
       case EfiBltVideoToVideo:
         {
           ...
           /* If display frame buffer is cached, need to call cache maintenance function */
           FlushStaleLines(pDstBuffer + (Stride * DestinationY), (Stride * CopyHeight));
           eStatus = EFI_SUCCESS;
