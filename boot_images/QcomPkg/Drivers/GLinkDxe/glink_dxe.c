...
--------   ---     ----------------------------------------------------------
07/18/16   ab      Adding registration of tear down callback for Exis BS
...
EFI_EVENT GlinkExitBSEvent = (EFI_EVENT)NULL;
...
**/
static VOID GlinkRegisterEBSCallback(VOID)
{
...
)
{
  ...
  //Register for Exit Boot Service Callback
  GlinkRegisterEBSCallback();
