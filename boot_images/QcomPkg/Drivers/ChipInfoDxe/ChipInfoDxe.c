                          ...
                          OUT EFIChipInfoIdType *peId)
{
  ...
  if(chipInfoHandle)
  {
    result = DalChipInfo_GetChipId(chipInfoHandle, (DalChipInfoIdType *)peId);
  }
  if(DAL_SUCCESS == result)
  {
    return(EFI_SUCCESS);
                              ...
                              OUT EFIChipInfoFamilyType *peFamily)
{
  ...
  if(chipInfoHandle)
  {
    result = DalChipInfo_GetChipFamily(chipInfoHandle, ( DalChipInfoFamilyType *)peFamily);
  }
  if(DAL_SUCCESS == result)
  {
    return(EFI_SUCCESS);
                                ...
                                OUT EFIChipInfoModemType *pnModem)
{
  ...
  if(chipInfoHandle)
  {
    result = DalChipInfo_GetModemSupport(chipInfoHandle,(DalChipInfoModemType *) pnModem);
  }
  if(DAL_SUCCESS == result)
  {
    return(EFI_SUCCESS);
                                ...
                                IN UINT32 nMaxLength)
{
  ...
  if(chipInfoHandle)
  {
    result = DalChipInfo_GetProcessorNameString(chipInfoHandle, szNameString, nMaxLength );
  }
  if(DAL_SUCCESS == result)
  {
    return(EFI_SUCCESS);
                               ...
                               OUT EFIChipInfoSerialNumType *peId )
{
  ...
  if(chipInfoHandle)
  {
    result = DalChipInfo_GetSerialNumber(chipInfoHandle,(DalChipInfoSerialNumType *) peId );
  }
  if(DAL_SUCCESS == result)
  {
    return(EFI_SUCCESS);
                               ...
                               OUT EFIChipInfoFoundryIdType *peId )
{
  ...
  if(chipInfoHandle)
  {
    result = DalChipInfo_GetFoundryId(chipInfoHandle,(DalChipInfoFoundryIdType *) peId );
  }
  if(DAL_SUCCESS == result)
  {
    return(EFI_SUCCESS);
                               ...
                               OUT EFIChipInfoQFPROMChipIdType *pnId )
{
  ...
  if(chipInfoHandle)
  {
    result = DalChipInfo_GetQFPROMChipId(chipInfoHandle,(DalChipInfoQFPROMChipIdType *) pnId );
  }
  if(DAL_SUCCESS == result)
  {
    return(EFI_SUCCESS);
