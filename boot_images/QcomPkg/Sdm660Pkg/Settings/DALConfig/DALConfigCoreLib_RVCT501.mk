# @file DALConfigCoreLib_RVCT501.mk
#
...
# 03/12/15   ap      Added DALConfigCoreLib_RVCT501.mk for DALConfigCoreLib.inf
#
#==============================================================================
...
INC_DEPS = $(WORKSPACE)/QcomPkg/Include/api/dal/*.h \
           $(WORKSPACE)/QcomPkg/Sdm660Pkg/Settings/DALConfig/*.h \
...
#
XML_DEPS = $(WORKSPACE)/QcomPkg/Sdm660Pkg/Settings/DALSystem/$(MACRO_NAME)/dalsystem_$(MACRO_NAME).xml \
           $(WORKSPACE)/QcomPkg/Sdm660Pkg/Settings/ChipInfo/DalChipInfo.xml \
           $(WORKSPACE)/QcomPkg/Sdm660Pkg/Settings/Clock/ClockChipset.xml \
           $(WORKSPACE)/QcomPkg/Settings/Clock/$(MACRO_NAME)/DalClock.xml \
           $(WORKSPACE)/QcomPkg/Sdm660Pkg/Settings/HWIO/$(MACRO_NAME)/DalHWIO.xml \
           $(WORKSPACE)/QcomPkg/Sdm660Pkg/Settings/I2C/$(MACRO_NAME)/i2c_uefi_Sdm660.xml \
           $(WORKSPACE)/QcomPkg/Sdm660Pkg/Settings/SPI/$(MACRO_NAME)/spi_uefi_Sdm660.xml \
           $(WORKSPACE)/QcomPkg/Sdm660Pkg/Settings/PMIC/$(MACRO_NAME)/pm_config_target_$(MACRO_NAME).xml \
           $(WORKSPACE)/QcomPkg/Settings/PMIC/pm_config_common.xml \
           $(WORKSPACE)/QcomPkg/Settings/PlatformInfo/PlatformInfo.xml \
           $(WORKSPACE)/QcomPkg/Sdm660Pkg/Settings/Qusb/qusb.xml \
           $(WORKSPACE)/QcomPkg/Sdm660Pkg/Settings/TSENS/tsens_props.xml \
           $(WORKSPACE)/QcomPkg/Sdm660Pkg/Settings/ADC/internal/core/adc_props.xml \
           $(WORKSPACE)/QcomPkg/Sdm660Pkg/Settings/ADC/internal/core/vadc_props.xml \
           $(WORKSPACE)/QcomPkg/Sdm660Pkg/Settings/ADC/internal/core/fgadc_props.xml \
           $(WORKSPACE)/QcomPkg/Sdm660Pkg/Settings/BAM/bam_config.xml \
...
INC = --via $(MODULE_BUILD_DIR)/../DALGenLibCore/OUTPUT/inc_list.inc
...
$(OUTPUT_DIR)/DALConfigLib.lib : $(OBJECT_FILES)
	"$(SLINK)"  $(SLINK_FLAGS) $(OUTPUT_DIR)/DALConfigLib.lib $(OUTPUT_DIR)/DALConfig_$(MACRO_NAME).obj
...
$(DALCONFIG_XML_PRE) :  $(DALCONFIG_XML)
	( "$(CC)" -E -o $(DALCONFIG_XML_PRE) -I$(WORKSPACE)/QcomPkg/Include/api/dal -I$(MODULE_DIR) $(INC) $(DALCONFIG_XML) )
