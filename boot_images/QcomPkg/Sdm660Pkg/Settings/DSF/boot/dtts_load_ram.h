#ifndef __DTTS_LOAD_RAM_H__
#define __DTTS_LOAD_RAM_H__
...
/*==============================================================================
                                  DATA
==============================================================================*/
extern uint32 *dtts_isram_base_data;
extern uint32 *dtts_dsram_base_data;
...
void dtts_load_sram
(
  uint32 dtts_sram_base_addr,
  uint32 *dtts_sram_base_data,
  uint16 load_dram,
  uint16 data_length
);

void dtts_load_sram_constant
(
  uint32 dtts_sram_base_addr,
  uint32 dtts_sram_data,
  uint16 data_length
);

void dtts_load_pc_sel
(
  uint32 dtts_pc_sel_base_addr,
  uint32 *dtts_pc_sel_base_data
);


void dtts_load_isram
(
    uint32 base_addr,
    uint16 channel
);

void dtts_load_dsram
(
    uint32 base_addr,
    uint16 channel
);
