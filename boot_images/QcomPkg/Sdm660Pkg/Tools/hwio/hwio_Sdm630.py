...
# REMOVED -- Use hwio_sdm660.py instead, it is the superset.
#HWIO_BASE_FILES = [
#  {
...
HWIO_T32VIEW_FILES = [
  {
    'symbol-filename': 'scripts/hwio630.cmm',
    'limit-array-size': [ 10, 4 ],
    'per-filename': 'scripts/hwioreg630',
...
if __name__ == "__main__":
  ...
  hwiogen = Popen([r"python", r"\\ben\corebsp_labdata_0001\sysdrv\hwio\HWIOGen.py", "--cfg=hwio_Sdm630.py", "--flat=ARM_ADDRESS_FILE_SDM630.FLAT"], shell=True)
  hwiogen.wait()
  print "============================!! NOTICE !!========================================="
  print "This Generates only T32 files, use hwio_sdm660.py to generate the C and H files"