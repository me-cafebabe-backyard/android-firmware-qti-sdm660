...
/*===========================================================================
  ...
  $Header: //components/rel/boot.xf/1.4/QcomPkg/Sdm660Pkg/Library/XBLLoaderLib/pbl_sbl_shared.h#1 $
...
typedef enum
{
  BOOT_DEFAULT_OPTION = 0,              /* eMMC@SDC1 -> SD@SDC2 -> USB */
  BOOT_SDC_PORT2_THEN_SDC_PORT1_OPTION, /* 1, SD@SDC2 -> eMMC@SDC1*/
  BOOT_SDC_PORT1_OPTION,                /* 2, eMMC@SDC1 */
  BOOT_USB_OPTION,                      /* 3, USB */
  BOOT_UFS_OPTION,                      /* 4, UFS */
  BOOT_SDC_PORT2_THEN_UFS_OPTION,       /* 5, SD@SDC2 -> UFS */
  BOOT_UFS_THEN_SDC_PORT2_OPTION,       /* 6, UFS -> SD@SDC2 -> USB*/
  BOOT_SPI_ON_BLSP1_QUP1_OPTION,        /* 7 */
  BOOT_SPI_ON_BLSP1_QUP2_OPTION,	    /* 8 */
  BOOT_SELECT_OPTION_COUNT,
  BOOT_SDC_PORT2_THEN_USB_OPTION = 0x80,/* This is not a boot option, it is for error handler*/
