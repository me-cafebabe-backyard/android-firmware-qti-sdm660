...
$Header: //components/rel/boot.xf/1.4/QcomPkg/Sdm660Pkg/Library/TLMMTargetLib/HALtlmm.h#1 $
...
void HAL_tlmm_WriteGpioGroup  ( uint32 *nWhichConfigSet, uint32 nWhatSize, boolean nValue );

void HAL_tlmm_ConfigGpio      ( uint32 nWhichConfig );

void HAL_tlmm_ConfigPin( HAL_tlmm_GpioType* pGpio );

void HAL_tlmm_ConfigGpioGroup ( uint32 *nWhichGpioSet, uint32 nWhatSize );
