...
$Header: //components/rel/boot.xf/1.4/QcomPkg/Sdm660Pkg/Library/TLMMTargetLib/HALtlmmtilePlatform.c#2 $
...
void HAL_tlmmtile_PlatformInit (HalTlmmGpioDescriptionType *pDesc)
{
  ...
  pDesc->DirConnIntrCfg.nBase                     = (uint32)( HWIO_TLMM_NORTH_DIR_CONN_INTRn_CFG_LPA_DSP_ADDR(0) ); 
