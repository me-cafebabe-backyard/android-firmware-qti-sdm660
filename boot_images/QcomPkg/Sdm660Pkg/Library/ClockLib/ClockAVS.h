...
** =========================================================================*/
/**
  Programs the power mode for the specified AVS core.

  This function updates the power mode for the specified AVS core.

  @param eCore [in] -- Core for which to resume AVS functionality.
  @param eMode [in] -- The power mode to program to HW.

  @return
  DAL_SUCCESS -- The core power mode was set successfully.
