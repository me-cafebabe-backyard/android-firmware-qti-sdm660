...
CPR_CONFIG_DIR = $(WORKSPACE)/QcomPkg/$(MSM_ID)Pkg/Settings/CPR
CPR_FUSES_DIR  = $(WORKSPACE)/QcomPkg/$(MSM_ID)Pkg/Library/CPRTargetLib/target/$(MSM_ID)
...
GEN_CPR_CFG_CMD  = python $(CPR_CFG_SCRIPT) xbl $(MSM_ID) $(CPR_CONFIG_DIR) $(CPR_CONFIG_DIR) $(CPR_FUSES_DIR)   # \
GEN_CPR_CFG_CMD2 = python $(CPR_CFG_SCRIPT) xbl $(MSM_ID2) $(CPR_CONFIG_DIR) $(CPR_CONFIG_DIR) $(CPR_FUSES_DIR)  # \
!ENDIF # \
...
OBJ =  \
    ...
    $(OUTPUT_DIR)/cpr_voltage_plan_$(MSM_ID).obj \
    $(OUTPUT_DIR)/cpr_voltage_plan_$(MSM_ID2).obj \
    $(OUTPUT_DIR)/image/xbl/target/$(MSM_ID)/cpr_image_target_init.obj \
    $(OUTPUT_DIR)/image/xbl/target/$(MSM_ID)/cpr_image_target.obj


INC =  \
    -I$(WORKSPACE)/QcomPkg/$(MSM_ID)Pkg/Library/CPRTargetLib/target/$(MSM_ID) \
    -I$(WORKSPACE)/QcomPkg/$(MSM_ID)Pkg/Library/CPRTargetLib/target/$(MSM_ID)/hwio \
    -I$(WORKSPACE)/QcomPkg/$(MSM_ID)Pkg/Library/CPRTargetLib/image/xbl/target/$(MSM_ID) \
    -I$(WORKSPACE)/QcomPkg/$(MSM_ID)Pkg/Settings/CPR \
    ...
    -I$(WORKSPACE)/QcomPkg/$(MSM_ID)Pkg/Library/CPRTargetLib \
    -I$(DEBUG_DIR) \
    -I$(WORKSPACE)/MdePkg \
    ...
    -I$(WORKSPACE)/QcomPkg/Include/api/systemdrivers/pmic \
...
$(OUTPUT_DIR)/cpr_voltage_plan_$(MSM_ID).obj : $(WORKSPACE)/QcomPkg/$(MSM_ID)Pkg/Settings/CPR/cpr_voltage_plan_$(MSM_ID).c
	"$(CC)" $(CC_FLAGS) -o $@ $(INC) $(WORKSPACE)/QcomPkg/$(MSM_ID)Pkg/Settings/CPR/cpr_voltage_plan_$(MSM_ID).c

$(OUTPUT_DIR)/cpr_voltage_plan_$(MSM_ID2).obj : $(WORKSPACE)/QcomPkg/$(MSM_ID)Pkg/Settings/CPR/cpr_voltage_plan_$(MSM_ID2).c
	"$(CC)" $(CC_FLAGS) -o $@ $(INC) $(WORKSPACE)/QcomPkg/$(MSM_ID)Pkg/Settings/CPR/cpr_voltage_plan_$(MSM_ID2).c

$(OUTPUT_DIR)/image/xbl/target/$(MSM_ID)/cpr_image_target_init.obj : $(WORKSPACE)/QcomPkg/$(MSM_ID)Pkg/Library/CPRTargetLib/image/xbl/target/$(MSM_ID)/cpr_image_target_init.c
	"$(CC)" $(CC_FLAGS) -o $@ $(INC) $(WORKSPACE)/QcomPkg/$(MSM_ID)Pkg/Library/CPRTargetLib/image/xbl/target/$(MSM_ID)/cpr_image_target_init.c
...
$(OUTPUT_DIR)/image/xbl/target/$(MSM_ID)/cpr_image_target.obj : $(WORKSPACE)/QcomPkg/$(MSM_ID)Pkg/Library/CPRTargetLib/image/xbl/target/$(MSM_ID)/cpr_image_target.c
	"$(CC)" $(CC_FLAGS) -o $@ $(INC) $(WORKSPACE)/QcomPkg/$(MSM_ID)Pkg/Library/CPRTargetLib/image/xbl/target/$(MSM_ID)/cpr_image_target.c
