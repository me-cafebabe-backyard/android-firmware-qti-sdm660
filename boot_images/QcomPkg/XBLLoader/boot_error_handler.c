...
Copyright 2009 - 2017 by Qualcomm Technologies, Inc.  All Rights Reserved.
=============================================================================*/
...
--------   ---     ------------------------------------------------------------
03/03/17   bd      exception_context - variable name correction
...
void boot_reserved_c_handler( void )
{
  /* Don't use the global error handler pointer in case it's invalid and
     caused the abort */
  boot_error_handler( __FILE__, __LINE__, BL_ERR_RESERVED_HANDLER ); 
}
