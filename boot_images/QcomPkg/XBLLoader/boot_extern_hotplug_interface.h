#ifndef BOOT_EXTERN_HOTPLUG_INTERFACE_H
#define BOOT_EXTERN_HOTPLUG_INTERFACE_H
...
10/18/13   jz      Added new hotplug API functions
03/20/12   dh      Add boot_hotplug_dev_get_size
...
*****************************************************************************/
int boot_hotplug_dev_read(struct hotplug_device * hdev,
                          uint32 lba,
                          unsigned char * buf,
                          uint16 block_count);
 ...
 * parameters and return values.
*****************************************************************************/
int boot_hotplug_dev_write(struct hotplug_device * hdev,
                           uint32 lba,
                           unsigned char * buf,
                           uint16 block_count);
 ...
 */
int
boot_hotplug_poll_and_mount_first_fat(hotplug_dev_type dev_type,
                                      enum hotplug_iter_device_location dev_loc);

#endif  /* BOOT_EXTERN_HOTPLUG_INTERFACE_H */
