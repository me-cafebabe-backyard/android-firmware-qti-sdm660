...
Copyright 2007-2008, 2010, 2014 by Qualcomm Technologies Incorporated.  All Rights Reserved.
============================================================================*/
...
* 
*/
static __inline boot_clobber_local_type* boot_flash_trans_get_clobber_tbl_ptr
(
  boot_flash_trans_if_type *trans_if
)
{
