...
Copyright 2005-2006, 2010-2017 by Qualcomm Technologies Incorporated.  All Rights Reserved.
...
--------   ---     ----------------------------------------------------------
01/03/17   bd      Increase number of dump regions to accomodate minidump regions
12/07/16   sj  	   Corrected BUILD_ASIC using target specfic header
