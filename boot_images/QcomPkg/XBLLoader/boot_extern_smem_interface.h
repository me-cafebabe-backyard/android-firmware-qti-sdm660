...
Copyright 2011, 2013-2016 by QUALCOMM Technologies Incorporated.  All Rights Reserved.
============================================================================*/
/*===========================================================================
...
--------   ---     ----------------------------------------------------------
09/05/16   yps     Enable boot_smem_get_addr API for Ramdump
...
void * boot_smem_get_addr(smem_mem_type  smem_type,
                      uint32 *buf_size);
