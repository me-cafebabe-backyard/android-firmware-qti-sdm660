...
def get_encdec(imageinfo, validating=False):
    ident = imageinfo.general_properties.selected_encryptor
    encdec_class = _get_encdec_class_by_ident(ident)
    return encdec_class(imageinfo=imageinfo, debug_dir=imageinfo.dest_image.debug_dir_encdec, validating=validating)
