...
from sectools.features.isc.signer.base_signer import BaseSigner, ishmac, SignerOutput, ConfigError
...
class OpenSSLSigner(BaseSigner):
    ...
    def sign(self, binary_to_sign, imageinfo, debug_dir=None, is_hash=False):
        ...
        if is_hash:
            ...
            logger.info('Using ' + ('QTI HMAC' if is_hmac else 'SHA') + ' for hash segment')
