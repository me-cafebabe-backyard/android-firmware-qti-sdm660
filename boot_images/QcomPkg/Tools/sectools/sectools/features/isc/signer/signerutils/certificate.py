...
class Certificate(object):
    ...
    SIGNATTR_ROOT_REVOKE_ACTIVATE_ENABLE = "ROOT_REVOKE_ACTIVATE_ENABLE"
    SIGNATTR_UIE_KEY_SWITCH_ENABLE = "UIE_KEY_SWITCH_ENABLE"
    ...
    def _repr_properties(self):
        ...
        if self.root_revoke_activate_enable is not None:
            properties += [(self.SIGNATTR_ROOT_REVOKE_ACTIVATE_ENABLE, self.root_revoke_activate_enable)]
        if self.uie_key_switch_enable is not None:
            properties += [(self.SIGNATTR_UIE_KEY_SWITCH_ENABLE, self.uie_key_switch_enable)]
    ...
    def root_revoke_activate_enable(self):
        return self.get_attr(self.SIGNATTR_ROOT_REVOKE_ACTIVATE_ENABLE)

    @property
    def uie_key_switch_enable(self):
        return self.get_attr(self.SIGNATTR_UIE_KEY_SWITCH_ENABLE)
...
class Certificate_OU(object):
    OU_DICT = {Certificate.SIGNATTR_SW_ID: "01",
               ...
               Certificate.SIGNATTR_ROOT_REVOKE_ACTIVATE_ENABLE: "20",
               Certificate.SIGNATTR_UIE_KEY_SWITCH_ENABLE: "21"
               }
