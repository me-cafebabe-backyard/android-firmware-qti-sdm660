...
class PathHandler(BaseHandler):
    ...
    def __init__(self, data_handler):
        ...
        self._i_detailer = PathDetailer(self)
    ...
    @property
    def _detailer(self):
        """Returns the :class:`PathDetailer` object for the data type."""
...
class PathDetailer(BaseDetailer):
    """Detailer for Path data.
    ...
    def detail(self, i_format):
        ...
        assert isinstance(i_format, TypePath)
        return DataDetail(DataType.Path, self.data_handler, i_format)
