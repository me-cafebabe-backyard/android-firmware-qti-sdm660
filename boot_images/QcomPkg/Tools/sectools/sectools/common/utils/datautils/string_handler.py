...
class StringHandler(BaseHandler):
    ...
    def __init__(self, data_handler):
        ...
        self._i_detailer = StringDetailer(self)
    ...
    @property
    def _detailer(self):
        """Returns the :class:`StringDetailer` object for the data type."""
...
class StringDetailer(BaseDetailer):
    """Detailer for String data.
    ...
    def detail(self, i_format):
        ...
        assert isinstance(i_format, str)
        return DataDetail(DataType.String, self.data_handler, i_format)
