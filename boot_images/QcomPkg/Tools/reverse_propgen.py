...
class Props:    
    ...
    def write_modified_props_to_elf(self,elf_fp): 
		...
		#ignore MSB in type, used for visibility attr 
...
class Props_XML:
    ...
    def is_modified(self,Props):
        ...
        if self.ishidden != Props.ishidden:
           return True
