 ...
 * Description:
 *      Enable/Disable QoS clock which is needed for danger and external throttle.
 * Params: 
 ...
 *      -1 - for failure
******************************************************************************/
int sysmon_qos_clock_enable(sysmonQosClientId_t clientId, unsigned char enable);
