/*========================================================================
  ...
  $Header: //components/rel/avs.adsp/2.8/afe/services/static/inc/AFEInterface.h#9 $
 ====================================================================== */
...
/** Macro to check if a given combined ID is PCIE port. */
#define IS_PCIE_PORT_AFE_ID(port_afe_id) ( (AFE_PORT_ID_PCIE_AUDIO_0_RX <= port_afe_id) &&  \
         (port_afe_id <= AFE_PORT_ID_PCIE_AUDIO_0_TX) )
...
/** get index for PCIE port */
#define GET_PCIE_PORT_INDEX(port_afe_id) (port_afe_id - AFE_PORT_ID_PCIE_RANGE_START)
...
typedef struct afe_client
{
  ...
  uint8_t               channel_mapping[AFE_PORT_MAX_CHANNEL_CNT]; /**< Channel mapping information.*/
