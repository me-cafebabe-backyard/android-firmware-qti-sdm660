/*========================================================================
  ...
  $Header: //components/rel/avs.adsp/2.8/afe/services/static/inc/AFEPortManager.h#4 $
 ====================================================================== */
...
/**
 * To hold all the information corresponding to the sample slip CAPIV2 library.
 */
typedef struct rate_match_ss_lib_info_t { 
   capi_v2_t* lib_ptr;
   capi_v2_buf_t in_bufs[MAX_AUDIO_CHANNELS];
   capi_v2_buf_t out_bufs[MAX_AUDIO_CHANNELS];
   uint32_t kpps;
   uint32_t algo_delay_us;
   bool_t use_lib;
} rate_match_ss_lib_info_t;
...
typedef struct afe_rate_match_info
{
	...
	rate_match_ss_lib_info_t          ss_lib_info;
	/**< To hold all the information corresponding to the sample slip library. */
	void*                             ss_amdb_handle_info;
	/**< The handle to the capi v2 sample slip library. */
