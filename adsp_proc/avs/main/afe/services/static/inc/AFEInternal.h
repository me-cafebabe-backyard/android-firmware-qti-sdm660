/*========================================================================
  ...
  $Header: //components/rel/avs.adsp/2.8/afe/services/static/inc/AFEInternal.h#18 $
 ====================================================================== */
 ...
 */
static const uint32 AFE_THREAD_STACK_SIZE = 5120;

/**< AFE port will operate at 20ms frame size. */
#define AFE_PORT_HIGH_LATENCY_MODE_20MS                             2
...
typedef struct aud_stat_afe_svc
{
   ...
   afe_dev_port_t       *ports_pcie_ptr[AFE_PORT_ID_PCIE_RANGE_SIZE];
   /**< pointer to PCIE port pool objects. */
