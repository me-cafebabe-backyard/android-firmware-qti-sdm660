/*========================================================================
  ...
  Copyright (c) 2009 -2018 QUALCOMM Technologies, Inc. (QTI).  All Rights Reserved.
  QUALCOMM Proprietary.  Export of this technology or software is regulated
  by the U.S. Government, Diversion contrary to U.S. law prohibited.

  $Header: //components/rel/avs.adsp/2.8/afe/services/static/src/AFEPortManager.cpp#25 $
 ====================================================================== */
                               ...
                               int8_t *ptr_src_port_buf, int8_t *ptr_scratch_buf)
{
  ...
  if((pDevPort->dir == AFE_PORT_RX_DIR) && (1 == nClientChannels) && (2 == nPortChannels))
  {
    ...
    ptr_src_port_buf = ptr_stereo_to_mono_avg_out;
  }
  ...
  if(pDevPort->sample_rate != pClientInfo->afe_client.sample_rate)
  {
    ...
    {
      sample_rate_conv_process(paResampler, (int8 *)inp_data_ptr, (int8 *)ptr_dst_client_buf,
      ...
      if(port_bit_width < client_bit_width)
      {
         ...
         */
        afe_port_sample_up_down_convertor(pDevPort, ptr_dst_client_buf, ptr_dst_client_buf, nSamplesOut,
