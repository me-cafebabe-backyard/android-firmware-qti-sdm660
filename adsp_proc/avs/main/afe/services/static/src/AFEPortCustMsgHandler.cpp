/*========================================================================
  ...
  $Header: //components/rel/avs.adsp/2.8/afe/services/static/src/AFEPortCustMsgHandler.cpp#4 $
 ====================================================================== */
...
ADSPResult afe_port_custom_msg_handler(void* vpDevPort, elite_msg_any_t* pMsg)
{
   ...
   switch (((elite_msg_custom_header_t *)pMsg->pPayload)->unSecOpCode)
   {
      ...
      break;
      case ELITEMSG_CUSTOM_VFR_AFE_DATA_RW_OFFSETS:
      {
         result = afe_port_vfr_data_rw_offsets(pDevPort, pMsg);
      }
	  break;
      default:
      {
