/*==============================================================================
$Header: //components/rel/avs.adsp/2.8/afe/drivers/hw/devcfg/config/lpasshwio_devcfg_8909.c#17 $
$DateTime: 2017/10/26 20:03:07 $
$Author: pwbldsvc $
$Change: 14705818 $
$Revision: #17 $

FILE: lpasshwio_devcfg_8909.c

DESCRIPTION: 8909 Device Config
...
lpasshwio_prop_lpaif_struct_t lpaif_prop =
{
   ...
   (0x1000 * 16),   /**< LPAIF overal reg page size */
    ...
    {
        0x07709040,  /**< LPASS_LPAIF_PCM_CTL0, offset addr */
        1,          /**< Number of supported PCM interfaces */
        {
...
HwdGenericClkPropertyType genericclk_prop =
{
   ...
   (64 * 1024),              /**< TCSR reg size in bytes */
    ...
    8,                     /**< Number of clk-id's defined below   */
    /**< List of clock ids */
    {
    ...
    1, /**< Number of PCM clock defined with OE set availability  */
