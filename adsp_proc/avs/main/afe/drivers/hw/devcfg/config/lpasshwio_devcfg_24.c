/*==============================================================================
$Header: //components/rel/avs.adsp/2.8/afe/drivers/hw/devcfg/config/lpasshwio_devcfg_24.c#10 $
...
lpm_prop_struct_t lpm_prop = {
    0x01A18000, /**< Starting physical address, 64-bit */
    4*1024,    /**< Size of LPM in bytes */
    4*1024,    /**< Size allocated for AFE DMA buffers, in bytes */
    QURT_MEM_CACHE_WRITEBACK_NONL2CACHEABLE,  /**< Cache attribute: L1 WB L2 uncached */
