/*==============================================================================
$Header: //components/rel/avs.adsp/2.8/afe/drivers/hw/devcfg/config/lpasshwio_devcfg_9x65.c#14 $
$DateTime: 2018/05/21 21:47:33 $
$Author: pwbldsvc $
$Change: 16220771 $
$Revision: #14 $

FILE: lpasshwio_devcfg_9x65.c

DESCRIPTION: 9x65 Device Config
...
{
   0x07700000,             /**< LPASS register base address */
...
{
    0x7706000,    /**< Reg base address: LPASS_LPASS_SYNC_WRAPPER */
    ...
    /* AV timer Hw instances information */
    {
        ...
        {
            0x07706000,              /**< AVT reg base addr: LPASS_AVTIMER_HW_VERSION>*/
...
lpm_prop_struct_t lpm_prop = {
    ...
    QURT_MEM_CACHE_WRITEBACK_NONL2CACHEABLE,    /**< Cache attribute: Cache attribute: L1 WB L2 uncached */
