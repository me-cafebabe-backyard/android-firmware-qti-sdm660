/*==============================================================================
$Header: //components/rel/avs.adsp/2.8/afe/drivers/hw/devcfg/config/lpasshwio_devcfg_8998.c#17 $
$DateTime: 2017/11/13 21:14:08 $
$Author: pwbldsvc $
$Change: 14835627 $
$Revision: #17 $

FILE: lpasshwio_devcfg_8998.c

DESCRIPTION: 8998 Device Config
...
lpasshwio_prop_lpaif_struct_t lpaif_prop = {
   ...
   { 0x17101000, //i2s reg offset : LPASS_LPAIF_I2S_CTL0
   ...
   { 0xC9A0000,  //MMSS_HDMI_CTRL
      ...
      SUPPORTED },
   { 0x1711A000, // mux reg base LPASS_LPAIF_PCM_I2S_SEL0
...
lpasshwio_prop_afe_dma_struct_t hdmiout_dma_prop = {
    ...
    0x40000002   //  hdmiout hw revision
};
...
HwdResamplerPropertyType resampler_prop = {
    0x17138000,   // baseRegAddr: base address of resampler - LPASS_RESAMPLER_HW_VERSION
...
{
    0x17080000,     // base address of tcsr reg  -- LPASS_LPASS_TCSR
