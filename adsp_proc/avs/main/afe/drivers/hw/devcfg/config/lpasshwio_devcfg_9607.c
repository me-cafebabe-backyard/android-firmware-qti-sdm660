/*==============================================================================
$Header: //components/rel/avs.adsp/2.8/afe/drivers/hw/devcfg/config/lpasshwio_devcfg_9607.c#12 $
$DateTime: 2017/10/26 20:03:07 $
$Author: pwbldsvc $
$Change: 14705818 $
$Revision: #12 $
...
lpasshwio_vfr_prop_t vfr_prop = {
    ...
    {59, 60}, // l2vic_num[]: Available L2VIC # for VFR interrupts
...
/* LPM configuration for LYKAN 9607 */
...
HwdGenericClkPropertyType genericclk_prop =
{
    ...
    LPASS_HW_VER_3_5_0,    /**< hw revision */
