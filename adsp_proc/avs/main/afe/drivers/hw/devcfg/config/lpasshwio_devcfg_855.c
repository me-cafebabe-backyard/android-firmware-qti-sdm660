/*==============================================================================
$Header: //components/rel/avs.adsp/2.8/afe/drivers/hw/devcfg/config/lpasshwio_devcfg_855.c#8 $
$DateTime: 2017/11/13 21:14:08 $
$Author: pwbldsvc $
$Change: 14835627 $
$Revision: #8 $

FILE: lpasshwio_devcfg_855.c

DESCRIPTION: SDM855 Device Config
...
/* For Hana, spkr_i2s interface (from Napali) is updated
