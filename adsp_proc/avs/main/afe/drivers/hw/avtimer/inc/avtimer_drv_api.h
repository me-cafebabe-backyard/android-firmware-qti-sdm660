...
$Header: //components/rel/avs.adsp/2.8/afe/drivers/hw/avtimer/inc/avtimer_drv_api.h#4 $
...
@return
 True if avtimer hw mode is QCOUNTER, false otherwise.

@dependencies
 Before calling this function, ensure that avtimer was initialized.
*/
ADSPResult avtimer_drv_is_hw_mode_qcounter(bool_t* bIsQtimerEnabled);
