/*========================================================================
  ...
  $Header: //components/rel/avs.adsp/2.8/afe/drivers/hw/common/src/hwd_mmpm.c#2 $
 ====================================================================== */
...
static void HwdCreateClientName(char clientName[], MmpmCoreIdType coreId)
{
   switch(coreId)
   {
      ...
      break;
      case MMPM_CORE_ID_LPASS_CORE:
      {
         strlcpy(clientName, "LPASS_CORE", HWD_MAX_LEN_CLIENT_NAME);
      }
      break;
      default:
      {
