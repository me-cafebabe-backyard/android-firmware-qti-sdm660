...
by the U.S. Government, Diversion contrary to U.S. law prohibited.
  ...
  $Header: //components/rel/avs.adsp/2.8/afe/drivers/afe/clock_manager/src/clock_manager.cpp#18 $
 ====================================================================== */
   ...
   else
   {
     /* Latest clock API*/
      ...
      if ((LPASS_HW_VER_4_0_0 == (afe_generic_clk_cfg_global_ctx_ptr->devcfg).hw_revision) ||
          ...
          (LPASS_HW_VER_4_2_1 == (afe_generic_clk_cfg_global_ctx_ptr->devcfg).hw_revision))
      {
         /* Select v1 table */
         if (LPASS_HW_VER_4_0_0 == (afe_generic_clk_cfg_global_ctx_ptr->devcfg).hw_revision)
         {
         ...
         else if (LPASS_HW_VER_4_2_1 == (afe_generic_clk_cfg_global_ctx_ptr->devcfg).hw_revision)
         {
            /* Select v9 table */
            afe_generic_clk_cfg_global_ctx_ptr->clks_map_table_ptr = g_generic_clk_map_table_v9;
            /* Calculate the number of entries in the table */
            afe_generic_clk_cfg_global_ctx_ptr->num_map_table_entries =\
               sizeof(g_generic_clk_map_table_v9) / sizeof(generic_map_tab_info_t);
         }
         else
         {
            /* Select v5 table */
