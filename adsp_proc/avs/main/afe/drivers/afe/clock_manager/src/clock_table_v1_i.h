...
by the U.S. Government, Diversion contrary to U.S. law prohibited.
  ...
  $Header: //components/rel/avs.adsp/2.8/afe/drivers/afe/clock_manager/src/clock_table_v1_i.h#9 $
 ====================================================================== */
...
// List of clk-id, clk-name, clk-attr, enable, disable functions
const generic_map_tab_info_t g_generic_clk_map_table_v9[] =
{
  // Clk-ID, Clk-name, enable-func, disable-func
  //QUI MI2S
  {AFE_CLOCK_SET_CLOCK_ID_QUI_MI2S_IBIT, "lpass_audio_core_lpaif_qui_ibit_clk",
    afe_clk_set_freq_divider_enable, afe_clk_set_disable},
  {AFE_CLOCK_SET_CLOCK_ID_QUI_MI2S_EBIT, "lpass_audio_core_lpaif_qui_ebit_clk",
    afe_clk_set_enable, afe_clk_set_disable},
  {AFE_CLOCK_SET_CLOCK_ID_QUI_MI2S_OSR,  "lpass_audio_core_lpaif_qui_osr_clk",
    afe_clk_set_freq_divider_enable, afe_clk_set_disable},
  ...
  {AFE_CLOCK_SET_CLOCK_ID_QUAD_MI2S_EBIT,"lpass_audio_core_lpaif_quad_ebit_clk",
    ...
    //QUI PCM
  {AFE_CLOCK_SET_CLOCK_ID_QUI_PCM_IBIT, "lpass_audio_core_lpaif_qui_ibit_clk",
    afe_clk_set_freq_divider_enable, afe_clk_set_disable},
  {AFE_CLOCK_SET_CLOCK_ID_QUI_PCM_EBIT, "lpass_audio_core_lpaif_qui_ebit_clk",
    afe_clk_set_enable, afe_clk_set_disable},
  {AFE_CLOCK_SET_CLOCK_ID_QUI_PCM_OSR,  "lpass_audio_core_lpaif_qui_osr_clk",
    afe_clk_set_freq_divider_enable, afe_clk_set_disable},
