...
$Header: //components/rel/avs.adsp/2.8/afe/drivers/afe/pcmif/hal_v2/stub_src/AFEHalPcmV2_stub.c#1 $
...
void hal_pcm_get_func_table_v2(afe_pcm_hal_func_def_t *func_table)
{
   ...
   MSG(MSG_SSID_QDSP6, DBG_ERROR_PRIO, "hal_pcm_get_func_table_v2 stub hal func_table set to NULL"); 
