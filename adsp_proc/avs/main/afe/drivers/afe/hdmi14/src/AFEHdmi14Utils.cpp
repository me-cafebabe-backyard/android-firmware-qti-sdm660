...
$Header: //components/rel/avs.adsp/2.8/afe/drivers/afe/hdmi14/src/AFEHdmi14Utils.cpp#2 $
...
ADSPResult afe_hdmi14_init_IEC60958_ch_status_table(hdmi14_port_state_t *p_dev_state)
{
   ...
   */
   ...
   if((AFE_NON_LINEAR_DATA_PACKED_60958 == p_dev_state->data_format) ||
       (AFE_NON_LINEAR_DATA == p_dev_state->data_format)) //AFE_NON_LINEAR_DATA_PACKED_60958 used for sim test.  //TODO: it will be used for I2S HDMI input
   {
