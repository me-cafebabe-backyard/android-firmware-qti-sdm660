/*==============================================================================
$Header: //components/rel/avs.adsp/2.8/afe/drivers/afe/vfr/vfr_drv/src/VFRIsrHandler.cpp#6 $
$DateTime: 2017/12/05 13:42:36 $
$Author: pwbldsvc $
$Change: 14987494 $
$Revision: #6 $
...
void vfr_fastintr_callback(void *intr_cntxt)
{
   ...
   if (TRUE == p_vfr_src_state->is_vfr_enabled)
   {
      ...
      {
         p_vfr_src_state->cur_av_time_stamp = qurt_elite_fwk_get_time(p_vfr_src_state->avt_drv_hdl);
      }
