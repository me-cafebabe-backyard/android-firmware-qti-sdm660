/*==============================================================================
$Header: //components/rel/avs.adsp/2.8/afe/drivers/afe/common/src/AFEDeviceDriftUtils.cpp#3 $
...
void afe_port_update_timestamp(afe_dev_port_t *dev_port_ptr)
{
	...
	else if(IS_USBA_PORT_AFE_ID(dev_port_ptr->intf))
	{
  	...
  	else if(IS_PCIE_PORT_AFE_ID(dev_port_ptr->intf))
  	{
      afe_pcie_get_timestamp(dev_port_ptr);
  	}
}
