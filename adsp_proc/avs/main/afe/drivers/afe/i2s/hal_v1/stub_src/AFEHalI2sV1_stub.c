...
$Header: //components/rel/avs.adsp/2.8/afe/drivers/afe/i2s/hal_v1/stub_src/AFEHalI2sV1_stub.c#1 $
...
void hal_i2s_get_func_table_v1(afe_i2s_hal_func_def_t *func_table)
{
   ...
   MSG(MSG_SSID_QDSP6, DBG_ERROR_PRIO, "hal_i2s_get_func_table_v1 stub hal func_table set to NULL"); 
}
