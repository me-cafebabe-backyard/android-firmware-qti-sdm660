...
QUALCOMM Proprietary/GTDR
  ...
  $Header: //components/rel/avs.adsp/2.8/afe/drivers/afe/pseudo_port/src/AFEPseudoPort.cpp#7 $
 ====================================================================== */
...
ADSPResult afe_pseudo_port_config (afe_dev_port_t* pDevPort, afe_param_id_pseudo_port_cfg_t *p_cfg)
{
	...
	if((p_cfg->num_channels > AFE_DRIVER_PSEUDO_PORT_MAX_CHANNEL_CNT) || (p_cfg->num_channels < 1))
	{
