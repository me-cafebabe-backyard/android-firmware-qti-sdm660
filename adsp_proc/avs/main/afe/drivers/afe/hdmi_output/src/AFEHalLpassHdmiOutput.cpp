/*==============================================================================
$Header: //components/rel/avs.adsp/2.8/afe/drivers/afe/hdmi_output/src/AFEHalLpassHdmiOutput.cpp#1 $
...
$Header: //components/rel/avs.adsp/2.8/afe/drivers/afe/hdmi_output/src/AFEHalLpassHdmiOutput.cpp#1 $ $DateTime: 2016/02/18 02:06:49 $ $Author: pwbldsvc $
...
void hal_lpass_hdmi_output_enable_legacy_mode_v1(uint16 enable)   //0 - diable, 1 - enable
{
   //lpass HDMI hw cfg
...
void hal_lpass_hdmi_output_enable_parity_hw_mode_v1(uint16 enable)   //0 - diable, 1 - enable
{
...
void hal_lpass_hdmi_output_cfg_ch_status_buf_v1(hal_lpass_hdmi_output_ch_status_cfg_t chs_cfg)
{
...
void hal_lpass_hdmi_output_cfg_user_bits_buf_v1(hal_lpass_hdmi_output_user_bits_cfg_t ubs_cfg)
{
  //HDMITX_DMA0_CTRL RESET_VALUE 0x00000000
   //     HW_USER_SEL BIT[6:5]         Map to 4 user bit buffer via [0, 1, 2, 3]
   //     HW_CHS_SEL BIT[4:2]      ->  Map to 8 channel status buffers via [0, 1, 2, 3, 4, 5,6, 7]
...
void hal_lpass_hdmi_output_enable_vbit_hw_mode_v1(hal_lpass_hdmi_output_stream_mode s_mode, uint16 dma_idx, uint16 vbit)
{
   //use dma_idx to set VBIT for different DMAs once hw support this

//11.	HDMITX_VBIT_CTRL     -? for both single stream and multi-stream? 

  //HDMITX_VBIT_CTRL RESET_VALUE 0x00000000
  //      VBIT BIT[1]
  //      REPLACE_VBIT BIT[0]      (when set the Validity bit will be taken from VBIT field)
  uint32 mask,fieldValue;

   mask = LPASS_HDMITX_VBIT_CTRL__REPLACE_VBIT___M | LPASS_HDMITX_VBIT_CTRL__VBIT___M;
   fieldValue = (1 << LPASS_HDMITX_VBIT_CTRL__REPLACE_VBIT___S) | (vbit << LPASS_HDMITX_VBIT_CTRL__VBIT___S);

   UpdateRegister1(hdmi_tx_phy_base + REG_OFFSET(LPASS_HDMITX_VBIT_CTRL), hdmi_tx_virt_offset, mask,fieldValue,0);
}

void hal_lpass_hdmi_output_disable_vbit_hw_mode_v1(hal_lpass_hdmi_output_stream_mode s_mode, uint16 dma_idx)
{
   //use dma_idx to set VBIT for different DMAs once hw support this
...
void hal_lpass_hdmi_output_enable_dma_interrupt_v1(uint16 dma_idx, uint16 enable)   //1 - enable, 0 - disable
{
   uint32 mask,fieldValue;
...
void hal_lpass_hdmi_output_enable_packet_update_interrupt_v1(uint16 enable)   //1 - enable, 0 - disable
{
   uint32 mask,fieldValue;
...
void hal_lpass_hdmi_output_enable_packet_update_b_interrupt_v1(uint16 enable)   //1 - enable, 0 - disable
{
   uint32 mask,fieldValue;
...
void hal_lpass_hdmi_outputt_read_interrupt_status_v1(uint32_t *int_status)
{
   uint32_t int_enable;
...
void hal_lpass_hdmi_outputt_clear_interrupts_v1(uint32_t clear_mask)
{
   uint32 mask;
...
uint32 hal_lpass_hdmi_output_check_dma_intr_v1(uint16 dma_idx, uint32 int_status)
{
...
void hal_lpass_hdmi_output_get_dma_int_stc_v1(uint16 dma_idx, uint64 *stc_ptr)
{
...
void hal_lpass_hdmi_output_get_dma_fifo_v1(uint16 dma_idx, uint32_t *fifo_count_ptr)
{
   uint32_t fifo_cnt;
...
void hal_lpass_hdmi_output_get_samples_in_dword_after_intr_v1(uint16 dma_idx, uint32_t *sample_in_dwrod_ptr)
{
   uint32  value;
...
//Single stream ONLY functions
////////////////////////////////////////////////
void hal_lpass_hdmi_output_ss_cfg_pack_trans_v1(hal_lpass_hdmi_output_ss_pack_trans_cfg_t ss_cfg)
{
...
void hal_lpass_hdmi_output_ss_enable_pack_trans_v1(uint16 enable)   //1 - enable, 0 - disable
{
...
void hal_lpass_hdmi_output_ms_cfg_pack_trans_v1(hal_lpass_hdmi_output_ms_pack_trans_cfg_t ms_cfg)
{
...
void hal_lpass_hdmi_output_ms_enable_pack_trans_v1(uint16 enable)   //1 - enable, 0 - disable
{
...
void hal_lpass_hdmi_output_ms_mute_stream_v1(uint16 stream_id, uint16 mute)   //1 - mute, 0 - unmute
{
...
void hal_lpass_hdmi_output_ms_wait_bbit_v1(uint16 stream_id, uint16 wait)    //1 - wait, 0 - unwait)
{
...
void hal_lpass_hdmi_output_dp_mute_stream_v1(uint16 stream_id, uint16 mute)
{
   //not support
   return;
}

void hal_lpass_hdmi_output_dp_cfg_audio_info_v1(hal_lpass_hdmi_output_dp_audioinfo_cfg_t audioinfo_cfg)
{
   //not support
   return;
}

void hal_lpass_hdmi_output_dp_engine_enable_v1(uint16 enable)
{
   //not support
   return;
}
...
void hal_lpass_hdmi_output_init_v1(hal_hdmi_output_func_def_t* func_table_ptr, uint32 phy_base, uint32 virt_base, uint32 reset_phy_base, uint32 reset_virt_base)
{
   ...
   if(func_table_ptr)
   {
      func_table_ptr->hal_lpass_hdmi_output_enable_dma_interrupt_fptr = hal_lpass_hdmi_output_enable_dma_interrupt_v1;
      func_table_ptr->hal_lpass_hdmi_output_enable_packet_update_interrupt_fptr = hal_lpass_hdmi_output_enable_packet_update_interrupt_v1;
      func_table_ptr->hal_lpass_hdmi_output_enable_packet_update_b_interrupt_fptr = hal_lpass_hdmi_output_enable_packet_update_b_interrupt_v1;
      func_table_ptr->hal_lpass_hdmi_outputt_read_interrupt_status_fptr = hal_lpass_hdmi_outputt_read_interrupt_status_v1;
      func_table_ptr->hal_lpass_hdmi_outputt_clear_interrupts_fptr = hal_lpass_hdmi_outputt_clear_interrupts_v1;
      func_table_ptr->hal_lpass_hdmi_output_check_dma_intr_fptr = hal_lpass_hdmi_output_check_dma_intr_v1;
      func_table_ptr->hal_lpass_hdmi_output_get_dma_int_stc_fptr = hal_lpass_hdmi_output_get_dma_int_stc_v1;
      func_table_ptr->hal_lpass_hdmi_output_get_dma_fifo_fptr = hal_lpass_hdmi_output_get_dma_fifo_v1;
      func_table_ptr->hal_lpass_hdmi_output_get_samples_in_dword_after_intr_fptr = hal_lpass_hdmi_output_get_samples_in_dword_after_intr_v1;
      func_table_ptr->hal_lpass_hdmi_output_enable_legacy_mode_fptr = hal_lpass_hdmi_output_enable_legacy_mode_v1;   
      func_table_ptr->hal_lpass_hdmi_output_enable_parity_hw_mode_fptr = hal_lpass_hdmi_output_enable_parity_hw_mode_v1;   
      func_table_ptr->hal_lpass_hdmi_output_cfg_ch_status_buf_fptr = hal_lpass_hdmi_output_cfg_ch_status_buf_v1;
      func_table_ptr->hal_lpass_hdmi_output_cfg_user_bits_buf_fptr = hal_lpass_hdmi_output_cfg_user_bits_buf_v1;
      func_table_ptr->hal_lpass_hdmi_output_enable_vbit_hw_mode_fptr = hal_lpass_hdmi_output_enable_vbit_hw_mode_v1;
      func_table_ptr->hal_lpass_hdmi_output_disable_vbit_hw_mode_fptr = hal_lpass_hdmi_output_disable_vbit_hw_mode_v1;

      func_table_ptr->hal_lpass_hdmi_output_ss_cfg_pack_trans_fptr = hal_lpass_hdmi_output_ss_cfg_pack_trans_v1;
      func_table_ptr->hal_lpass_hdmi_output_ss_enable_pack_trans_fptr = hal_lpass_hdmi_output_ss_enable_pack_trans_v1;   

      func_table_ptr->hal_lpass_hdmi_output_ms_cfg_pack_trans_fptr = hal_lpass_hdmi_output_ms_cfg_pack_trans_v1;
      func_table_ptr->hal_lpass_hdmi_output_ms_enable_pack_trans_fptr = hal_lpass_hdmi_output_ms_enable_pack_trans_v1;   
      func_table_ptr->hal_lpass_hdmi_output_ms_mute_stream_fptr = hal_lpass_hdmi_output_ms_mute_stream_v1;  
      func_table_ptr->hal_lpass_hdmi_output_ms_wait_bbit_fptr = hal_lpass_hdmi_output_ms_wait_bbit_v1;    

      func_table_ptr->hal_lpass_hdmi_output_dp_mute_stream_fptr = hal_lpass_hdmi_output_dp_mute_stream_v1;    
      func_table_ptr->hal_lpass_hdmi_output_dp_cfg_audio_info_fptr = hal_lpass_hdmi_output_dp_cfg_audio_info_v1;
      func_table_ptr->hal_lpass_hdmi_output_dp_engine_enable_fptr = hal_lpass_hdmi_output_dp_engine_enable_v1;
   }
