/*==============================================================================
$Header: //components/rel/avs.adsp/2.8/afe/drivers/afe/slimbus/src/AFESlimbusDriverUtils.cpp#11 $
...
$Header: //components/rel/avs.adsp/2.8/afe/drivers/afe/slimbus/src/AFESlimbusDriverUtils.cpp#11 $ $DateTime: 2018/01/11 11:19:00 $ $Author: pwbldsvc $
...
ADSPResult afe_sb_open_stream_ports(afe_slimbus_state_struct_t *p_dev_state)
{
  ...
  SlimBusResourceHandle h_master_port[AFE_DRIVER_SLIMBUS_MAX_CHANNEL_CNT];
  uint32_t virt_addr;
  uint32_t phy_addr = 0;
  uint16_t pipe_size;
  ...
  /*for multi end points, there is HW bug for which we need to add extra pipe memory for holding dummy 
    descriptor. This dummy descriptor will be submitted by SLIMBus driver*/
