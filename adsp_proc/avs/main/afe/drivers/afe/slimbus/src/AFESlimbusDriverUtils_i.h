...
/*==============================================================================
$Header: //components/rel/avs.adsp/2.8/afe/drivers/afe/slimbus/src/AFESlimbusDriverUtils_i.h#8 $
$DateTime: 2018/01/11 11:19:00 $
$Author: pwbldsvc $
$Change: 15219083 $
$Revision: #8 $
...
$Header: //components/rel/avs.adsp/2.8/afe/drivers/afe/slimbus/src/AFESlimbusDriverUtils_i.h#8 $ $DateTime: 2018/01/11 11:19:00 $ $Author: pwbldsvc $
...
#define SB_MAX_MASTER_PORTS_CNT             AFE_DRIVER_SLIMBUS_MAX_CHANNEL_CNT
...
typedef struct afe_slimbus_state_struct_t
{
  ...
  SlimBusResourceHandle h_data_channel[AFE_DRIVER_SLIMBUS_MAX_CHANNEL_CNT];
