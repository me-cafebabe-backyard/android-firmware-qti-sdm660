/*==============================================================================
$Header: //components/rel/avs.adsp/2.8/afe/drivers/afe/tdmif/common/src/AFETdmGroupDevice.cpp#5 $
...
static ADSPResult afe_configure_tdm_group_device (afe_param_id_group_device_tdm_cfg_t *p_group_dev_tdm_cfg)
{
   ...
   if(p_group_dev_tdm_cfg->num_channels > AFE_DRIVER_TDM_MAX_CHANNEL_CNT)
   {
