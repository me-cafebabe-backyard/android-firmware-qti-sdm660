/*==============================================================================
$Header: //components/rel/avs.adsp/2.8/afe/drivers/afe/usba/src/AFEUSBAudioDriver.cpp#9 $
...
$Header: //components/rel/avs.adsp/2.8/afe/drivers/afe/usba/src/AFEUSBAudioDriver.cpp#9 $ $DateTime: 2018/01/11 11:19:00 $ $Author: pwbldsvc $
    ...
    case AFE_PARAM_ID_USB_AUDIO_CONFIG:
    {
      ...
      switch(cfg_ver)
      {
        case 1:
        {
          ...
          if((p_usba_cfg->num_channels < 1) || (p_usba_cfg->num_channels > AFE_DRIVER_USBA_MAX_CHANNEL_CNT))
          {
