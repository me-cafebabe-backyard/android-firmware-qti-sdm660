/*==============================================================================
$Header: //components/rel/avs.adsp/2.8/afe/drivers/afe/dma_manager/common/src/AFEHalDmaFuncWrapper.cpp#6 $
      ...
      if (0 != dma_hw_info_ptr->hw_revision)
      {
         switch (dma_type)
         {
            case LPASS_HW_DMA_TYPE0:
            {
               ...
               else if ((LPASS_HW_VER_4_2_0 == dma_hw_info_ptr->hw_revision) || (LPASS_HW_VER_4_2_1 == dma_hw_info_ptr->hw_revision))
               {
            ...
            case LPASS_HW_DMA_TYPE1:
            {
               ...
               if (LPASS_HW_VER_4_0_0 == dma_hw_info_ptr->hw_revision)
               {
                  hal_dma_init_type1(&afe_hal_func_def[LPASS_HW_DMA_TYPE1],
                        ...
                        (LPASS_HW_VER_4_2_1 == dma_hw_info_ptr->hw_revision))
               {
