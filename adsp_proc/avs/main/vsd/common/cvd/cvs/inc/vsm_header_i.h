...
/*
  ...
  $Header: //components/rel/avs.adsp/2.8/vsd/common/cvd/cvs/inc/vsm_header_i.h#21 $
  $Author: pwbldsvc $
*/
...
#define VSM_VOICE_FRAME_SIZE_US (20000)
...
typedef struct vsm_pcie_settings_t
{
  uint32_t tx_port_id;
  uint32_t rx_port_id;
}
...
typedef struct vsm_session_settings_t
{
  ...
  vsm_pcie_settings_t pcie_config;
}
