...
/*
  ...
  $Header: //components/rel/avs.adsp/2.8/vsd/common/cvd/cvs/inc/vsm_common_i.h#20 $
  $Author: pwbldsvc $
*/
...
#define VSM_IS_PCIE_PORT(obj) ( IS_PCIE_PORT_AFE_ID((obj)->tx_port_id) && IS_PCIE_PORT_AFE_ID((obj)->rx_port_id) )
...
ADSPResult vsm_action_pcie_connect_afe_tx(
  vsm_session_object_t* session_object
);
