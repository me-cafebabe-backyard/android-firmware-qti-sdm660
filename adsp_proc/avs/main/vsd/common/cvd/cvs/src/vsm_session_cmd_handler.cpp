/*
  ...
  $Header: //components/rel/avs.adsp/2.8/vsd/common/cvd/cvs/src/vsm_session_cmd_handler.cpp#34 $
  $Author: pwbldsvc $
*/
  ...
  for ( ; ; )
  {
    switch ( session_object->cmd_control.current_action )
    {
      ...
      case VSM_ACTION_ENUM_COMPLETE:
      {
        ...
        if( VSM_IS_PCIE_PORT( &session_object->active_set.pcie_config ) )
        {
        	apr_pkt->dst_port = session_object->active_set.attach_detach_vocproc_handle;
        	apr_pkt->dst_addr = vsm_cvp_addr;
        	MSG_1( MSG_SSID_DFLT, MSG_LEGACY_MED,"VSM_volume_mute_v2_cmd_control: command Success: port %d",   
...
static int32_t VSM_stream_disable_cmd_control( vsm_session_object_t* session_object )
{
  ...
  {
    VSM_ACTION_ENUM_UNINITIALIZED,
    VSM_ACTION_ENUM_RESET_VOICE_TIMING_TO_AFE_1,
    VSM_ACTION_ENUM_RESET_VOICE_TIMING_TO_AFE_RESPONSE_WAIT_2,
    VSM_ACTION_ENUM_PCIE_DISCONNECT_WITH_AFE_3,
    VSM_ACTION_ENUM_PCIE_DISCONNECT_WITH_AFE_WAIT_4,
    VSM_ACTION_ENUM_PCIE_DISCONNECT_DOWN_STREAM_5,
    VSM_ACTION_ENUM_PCIE_DISCONNECT_DOWN_STREAM_WAIT_6,
    VSM_ACTION_ENUM_STOP_RECORD_7,
    VSM_ACTION_ENUM_STOP_PLAYBACK_8,
    VSM_ACTION_ENUM_STOP_SERVICES_9,
    VSM_ACTION_ENUM_WAIT_10,
    VSM_ACTION_ENUM_STOP_PORTS_11,
    VSM_ACTION_ENUM_WAIT_12,
    VSM_ACTION_ENUM_SEND_DISABLE_NOTIFICATIONS_TO_CLIENT_13,
    VSM_ACTION_ENUM_ERROR_HANDLE,
    VSM_ACTION_ENUM_REPORT_FAILURE,
    VSM_ACTION_ENUM_COMPLETE,
    VSM_ACTION_ENUM_INVALID
  ...
  while ( VSM_ACTION_ENUM_UNINITIALIZED == session_object->cmd_control.current_action )
  {
    ...
    session_object->cmd_control.current_action = VSM_ACTION_ENUM_RESET_VOICE_TIMING_TO_AFE_1; 
    break;
  }
  ...
  for ( ; ; )
  {
    switch ( session_object->cmd_control.current_action )
    {
      case VSM_ACTION_ENUM_RESET_VOICE_TIMING_TO_AFE_1:
      {        
        rc = vsm_action_clear_voice_timing_to_afe( session_object );
        if( ADSP_FAILED( rc ) )
        {
          session_object->cmd_control.cmd_result = ADSP_EFAILED;
          session_object->cmd_control.current_action = VSM_ACTION_ENUM_ERROR_HANDLE;
        ...
        else 
        {
          if ( TRUE == session_object->cmd_control.is_resp_pending )
          {
            session_object->cmd_control.current_action = VSM_ACTION_ENUM_RESET_VOICE_TIMING_TO_AFE_RESPONSE_WAIT_2;
            return ADSP_EOK;
          }
          else
          {
            session_object->cmd_control.current_action = VSM_ACTION_ENUM_PCIE_DISCONNECT_WITH_AFE_3;
            continue;
          }
        }
      }
      ...
      case VSM_ACTION_ENUM_RESET_VOICE_TIMING_TO_AFE_RESPONSE_WAIT_2:
      {
        if ( ADSP_FAILED( session_object->cmd_control.resp_result ) )
        {
          session_object->cmd_control.cmd_result = session_object->cmd_control.resp_result;
      ...
      break;
      case VSM_ACTION_ENUM_PCIE_DISCONNECT_WITH_AFE_3:
    	{
      	if ( TRUE == VSM_IS_PCIE_PORT(&session_object->active_set.pcie_config ) )
      	{    	        
	        rc = vsm_action_pcie_disconnect_afe( session_object );
	        if ( ADSP_FAILED( rc ) )
	        {
	          session_object->cmd_control.cmd_result = ADSP_EFAILED;
	          session_object->cmd_control.current_action = VSM_ACTION_ENUM_ERROR_HANDLE;
        ...
        if ( TRUE == session_object->cmd_control.is_resp_pending  )
        {
        	session_object->cmd_control.current_action = VSM_ACTION_ENUM_PCIE_DISCONNECT_WITH_AFE_WAIT_4;
        	return ADSP_EOK;        
        }
        else
        {
          session_object->cmd_control.current_action = VSM_ACTION_ENUM_PCIE_DISCONNECT_DOWN_STREAM_5;
          continue;
        }        
      }
      case VSM_ACTION_ENUM_PCIE_DISCONNECT_WITH_AFE_WAIT_4:
      {
        if ( ADSP_FAILED( session_object->cmd_control.resp_result ) )
        {
          session_object->cmd_control.cmd_result = session_object->cmd_control.resp_result;
      ...
      break;
      case VSM_ACTION_ENUM_PCIE_DISCONNECT_DOWN_STREAM_5:
      {
      	if ( TRUE == VSM_IS_PCIE_PORT(&session_object->active_set.pcie_config)  )
      	{
        	rc = vsm_action_disconnect_afe_rx_downstream( session_object );
        }                    
        if( ADSP_FAILED( rc ) )
        {
          session_object->cmd_control.cmd_result = ADSP_EFAILED;
        ...
        if ( TRUE == session_object->cmd_control.is_resp_pending )
        {
        	session_object->cmd_control.current_action = VSM_ACTION_ENUM_PCIE_DISCONNECT_DOWN_STREAM_WAIT_6;
        	return ADSP_EOK;        
        }
        else
        {
          session_object->cmd_control.current_action = VSM_ACTION_ENUM_STOP_RECORD_7;
          continue;
        }        
      }
      case VSM_ACTION_ENUM_PCIE_DISCONNECT_DOWN_STREAM_WAIT_6:
      {
        if ( ADSP_FAILED( session_object->cmd_control.resp_result ) )
        {
          session_object->cmd_control.cmd_result = session_object->cmd_control.resp_result;
      ...
      break;
      case VSM_ACTION_ENUM_STOP_RECORD_7:
      {
        if ( VSM_ENABLED == session_object->active_set.record.enable_flag )
        {
          rc = vsm_utility_record_control_stop( session_object );
          ...
          {
            session_object->cmd_control.current_action = VSM_ACTION_ENUM_STOP_PLAYBACK_8;
            continue;
          }
        }
        else
      ...
      case VSM_ACTION_ENUM_STOP_PLAYBACK_8:
      {
        if ( VSM_ENABLED == session_object->active_set.playback.enable_flag )
        {
          rc = vsm_utility_playback_control_stop( session_object );
          ...
          {
            session_object->cmd_control.current_action = VSM_ACTION_ENUM_STOP_SERVICES_9;
            continue;
          }
        }
        else
      ...
      case VSM_ACTION_ENUM_STOP_SERVICES_9:
      {
      ...
      case VSM_ACTION_ENUM_WAIT_10:
      {
        ...
        {
          session_object->cmd_control.current_action = VSM_ACTION_ENUM_STOP_PORTS_11;
        }
        continue;
      }
      break;

      case VSM_ACTION_ENUM_STOP_PORTS_11:
      {
        ...
        else
        {
          ...
          {
          	session_object->cmd_control.current_action = VSM_ACTION_ENUM_SEND_DISABLE_NOTIFICATIONS_TO_CLIENT_13;
          	continue;
          }       
        }
      }
      ...
      case VSM_ACTION_ENUM_SEND_DISABLE_NOTIFICATIONS_TO_CLIENT_13:
      {
...
static int32_t VSM_stream_enable_cmd_control( vsm_session_object_t* session_object )
{
  ...
  {
    VSM_ACTION_ENUM_UNINITIALIZED,
    VSM_ACTION_ENUM_PCIE_DISCONNECT_DOWNSTREAM_1,
    VSM_ACTION_ENUM_WAIT_2,
    VSM_ACTION_ENUM_CLOSE_MIXER_INPUT_PORTS_3,
    VSM_ACTION_ENUM_WAIT_4,
    VSM_ACTION_ENUM_PCIE_CONNECT_WITH_AFE_5,
    VSM_ACTION_ENUM_PCIE_CONNECT_WITH_AFE_WAIT_6,
    VSM_ACTION_ENUM_PCIE_CONNECT_DOWN_STREAM_7,
    VSM_ACTION_ENUM_PCIE_CONNECT_DOWN_STREAM_WAIT_8,
    VSM_ACTION_ENUM_RECONFIG_MAILBOX_TIMING_9,
    VSM_ACTION_ENUM_RECONFIG_MAILBOX_TIMING_RESPONSE_WAIT_10,
    VSM_ACTION_ENUM_SET_VOICE_TIMING_11,
    VSM_ACTION_ENUM_SET_VOICE_TIMING_RESPONSE_WAIT_12,
    VSM_ACTION_ENUM_SET_VOICE_TIMING_TO_AFE_13,
    VSM_ACTION_ENUM_SET_VOICE_TIMING_TO_AFE_RESPONSE_WAIT_14,
    VSM_ACTION_ENUM_SET_TX_RX_MUTE_15,
    VSM_ACTION_ENUM_SET_TX_RX_MUTE_RESPONSE_WAIT_16,
    VSM_ACTION_ENUM_SET_UI_PROPERTIES_17,
    VSM_ACTION_ENUM_SET_UI_PROPERTIES_RESPONSE_WAIT_18,
    VSM_ACTION_ENUM_UPDATE_TTY_MODE_19,
    VSM_ACTION_ENUM_UPDATE_TTY_MODE_RESPONSE_WAIT_20,
    VSM_ACTION_ENUM_SEND_ENABLE_NOTIFICATIONS_TO_CLIENT_21,
    VSM_ACTION_ENUM_RUN_PORTS_22,
    VSM_ACTION_ENUM_RUN_PORTS_RESPONSE_WAIT_23,
    VSM_ACTION_ENUM_RUN_SERVICES_24,
    VSM_ACTION_ENUM_RUN_SERVICES_RESPONSE_WAIT_25,
    VSM_ACTION_ENUM_START_RECORD_26,
    VSM_ACTION_ENUM_START_PLAYBACK_27,
    VSM_ACTION_ENUM_ERROR_HANDLE,
    VSM_ACTION_ENUM_REPORT_FAILURE,
    VSM_ACTION_ENUM_COMPLETE,
    VSM_ACTION_ENUM_INVALID
  ...
  while ( VSM_ACTION_ENUM_UNINITIALIZED == session_object->cmd_control.current_action )
  {
    ...
    session_object->cmd_control.current_action = VSM_ACTION_ENUM_PCIE_DISCONNECT_DOWNSTREAM_1;    
    break;
  }
  ...
  for ( ; ; )
  {
    switch ( session_object->cmd_control.current_action )
    {
      case VSM_ACTION_ENUM_PCIE_DISCONNECT_DOWNSTREAM_1:
      {
        if ( ( TRUE == VSM_IS_PCIE_PORT(&session_object->target_set.pcie_config) )&& 
             ( FALSE == VSM_IS_PCIE_PORT(&session_object->active_set.pcie_config) ) )
        {
        	rc = vsm_action_disconnect_rx_downstream( session_object );
        }        
        if ( ADSP_FAILED( rc ) )
        {
          session_object->cmd_control.cmd_result = ADSP_EFAILED;
        ...
        {
        	session_object->cmd_control.current_action = VSM_ACTION_ENUM_CLOSE_MIXER_INPUT_PORTS_3;
        	continue;
        }        
      }
      break;
      ...
      case VSM_ACTION_ENUM_CLOSE_MIXER_INPUT_PORTS_3:
      {
      	if ( ( TRUE == VSM_IS_PCIE_PORT(&session_object->target_set.pcie_config) )&& 
             ( FALSE == VSM_IS_PCIE_PORT(&session_object->active_set.pcie_config) ) )
        {     	
        ...
        else
        {
          ...
          {
          	session_object->cmd_control.current_action = VSM_ACTION_ENUM_PCIE_CONNECT_WITH_AFE_5;
	        continue;
          }
        }
      }
      ...
      break;
      case VSM_ACTION_ENUM_PCIE_CONNECT_WITH_AFE_5:
      {
        if ( TRUE == VSM_IS_PCIE_PORT(&session_object->target_set.pcie_config ) )
        {    	        
          rc = vsm_action_pcie_connect_afe( session_object );
          if ( ADSP_FAILED( rc ) )
          {
            session_object->cmd_control.cmd_result = ADSP_EFAILED;
            session_object->cmd_control.current_action = VSM_ACTION_ENUM_ERROR_HANDLE;
        ...
        if ( TRUE == session_object->cmd_control.is_resp_pending )
        {
          session_object->cmd_control.current_action = VSM_ACTION_ENUM_PCIE_CONNECT_WITH_AFE_WAIT_6;
          return ADSP_EOK;        
        }
        else
        {
          session_object->cmd_control.current_action = VSM_ACTION_ENUM_PCIE_CONNECT_DOWN_STREAM_7;
          continue;
        }        
      }
      break;
      case VSM_ACTION_ENUM_PCIE_CONNECT_WITH_AFE_WAIT_6:
      {
        if ( ADSP_FAILED( session_object->cmd_control.resp_result ) )
        {
          session_object->cmd_control.cmd_result = session_object->cmd_control.resp_result;
      ...
      break;
      case VSM_ACTION_ENUM_PCIE_CONNECT_DOWN_STREAM_7:
      {
      	if ( TRUE == VSM_IS_PCIE_PORT(&session_object->target_set.pcie_config)  )
      	{
        	rc = vsm_action_connect_afe_rx_downstream( session_object );
        }                    
        if( ADSP_FAILED( rc ) )
        {
          session_object->cmd_control.cmd_result = ADSP_EFAILED;
        ...
        if ( TRUE == session_object->cmd_control.is_resp_pending  )
        {
        	session_object->cmd_control.current_action = VSM_ACTION_ENUM_PCIE_CONNECT_DOWN_STREAM_WAIT_8;
        	return ADSP_EOK;        
        }
        else
        {
          session_object->cmd_control.current_action = VSM_ACTION_ENUM_SET_VOICE_TIMING_11;
          continue;
        }        
      }
      break;
      case VSM_ACTION_ENUM_PCIE_CONNECT_DOWN_STREAM_WAIT_8:
      {
        if ( ADSP_FAILED( session_object->cmd_control.resp_result ) )
        {
          session_object->cmd_control.cmd_result = session_object->cmd_control.resp_result;
      ...
      break;
      case VSM_ACTION_ENUM_RECONFIG_MAILBOX_TIMING_9:
      {
        ...
        {
          session_object->cmd_control.current_action = VSM_ACTION_ENUM_RECONFIG_MAILBOX_TIMING_RESPONSE_WAIT_10;
          return ADSP_EOK;
        }
      }
      break;

      case VSM_ACTION_ENUM_RECONFIG_MAILBOX_TIMING_RESPONSE_WAIT_10:
      {
        if ( ADSP_FAILED( session_object->cmd_control.resp_result ) )
        {
          session_object->cmd_control.cmd_result = session_object->cmd_control.resp_result;
      ...
      case VSM_ACTION_ENUM_SET_VOICE_TIMING_11:
      {
        ...
        {
          session_object->cmd_control.current_action = VSM_ACTION_ENUM_SET_VOICE_TIMING_RESPONSE_WAIT_12;
          return ADSP_EOK;
        }
      }
      break;

      case VSM_ACTION_ENUM_SET_VOICE_TIMING_RESPONSE_WAIT_12:
      {
        if ( ADSP_FAILED( session_object->cmd_control.resp_result ) )
        {
          session_object->cmd_control.cmd_result = session_object->cmd_control.resp_result;
        ...
        {
          session_object->active_set.media_id = session_object->target_set.media_id;
          session_object->cmd_control.current_action = VSM_ACTION_ENUM_SET_VOICE_TIMING_TO_AFE_13;
        }
        continue;
      }
      break;
      
      case VSM_ACTION_ENUM_SET_VOICE_TIMING_TO_AFE_13:
      {
        rc = vsm_action_set_voice_timing_to_afe( session_object );
        if( ADSP_FAILED( rc ) )
        {
          session_object->cmd_control.cmd_result = ADSP_EFAILED;
          session_object->cmd_control.current_action = VSM_ACTION_ENUM_ERROR_HANDLE;
        ...
        else 
        {
          if ( TRUE == session_object->cmd_control.is_resp_pending )
          {
            session_object->cmd_control.current_action = VSM_ACTION_ENUM_SET_VOICE_TIMING_TO_AFE_RESPONSE_WAIT_14;
            return ADSP_EOK;
          }
          else
          {
            session_object->cmd_control.current_action = VSM_ACTION_ENUM_SET_TX_RX_MUTE_15;
            continue;
          }
        }
      }
      ...
      case VSM_ACTION_ENUM_SET_VOICE_TIMING_TO_AFE_RESPONSE_WAIT_14:
      {
        if ( ADSP_FAILED( session_object->cmd_control.resp_result ) )
        {
          session_object->cmd_control.cmd_result = session_object->cmd_control.resp_result;
      ...
      case VSM_ACTION_ENUM_SET_TX_RX_MUTE_15:
      {
        ...
        else
        {
          if ( TRUE == session_object->cmd_control.is_resp_pending )
          {
            session_object->cmd_control.current_action = VSM_ACTION_ENUM_SET_TX_RX_MUTE_RESPONSE_WAIT_16;
            return ADSP_EOK;
          }
          else
          {
            session_object->cmd_control.current_action = VSM_ACTION_ENUM_SET_UI_PROPERTIES_17;
            continue;
          }
        }
      }
      ...
      case VSM_ACTION_ENUM_SET_TX_RX_MUTE_RESPONSE_WAIT_16:
      {
        if ( ADSP_FAILED( session_object->cmd_control.resp_result ) )
        {
          session_object->cmd_control.cmd_result = session_object->cmd_control.resp_result;
        ...
        else
        {
          ...
          {
            session_object->cmd_control.current_action = VSM_ACTION_ENUM_UPDATE_TTY_MODE_19;
          }
        }
        continue;
      }
      ...
      case VSM_ACTION_ENUM_SET_UI_PROPERTIES_17:
      {
        rc = vsm_action_set_ui_properties( session_object );
        if ( ADSP_FAILED( rc ) )
        {
        ...
        {
          session_object->cmd_control.current_action = VSM_ACTION_ENUM_SET_UI_PROPERTIES_RESPONSE_WAIT_18;
          return ADSP_EOK;
        }
      }
      break;

      case VSM_ACTION_ENUM_SET_UI_PROPERTIES_RESPONSE_WAIT_18:
      {
        if ( ADSP_FAILED( session_object->cmd_control.resp_result ) )
        {
      ...
      case VSM_ACTION_ENUM_UPDATE_TTY_MODE_19:
      {
        ...
        {
          session_object->cmd_control.current_action = VSM_ACTION_ENUM_UPDATE_TTY_MODE_RESPONSE_WAIT_20;
          return ADSP_EOK;
        }
      }
      break;

      case VSM_ACTION_ENUM_UPDATE_TTY_MODE_RESPONSE_WAIT_20:
      {
        if ( ADSP_FAILED( session_object->cmd_control.resp_result ) )
        {
          session_object->cmd_control.cmd_result = session_object->cmd_control.resp_result;
        ...
        {
          session_object->cmd_control.current_action = VSM_ACTION_ENUM_SEND_ENABLE_NOTIFICATIONS_TO_CLIENT_21;
        }
        continue;
      }
      break;

      case VSM_ACTION_ENUM_SEND_ENABLE_NOTIFICATIONS_TO_CLIENT_21:
      {
        ( void )vsm_action_send_enable_notifications_to_clients( session_object );
        session_object->cmd_control.current_action = VSM_ACTION_ENUM_RUN_PORTS_22;
        continue;
      }
      break;

      case VSM_ACTION_ENUM_RUN_PORTS_22:
      {
        ...
        else
        {
          if ( TRUE == session_object->cmd_control.is_resp_pending )
          {
          	session_object->cmd_control.current_action = VSM_ACTION_ENUM_RUN_PORTS_RESPONSE_WAIT_23;
          	return ADSP_EOK;
          }
          else
          {
          	session_object->cmd_control.current_action = VSM_ACTION_ENUM_RUN_SERVICES_24;
          	continue;
          }
        }
      }
      ...
      case VSM_ACTION_ENUM_RUN_PORTS_RESPONSE_WAIT_23:
      {
        if ( ADSP_FAILED( session_object->cmd_control.resp_result ) )
        {
          session_object->cmd_control.cmd_result = session_object->cmd_control.resp_result;
      ...
      case VSM_ACTION_ENUM_RUN_SERVICES_24:
      {
        ...
        {
          session_object->cmd_control.current_action = VSM_ACTION_ENUM_RUN_SERVICES_RESPONSE_WAIT_25;
          return ADSP_EOK;
        }
      }
      break;

      case VSM_ACTION_ENUM_RUN_SERVICES_RESPONSE_WAIT_25:
      {
        if ( ADSP_FAILED( session_object->cmd_control.resp_result ) )
        {
          session_object->cmd_control.cmd_result = session_object->cmd_control.resp_result;
        ...
        else
        {
          ...
          session_object->cmd_control.current_action = VSM_ACTION_ENUM_START_RECORD_26;
        }
        continue;
      }
      break;

      case VSM_ACTION_ENUM_START_RECORD_26:
      {
        if ( VSM_ENABLED == session_object->active_set.record.enable_flag )
        {
          rc = vsm_utility_record_control_start( session_object );
          ...
          {
            session_object->cmd_control.current_action = VSM_ACTION_ENUM_START_PLAYBACK_27;
            continue;
          }
        }
        else
      ...
      case VSM_ACTION_ENUM_START_PLAYBACK_27:
      {
        if ( VSM_ENABLED == session_object->active_set.playback.enable_flag )
        {
          rc = vsm_utility_playback_control_start( session_object );
      ...
      case VSM_ACTION_ENUM_COMPLETE:
      {
        ...
        elite_apr_if_end_cmd( vsm_apr_handle, apr_pkt, ADSP_EOK );
        session_object->cmd_control.is_cmd_pending = FALSE;
        session_object->active_set.pcie_config.tx_port_id = session_object->target_set.pcie_config.tx_port_id;
        session_object->active_set.pcie_config.rx_port_id = session_object->target_set.pcie_config.rx_port_id;
        return ADSP_EOK;
      }
      break;
...
)
{
  ...
  enum
  {
    ...
    VSM_ACTION_ENUM_WAIT_2,    
    VSM_ACTION_ENUM_REASSIGN_MIXER_INOUT_PORTS_3,
    VSM_ACTION_ENUM_WAIT_4,
    VSM_ACTION_ENUM_ERROR_HANDLE,
    VSM_ACTION_ENUM_REPORT_FAILURE,
    VSM_ACTION_ENUM_COMPLETE,
  ...
  for ( ; ; )
  {
    switch ( session_object->cmd_control.current_action )
    {
      ...
      case VSM_ACTION_ENUM_WAIT_2:
      {
        ...
        {
          session_object->cmd_control.current_action = VSM_ACTION_ENUM_REASSIGN_MIXER_INOUT_PORTS_3;
        }
        continue;
      }
      break;
      case VSM_ACTION_ENUM_REASSIGN_MIXER_INOUT_PORTS_3:
      {      	
...
static int32_t VSM_destroy_session_cmd_control( vsm_session_object_t* session_object )
{
  ...
  //Close timer
  if( session_object->vsm_timer_handle != NULL ) 
  {
    ( void ) qurt_elite_timer_close(session_object->vsm_timer_handle);
    session_object->vsm_timer_handle  = NULL;
  }
