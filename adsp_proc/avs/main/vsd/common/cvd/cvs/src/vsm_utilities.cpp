/*
  ...
  $Header: //components/rel/avs.adsp/2.8/vsd/common/cvd/cvs/src/vsm_utilities.cpp#27 $
  $Author: pwbldsvc $
*/
...
void vsm_utility_initialize_session_variables( vsm_session_object_t* session_obj )
{
  ...
  session_obj->vsm_timer_handle = NULL;
  ( void ) qurt_elite_timer_open(&(session_obj->vsm_timer_handle), (char *)"VSMTIMER"); 
