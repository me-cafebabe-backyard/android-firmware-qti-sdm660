...
$Header: //components/rel/avs.adsp/2.8/vsd/common/cvd/cvp/src/vpm_session_utils.h#14 $
...
#define VPM_IS_PCIE_PORT(obj) \
( (obj.tx_topology_id == VSS_IVOCPROC_TOPOLOGY_ID_NONE) && \
	(obj.rx_topology_id == VSS_IVOCPROC_TOPOLOGY_ID_NONE) && \
		( IS_PCIE_PORT_AFE_ID(obj.tx_port_id) && IS_PCIE_PORT_AFE_ID(obj.rx_port_id) ) ) 
