/*
  ...
  $Header: //components/rel/avs.adsp/2.8/vsd/common/cvd/cvd_devcfg/mpq8092/cvd_devcfg.c#2 $
  $Author: pwbldsvc $
*/
...
/**
  ...
  1. Voice use case <-> clock value table as follows: 
     ...
     -----------------------------------------------------------------------------------
     NONE +           |  100MHz/HW thread  |  150MHz/HW thread   |  150MHz/HW thread    |
     ANY VFR          |                    |                     |                      |
     -----------------------------------------------------------------------------------
     SM_ECNS +        |  100MHz/HW thread  |  150MHz/HW thread   |  150MHz/HW thread    |
     any VFR mode     |                    |                     |                      |
     -----------------------------------------------------------------------------------
     DM_FLUENCE +     |  100MHz/HW thread  |  150MHz/HW thread   |  150MHz/HW thread    |
     any VFR mode     |                    |                     |
     -----------------------------------------------------------------------------------
     SM_FLUENCEV5 +   |  100MHz/HW thread  |  150MHz/HW thread   |  150MHz/HW thread    |
     any VFR mode     |                    |                     |
     -----------------------------------------------------------------------------------
     DM_VPECNS +      |  100MHz/HW thread  |  150MHz/HW thread   |  150MHz/HW thread    |
     any VFR mode     |                    |                     |                      |
     -----------------------------------------------------------------------------------
     DM_FLUENCEV5 +   |  100MHz/HW thread  |  150MHz/HW thread   |  150MHz/HW thread    |
     any VFR mode     |                    |                     |                      |
     -----------------------------------------------------------------------------------
     QM_FLUENCE_PRO + |  150MHz/HW thread  |  150MHz/HW thread   |  150MHz/HW thread    |
     any VFR mode     |                    |                     |                      |
...
static cvd_devcfg_clock_level_t cvd_devcfg_clock_levels[ 2 ] = 
  {
    { 100000000, 7, cvd_devcfg_clock_level_0_use_cases },
    { 150000000, 1, cvd_devcfg_clock_level_1_use_cases }
  };
