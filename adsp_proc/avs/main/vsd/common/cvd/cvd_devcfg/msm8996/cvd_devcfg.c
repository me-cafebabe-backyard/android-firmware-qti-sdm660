/*
  ...
  $Header: //components/rel/avs.adsp/2.8/vsd/common/cvd/cvd_devcfg/msm8996/cvd_devcfg.c#6 $
  $Author: pwbldsvc $
*/
...
#define CVD_DEVCFG_SVS2    (297000000)

#define CVD_DEVCFG_SVS     (460000000)

#define CVD_DEVCFG_NOMINAL (652000000)
