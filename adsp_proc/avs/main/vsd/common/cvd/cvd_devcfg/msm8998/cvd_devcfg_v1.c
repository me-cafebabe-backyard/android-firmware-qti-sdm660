/*
  ...
  $Header: //components/rel/avs.adsp/2.8/vsd/common/cvd/cvd_devcfg/msm8998/cvd_devcfg_v1.c#4 $
  $Author: pwbldsvc $
*/
...
/**
  ...
  1. Voice use case <-> floor clock value table as follows:
     ...
     -----------------------------------------------------------------------------------
     NONE +           |  297MHz           |  297MHz             |  652MHz              |
     any non-EVS +    |                   |                     |                      |
     any  VFR mode    |                   |                     |                      |
     -----------------------------------------------------------------------------------
     SM_ECNS +        |  297MHz           |  297MHz             |  652MHz              |
     any non-EVS +    |                   |                     |                      |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     SM_ECNS_V2 +     |  297MHz           |  297MHz             |  652MHz              |
     any non-EVS +    |                   |                     |                      |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     DM_FLUENCE +     |  297MHz           |  460MHz             |  652MHz              |
     any non-EVS +    |                   |                     |                      |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     SM_FLUENCEV5 +   |  297MHz           |  297MHz             |  652MHz              |
     any non-EVS +    |                   |                     |                      |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     SM_CUSTOM TOPOs+ |  297MHz           |  297MHz             |  652MHz              |
     any non-EVS +    |                   |                     |                      |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     DM_VPECNS +      |  297MHz           |  460MHz             |  652MHz              |
     any non-EVS +    |                   |                     |                      |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     DM_FLUENCEV5 +   |  297MHz           |  460MHz             |  652MHz              |
     any non-EVS +    |                   |                     |                      |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     DM_CUSTOM TOPOs+ |  297MHz           |  460MHz             |  652MHz              |
     any non-EVS +    |                   |                     |                      |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     DM_FV5 BROADSIDE +| 460MHz           |  652MHz             |  652MHz              |
     any non-EVS +    |                   |                     |                      |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     QM_FLUENCE_PRO + |  652MHz           |  652MHz             |  652MHz              |
     any non-EVS +    |                   |                     |                      |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     QM_FLUENCE_PROV2 |  652MHz           |  652MHz             | 652MHz               |
     any non-EVS +    |                   |                     |                      |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     QM_CUSTOM TOPOs +|  652MHz           |  652MHz             | 652MHz               |
     any non-EVS +    |                   |                     |                      |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     Any Tx Topology+ |  652MHz           |  652MHz             | 652MHz               |
     EVS media +      |                   |                     |                      |		 
     any VFR mode     |                   |                     |                      |
...
#define CVD_DEVCFG_V1_SVS2    (297000000)

#define CVD_DEVCFG_V1_SVS     (460000000)

#define CVD_DEVCFG_V1_NOMINAL (652000000)
...
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_v1_bw_level_0_use_cases[ ] =
  {
...
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_v1_bw_level_1_use_cases[ ] =
  {
...
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_v1_bw_level_2_use_cases[ ] =
  {
    /*  Use cases covered for EVS Media Type:
...
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_v1_bw_level_3_use_cases[ ] =
  {
...
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_v1_bw_level_4_use_cases[ ] =
  {
    /*  Use cases covered for each of the below topologies:
...
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_v1_bw_level_5_use_cases[ ] =
  {
    /* All other use cases */
    { CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT32_NA, CVD_UINT32_NA, CVD_UINT32_NA, CVD_UINT16_NA }
  };
  ...
  {
    {
      ...
      CVD_DEVCFG_SIZEOF_ARRAY(cvd_devcfg_v1_bw_level_0_use_cases),
        cvd_devcfg_v1_bw_level_0_use_cases
    },
    {
      {
        .busRoute = { MMPM_BW_PORT_ID_ADSP_MASTER, MMPM_BW_PORT_ID_DDR_SLAVE },
      ...
      CVD_DEVCFG_SIZEOF_ARRAY(cvd_devcfg_v1_bw_level_1_use_cases),
        cvd_devcfg_v1_bw_level_1_use_cases
   },
   {
      {
         .busRoute = { MMPM_BW_PORT_ID_ADSP_MASTER, MMPM_BW_PORT_ID_DDR_SLAVE },
      ...
      CVD_DEVCFG_SIZEOF_ARRAY(cvd_devcfg_v1_bw_level_2_use_cases),
      cvd_devcfg_v1_bw_level_2_use_cases
   },
   {
      {
         .busRoute = { MMPM_BW_PORT_ID_ADSP_MASTER, MMPM_BW_PORT_ID_DDR_SLAVE },
      ...
      CVD_DEVCFG_SIZEOF_ARRAY(cvd_devcfg_v1_bw_level_3_use_cases),
      cvd_devcfg_v1_bw_level_3_use_cases
   },
   {
      {
         .busRoute = { MMPM_BW_PORT_ID_ADSP_MASTER, MMPM_BW_PORT_ID_DDR_SLAVE },
      ...
      CVD_DEVCFG_SIZEOF_ARRAY(cvd_devcfg_v1_bw_level_4_use_cases),
      cvd_devcfg_v1_bw_level_4_use_cases
   },
   {
      {
         .busRoute = { MMPM_BW_PORT_ID_ADSP_MASTER, MMPM_BW_PORT_ID_DDR_SLAVE },
      ...
      CVD_DEVCFG_SIZEOF_ARRAY(cvd_devcfg_v1_bw_level_5_use_cases),
      cvd_devcfg_v1_bw_level_5_use_cases
    }
  };
...
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_v1_clock_level_0_use_cases[ ] =
  {
    /* All Quad Mic use cases. */
    { 1, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, VPM_TX_QM_FLUENCE_PROV2,CVD_UINT32_NA, CVD_UINT32_NA, CVD_UINT16_NA }
  };

static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_v1_clock_level_1_use_cases[ ] =
  {
    /*  Use cases covered for EVS Media Type:
        1 voice session -> NB Stream -> NB/WB/SWB/FBP VocProc
        1 voice session -> WB Stream -> NB/WB/SWB/FBP VocProc
...
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_v1_clock_level_2_use_cases[ ] =
  {
    /*  Use cases covered for EVS Media Type:
        1 voice session -> SWB Stream -> NB/WB/SWB/FBP VocProc
        1 voice session -> FB Stream  -> NB/WB/SWB/FBP VocProc 
...
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_v1_clock_level_3_use_cases[ ] =
  {
    /*  Use cases covered for each of the below topologies:
        1 voice session -> NB Stream -> NB/WB(WVE) VocProc
        1 voice session -> WB Stream -> WB VocProc 
...
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_v1_clock_level_4_use_cases[ ] =
  {
    /*  Use cases covered for each of the below topologies:
        1 voice session -> NB Stream -> WB VocProc
        1 voice session -> WB Stream -> WB VocProc
...
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_v1_clock_level_5_use_cases[ ] =
  {
    /* All other use cases */
    { CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT16_NA, CVD_UINT32_NA, CVD_UINT32_NA, CVD_UINT32_NA, CVD_UINT16_NA }
  };

static cvd_devcfg_clock_level_t cvd_devcfg_v1_clock_levels[ ] =
  {
    { CVD_DEVCFG_V1_NOMINAL, CVD_DEVCFG_SIZEOF_ARRAY(cvd_devcfg_v1_clock_level_0_use_cases), cvd_devcfg_v1_clock_level_0_use_cases },
    { CVD_DEVCFG_V1_SVS, CVD_DEVCFG_SIZEOF_ARRAY(cvd_devcfg_v1_clock_level_1_use_cases), cvd_devcfg_v1_clock_level_1_use_cases },
    { CVD_DEVCFG_V1_NOMINAL, CVD_DEVCFG_SIZEOF_ARRAY(cvd_devcfg_v1_clock_level_2_use_cases), cvd_devcfg_v1_clock_level_2_use_cases },
    { CVD_DEVCFG_V1_SVS2, CVD_DEVCFG_SIZEOF_ARRAY(cvd_devcfg_v1_clock_level_3_use_cases), cvd_devcfg_v1_clock_level_3_use_cases },
    { CVD_DEVCFG_V1_SVS, CVD_DEVCFG_SIZEOF_ARRAY(cvd_devcfg_v1_clock_level_4_use_cases), cvd_devcfg_v1_clock_level_4_use_cases },
    { CVD_DEVCFG_V1_NOMINAL, CVD_DEVCFG_SIZEOF_ARRAY(cvd_devcfg_v1_clock_level_5_use_cases), cvd_devcfg_v1_clock_level_5_use_cases }
  };

cvd_devcfg_clock_table_t cvd_devcfg_clock_table =
  { CVD_DEVCFG_SIZEOF_ARRAY(cvd_devcfg_v1_clock_levels), cvd_devcfg_v1_clock_levels };
