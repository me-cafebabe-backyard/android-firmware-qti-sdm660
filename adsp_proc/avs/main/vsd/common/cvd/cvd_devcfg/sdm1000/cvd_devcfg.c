/*
  ...
  $Header: //components/rel/avs.adsp/2.8/vsd/common/cvd/cvd_devcfg/sdm1000/cvd_devcfg.c#1 $
  $Author: pwbldsvc $
*/
...
/**
  ...
  1. Voice use case <-> floor clock value table as follows:
    ...
    evs-swb                 svs_L1      NA      minSVS      minSVS      NA      NA
    ...
    evs-swb                 svs_L1      NA      nom        NA           minSVS      minSVS      svs2    svs2        svs2      svs2
...
#define CVD_DEVCFG_MINSVS  (364800000)

#define CVD_DEVCFG_SVS2    (576000000)

#define CVD_DEVCFG_SVS     (768000000)

#define CVD_DEVCFG_SVS_L1  (960000000)

#define CVD_DEVCFG_NOMINAL (1171200000)

#define CVD_DEVCFG_NOMINAL_L1 (1324800000)
...
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_clock_level_0_use_cases[ ] =
  {
    ...
    */
    ...
    /*  Use case of EVS-NB/EVS-WB/EVS-SWB with DM_FV5/DM_FV5_BROADSIDE

        1 voice session -> EVS-NB/EVS-WB/EVS-SWB stream -> DM_FV5. RTD: 94.11ms (EVS-NB),100.06ms (EVS-WB), 123.083 (EVS-SWB)
        1 voice session -> EVS-NB/EVS-WB/EVS-SWB stream -> DM_FV5_BROADSIDE. RTD: 91.93ms (EVS-NB), 104.27ms (EVS-WB), 123.78 (EVS-SWB)
        Allocate CVD_DEVCFG_MINSVS
    */
...
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_clock_level_1_use_cases[ ] =
  {
    ...
    */
    ...
    /*  Use case of EVS-FB with DM_FV5/DM_FV5_BROADSIDE

        1 voice session -> EVS-FB stream -> DM_FV5. RTD: 113.29ms.
        1 voice session -> EVS-FB stream -> DM_FV5_BROADSIDE. RTD: 113.71ms.
        Allocate CVD_DEVCFG_SVS2
    */
