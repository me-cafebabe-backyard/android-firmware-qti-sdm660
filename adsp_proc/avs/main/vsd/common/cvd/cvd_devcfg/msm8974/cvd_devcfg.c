/*
  ...
  $Header: //components/rel/avs.adsp/2.8/vsd/common/cvd/cvd_devcfg/msm8974/cvd_devcfg.c#2 $
  $Author: pwbldsvc $
*/
...
/**
  ...
  1. Voice use case <-> clock value table as follows: 
     ...
     -----------------------------------------------------------------------------------
     ANY +            |                   |  113MHz/HW thread   |  163MHz/HW thread    |
     SOFT VFR         |                   |                     |                      |                      
     -----------------------------------------------------------------------------------
     NONE +           |  81MHz/HW thread  |  163MHz/HW thread   |  163MHz/HW thread    |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     SM_ECNS +        |  81MHz/HW thread  |  163MHz/HW thread   |  163MHz/HW thread    |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     DM_FLUENCE +     |  81MHz/HW thread  |  163MHz/HW thread   |  163MHz/HW thread    |
     any VFR mode     |                   |                     |
     -----------------------------------------------------------------------------------
     SM_FLUENCEV5 +   |  81MHz/HW thread  |  163MHz/HW thread   |  163MHz/HW thread    |
     any VFR mode     |                   |                     |
     -----------------------------------------------------------------------------------
     DM_VPECNS +      |  81MHz/HW thread  |  163MHz/HW thread   |  163MHz/HW thread    |
     any VFR mode     |                   |                     |
     -----------------------------------------------------------------------------------
     DM_FLUENCEV5 +   |  81MHz/HW thread  |  163MHz/HW thread   |  163MHz/HW thread    |
     any VFR mode     |                   |                     |                      |
     -----------------------------------------------------------------------------------
     QM_FLUENCE_PRO + |  163MHz/HW thread |  163MHz/HW thread   |  163MHz/HW thread    |
     any VFR mode     |                   |                     |                      |
...
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_clock_level_0_use_cases[ 6 ] =
  {
...
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_clock_level_1_use_cases[ 3 ] = 
  {
    ...
    { 1, 0, 0, 0, 1, 1, 0, 0, 0, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, VSS_ICOMMON_VFR_MODE_SOFT },
    { 1, 0, 0, 0, 1, 0, 1, 0, 0, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, VSS_ICOMMON_VFR_MODE_SOFT },
  };

static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_clock_level_2_use_cases[ 1 ] = 
  {  
    { 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFF }{ 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFFFFFF, 0xFFFF }
  };

static cvd_devcfg_clock_level_t cvd_devcfg_clock_levels[ 3 ] = 
  {
    { 81000000, 7, cvd_devcfg_clock_level_0_use_cases },
    { 113000000, 3, cvd_devcfg_clock_level_1_use_cases },
    { 163000000, 1, cvd_devcfg_clock_level_2_use_cases } 
  };
