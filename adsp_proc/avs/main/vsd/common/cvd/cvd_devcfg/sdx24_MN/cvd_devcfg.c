/*
  ...
  $Header: //components/rel/avs.adsp/2.8/vsd/common/cvd/cvd_devcfg/sdx24_MN/cvd_devcfg.c#2 $
  $Author: pwbldsvc $
*/
...
/* EVS-NB, EVS-WB with VPTX_NONE would need minSVS frequency */
static cvd_devcfg_supported_voice_use_case_t cvd_devcfg_clock_level_0_use_cases[ ] =
  {
    ...
    { 1, 0, 1, 0, 0, 0, 1, 0, 0, VPM_TX_NONE, CVD_UINT32_NA, VSS_MEDIA_ID_EVS, CVD_UINT16_NA }
  };

/* EVS-SWB, EVS-FB with VPTX_NONE would need SVS frequency */
...
/* 4GV-WB and 4GV-NW with VPTX_NONE would need SVS2 frequency */
...
/* All NB and other WB with VPTX_NONE would need minSVS frequency */
...
static cvd_devcfg_clock_level_t cvd_devcfg_clock_levels[ ] =
  {
    ...
    { CVD_DEVCFG_CLK_HZ_SVS, CVD_DEVCFG_SIZEOF_ARRAY(cvd_devcfg_clock_level_1_use_cases),  cvd_devcfg_clock_level_1_use_cases },
    { CVD_DEVCFG_CLK_HZ_SVS2, CVD_DEVCFG_SIZEOF_ARRAY(cvd_devcfg_clock_level_2_use_cases),  cvd_devcfg_clock_level_2_use_cases },
    { CVD_DEVCFG_CLK_HZ_minSVS, CVD_DEVCFG_SIZEOF_ARRAY(cvd_devcfg_clock_level_3_use_cases), cvd_devcfg_clock_level_3_use_cases }
  };
