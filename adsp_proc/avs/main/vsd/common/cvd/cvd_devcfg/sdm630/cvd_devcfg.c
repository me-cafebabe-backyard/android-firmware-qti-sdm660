/*
  ...
  $Header: //components/rel/avs.adsp/2.8/vsd/common/cvd/cvd_devcfg/sdm630/cvd_devcfg.c#3 $
  $Author: pwbldsvc $
*/
...
/**
  ...
  1. Voice use case <-> floor clock value table as follows:
    ...
    evs-nb                  minSVS      minSVS  minSVS      minSVS      NA      NA
    evs-wb                  svs2        minSVS  minSVS      svs2        NA      NA
    evs-swb                 svs_plus    NA      svs2        svs2        NA      NA
    evs-fb                  nom         NA      svs2        svs2        NA      NA
    ...
    evs-nb                  minSVS      minSVS  SVS2     NA         minSVS      minSVS      NA      NA          NA        svs2
    evs-wb                  svs2        minSVS  svs      NA         minSVS      svs2        NA      NA          NA        svs2
    evs-swb                 svs_plus    NA      nom      NA         svs2        svs2        NA      NA          NA        svs
    evs-fb                  nom         NA      nom      NA         svs2        svs2        NA      NA          NA        svs
