...
/*
  ...
  $Header: //components/rel/avs.adsp/2.8/vsd/inc/private/cvd_cal_log_i.h#4 $
  $Author: pwbldsvc $
*/
...
*/
  ...
  #define LOG_ADSP_CVD_CAL_DATA_C ( 0x1FFE )
#endif
...
*/
  ...
  #define LOG_ADSP_CVD_VP3_C ( 0x1FFF )
#endif
