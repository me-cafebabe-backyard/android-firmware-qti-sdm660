...
$Header: //components/rel/avs.adsp/2.8/api/audio/inc/adsp_asm_stream_commands.h#15 $
...
/** Parameter ID for decoder output channel mapping in the
    ...
    @msgpayload{asm_dec_out_chan_map_param_v2_t}
    @table{weak__asm__dec__out__chan__map__param__v2__t}
*/
#define ASM_PARAM_ID_DEC_OUTPUT_CHAN_MAP_V2                   0x00013223

/** Maximum number of decoder output channels with version 2 command. @newpage */
...
/** @weakgroup weak_asm_dec_out_chan_map_param_v2_t
@{ */
/* Payload of the ASM_PARAM_ID_DEC_OUTPUT_CHAN_MAP_V2 parameter in the
    ASM_PARAM_ID_DEC_OUTPUT_CHAN_MAP_V2 command.
    following this will be the dynamic payload for channel map based
    on number of channels.
*/
typedef struct asm_dec_out_chan_map_t asm_dec_out_chan_map_t;
struct asm_dec_out_chan_map_t
{
...
/* Structure for decoder output channel mapping. */
typedef struct asm_dec_out_chan_map_param_v2_t asm_dec_out_chan_map_param_v2_t;

struct asm_dec_out_chan_map_param_v2_t
{
    uint32_t                 num_channels;
    /**< Number of decoder output channels.

         @values 0 to #MAX_CHAN_MAP_CHANNELS_V2

         A value of 0 indicates native channel mapping, which is valid only
         for NT mode. This value means the output of the decoder is
         preserved as is. */

    asm_dec_out_chan_map_t           channel_mapping[0];
    /**< Channel array of size num_channels.
...
/** @} *//* end_weakgroup weak_asm_dec_out_chan_map_param_v2_t */
