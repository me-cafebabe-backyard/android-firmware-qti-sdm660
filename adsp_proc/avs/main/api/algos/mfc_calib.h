...
/* ID of the Media Format Converter (MFC) module.
    ...
    - #AUDPROC_PARAM_ID_MFC_OUTPUT_MEDIA_FORMAT_V2
 */
...
/** @h2xmlp_parameter   {"AUDPROC_PARAM_ID_MFC_OUTPUT_MEDIA_FORMAT_V2", AUDPROC_PARAM_ID_MFC_OUTPUT_MEDIA_FORMAT_V2}
    @h2xmlp_description {Structure for the output media format parameter used by the Media
 Format Converter module.\n } */

/* Structure for the output media format parameter used by the Media
 Format Converter module. */
typedef struct audproc_mfc_output_media_fmt_v2_t audproc_mfc_output_media_fmt_v2_t;
