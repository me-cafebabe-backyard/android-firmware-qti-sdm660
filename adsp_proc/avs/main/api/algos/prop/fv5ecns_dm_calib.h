#ifndef FV5ECNS_DM_CALIB_H
#define FV5ECNS_DM_CALIB_H
/*==============================================================================
  @file fv5ecns_dm_calib.h
  @brief This file contains FV5ECNS_DM
==============================================================================*/
/*=======================================================================
...
/** @h2xml_title1           {VOICE_MODULE_FV5ECNS_DM}
    @h2xml_title_agile_rev  {VOICE_MODULE_FV5ECNS_DM}
    @h2xml_title_date       {April 11, 2017} */


#define VOICE_MODULE_FV5ECNS_DM  0x00010F0A
/**
    @h2xmlm_module       {"VOICE_MODULE_FV5ECNS_DM",
                          VOICE_MODULE_FV5ECNS_DM}
    @h2xmlm_displayName  {"TX VOICE FV5ECNS DM"}
	@h2xmlm_description {Dual-mic Fluence version 5 ECNS in the voice processor on the Tx path.\n
