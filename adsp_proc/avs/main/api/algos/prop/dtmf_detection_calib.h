...
/**
    @h2xmlm_module       {"AUDIO_MODULE_DTMF_DETECTION",
                          AUDPROC_MODULE_ID_DTMF_DETECTION}
    @h2xmlm_displayName  {"RX AUDIO DTMF DETECTION"}
	@h2xmlm_description {DTMF detection algorithm in the audio postprocessor on the Rx path.\n
This module supports the following parameter IDs\n
...
VOICE_PARAM_DTMF_DETECTION\n\n}
    ...
    @h2xml_Select					{audproc_enable_param_t}
    @h2xmlm_InsertParameter
    @h2xmlp_toolPolicy	        {NO_SUPPORT }
