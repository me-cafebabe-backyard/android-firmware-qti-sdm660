...
struct audproc_mchan_iir_enable_t
{
   ...
   /**< @h2xmle_description  {Number of channels for which enable flags are provided.\n IIR_TUNING_FILTER_MAX_CHANNELS_V2=32}
        @h2xmle_range    {0..IIR_TUNING_FILTER_MAX_CHANNELS_V2}
        @h2xmle_default	{1}
        @h2xmle_readOnly {true}  */

   audproc_channel_type_iir_enable_pair_t enable_flag_settings[IIR_TUNING_FILTER_MAX_CHANNELS_V2];
...
struct audproc_mchan_iir_pregain_t
{
   ...
   audproc_channel_type_iir_pregain_pair_t preGain_settings[IIR_TUNING_FILTER_MAX_CHANNELS_V2];
   /**< @h2xmle_description  {Number of channels for which pregains are provided} */
