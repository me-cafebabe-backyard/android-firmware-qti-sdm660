...
/** @h2xml_title1           {VOICE_MODULE_FV5ECNS_SM}
    @h2xml_title_agile_rev  {VOICE_MODULE_FV5ECNS_SM}
    @h2xml_title_date       {April 11, 2017} */


#define VOICE_MODULE_FV5ECNS_SM  0x00010F09
/**
    @h2xmlm_module       {"VOICE_MODULE_FV5ECNS_SM",
                          VOICE_MODULE_FV5ECNS_SM}
    @h2xmlm_displayName  {"TX VOICE FV5ECNS SM"}
