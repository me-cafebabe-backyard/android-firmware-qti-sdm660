...
#define AUDPROC_PARAM_ID_MULTICHANNEL_GAIN_V2                          0x00010947

#define VOLUME_CONTROL_MAX_CHANNELS_V2                       32

/* Structure for the multichannel gain command */
typedef struct audproc_volume_ctrl_multichannel_gain_v2_t audproc_volume_ctrl_multichannel_gain_v2_t;
/** @h2xmlp_parameter   {"AUDPROC_PARAM_ID_MULTICHANNEL_GAIN_V2",AUDPROC_PARAM_ID_MULTICHANNEL_GAIN_V2}
    @h2xmlp_description { VOLUME_CONTROL_MAX_CHANNELS - 32. \n Payload of the AUDPROC_PARAM_ID_MULTICHANNEL_GAIN_V2 channel type/gain
    pairs used by the Volume Control module.\n
    This structure immediately follows the
    audproc_volume_ctrl_multichannel_gain_t structure.}
     @h2xmlp_toolPolicy   {NO_SUPPORT}  */
...
/** Immediately following this structure are num_channels structures of type
    audproc_volume_ctrl_channel_type_gain_pair_t.
 */

struct audproc_volume_ctrl_multichannel_gain_v2_t
{
   uint32_t num_channels;
   /**< @h2xmle_description  {Number of channels for which gain values are provided. Any channels
        present in the data for which gain is not provided are set to unity
   ...
   audproc_volume_ctrl_channel_type_gain_pair_t gain_data[0];
   /**< @h2xmle_description {Specifies the different sets of channel_type/gain configurations}
...
/* ID of the Multichannel Mute Configuration parameters to support dynamic payload used by #AUDPROC_MODULE_ID_VOL_CTRL. */
#define AUDPROC_PARAM_ID_MULTICHANNEL_MUTE_V2                          0x00010948


/* Structure for the multichannel mute command */
typedef struct audproc_volume_ctrl_multichannel_mute_v2_t audproc_volume_ctrl_multichannel_mute_v2_t;
/** @h2xmlp_parameter   {"AUDPROC_PARAM_ID_MULTICHANNEL_MUTE_V2", AUDPROC_PARAM_ID_MULTICHANNEL_MUTE_V2}
    @h2xmlp_description {Payload of the AUDPROC_PARAM_ID_MULTICHANNEL_MUTE_V2 channel type/mute
 setting pairs used by the Volume Control module.\n
 This structure immediately follows the audproc_volume_ctrl_multichannel_mute_v2_t structure.}
     @h2xmlp_toolPolicy   {NO_SUPPORT}  */

#include "adsp_begin_pack.h"


struct audproc_volume_ctrl_multichannel_mute_v2_t
{
   uint32_t num_channels;
   /**< @h2xmle_description  {Number of channels for which mute configuration is provided. Any
        channels present in the data for which mute configuration is not
   ...
   audproc_volume_ctrl_channel_type_mute_pair_t mute_data[0];
   /**< @h2xmle_description {Specifies the different sets of channel_type/mute configurations}
        @h2xmle_variableArraySize {num_channels}
        @h2xmle_default      {0}   */
