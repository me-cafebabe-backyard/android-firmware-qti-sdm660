...
/*========================================================================
Copyright (c) 2009-2010, 2012-2016, 2018 Qualcomm Technologies, Inc.  All Rights Reserved.
...
$Header: //components/rel/avs.adsp/2.8/aud/algorithms/utils/audio_cmn_lib/inc/asm_macros.h#3 $
