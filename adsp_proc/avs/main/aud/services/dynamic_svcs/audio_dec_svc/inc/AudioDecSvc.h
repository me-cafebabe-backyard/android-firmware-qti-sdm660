...
$Header: //components/rel/avs.adsp/2.8/aud/services/dynamic_svcs/audio_dec_svc/inc/AudioDecSvc.h#10 $
...
struct asm_multi_channel_pcm_fmt_blk_v5_dec_t
{
   asm_multi_channel_pcm_fmt_blk_v5_t fmt;
   asm_multi_channel_pcm_fmt_ch_map_t channel_map[ELITE_PCM_MAX_NUM_CH];  // put a macro
};
...
struct AudioDecSvcPullModeParams_t
{
   union
   {
     asm_multi_channel_pcm_fmt_blk_v5_dec_t pcm;
   } MediaFmt;
