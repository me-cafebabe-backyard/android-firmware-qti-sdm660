...
$Header: //components/rel/avs.adsp/2.8/aud/services/dynamic_svcs/audio_dec_svc/src/AudioDecSvc_MiMoUtil.cpp#7 $
...
ADSPResult AudioDecSvc_CreateInpStream(AudioDecSvc_t *pMe, AudioDecSvcIOStreamInitParams_t *pIOInitParams, void **handle)
{
   ...
   pMe->in_streams_ptr[stream_index] = (AudioDecSvc_InpStream_t*) qurt_elite_memory_malloc( sizeof(AudioDecSvc_InpStream_t), QURT_ELITE_HEAP_DEFAULT);
...
ADSPResult AudioDecSvc_CreateOutStream(AudioDecSvc_t *pMe, AudioDecSvcIOStreamInitParams_t *pIOInitParams, void **handle)
{
   ...
   pMe->out_streams_ptr[stream_index] = (AudioDecSvc_OutStream_t*) qurt_elite_memory_malloc( sizeof(AudioDecSvc_OutStream_t), QURT_ELITE_HEAP_DEFAULT);
