...
$Header: //components/rel/avs.adsp/2.8/aud/services/dynamic_svcs/audio_dec_svc/src/AudioDecSvc_CapiV2Util.cpp#19 $
...
ADSPResult aud_dec_svc_set_pcm_out_chan_map(capi_v2_t *capi_v2_ptr, uint16_t out_port_index, DecChannelMap_t *chan_map)
{
   ...
   for (uint16_t ch=0;(ch<chan_map->nChannels) && (ch < SIZEOFARRAY(media_fmt.std.channel_type)); ch++)
   {
