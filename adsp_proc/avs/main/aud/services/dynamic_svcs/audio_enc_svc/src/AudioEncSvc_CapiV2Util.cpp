...
$Header: //components/rel/avs.adsp/2.8/aud/services/dynamic_svcs/audio_enc_svc/src/AudioEncSvc_CapiV2Util.cpp#10 $
...
ADSPResult audio_enc_svc_create_init_auto_capi_v2(capi_v2_t **capi_v2_ptr_ptr,  AudioEncSvcInitParams_t *pInitParams, enc_CAPI_init_params_t *pCapiInitParams)
{
   ...
   audio_enc_svc_capi_v2_media_fmt_v1_t media_fmt;
...
ADSPResult audio_enc_svc_create_init_pack_capi_v2(capi_v2_t **capi_v2_ptr_ptr,  AudioEncSvcInitParams_t *pInitParams, enc_CAPI_init_params_t *pCapiInitParams)
{
   ...
   //Input media fmt
   audio_enc_svc_capi_v2_media_fmt_v1_t input_fmt;
   ...
   props[2].payload.actual_data_len = props[2].payload.max_data_len = sizeof(audio_enc_svc_capi_v2_media_fmt_v1_t);
...
ADSPResult aud_enc_svc_set_media_fmt(capi_v2_t *capi_v2_ptr, audio_enc_svc_capi_v2_media_fmt_v1_t *media_fmt, capi_v2_property_id_t prop_id)
{
   capi_v2_err_t err_code = CAPI_V2_EOK;
