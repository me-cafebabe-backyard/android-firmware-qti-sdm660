...
$Header: //components/rel/avs.adsp/2.8/aud/services/dynamic_svcs/utils/inc/audio_module_chain_wrapper.h#2 $
...
typedef struct aud_module_media_fmt_v2_t
{
...
}aud_module_media_fmt_v2_t;

typedef struct aud_module_media_fmt_v1_t
{
    capi_v2_data_format_header_t h;
    capi_v2_standard_data_format_t f;
}aud_module_media_fmt_v1_t;

typedef struct aud_module_media_event_t
{
   bool_t event_is_pending;
   aud_module_media_fmt_v2_t event;
