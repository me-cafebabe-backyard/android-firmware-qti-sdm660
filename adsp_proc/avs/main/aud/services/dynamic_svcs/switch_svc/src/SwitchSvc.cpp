...
$Header: //components/rel/avs.adsp/2.8/aud/services/dynamic_svcs/switch_svc/src/SwitchSvc.cpp#5 $
...
static ADSPResult switch_svc_check_recreate_output_buffers(switch_svc_t *pMe, elite_msg_any_t* out_msg_ptr)
{
   ...
   void *out_buf_ptr =  qurt_elite_memory_malloc(out_buf_size, QURT_ELITE_HEAP_DEFAULT);
   if (NULL==out_buf_ptr)
   {
