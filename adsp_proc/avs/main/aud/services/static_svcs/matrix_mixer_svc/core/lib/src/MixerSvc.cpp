...
$Header: //components/rel/avs.adsp/2.8/aud/services/static_svcs/matrix_mixer_svc/core/lib/src/MixerSvc.cpp#8 $
...
ADSPResult MtMx_CustomMsgHandler(void* pInstance, elite_msg_any_t* pMsg)
{
	...
	case ELITEMSG_CUSTOM_MT_MX_RAMP_GAINS_V7:
	{
		result = MtMx_RampGainsv7(me, pMsg);
		break;
	}
	...
	case ELITEMSG_CUSTOM_MT_MX_MUTE_V7:
	{
		result = MtMx_Mutev7(me, pMsg);
		break;
	}
