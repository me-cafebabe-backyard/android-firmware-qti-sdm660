...
$Header: //components/rel/avs.adsp/2.8/aud/services/static_svcs/matrix_mixer_svc/core/lib/src/MixerSvc.h#15 $
...
#define MT_MX_NUM_CHANNELS_THIRTY_TWO                             32
#define MAX_CHANNEL_MAPPING_NUMBER                                PCM_MAX_CHANNEL_MAP
...
#define MTMX_ALIGNTO4(x)            (ELITE_ALIGN_BY_4(x))
...
struct mt_mx_struct_ramp_gain_t
{
    ...
    uint16_t                   unTargetGain[MT_MX_NUM_CHANNELS_THIRTY_TWO];
    int16_t                    nGainIncDecStep[MT_MX_NUM_CHANNELS_THIRTY_TWO];
    uint16_t                   unCurrentGain[MT_MX_NUM_CHANNELS_THIRTY_TWO];
    bool_t                     bShouldRampGainBeApplied;
    bool_t                     bIsRunningInSlowRampModeSR[MT_MX_NUM_CHANNELS_THIRTY_TWO];
    uint16_t                   unNumSamplesWaitToIncDecSR[MT_MX_NUM_CHANNELS_THIRTY_TWO];
    uint16_t                   unCurrentSamplesWaitCounterSR[MT_MX_NUM_CHANNELS_THIRTY_TWO];
    bool_t                     bIsChannelMuted[MT_MX_NUM_CHANNELS_THIRTY_TWO];
    uint16_t                   unCachedTargetGainAfterUnMute[MT_MX_NUM_CHANNELS_THIRTY_TWO];
};
...
struct MatrixInPortInfoType
{
    ...
    uint8_t                   unChannelMapping[MT_MX_NUM_CHANNELS_THIRTY_TWO];        //Channel mapping
    uint8_t                   unNewChannelMapping[MT_MX_NUM_CHANNELS_THIRTY_TWO]; //New channel mapping: Used when media fmt is rcvd in steady-state and
...
struct MatrixOutPortInfoType
{
    ...
    uint8_t                      usChannelMappingPrRecfg[MT_MX_NUM_CHANNELS_THIRTY_TWO];
