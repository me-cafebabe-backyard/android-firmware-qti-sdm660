...
$Header: //components/rel/avs.adsp/2.8/aud/services/static_svcs/matrix_mixer_svc/core/lib/src/MixerSvc_Pspd.h#5 $
...
#define PSPD_KPPS_CHMIXER_MODULE_ENABLED_16CH (28000) // todo : profile
#define PSPD_KPPS_CHMIXER_MODULE_ENABLED_32CH (56000) // todo : profile
...
#define PSPD_BW_CHMIXER_MODULE_ENABLED_16CH (1024*1024*6) //6 MBps
#define PSPD_BW_CHMIXER_MODULE_ENABLED_32CH (1024*1024*12) //12 MBps

//Maximum number of channels supported in PSPD threads.
#define PSPD_MAX_CHAN      (ELITE_PCM_MAX_NUM_CH)
