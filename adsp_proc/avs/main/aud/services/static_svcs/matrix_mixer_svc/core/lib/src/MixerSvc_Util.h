...
$Header: //components/rel/avs.adsp/2.8/aud/services/static_svcs/matrix_mixer_svc/core/lib/src/MixerSvc_Util.h#6 $
...
void MtMx_SetupInputToOutputGainParams(This_t *me, uint32_t unInPortID, uint32_t unOutPortID, mtmx_gain_params_t *pGain_params);
void MtMx_SetupInputToOutputMuteParams(This_t *me, uint32_t unInPortID, uint32_t unOutPortID, mtmx_mute_params_t *pMute_params);
