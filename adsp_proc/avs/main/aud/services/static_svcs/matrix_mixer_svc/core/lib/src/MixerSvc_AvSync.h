...
$Header: //components/rel/avs.adsp/2.8/aud/services/static_svcs/matrix_mixer_svc/core/lib/src/MixerSvc_AvSync.h#8 $
...
struct mt_mx_sampleslip_t
{
	...
	capi_v2_buf_t   inBufs[ELITE_PCM_MAX_NUM_CH]; // 32 channels
	capi_v2_buf_t   outBufs[ELITE_PCM_MAX_NUM_CH]; //32 channels
	uint32_t        frame_size;
