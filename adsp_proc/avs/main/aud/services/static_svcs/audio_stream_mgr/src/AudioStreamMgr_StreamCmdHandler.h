...
$Header: //components/rel/avs.adsp/2.8/aud/services/static_svcs/audio_stream_mgr/src/AudioStreamMgr_StreamCmdHandler.h#6 $
...
ADSPResult AudioStreamMgr_RegisterDeRegisterPPEvents(AudioStreamMgr_t *pMe,
												  uint8_t int_session_id, uint8_t stream_id	);
/**
 * This is the function handler to handle the cleanup/bail_out step for all the stream open commands
 */
...
/**
 * Common Handler to open the streams of the session
 */
