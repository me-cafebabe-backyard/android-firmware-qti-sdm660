...
/*========================================================================
$Header: //components/rel/avs.adsp/2.8/aud/services/static_svcs/audio_stream_mgr/src/AudioStreamMgr_StreamUtil.cpp#9 $
      ...
      ASM_OpenStreamParams_t *pOpenStream)
{
   ...
   {
      PPInitParams.is_input_output_realtime = 1;
   }
   else if ( ASM_NT_MODE == pSession->unMode)
   {
      PPInitParams.is_input_output_realtime = 2;
   }
   else
   {
	   PPInitParams.is_input_output_realtime = 0;
   }
