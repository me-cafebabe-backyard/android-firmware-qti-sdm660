...
/*========================================================================
$Header: //components/rel/avs.adsp/2.8/aud/services/static_svcs/audio_stream_mgr/src/AudioStreamMgr_AprIf.cpp#10 $
                                                ...
                                                uint32_t ulPayloadSize)
{
   ...
   AudioStreamMgr_CallBackHandleType *pCb =
    ...
    switch (eventOpcode) {
        ...
        case ASM_DATA_EVENT_SR_CM_CHANGE_NOTIFY_V2:
        case ASM_DATA_EVENT_ENC_SR_CM_CHANGE_NOTIFY:
        case ASM_DATA_EVENT_ENC_SR_CM_CHANGE_NOTIFY_V2:
