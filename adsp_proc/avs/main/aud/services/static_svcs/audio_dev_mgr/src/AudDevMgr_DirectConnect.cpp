...
$Header: //components/rel/avs.adsp/2.8/aud/services/static_svcs/audio_dev_mgr/src/AudDevMgr_DirectConnect.cpp#16 $
...
/*
  ...
  will be used to send disconnect command to ASM.
   ...
   @param pRspQ           [in] Response Q to fetch the message acknowledgments
   @return Success or Failure
 */
...
static ADSPResult Adm_DC_OpenUllppRxDevice(AdmStatSvc_InfoType *pAdmStatSvc,
                                           ...
                                           uint16_t unCoppID,
                                           adm_cmd_device_open_t *pCoppOpenParams,
                                           qurt_elite_queue_t *pRspQ);
                                       ...
                                       qurt_elite_queue_t *pRspQ)
{
  ...
  pConnectCmdPayload->pResponseQ         = pRspQ;
                                           ...
                                           uint32_t opCode)
{
  ...
  if ((ADM_NUM_CHANNELS_THIRTY_TWO < unDevNumChannels)
      || ((ADM_NUM_CHANNELS_EIGHT < unDevNumChannels) && (ADM_CMD_DEVICE_OPEN_V8 != opCode))
      || (unDevNumChannels <= 0))
  {
    MSG_1(MSG_SSID_QDSP6, DBG_ERROR_PRIO,
                              ...
                              adm_cmd_device_open_t *pCoppOpenParams)
{
  ...
  for (uint16_t i = 0; i < pCoppOpenParams->dev_num_channel_eid1; i++)
  {
                                    ...
                                    qurt_elite_queue_t *pRspQ)
{
  ...
  result = Adm_DC_ValidateUllppDeviceOpenParams(pCoppOpenParams->endpoint_id_1,
                                                pCoppOpenParams->dev_num_channel_eid1,
                                                pCoppOpenParams->bit_width_eid1,
                                                pCoppOpenParams->sample_rate_eid1,
                                                pCoppOpenParams->opcode);
  ...
  uint32_t unCoppAfeFrameSizeInSamples;
   result = afe_port_get_frame_size(AFE_PORT_DEFAULT_LATENCY_MODE, pCoppOpenParams->sample_rate_eid1, &unCoppAfeFrameSizeInSamples);
  if(ADSP_FAILED(result))
  {
    MSG_2(MSG_SSID_QDSP6, DBG_ERROR_PRIO,
          "ADM: Invalid sampling rate [%lu] for Audio COPP topology %lu",
          pCoppOpenParams->sample_rate_eid1, pCoppOpenParams->topology_id);
    return result;
  }
  ...
  MSG_2(MSG_SSID_QDSP6, DBG_HIGH_PRIO,
        ...
        pCoppOpenParams->topology_id, pCoppOpenParams->sample_rate_eid1);
  ...
  result = Adm_SendCmdRunCopp(phCalPort->phDevCopp, pRspQ);
  if (ADSP_FAILED(result))
  {
                               ...
                               qurt_elite_queue_t *pRspQ)
{
  ...
  uint32_t unCoppAfeFrameSizeInSamples;
  elite_svc_get_frame_size(pCoppOpenParams->sample_rate_eid1, &unCoppAfeFrameSizeInSamples);
  ...
  MSG_7(MSG_SSID_QDSP6, DBG_HIGH_PRIO,
        ...
        phCalPort->unEID1.unAfePortID, pCoppOpenParams->sample_rate_eid1,  phCalPort->unEID1.unNumChannels, phCalPort->unEID1.unBitWidth, unCoppAfeFrameSizeInSamples,
...
ADSPResult Adm_DC_DisconnectRxStream(AdmStatSvc_InfoType *pAdmStatSvc, AdmCalPort_Type *phCalPort,
                                     adm_client_type_t eClient,
                                     qurt_elite_queue_t *pRspQ)
{
  ADSPResult result = ADSP_EOK;
                                     ...
                                     qurt_elite_queue_t *pRspQ)
{
  ...
  result = Adm_DC_DisconnectRxStream(pAdmStatSvc, phCalPort,eClient,pRspQ);
  ...
  result = Adm_DC_CloseCommonHandler(pAdmStatSvc, phCalPort, unCoppID, pRspQ);
                                          ...
                                          qurt_elite_queue_t *pRspQ)
{
  ...
  result = Adm_SendCmdQueryAsmTxSinkHandle(pAdmStatSvc, unSessionID, &phSinkHandle, pRspQ);
  if (ADSP_FAILED(result))
  {
    MSG_1(MSG_SSID_QDSP6, DBG_ERROR_PRIO,
                                               ...
                                               qurt_elite_queue_t *pRspQ)
{
  ...
  if (NULL != phCalPort->unEID1.phAfePort)
  {
    ...
    if (0 != phCalPort->unDirectConnSessionID)
    {
      ...
      {
        result = Adm_SendCmdAsmPrepDisconnect(pAdmStatSvc, unSessionID, pRspQ);
        if (ADSP_FAILED(result))
        {
          MSG_1(MSG_SSID_QDSP6, DBG_ERROR_PRIO,
                                      ...
                                      EliteMsg_CustomAdmStreamConnectType *pPayload, adm_client_type_t eClient)
{
  ...
  if (0 != pAdmStatSvc->rxsessionMappingMask[unIndex])
  {
    ...
    if (ADM_ULTRA_LOW_LATENCY_DEVICE_SESSION == phCalPort->unDevicePerfMode)
    {
      ...
      (void)Adm_DC_ReconnectAfeToCopp(pAdmStatSvc, phCalPort, unCoppId, pAdmStatSvc->admInlineRspQ);
    }
...
ADSPResult Adm_UllppMultiChannelDeviceOpenCmdHandler(AdmStatSvc_InfoType *pAdmStatSvc,
                                                     ...
                                                     uint16_t unCoppID,
                                                     adm_cmd_device_open_t *pCoppOpenCmdPayload,
                                                     qurt_elite_queue_t *pRspQ)
{
  ADSPResult  result = ADSP_EOK;
  ADSPResult bailRes = ADSP_EOK;
  AdmCalPort_Type          *phCalPort;
  ...
  result = Adm_DC_OpenUllppRxDevice(pAdmStatSvc, phCalPort, unCoppID, pCoppOpenCmdPayload, pRspQ);
  if (ADSP_FAILED(result))
  {
  ...
  /* Attempt to setup the device Cmd Q for this COPP */
  ...
  if(ADSP_FAILED(result))
  {
    ...
    goto __bailoutUllppMultiChannelCoppOpenDeviceQ;
  }

  AudDevMgr_RequestHwResources(pAdmStatSvc);
  return result;

  __bailoutUllppMultiChannelCoppOpenDeviceQ:
  bailRes = Adm_DC_CloseUllppRxDevice(pAdmStatSvc, phCalPort, unCoppID, eASM_TYPE, pRspQ);
  MSG_1(MSG_SSID_QDSP6, DBG_HIGH_PRIO, "ADM: Closed Device [%u]. ULLPP COPP during Open itself", unCoppID);
                                          ...
                                          qurt_elite_queue_t *pRspQ)
{
  ...
  result = Adm_DC_CloseUllppRxDevice(pAdmStatSvc, phCalPort, unCoppID, eClient, pRspQ);
                                                   ...
                                                   qurt_elite_queue_t *pRspQ)
{
  ...
  result = Adm_DC_OpenRxDevice(pAdmStatSvc, phCalPort, unCoppID, pCoppOpenCmdPayload, pRspQ);
  ...
  {
    MSG_1(MSG_SSID_QDSP6, DBG_ERROR_PRIO, "ADM: Failed to setup devicecmdQ for COPP [%u]", unCoppID);
    goto __bailoutUllMultiChannelCoppOpenDeviceQ;
  }
  ...
  __bailoutUllMultiChannelCoppOpenDeviceQ:

  bailRes = Adm_DC_CloseRxDevice(pAdmStatSvc, phCalPort, unCoppID, eASM_TYPE, pRspQ);
  MSG_1(MSG_SSID_QDSP6, DBG_HIGH_PRIO, "ADM: Closed Device [%u]. ULL COPP during Open itself", unCoppID);

  __bailoutUllMultiChannelCoppOpen:

  /* Failed to setup ULL COPP RETURN ERROR */
  elite_apr_if_end_cmd(pAdmStatSvc->admAprHandle, pPkt, result);
  return result;
}
                                        ...
                                        qurt_elite_queue_t *pRspQ)
{
  ...
  result = Adm_DC_CloseRxDevice(pAdmStatSvc, phCalPort, unCoppID, eClient, pRspQ);
                                                    ...
                                                    qurt_elite_queue_t *pRspQ)
{
    ...
    if (ADSP_FAILED(result))
    {
      ...
      goto __bailout;
            ...
            (ADM_CMD_COPP_OPEN_MODE_OF_OPERATION_TX_PATH_NON_LIVE_COPP ==
                pCoppOpenCmdPayload->mode_of_operation))
  {
    result = Adm_DC_OpenTxDevice(phCalPort, pCoppOpenCmdPayload, pRspQ);
  ...
  MSG_3(MSG_SSID_QDSP6, DBG_HIGH_PRIO, "ADM: sampling rate %lu, bits per sample %u, #ch %u",
        pCoppOpenCmdPayload->sample_rate_eid1, pCoppOpenCmdPayload->bit_width_eid1,
        pCoppOpenCmdPayload->dev_num_channel_eid1);
  ...
  /* Attempt to setup the device Cmd Q for this COPP */
   ...
   {
     MSG_1(MSG_SSID_QDSP6, DBG_ERROR_PRIO, "ADM: Failed to setup devicecmdQ for COPP [%u]", unCoppID);
     goto __bailoutLLNPMultiChannelCoppOpenDeviceQ;
   }
  ...
  __bailoutLLNPMultiChannelCoppOpenDeviceQ:
  ...
  {
    bailRes = Adm_DC_CloseTxDevice(pAdmStatSvc, phCalPort, unCoppID, eASM_TYPE, pRspQ);
  }
  MSG_1(MSG_SSID_QDSP6, DBG_HIGH_PRIO, "ADM: Closed Device [%u]. LLNP COPP during Open itself", unCoppID);
                                         ...
                                         qurt_elite_queue_t *pRspQ)
{
  ...
  else
  {
    ...
    result = Adm_DC_CloseTxDevice(pAdmStatSvc, phCalPort, unCoppID, eClient, pRspQ);
    if (ADSP_FAILED(result))
    {
      MSG_2(MSG_SSID_QDSP6, DBG_ERROR_PRIO,
                                    ...
                                    adm_client_type_t eClient)
{
  ...
  if (ADM_RX_DIR == unDirection)
  {
    ...
    if (0 != pAdmStatSvc->rxsessionMappingMask[unIndex])
    {
      ...
      // disconnect/reconnect to the AFE - this releases any held buffers if the AFE is stopped.
      // The connection between "COPP" and AFE is maintained by reconnecting
      Adm_DC_ReconnectAfeToCopp(pAdmStatSvc, phCalPort, unCoppId, pAdmStatSvc->admInlineRspQ);
    }
  ...
  else // TX Direction
  {
    ...
    if (0 != pAdmStatSvc->txsessionMappingMask[unIndex])
    {
      ...
      {
        MSG_2(MSG_SSID_QDSP6, DBG_ERROR_PRIO,
                    "ADM: Unable to detect device %d comnnected to stream ID 0x%x, issuing AFE disable on disconnect",
                    unCoppID, unSessionID);
      }
    }
