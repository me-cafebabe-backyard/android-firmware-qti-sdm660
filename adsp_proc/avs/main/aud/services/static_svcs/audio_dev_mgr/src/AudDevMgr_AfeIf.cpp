...
$Header: //components/rel/avs.adsp/2.8/aud/services/static_svcs/audio_dev_mgr/src/AudDevMgr_AfeIf.cpp#4 $
...
ADSPResult Adm_SendCmdDisconnectAFE(AdmStatSvc_InfoType *pAudStatAdmSvc,
                                    uint32_t port,
                                    elite_svc_handle_t *phAfeClient,
                                    uint32_t cmd,
                                    qurt_elite_queue_t *pRspQ)
{
  ...
  pConnectMsgPayload->responseq_ptr      = pRspQ;
