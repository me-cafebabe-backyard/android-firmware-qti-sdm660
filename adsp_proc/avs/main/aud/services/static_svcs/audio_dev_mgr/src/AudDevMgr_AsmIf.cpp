...
$Header: //components/rel/avs.adsp/2.8/aud/services/static_svcs/audio_dev_mgr/src/AudDevMgr_AsmIf.cpp#4 $
		...
		uint32_t session_id)
{
	...
	pRunPayload->pResponseQ = pAudStatAdmSvc->admInlineRspQ;
                                              ...
                                              uint32_t bits_per_sample)
{
   ...
   pPayload->pResponseQ = pAudStatAdmSvc->admInlineRspQ;
   ...
   pPayload->outputNumChannels =
         (ADM_NUM_CHANNELS_THIRTY_TWO >= num_channels) ? num_channels: ADM_NUM_CHANNELS_THIRTY_TWO;
