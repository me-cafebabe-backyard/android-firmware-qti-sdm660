...
/*========================================================================
 ...
 $Header: //components/rel/avs.adsp/2.8/voice/services/voice_dec/src/vdec_svc.cpp#27 $
...
static ADSPResult vdec_vfr_decode_handler (void *instance_ptr)
{
   ...
   {   
	 ...
	 params.client = MVM_CSM_CLIENT_ENUM_VDEC;
	 params.vote = FALSE;
...
static ADSPResult vdec_send_dec_pkt_req (vdec_t *vdec_ptr)
{
   ...
   ADSPResult result = ADSP_EOK;
   MSG_1(MSG_SSID_QDSP6, DBG_HIGH_PRIO,"VCP: vdec_send_dec_pkt_req begin session(%x)",(int)vdec_ptr->session_num);
