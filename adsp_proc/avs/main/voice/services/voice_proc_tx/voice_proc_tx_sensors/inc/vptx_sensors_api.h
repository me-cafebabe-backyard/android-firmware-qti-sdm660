...
/*============================================================================
  ...
  $Header: //components/rel/avs.adsp/2.8/voice/services/voice_proc_tx/voice_proc_tx_sensors/inc/vptx_sensors_api.h#2 $
...
pQmi_object  -> pointer to qmi structure
facing_angle_threshold     -> facing angle threshold as reported by fpro V2 library
*/
