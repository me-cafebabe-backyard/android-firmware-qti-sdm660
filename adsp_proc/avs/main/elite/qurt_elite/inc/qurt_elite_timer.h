/*========================================================================
Copyright (c) 2010-2011, 2013-2017 Qualcomm Technologies, Inc.
All Rights Reserved.
...
$Header: //components/rel/avs.adsp/2.8/elite/qurt_elite/inc/qurt_elite_timer.h#4 $
...
/**
  Gets the wall clock time. Must invoke qurt_elite_timer_open
  before calling this. This is used in cases where the client
  wants to maintain a handle.

  @param[in] pTimer_h  Handle to the timer.

  @return
  Returns the wall clock time in microseconds.

  @dependencies
  qurt_elite_timer_open()
*/
...
@dependencies
 Client should call this function before using any timer features
*/
...
@dependencies
 Client should call this function if client does not use any timer feature
*/
...
using qurt_elite_timer.

@return
 ADSPResult error code.
*/
ADSPResult qurt_elite_timer_init(void);
