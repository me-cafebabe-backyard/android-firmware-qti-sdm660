...
$Header: //components/rel/avs.adsp/2.8/elite/qurt_elite/inc/qurt_elite_globalstate.h#7 $
...
struct qurt_elite_globalstate_t
{
   ...
   volatile uint32_t uApStatSvcUpStatus;
   /**< Specifies whether the Remote AP Static Service(s) are up.
        Each bit corresponds to the Remote PROC ID. For eg :-
        #MODEM_PROC_ID 2
   */
