...
/** @weakgroup weak_elite_msg_param_cal_v2_t
@{ */
/* Payload of the ELITE_CMD_SET_PARAM and ELITE_CMD_GET_PARAM messages
  when unParamId&nbsp;= ELITEMSG_PARAM_ID_CAL.
 */
typedef struct
{
   ...
   /** < Contains the shared memory details of the command */

} elite_msg_param_cal_v2_t;
/** @} */ /* end_weakgroup weak_elite_msg_param_cal_v2_t */
