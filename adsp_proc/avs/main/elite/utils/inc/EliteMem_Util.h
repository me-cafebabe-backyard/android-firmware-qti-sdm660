 ...
 * -------------------------------------------------------------------------*/
#define L2_LINESIZE    64  // for v60 reference : https://birch/gitbuilder/arch/pkg/v60_latest/doc/versions.html
...
/**
  Unmap the shared memory with remote DSP perocessor.
*/
...
/**
  Allocate memory from MDF shared memroy heap for the processorID given.
*/
...
/**
  Free the memory allocated from MDF shared memory heap.
*/
void elite_mem_mdf_mem_free( void* ptr, uint32_t mem_map_handle, uint32_t mem_size );

/**
  Response handler for AP_CMDRSP_SHARED_MEM_MAP_REGIONS.
*/
...
/**
  Maps command with remote processor using API AP_CMD_SHARED_MEM_MAP_REGIONS.
*/
