...
$Header: //components/rel/avs.adsp/2.8/elite/utils/inc/EliteLoggingUtils.h#4 $
...
/** Maximum number of channels supported for multichannel PCM version 2 logging. */
#define ELITE_MAX_NUM_CH_V2            32
...
typedef PACK(struct)
{
    ...
    uint8_t                             channel_mapping[ELITE_MAX_NUM_CH_V2];
    /**< Array of channel mappings. @newpagetable */

} audiolog_pcm_data_format_v2;
...
typedef PACK(struct)
{
    ...
    audiolog_pcm_data_format_v2    pcm_data_fmt;
    /**< Audio log PCM data format. */

} audiolog_header_pcm_data_v2;
...
/** Complete log packet structure for logging PCM version 2 data.
*/
typedef PACK(struct)
{
    log_hdr_type                         hdr;
    ...
    audiolog_header_pcm_data_v2        log_header_pcm;
    /**< Audio log header for PCM data. */
