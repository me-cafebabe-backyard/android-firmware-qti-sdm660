...
/** @addtogroup capiv2_property_ids
  ...
  @par
    - Properties that can be set using capi_v2_vtbl_t::set_properties() and
      queried using capi_v2_vtbl_t::get_properties():
...
enum capi_v2_property_id_t
{
   ...
   CAPI_V2_INPUT_MEDIA_FORMAT_V2,
    /**< Sets media format version 2 for an input port.
         ...
         Payload structure: capi_v2_set_get_media_format_t followed by
         capi_v2_standard_data_format_v2_t, which is then followed by the
         channel type information. @vertspace{6} */
