...
/** Maximum number of channels supported in a stream with media format
    version 2 modules. */
#define CAPI_V2_MAX_CHANNELS_V2 32

/** Minor version of media format version 2. */
#define CAPI_V2_MEDIA_FORMAT_MINOR_VERSION      (1)
...
typedef struct capi_v2_standard_data_format_v2_t capi_v2_standard_data_format_v2_t;

/** For information on channel types, refer to
    @xrefcond{Q3,80-NF774-1,80-NA610-1}.
 */
typedef uint16_t   capi_v2_channel_type_t;

/** Media format version 2 payload for FIXED_POINT, FLOATING_POINT, and
    IEC61937_PACKETIZED data formats.
 */
struct capi_v2_standard_data_format_v2_t
{
   uint32_t minor_version;
   /**< Minor version for this payload. */

   uint32_t bitstream_format;
   /**< Type of bit stream format.

        @values ADSP_MEDIA_FMT_* as defined in 
        @xrefcond{Q3,80-NF774-1,80-NA610-1}. */
   /* adsp_media_fmt.h */
   ...
   capi_v2_channel_type_t channel_type[0];
   /**< Channel type payload is of variable length and depends on the number
        ...
        @values PCM_CHANNEL_* types defined in 
        @xrefcond{Q3,80-NF774-1,80-NA610-1}. */
   /* adsp_media_fmt.h */
};
