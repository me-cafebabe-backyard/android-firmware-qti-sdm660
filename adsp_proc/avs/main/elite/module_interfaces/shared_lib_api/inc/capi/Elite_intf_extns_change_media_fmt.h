...
/*==============================================================================
  ...
  $Header: //components/rel/avs.adsp/2.8/elite/module_interfaces/shared_lib_api/inc/capi/Elite_intf_extns_change_media_fmt.h#6 $
...
/** ID of the parameter used to set single or multiple fields of media format
    output to a custom value.

    This parameter is optional; modules can ignore it. If a module supports
    payload version 1 of INTF_EXTN_CHG_MF, this structure should be
    used.

    @msgpayload{intf_extn_param_id_chg_mf_propose_op_mf_t}
    @tablens{weak__intf__extn__param__id__chg__mf__propose__op__mf__t} @newpage
 */
#define INTF_EXTN_PARAM_ID_CHG_MF_PROPOSE_OP_MF              0x00013C12

/** @weakgroup weak_intf_extn_param_id_chg_mf_propose_op_mf_t
@{ */
/* Data Structure to send info to the module. if module supports payload version 1 of INTF_EXTN_CHG_MF then this structure should be used*/ 
...
/** ID of the parameter used to set single or multiple fields of output media
    format to a custom value. This parameter supports more than 16 channels,
    and it is backward-compatible.

    This parameter is optional; modules can ignore it. If a module supports
    payload version 2 of INTF_EXTN_CHG_MF, this structure should be used.

    @msgpayload{intf_extn_param_id_chg_mf_propose_op_mf_v2_t}
    @tablens{weak__intf__extn__param__id__chg__mf__propose__op__mf__v2__t}
 */
#define INTF_EXTN_PARAM_ID_CHG_MF_PROPOSE_OP_MF_V2              0x00013C13

/** @weakgroup weak_intf_extn_param_id_chg_mf_propose_op_mf_v2_t
@{ */
/* Data Structure to send info to the module if module supports payload version 2 of INTF_EXTN_CHG_MF then this structure should be used */
/** This structure can be extended if new fields are to be added.
 */
typedef struct intf_extn_param_id_chg_mf_propose_op_mf_v2_t
{
   bool_t       default_sampling_rate;
   /**< Indicates whether the module uses a default value instead of
        sampling_rate.
   ...
   /**< Channel mapping array for all the channels.
...
}/** @cond */intf_extn_param_id_chg_mf_propose_op_mf_v2_t/** @endcond */;
/** @} *//* end_weakgroup weak_intf_extn_param_id_chg_mf_propose_op_mf_v2_t */
