...
/*=============================================================================
  ...
  $Header: //components/rel/avs.adsp/2.8/elite/module_interfaces/shared_lib_api/inc/capi/Elite_lib_get_capi_v2_module.h#5 $
...
/** @addtogroup capiv2_lib_module_create
...
/** @} *//* end_addtogroup capiv2_lib_module_create */
