...
$Header: //components/rel/avs.adsp/2.8/elite/module_interfaces/shared_lib_api/inc/qurt_elite/qurt_elite_memory.h#5 $
...
/**
  ...
  @param[in] unBytes      Number of bytes to allocate.
  @param[in] unAlignSize  Number of alignment bytes.
                          This value must be a power of 2.
  @param[in] heapId       ID of the heap from which to allocate memory.
...
/**
  Frees memory that was allocated with qurt_elite_memory_heapmgr_aligned_malloc().
