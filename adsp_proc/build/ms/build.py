...
#---------------------------------------------------------------------------------
#
#  $Header: //components/rel/dspbuild.adsp/3.0/ms/build.py#6 $
...
if CHIPSET == 'msm8974':
   ...
   os.environ['BUILD_ASIC'] = BUILD_ASIC = '830'
   os.environ['MSM_ID'] = MSM_ID = '830'
   os.environ['HAL_PLATFORM'] = HAL_PLATFORM = '830'
   os.environ['TARGET_FAMILY'] = TARGET_FAMILY = '830'
   os.environ['CHIPSET'] = CHIPSET = 'sdm830'   
elif CHIPSET == 'sdm660':
