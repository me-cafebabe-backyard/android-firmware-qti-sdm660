    ...
    for cnt in range(0,60):
        ...
        if os.path.isfile(smmu_files):
            ...
            for line_smmufile in f_smmuInputfile:
                # print f_smmuInputfile,line_smmufile
                if first == 0:
                    if not "audio" in line_smmufile:
                        break
                first = 1
                # print f_smmuInputfile
...
def main():
    ...
    for line_dsppgt in f_dsppgt:
        if ( line_dsppgt[0:2] == '0x'):
            ...
            # print line_dsppgt
            # print asid
            if asid == None or "0x0" in asid:
                print vpage_address, ipage_address, size
