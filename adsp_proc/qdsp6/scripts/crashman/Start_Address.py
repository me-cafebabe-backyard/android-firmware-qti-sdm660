...
def Ocimem_Check(input,outputpath,slpi_flag):
    ocimem_check = False
...
if (TargetName == "8998" and sensor=="True") or (TargetName == "8996" and sensor=="True") or (TargetName == "845" and sensor=="True") or (Enable_6GB == True):
    if DumpSize > 4294967296:
        Ocimem_Check(input,outputpath,"True")
...
if (TargetName == "8998" and sensor=="False") or TargetName == "8937" or TargetName == "8953"  or TargetName == "8976" or (TargetName == "8996" and sensor=="False"):
    Ocimem_Check(input,outputpath,"False")
    if os.path.isfile(outputpath+"\\temp\\adspstartaddr.txt"):
        sys.exit(0)
