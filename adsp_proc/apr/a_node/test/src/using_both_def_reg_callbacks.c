/*==============================================================================
  @file using_both_def_reg_callbacks.c
  @brief Sample implementation of a_node user that using both default and
         registered callbacks for command and response handling. Typically,
         default command callbacks is used to handle unknown messages and
         generate a BASIC response. Correspondingly, typical default response
         handler are used to handle these BASIC responses.
...
/*==============================================================================
  ...
  $Header: //components/rel/apr.common/1.0/a_node/test/src/using_both_def_reg_callbacks.c#1 $
...
/* Main Test entry */
void a_node_test_using_both_all()
{
  APR_DBG_0(APR_DBG_HIGH, "Test: a_node_test_using_both_all :Started");
  sample_scenario_1();
  sample_scenario_2();
  APR_DBG_0(APR_DBG_HIGH, "Test: a_node_test_using_both_all :Ended");
}
