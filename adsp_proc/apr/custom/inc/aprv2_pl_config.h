...
/*
  ...
  $Header: //components/rel/apr.common/1.0/custom/inc/aprv2_pl_config.h#4 $
  $Author: pwbldsvc $
*/
...
#ifdef modem_proc
   #define CUSTOM_PL APRV2_IDS_SERVICE_ID_MODEM_OEM4_V
   #define CUSTOM_PL_NO 10
#endif

#ifdef adsp_proc

  #define CUSTOM_PL APRV2_IDS_SERVICE_ID_RESERVED_V
  #define CUSTOM_PL_NO 0
