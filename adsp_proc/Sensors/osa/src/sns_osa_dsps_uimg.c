...
$Header: //components/rel/ssc.slpi/2.2/osa/src/sns_osa_dsps_uimg.c#1 $
$DateTime: 2017/04/17 22:20:39 $
$Author: pwbldsvc $

when         who     what, where, why
----------   ---     ---------------------------------------------------------
12/20/2016   bd     Moved sns_os_sigs_accept() to uimage
...
#ifdef FAST_PLAYBACK
#define UMSG(a,b,c) //ignore UMSG for playback
#endif
/*=====================================================================
  PUBLIC FUNCTIONS
  =======================================================================*/
