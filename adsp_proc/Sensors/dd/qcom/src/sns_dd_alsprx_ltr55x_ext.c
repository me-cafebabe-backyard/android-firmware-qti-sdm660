...
DESCRIPTION
   ...
   Init and get_attrib routines for LTR55X ALS/PRX driver. These can be placed outside
   TCM if needed.
...
$Header: //components/rel/ssc.slpi/2.2/dd/qcom/src/sns_dd_alsprx_ltr55x_ext.c#1 $
...
============================================================================*/
extern sns_ddf_status_e sns_dd_alsprx_ltr55x_reset
(
...
/*===========================================================================
  ...
  FUNCTION:   sns_dd_alsprx_ltr55x_init
...
*/
/*=========================================================================*/                                             
sns_ddf_status_e sns_dd_alsprx_ltr55x_init
(
...
)
{
  ...
  SNS_PRINTF_STRING_ID_ERROR_1(SNS_DBG_MOD_DSPS_SMGR, //SNS_DBG_MOD_DSPS_DD_ALSPRX,
...
if(device_info->first_gpio != 0xffff)
{
  ...
  ptr->dri_enable = false;
}

if (EnableI2C == TRUE)
{
  if(ptr->dri_enable == false){
  stat = sns_ddf_timer_init(&ptr->sns_dd_alsprx_common_db.als_timer.timer_obj, 
                            *dd_ptr, 
                            &sns_alsprx_ltr55x_driver_fn_list, 
                            &als_timer, 
                            FALSE);
...
#ifdef ALSPRX_DEBUG_ONE_SENSOR
  *num_sensors = 1;
#endif
  *sensors = (sns_ddf_sensor_e *)sns_dd_alsprx_sensor_types; 

  /* Resets the driver */
  stat = sns_dd_alsprx_ltr55x_reset((sns_ddf_handle_t) ptr);
...
/*===========================================================================
  ...
  FUNCTION:   sns_dd_alsprx_ltr55x_get_attrib
...
sns_ddf_status_e sns_dd_alsprx_ltr55x_get_attrib
(
