...
DESCRIPTION
  ...
  Private header file for ISL29044A driver 
...
$Header: //components/rel/ssc.slpi/2.2/dd/qcom/src/sns_dd_alsprx_isl29044a_priv.h#1 $
...
#define SNS_DD_ALSPRX_ALS_DATA_READY_US       0        /* 0ms for ALS */
#define SNS_DD_ALSPRX_PRX_DATA_READY_US       1000     /* 1ms for PRX */
#define SNS_DD_ALSPRX_ALPHA_LO                488
#define SNS_DD_ALSPRX_ALPHA_HI                7814
...
#define SNS_DD_ALSPRX_ISL29028_CHIPID         0xA0
#define SNS_DD_ALSPRX_ISL29044_CHIPID         0xB0
#define SNS_DD_ALSPRX_ISL29044A_CHIPID        0x2E

/******************************************************************************
                        Intersil Sensor(ISL29044A) defines
******************************************************************************/
...
#define SNS_DD_ISL_ALSPRX_PROX_SLP_MS           0x70    /* D6:4 - PROX_SLP @ 0ms */
...
#define SNS_DD_ALS_PWR                          94      /* unit of uA */
#define SNS_DD_ALS_RES                          FX_FLTTOFIX_Q16(0.7814)   /* unit of this data type is lux */
#define SNS_DD_ALSPRX_LO_PWR                    1       /* unit of uA */

/* attributes for proximity data type */
#define SNS_DD_PRX_PWR                          133   /* unit of uA */
...
#define SNS_DD_VISIBLE_TRANS_RATIO              100
...
#define SNS_DD_PRXDIST_TB_MAX_VALUE             255     /* 8 bits */
...
/* State struct for ALS/PRX ISL29044A */
typedef struct {
