...
$Header: //components/rel/ssc.slpi/2.2/dd/qcom/src/sns_dd_alsprx_isl29044a_ext.c#1 $
...
============================================================================*/
extern sns_ddf_status_e sns_dd_alsprx_isl29044a_reset
(
...
/*===========================================================================
  ...
  FUNCTION:   sns_dd_alsprx_isl29044a_init
...
*/
/*=========================================================================*/                                             
sns_ddf_status_e sns_dd_alsprx_isl29044a_init
(
...
)
{
  ...
  SNS_PRINTF_STRING_ID_LOW_1(SNS_DBG_MOD_DSPS_SMGR,
  ...
  *dd_ptr = (sns_ddf_handle_t)ptr;
  ...
  if (EnableI2C == TRUE)
  {
    stat = sns_ddf_timer_init(&ptr->sns_dd_alsprx_common_db.als_timer.timer_obj, 
                              *dd_ptr, 
                              &sns_alsprx_isl29044a_driver_fn_list, 
                              &als_timer, 
                              FALSE);
  ...
  *sensors = (sns_ddf_sensor_e *)sns_dd_alsprx_sensor_types; 
  ...
  /* Resets the driver */
  stat = sns_dd_alsprx_isl29044a_reset((sns_ddf_handle_t) ptr);
...
FUNCTION      sns_dd_alsprx_isl29044a_prx_query
...
==============================================================================*/
sns_ddf_status_e sns_dd_alsprx_isl29044a_prx_query
(
...
FUNCTION      sns_dd_alsprx_isl29044a_als_query
...
==============================================================================*/
sns_ddf_status_e sns_dd_alsprx_isl29044a_als_query
(
  sns_dd_alsprx_state_t* dd_ptr,
  sns_ddf_memhandler_s*  memhandler,
  sns_ddf_attribute_e    attrib,
...
)
{
  ...
  switch ( attrib )
  {
    case SNS_DDF_ATTRIB_RANGE:
    {
      ...
      *num_elems = 1;       
      device_ranges->min = FX_FLTTOFIX_Q16(0);
      device_ranges->max = FX_FLTTOFIX_Q16(3200.0);
      break;
    }
    ...
    case SNS_DDF_ATTRIB_ODR:
      if ( (odr_ptr = sns_ddf_memhandler_malloc(memhandler, sizeof(sns_ddf_device_info_s))) == NULL )
      {
        return SNS_DDF_ENOMEM;
      }
      *num_elems = 1;
      *odr_ptr = dd_ptr->chip.als_odr;
      *(uint32_t **)value = odr_ptr;
      break;
...
/*===========================================================================
  ...
  FUNCTION:   sns_dd_alsprx_isl29044a_get_attrib
...
*/
/*=========================================================================*/
sns_ddf_status_e sns_dd_alsprx_isl29044a_get_attrib
(
...
)
{
  ...
  if ( generic_attrib != TRUE )
  {
    ...
    case SNS_DDF_SENSOR_AMBIENT:
      status = sns_dd_alsprx_isl29044a_als_query(dd_ptr, memhandler, attrib, value, num_elems);
      break;

    case SNS_DDF_SENSOR_PROXIMITY:
      status = sns_dd_alsprx_isl29044a_prx_query(dd_ptr, memhandler, attrib, value, num_elems);
      break;
