...
$Header: //components/rel/ssc.slpi/2.2/dd/qcom/src/sns_dd_alsprx_cm36283_ext.c#1 $
...
==============================================================================*/
extern sns_ddf_status_e sns_dd_alsprx_cm36283_reset
(
  sns_ddf_handle_t dd_handle
);
extern sns_ddf_driver_if_s sns_alsprx_cm36283_driver_fn_list;
extern void sns_dd_alsprx_cm36283_handle_irq( sns_ddf_handle_t handle, sns_ddf_irq_e irq );
extern void sns_dd_alsprx_cm36283_set_default_reg(sns_dd_alsprx_state_t* dd_ptr);
extern void sns_dd_alsprx_cm36283_set_reg_from_nv(sns_dd_alsprx_state_t* state);

/*===========================================================================
FUNCTION      sns_dd_alsprx_cm36283_init

DESCRIPTION   init
===========================================================================*/
sns_ddf_status_e sns_dd_alsprx_cm36283_init(
    ...
    *dd_ptr      = (sns_ddf_handle_t) ptr;
    ...
    if(sns_ddf_signal_irq_enabled() && (ptr->int_gpio != 0xFFFF))
    {
        ...
        status = sns_ddf_signal_register(ptr->int_gpio,
                            *dd_ptr,
                            &sns_alsprx_cm36283_driver_fn_list,
     ...
     sns_dd_alsprx_cm36283_set_default_reg(ptr);
    ...
    if(reg_params)
    {
             ...
             (reg_params->data_len >= sizeof(sns_dd_nv_db_type)))
        {
            ...
            if ( (nv_ptr->lsc_num  == CAPELLA_MAGIC_NUM) &&
                 (nv_ptr->drv_ID          == CAPELLA_DRIVER_ID))
            {
                /* update value from NV parameters*/
                DDF_MSG_0(HIGH, "magic number for CM36283 verified");
                ...
                sns_dd_alsprx_cm36283_set_reg_from_nv(ptr);
        ...
        if (!data_from_registry) 
        {
            ...
            ptr->sns_dd_alsprx_common_db.nv_db.lsc_num = (uint32_t)CAPELLA_MAGIC_NUM;
            ptr->sns_dd_alsprx_common_db.nv_db.drv_ID  = (uint32_t)CAPELLA_DRIVER_ID;
            ptr->sns_dd_alsprx_common_db.nv_db.calibratePhone = SNS_DD_CALIBRATEPHONE;			
            ptr->sns_dd_alsprx_common_db.nv_db.device = SNS_DD_DEVICE;
            ptr->sns_dd_alsprx_common_db.nv_db.calLuxLower = SNS_DD_CAL_LUX_LOWER;  //avg set as 300
            ptr->sns_dd_alsprx_common_db.nv_db.calLuxUpper = SNS_DD_CAL_LUX_UPPER;
            ptr->sns_dd_alsprx_common_db.nv_db.luxCorrection = SNS_DD_ALS_LUX_CORRECTION;			
            ptr->sns_dd_alsprx_common_db.nv_db.ALS_thresh_high = SNS_DD_ALS_THRESH_HIGH;
            ptr->sns_dd_alsprx_common_db.nv_db.ALS_thresh_low = SNS_DD_ALS_THRESH_LOW;
...
/*===========================================================================
FUNCTION      sns_dd_alsprx_cm36283_prx_query

DESCRIPTION   prox query
===========================================================================*/
sns_ddf_status_e sns_dd_alsprx_cm36283_prx_query
(
  ...
  switch ( attrib )
  {
    ...
    case SNS_DDF_ATTRIB_POWER_INFO:
      ...
      *num_elems = 1;
      ...
      power_ptr->lowpower_current = 0; //as SNS_DD_ALSPRX_LO_PWR = 0.0002;
      SNS_PRINTF_STRING_ID_MEDIUM_1(SNS_DBG_MOD_DSPS_DD_ALSPRX,
    ...
    case SNS_DDF_ATTRIB_ODR:
      ...
      *(uint32_t **)value = odr_ptr;
      DDF_MSG_1(HIGH, "CM36283 get_attrib prx odr: %d",  *odr_ptr);
      break;
...
/*===========================================================================
FUNCTION      sns_dd_alsprx_cm36283_als_query

DESCRIPTION   als query
===========================================================================*/
sns_ddf_status_e sns_dd_alsprx_cm36283_als_query
(
  sns_dd_alsprx_state_t* dd_ptr,
  sns_ddf_memhandler_s*  memhandler,
  sns_ddf_attribute_e    attrib,
...
)
{
  ...
  switch ( attrib )
  {
    case SNS_DDF_ATTRIB_RANGE:
    {
      ...
      *num_elems = 1;
      device_ranges->min = FX_FLTTOFIX_Q16(0);
      device_ranges->max = FX_FLTTOFIX_Q16(6553);
      break;
    }
    case SNS_DDF_ATTRIB_RESOLUTION_ADC:
    {
    ...
    case SNS_DDF_ATTRIB_ODR:
      ...
      *(uint32_t **)value = odr_ptr;
      DDF_MSG_1(HIGH, "CM36283 get_attrib als odr: %d",  *odr_ptr);
      break;

    default:
      SNS_PRINTF_STRING_ID_HIGH_1(SNS_DBG_MOD_DSPS_SMGR,
                                  DBG_DD_ALSPRX_GET_ATTRIB_ERR,
                                  attrib);
      return SNS_DDF_EINVALID_ATTR;
  }
...
/*===========================================================================
FUNCTION      sns_dd_alsprx_cm36283_get_attrib

DESCRIPTION   sensor get attrib
===========================================================================*/
sns_ddf_status_e sns_dd_alsprx_cm36283_get_attrib
(
  ...
  if ( generic_attrib != TRUE )
  {
    switch ( sensor )
    {
      case SNS_DDF_SENSOR_AMBIENT:
        status = sns_dd_alsprx_cm36283_als_query(state, memhandler, attrib, value, num_elems);
        break;

      case SNS_DDF_SENSOR_PROXIMITY:
        status = sns_dd_alsprx_cm36283_prx_query(state, memhandler, attrib, value, num_elems);
        break;
