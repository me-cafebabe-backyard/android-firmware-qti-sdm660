...
============================================================================*/
/* $Header: //components/rel/ssc.slpi/2.2/dd/qcom/inc/sns_dd.h#1 $ */
...
/*============================================================================
  ...
  2016-04-22   BD   Added CM3526, TMG490x
  2016-04-12   SD   Added LSM6DSM
...
extern sns_ddf_driver_if_s sns_dd_press_lps22hb_if;
...
extern sns_ddf_driver_if_s sns_dd_cm3526_if;
