...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/ssc.slpi/2.2/common/idl/inc/sns_smgr_internal_api_v02.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
#define SNS_SMGR_INTERNAL_SVC_V02_IDL_MINOR_VERS 0x05
/** Major Version Number of the qmi_idl_compiler used to generate this file */
#define SNS_SMGR_INTERNAL_SVC_V02_IDL_TOOL_VERS 0x06
/** Maximum Defined Message ID */
#define SNS_SMGR_INTERNAL_SVC_V02_MAX_MESSAGE_ID 0x0028
/**
    @}
  */
...
/** @addtogroup SNS_SMGR_INTERNAL_SVC_qmi_enums
  ...
  */
typedef enum {
  SNS_SMGR_CAL_STATUS_E_MIN_ENUM_VAL_V02 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  SNS_SMGR_CAL_STATUS_DYN_RESET_V02 = 0, /**<  Reset of dynamic cal params occurred  */
  SNS_SMGR_CAL_STATUS_DYN_ANOMALY_V02 = 1, /**<  Anomaly in dynamic calibrated data detected  */
  SNS_SMGR_CAL_STATUS_E_MAX_ENUM_VAL_V02 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}sns_smgr_cal_status_e_v02;
/**
    @}
  */
...
/** @addtogroup SNS_SMGR_INTERNAL_SVC_qmi_messages
    @{
  */
/** Request Message; This command sends sensor events query request and
...
typedef struct {
  ...
  uint64_t timestamp;
  /**<   @VERSION 2.5
 The timestamp, in ticks, when sensor status change occurred*/

  /* Optional */
  uint8_t is_accurate_ts_client_present_valid;  /**< Must be set to true if is_accurate_ts_client_present is being passed */
  uint8_t is_accurate_ts_client_present;
  /**<   @VERSION 2.4
 true if there is an accurate timestamp client for this sensor.*/
...
/** @addtogroup SNS_SMGR_INTERNAL_SVC_qmi_messages
    @{
  */
/** Request Message; This command sends sensor calibration status monitor request and receives
    indications when the sensors calibration related properties change. */
typedef struct {
  ...
  uint8_t registering;
  /**<   TRUE to register, FALSE deregister*/
}sns_smgr_sensor_cal_status_monitor_req_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup SNS_SMGR_INTERNAL_SVC_qmi_messages
    @{
  */
/** Response Message; This command sends sensor calibration status monitor request and receives
    indications when the sensors calibration related properties change. */
typedef struct {
  ...
  uint64_t sensor_id;
  /**<   SNS_SMGR_SENSOR_ID_xxx*/
}sns_smgr_sensor_cal_status_monitor_resp_msg_v02;  /* Message */
/**
    @}
  */
...
/** @addtogroup SNS_SMGR_INTERNAL_SVC_qmi_messages
    @{
  */
/** Indication Message; This command sends sensor calibration status monitor request and receives
    indications when the sensors calibration related properties change. */
typedef struct {
  ...
  /* Mandatory */
  uint64_t timestamp;
  /**<   The timestamp, in ticks, when sensor calibration status change occurred*/

  /* Mandatory */
  sns_smgr_cal_status_e_v02 cal_status;
  /**<   Calibration status change associated with the sensor*/
}sns_smgr_sensor_cal_status_monitor_ind_msg_v02;  /* Message */
/**
    @}
  */
...
//#define REMOVE_SNS_SMGR_SENSOR_CAL_STATUS_MONITOR_V02 
...
#define SNS_SMGR_SENSOR_CAL_STATUS_MONITOR_REQ_V02 0x0027
#define SNS_SMGR_SENSOR_CAL_STATUS_MONITOR_RESP_V02 0x0027
#define SNS_SMGR_SENSOR_CAL_STATUS_MONITOR_IND_V02 0x0028
/**
    @}
  */
