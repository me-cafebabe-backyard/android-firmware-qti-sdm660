...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/ssc.slpi/2.2/common/idl/inc/sns_sam_cal_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define SNS_SAM_CAL_V01_IDL_MINOR_VERS 0x02
...
typedef enum {
  ...
  CAL_UPDATE_REGISTRY_WRITE_V01 = 1,
...
/** @addtogroup sns_sam_cal_qmi_enums
  ...
  */
typedef enum {
  SNS_SAM_PHONE_MODE_E_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  SNS_SAM_PHONE_MODE_0_V01 = 0, 
  SNS_SAM_PHONE_MODE_1_V01 = 1, /**<  refer to SNS_REG_SCM_GROUP_MAG_FAC_CAL_PARAMS  */
  SNS_SAM_PHONE_MODE_E_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}sns_sam_phone_mode_e_v01;
/**
    @}
  */
...
typedef struct {
  ...
  sns_sam_phone_mode_e_v01 phone_mode;
