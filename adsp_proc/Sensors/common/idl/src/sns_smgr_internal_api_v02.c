...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/ssc.slpi/2.2/common/idl/src/sns_smgr_internal_api_v02.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Sun May  1 2016 (Spin 0)
...
static const uint8_t sns_smgr_sensor_status_monitor_ind_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sns_smgr_sensor_status_monitor_ind_msg_v02, is_accurate_ts_client_present) - QMI_IDL_OFFSET8(sns_smgr_sensor_status_monitor_ind_msg_v02, is_accurate_ts_client_present_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(sns_smgr_sensor_status_monitor_ind_msg_v02, is_accurate_ts_client_present)
};
...
static const uint8_t sns_smgr_sensor_cal_status_monitor_req_msg_data_v02[] = {
  0x01,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(sns_smgr_sensor_cal_status_monitor_req_msg_v02, sensor_id),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x02,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(sns_smgr_sensor_cal_status_monitor_req_msg_v02, registering)
};

static const uint8_t sns_smgr_sensor_cal_status_monitor_resp_msg_data_v02[] = {
  2,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(sns_smgr_sensor_cal_status_monitor_resp_msg_v02, resp),
  QMI_IDL_TYPE88(1, 0),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sns_smgr_sensor_cal_status_monitor_resp_msg_v02, sensor_id) - QMI_IDL_OFFSET8(sns_smgr_sensor_cal_status_monitor_resp_msg_v02, sensor_id_valid)),
  0x10,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(sns_smgr_sensor_cal_status_monitor_resp_msg_v02, sensor_id)
};

static const uint8_t sns_smgr_sensor_cal_status_monitor_ind_msg_data_v02[] = {
  0x01,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(sns_smgr_sensor_cal_status_monitor_ind_msg_v02, sensor_id),

  0x02,
   QMI_IDL_GENERIC_8_BYTE,
  QMI_IDL_OFFSET8(sns_smgr_sensor_cal_status_monitor_ind_msg_v02, timestamp),

  QMI_IDL_TLV_FLAGS_LAST_TLV | 0x03,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(sns_smgr_sensor_cal_status_monitor_ind_msg_v02, cal_status)
};
...
static const qmi_idl_message_table_entry SNS_SMGR_INTERNAL_SVC_message_table_v02[] = {
  ...
  {sizeof(sns_smgr_sensor_cal_status_monitor_req_msg_v02), sns_smgr_sensor_cal_status_monitor_req_msg_data_v02},
  {sizeof(sns_smgr_sensor_cal_status_monitor_resp_msg_v02), sns_smgr_sensor_cal_status_monitor_resp_msg_data_v02},
  {sizeof(sns_smgr_sensor_cal_status_monitor_ind_msg_v02), sns_smgr_sensor_cal_status_monitor_ind_msg_data_v02}
};
...
static const qmi_idl_service_message_table_entry SNS_SMGR_INTERNAL_SVC_service_command_messages_v02[] = {
  ...
  {SNS_SMGR_SENSOR_CAL_STATUS_MONITOR_REQ_V02, QMI_IDL_TYPE16(0, 10), 15}
};
...
static const qmi_idl_service_message_table_entry SNS_SMGR_INTERNAL_SVC_service_response_messages_v02[] = {
  ...
  {SNS_SMGR_SENSOR_CAL_STATUS_MONITOR_RESP_V02, QMI_IDL_TYPE16(0, 11), 16}
};
...
static const qmi_idl_service_message_table_entry SNS_SMGR_INTERNAL_SVC_service_indication_messages_v02[] = {
  ...
  {SNS_SMGR_SENSOR_STATUS_MONITOR_IND_V02, QMI_IDL_TYPE16(0, 7), 44},
  {SNS_SMGR_EVENT_GATED_BUFFERING_IND_V02, QMI_IDL_TYPE16(2, 0), 1676},
  {SNS_SMGR_SENSOR_CAL_STATUS_MONITOR_IND_V02, QMI_IDL_TYPE16(0, 12), 29}
};
