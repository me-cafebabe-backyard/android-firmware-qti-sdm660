...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/ssc.slpi/2.2/common/idl/src/sns_sam_multishake_v01.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Wed Feb 17 2016 (Spin 0)
...
static const uint8_t sns_sam_multishake_enable_req_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sns_sam_multishake_enable_req_msg_v01, notify_suspend) - QMI_IDL_OFFSET8(sns_sam_multishake_enable_req_msg_v01, notify_suspend_valid)),
  0x11,
   QMI_IDL_AGGREGATE,
  QMI_IDL_OFFSET8(sns_sam_multishake_enable_req_msg_v01, notify_suspend),
  QMI_IDL_TYPE88(2, 1),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sns_sam_multishake_enable_req_msg_v01, event_bitmask) - QMI_IDL_OFFSET8(sns_sam_multishake_enable_req_msg_v01, event_bitmask_valid)),
  0x12,
   QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(sns_sam_multishake_enable_req_msg_v01, event_bitmask)
};
...
static const qmi_idl_service_message_table_entry SNS_SAM_MULTISHAKE_SVC_service_command_messages_v01[] = {
  ...
  {SNS_SAM_MULTISHAKE_ENABLE_REQ_V01, QMI_IDL_TYPE16(0, 0), 29},
