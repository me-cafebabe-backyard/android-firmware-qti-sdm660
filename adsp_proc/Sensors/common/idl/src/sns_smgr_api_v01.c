...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/ssc.slpi/2.2/common/idl/src/sns_smgr_api_v01.c#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Fri May 19 2017 (Spin 0)
...
static const uint8_t sns_smgr_single_sensor_test_ind_msg_data_v01[] = {
  ...
  QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sns_smgr_single_sensor_test_ind_msg_v01, ErrorCode) - QMI_IDL_OFFSET8(sns_smgr_single_sensor_test_ind_msg_v01, ErrorCode_valid)),
  0x10,
   QMI_IDL_GENERIC_1_BYTE,
  QMI_IDL_OFFSET8(sns_smgr_single_sensor_test_ind_msg_v01, ErrorCode),

  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sns_smgr_single_sensor_test_ind_msg_v01, AdditionalInfo) - QMI_IDL_OFFSET8(sns_smgr_single_sensor_test_ind_msg_v01, AdditionalInfo_valid)),
  0x11,
  QMI_IDL_FLAGS_IS_ARRAY | QMI_IDL_FLAGS_IS_VARIABLE_LEN |  QMI_IDL_GENERIC_4_BYTE,
  QMI_IDL_OFFSET8(sns_smgr_single_sensor_test_ind_msg_v01, AdditionalInfo),
  ADDITIONAL_INFOLENGTH_V01,
  QMI_IDL_OFFSET8(sns_smgr_single_sensor_test_ind_msg_v01, AdditionalInfo) - QMI_IDL_OFFSET8(sns_smgr_single_sensor_test_ind_msg_v01, AdditionalInfo_len)
};
...
static const qmi_idl_service_message_table_entry SNS_SMGR_SVC_service_indication_messages_v01[] = {
  ...
  {SNS_SMGR_SINGLE_SENSOR_TEST_IND_V01, QMI_IDL_TYPE16(0, 13), 94},
