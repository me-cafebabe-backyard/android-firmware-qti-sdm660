...
GENERAL DESCRIPTION
  ...
  $Header: //components/rel/ssc.slpi/2.2/common/idl/src/sns_time_api_v02.c#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.6 
   It was generated on: Wed Feb  5 2014 (Spin 0)
...
static const uint8_t sns_time_timestamp_resp_msg_data_v02[] = {
  ...
  QMI_IDL_TLV_FLAGS_LAST_TLV | QMI_IDL_TLV_FLAGS_OPTIONAL | (QMI_IDL_OFFSET8(sns_time_timestamp_resp_msg_v02, dsps_rollover_cnt) - QMI_IDL_OFFSET8(sns_time_timestamp_resp_msg_v02, dsps_rollover_cnt_valid)),
  0x13,
   QMI_IDL_GENERIC_4_BYTE,
...
static const qmi_idl_service_message_table_entry SNS_TIME2_SVC_service_response_messages_v02[] = {
  ...
  {SNS_TIME_TIMESTAMP_RESP_V02, QMI_IDL_TYPE16(0, 1), 37}
};

static const qmi_idl_service_message_table_entry SNS_TIME2_SVC_service_indication_messages_v02[] = {
  {SNS_TIME_TIMESTAMP_IND_V02, QMI_IDL_TYPE16(0, 2), 25}
};
