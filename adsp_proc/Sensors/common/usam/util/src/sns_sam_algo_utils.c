...
#ifdef FAST_PLAYBACK
  // TODO: FAST_PLAYBACK HACK BELOW. FIX ME ONCE BUFFERED_SMGR REPORTS ARE ENABLED!!!
  sns_sam_util_gen_smgr_periodic_req(sensorReq, enableReqMsg); // FAST PLAYBACK HACK
  return SAM_ENONE; // FAST PLAYBACK HACK
#endif
