...
*/
/*=======================================================================*/
SNS_SAM_UIMAGE_CODE uint32_t sns_buffer_size(
   uint32_t windowSize)
{
...
*/
/*=======================================================================*/
SNS_SAM_UIMAGE_CODE uint32_t sns_buffer_mem_req(
   uint32_t windowSize,
...
*/
/*=======================================================================*/
SNS_SAM_UIMAGE_CODE void sns_buffer_reset(
...
*/
/*=======================================================================*/
SNS_SAM_UIMAGE_CODE bool sns_buffer_full(
...
*/
/*=======================================================================*/
SNS_SAM_UIMAGE_CODE void sns_buffer_insert(
   sns_buffer_type* buffer,
   const float* newData)
{
   uint32_t i;
...
*/
/*=======================================================================*/
SNS_SAM_UIMAGE_CODE double sns_buffer_compute_variance(
   const sns_buffer_type* buffer,
   double* sumData,
...
SNS_SAM_UIMAGE_CODE void sns_buffer_sprd(sns_buffer_type *buffer, float *sprd_data)
{
