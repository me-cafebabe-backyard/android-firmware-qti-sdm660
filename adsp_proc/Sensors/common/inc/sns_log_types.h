...
#define LOG_SNS_HDRLL_DATA_C                  0x1964
#endif /* LOG_SNS_HDRLL_DATA_C */
#ifndef LOG_SNS_DEV_ORI_CONFIG_C
#define LOG_SNS_DEV_ORI_CONFIG_C              0x198E
#endif
#ifndef LOG_SNS_DEV_ORI_RESULT_C
#define LOG_SNS_DEV_ORI_RESULT_C              0x198F
#endif
#ifndef LOG_SNS_DEV_ORI_REPORT_C
#define LOG_SNS_DEV_ORI_REPORT_C              0x1990
#endif
...
typedef enum {
   ...
   SNS_LOG_DPC_REPORT,
   SNS_LOG_HDRLL_DATA,
   SNS_LOG_MULTISHAKE_CONFIG,
   SNS_LOG_MULTISHAKE_RESULT,
   SNS_LOG_MULTISHAKE_REPORT,
   SNS_LOG_DEV_ORI_CONFIG,
   SNS_LOG_DEV_ORI_RESULT,
   SNS_LOG_DEV_ORI_REPORT,
   SNS_LOG_NUM_IDS
} sns_log_id_e;
...
{                                   \
   ...
   LOG_SNS_HDRLL_DATA_C,  \
   LOG_SNS_MULTISHAKE_CONFIG_C,  \
   LOG_SNS_MULTISHAKE_RESULT_C,  \
   LOG_SNS_MULTISHAKE_REPORT_C,  \
   LOG_SNS_DEV_ORI_CONFIG_C,  \
   LOG_SNS_DEV_ORI_RESULT_C,  \
   LOG_SNS_DEV_ORI_REPORT_C,  \
};
...
#define SNS_LOG_QMAG_CAL_RESULT_VERSION 2
typedef PACK(struct) {
   log_hdr_type log_type;         /**< Type, as defined in log_codes.h */
   uint8_t      version;          /**< Version of the log packet       */
   uint8_t      timestamp_type;        /**< type of timestamp               */
