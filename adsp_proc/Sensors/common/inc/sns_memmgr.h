...
# define SNS_UIMAGE_HEAP_SIZE (120 * 1024) // in bytes
#else
// If subsequent builds run out of island space, this should be the first
...
/**
 * @return true if this address is located in uImage; false otherwise
 */
