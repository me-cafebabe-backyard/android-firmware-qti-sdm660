...
#define SNS_QDSS_DDF_NOTIFY_TIMER  1
#define SNS_QDSS_DDF_NOTIFY_IRQ    2
...
typedef struct {
  bool  ltcy_measure_enabled;
  uint64_t polling_cb_ts;
  uint64_t polling_get_data_start_ts;
  uint64_t polling_get_data_end_ts;
  uint64_t dri_notify_irq_ts;
  uint64_t dri_get_data_start_ts;
  uint64_t dri_get_data_end_ts;
