...
/*
 ...
 sns_init_done().
*/
#if defined(DAL_UCOS_TEST)  /* Init functions for DSPS test builds */
# define SNS_INIT_FUNCTIONS    \
  {   sns_memmgr_init,         \
      ...
      sns_init_tests,          \
      NULL }
#elif defined(QDSP6)  /* Init functions for all SSC builds (ADSP and SLPI) */
# if defined(SNS_QDSP_SIM)
#  if defined(SNS_USES_DISABLE_FP)
#    define SNS_INIT_FUNCTIONS    \
     {   sns_init_dsps,           \
       sns_em_init,             \
       sns_smr_init,            \
...
// Test modules:
//      sns_playback_init
//      debug_qmi_ping_client_start
//      sam_qmi_ping_client_start
...
#  define SNS_INIT_FUNCTIONS   \
    { sns_init_dsps,           \
      ...
      smgr_qmi_ping_client_start, \
      NULL }
# else  /* Init functions for non-test, non-bringup SSC builds */
#  if defined(SNS_USES_DISABLE_FP)
#    define SNS_INIT_FUNCTIONS     \
     {  sns_init_dsps,           \
        sns_em_init,             \
...
#  endif
# endif
#elif defined(_WIN32) /* Init functions for Windows */
# define SNS_INIT_FUNCTIONS                          \
  { { sns_memmgr_init, "sns_memmgr_init" },           \
    { sns_debug_test_init1, "sns_debug_test_init1" }, \
    { sns_em_init, "sns_em_init" },                   \
    { sns_smr_init, "sns_smr_init" },                   \
    { sns_pwr_init, "sns_pwr_init" }, /* WIN32 - moved below em */ \
    /* { sns_smr_init, "sns_smr_init" }, */           \
    { sns_reg_init, "sns_reg_init" },                 \
    /* { sns_sam_init, "sns_sam_init" }, WIN32, no SAM on APPS */  \
...
===========================================================================*/
/**
  @brief Initializes all the necessary data structures of SMGR task
...
===========================================================================*/
/**
  @brief Initializes all the necessary data structures of RH task
