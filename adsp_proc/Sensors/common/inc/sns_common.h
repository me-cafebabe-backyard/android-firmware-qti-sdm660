...
------------------------------------------------------------------------------
  ...
  $Header: //components/rel/ssc.slpi/2.2/common/inc/sns_common.h#1 $
...
#define SNS_MODULE_PRI_DSPS_SMR   (SNS_DSPS_MODULE_PRI_BASE + 3)
...
# else
#  define SNS_MODULE_STK_SIZE_DSPS_EVMGR    (0x300)
#  define SNS_MODULE_PRI_DSPS_SSM   (SNS_DSPS_MODULE_PRI_BASE + 10)
#  define SNS_MODULE_PRI_DSPS_EVMGR (SNS_DSPS_MODULE_PRI_BASE + 9)
#  define SNS_MODULE_PRI_DSPS_SMGR  (SNS_DSPS_MODULE_PRI_BASE + 8)
#  define SNS_MODULE_PRI_DSPS_SAM   (SNS_DSPS_MODULE_PRI_BASE + 7)
#  define SNS_MODULE_PRI_DSPS_RH    (SNS_DSPS_MODULE_PRI_BASE + 6)
#  define SNS_MODULE_PRI_DSPS_SCM   (SNS_DSPS_MODULE_PRI_BASE + 5)
#  define SNS_MODULE_PRI_DSPS_SMP2P (SNS_DSPS_MODULE_PRI_BASE + 4)
#  define SNS_MODULE_PRI_DSPS_PM    (SNS_DSPS_MODULE_PRI_BASE + 3)
# endif //SNS_QDSP_SIM
# define SNS_MODULE_PRI_DSPS_DEBUG (SNS_DSPS_MODULE_PRI_BASE + 2)
...
#if defined(SNS_LA) || defined(_WIN32)
...
#elif defined(QDSP6) || defined(SNS_DSPS_BUILD)
# ifdef SNS_DEBUG
#   define SNS_ASSERT(value) if((value)!=true)                          \
