...
/*============================================================================
  ...
  $Header: //components/rel/ssc.slpi/2.2/common/inc/sns_reg_common.h#1 $
  $DateTime: 2017/04/17 22:20:39 $

  when        who  what, where, why
  ----------  ---  -----------------------------------------------------------
  2016-09-20  qm   Added support for multi-mode qmagcal
  2016-06-15  BZ   Added Registry Data Group for device orientation
  2016-06-15  bd   Added LPS22HB
  2016-04-22  MW   Added CM3526, TMG490x
  2016-04-12  sd   Added LSM6DSM
  2016-03-17  bd   Added LIS3MDL
  2015-10-12  jtl  Added S4S flag
  2015-06-25  yh   Added MMC3530
  2015-06-17  AH   Support to request SNS_REG_GROUP_SSI_SMGR_CFG_3
  2015-04-02  MW   Added LSM6DS3, HTS221, LIS3MDL
  2016-02-10  jhh  Added QMag Cal Tuning parameter
  2015-10-19  TC   Added SSC GPIO config
  2015-09-24  AH   Added LSM6DS3
  2015-06-10  AH   Added Driver specific Registry for temperature and humidity
  2015-06-04  BD   Added IOD
  2015-05-20  AH   Support to request SNS_REG_GROUP_SSI_SMGR_CFG_3
  2015-04-03  AH   Added DTS201A and Object Temperature sensor type
  2015-03-25  AH   Added Registry Data Group for UV
  2015-03-12  AH   Added ADPD142
  2015-03-10  MW   Added UV sensor type, HSVDDD002A
  ...
  2014-04-18  MW   Added RGB driver specific registry
  2014-04-08  MW   Added LPS25H
  2014-04-08  MW   Added ambient temp sensor type
  2014-04-04  MW   Added generic vendor UUIDs - for HD22
  2014-02-05  ks   asynch reporting support for smd
  2013-12-18  MW   Support for Hall Effect sensor type
  2013-10-11  yh   Added AK09911C
  2013-11-29  yh   Added MC3410
  2013-11-27  DC   Added UUID for MAX44006
  2013-11-04  MW   Added LSM303D
  2013-10-23  MW   Added SNS_REG_SSI_DATA_TYPE_SAR and AD7146
  2013-09-23  yh   Added AL3320B
  2013-09-09  yh   Added CM36283
  2013-09-05  yh   Added KXTIK
  2013-10-09  RS   Added Memsic M34160PJ Mag
  2013-09-12  MW   Gesture type update, added BH1721
  ...
  2013-07-01  hw   Added Registry flag bit for latency measurement enabling/disabling
  2013-06-23  lka  Added SMGR CFG groups.
  2013-06-20  lka  Added UUID for MPU6515
  2013-06-17  pf   Added LTR55x
  2013-06-11  ae   Added QDSP SIM playback support
  2013-05-01  lka  Added LIS3DSH
  2013-02-27  ps   Added UUID for BMA2X2, TMD277x and HSCDTD008.
  2012-03-19  gju  Added driver-specific data fields to alp group.
  2012-03-02  pn   Added generic test flags item to test group
  2012-02-21  ks   Added registry support for gravity, orientation, fmv
  2011-12-04  ad   Remove use of featurization since the apps build does not support it
  2011-10-13  ad   Updated QMD configuration for 8960
  2011-09-19  gju  Added/updated throughout for new item/group: raw data mode
  2011-09-02  ks   Changed default RMD threshold value for LIS3DH
  2011-08-29  ad   Default AMD threshold support based on platform/sensor
  2011-08-29  ks   Changed default AMD threshold value for LIS3DH
  2011-08-02  rb   Added backwards compatibility for apps_registry module
  2011-07-28  rb   Added support for algorithm enabling/disabling & dynamic bias value storage
  2011-07-13  rb   Added support for gyro_cal configuration through registry
  2011-05-03  ad   Added support for QMD configuration through registry
  2011-04-14  dc   Changed als_factor and prx_factor to 16 bit items and changed defaults
  2011-03-31  dc   updates to group and items for accel and als/prx per revised design
  2011-03-08  dc   Initial revision
...
#define SNS_SAM_FUSION_DEF_SAMP_RATE_HZ (5)
#define SNS_SAM_FUSION_DEF_SAMP_RATE_HZ_Q16 (FX_CONV_Q16(SNS_SAM_FUSION_DEF_SAMP_RATE_HZ, 0))

/**
 * Default Values for items in group SNS_REG_SAM_GROUP_FMV_PARAMS_V02
 */
#define SNS_REG_DEF_FMV_TC_ACCURACY_0           3000
#define SNS_REG_DEF_FMV_TC_ACCURACY_1           250
...
#define SNS_REG_FMV_DEF_SENSOR_REPORT_RATE_Q16  SNS_SAM_FUSION_DEFAULT_REPORT_RATE_HZ_Q16
#define SNS_REG_FMV_DEF_SAMP_RATE_HZ_Q16        SNS_SAM_FUSION_DEF_SAMP_RATE_HZ_Q16
...
#define SNS_REG_GRAVITY_VECTOR_DEF_SENSOR_REPORT_RATE_Q16 SNS_SAM_FUSION_DEFAULT_REPORT_RATE_HZ_Q16
#define SNS_REG_GRAVITY_VECTOR_DEF_SAMP_RATE_HZ_Q16         SNS_SAM_FUSION_DEF_SAMP_RATE_HZ_Q16
...
#define SNS_REG_DEF_MAG_CAL_LAT_NUM_SAMPLES              0
#define SNS_REG_DEF_FUSION_MIN_SAMP_RATE_HZ              SNS_SAM_FUSION_DEF_SAMP_RATE_HZ
#define SNS_REG_ORIENTATION_DEF_SENSOR_REPORT_RATE_Q16   SNS_SAM_FUSION_DEFAULT_REPORT_RATE_HZ_Q16
#define SNS_REG_ORIENTATION_DEF_SAMP_RATE_HZ_Q16         SNS_SAM_FUSION_DEF_SAMP_RATE_HZ_Q16
...
#define SNS_REG_DEF_ITEM_SSI_SMGR_MIN_VER_NO 0

/*
 * SMGR CFG for 8974
 */
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_UUID_HIGH            0xcc4575757b462d60ULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_UUID_LOW             0x8d79ae42524820adULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_OFF_TO_IDLE          100000
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_IDLE_TO_READY        250000
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_I2C_BUS              12
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_REG_GROUP_ID         SNS_REG_DRIVER_GROUP_ACCEL_V02
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_CAL_PRI_GROUP_ID     SNS_REG_SCM_GROUP_ACCEL_FAC_CAL_PARAMS_V02
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_GPIO1                66
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_GPIO2                0xFFFF
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_SENSOR_ID            SNS_SMGR_ID_ACCEL_V01
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_I2C_ADDRESS          0x68
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_ACCEL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_RELATED_SENSOR_INDEX 1
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_SENSITIVITY_DEFAULT  1
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_FLAGS                SNS_REG_SSI_FLAG_NO_SENSITIVITY
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_DEVICE_SELECT        0

#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_UUID_HIGH            0xcc4575757b462d60ULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_UUID_LOW             0x8d79ae42524820adULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_OFF_TO_IDLE          100000
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_IDLE_TO_READY        250000
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_I2C_BUS              12
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_REG_GROUP_ID         SNS_REG_DRIVER_GROUP_GYRO_V02
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_CAL_PRI_GROUP_ID     SNS_REG_SCM_GROUP_GYRO_FAC_CAL_PARAMS_V02
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_GPIO1                66
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_GPIO2                0xFFFF
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_SENSOR_ID            SNS_SMGR_ID_GYRO_V01
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_I2C_ADDRESS          0x68
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_GYRO
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_TEMP
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_RELATED_SENSOR_INDEX 0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_SENSITIVITY_DEFAULT  2
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_FLAGS                SNS_REG_SSI_FLAG_NO_SENSITIVITY
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_DEVICE_SELECT        0

#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_UUID_HIGH            0x9e4e43dd9919b2d4ULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_UUID_LOW             0x355c5a01689ed8b6ULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_OFF_TO_IDLE          0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_IDLE_TO_READY        0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_I2C_BUS              3
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_REG_GROUP_ID         SNS_REG_DRIVER_GROUP_MAG_V02
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_CAL_PRI_GROUP_ID     SNS_REG_SCM_GROUP_MAG_FAC_CAL_PARAMS_V02
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_GPIO1                0xFFFF
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_GPIO2                0xFFFF
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_SENSOR_ID            SNS_SMGR_ID_MAG_V01
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_I2C_ADDRESS          0x0C
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_MAG
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_RELATED_SENSOR_INDEX 0xFF
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_SENSITIVITY_DEFAULT  0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_FLAGS                0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_DEVICE_SELECT        0

#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_UUID_HIGH            0xf2494d45c55e4f96ULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_UUID_LOW             0x8624930f2c38a784ULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_OFF_TO_IDLE          10000
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_IDLE_TO_READY        0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_I2C_BUS              3
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_REG_GROUP_ID         0xFFFF
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_CAL_PRI_GROUP_ID     0xFFFF
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_GPIO1                0xFFFF
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_GPIO2                0xFFFF
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_SENSOR_ID            SNS_SMGR_ID_PRESSURE_V01
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_I2C_ADDRESS          (0x0EE/2)
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_PRESSURE
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_TEMP
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_RELATED_SENSOR_INDEX 0xFF
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_SENSITIVITY_DEFAULT  0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_FLAGS                0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_DEVICE_SELECT        0

#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_UUID_HIGH            0x4c4bfbc3d8a879e6ULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_UUID_LOW             0x0ce6069d4d31faafULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_OFF_TO_IDLE          5000
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_IDLE_TO_READY        0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_I2C_BUS              3
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_REG_GROUP_ID         SNS_REG_DRIVER_GROUP_PROX_LIGHT_V02
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_CAL_PRI_GROUP_ID     0xFFFF
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_GPIO1                0xFFFF
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_GPIO2                0xFFFF
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_SENSOR_ID            SNS_SMGR_ID_PROX_LIGHT_V01
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_I2C_ADDRESS          0x39
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_PROXIMITY
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_AMBIENT
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_RELATED_SENSOR_INDEX 0xFF
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_SENSITIVITY_DEFAULT  0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_FLAGS                0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_DEVICE_SELECT        0

// CFG_2
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_2_UUID_HIGH            0x40410cafc67cfbbeULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_2_UUID_LOW             0xcc631478716da795ULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_2_OFF_TO_IDLE          10000
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_2_IDLE_TO_READY        10000
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_2_I2C_BUS              3
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_2_REG_GROUP_ID         0xFFFF
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_2_CAL_PRI_GROUP_ID     0xFFFF
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_2_GPIO1                0xFFFF
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_2_GPIO2                0xFFFF
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_2_SENSOR_ID            SNS_SMGR_ID_HUMIDITY_V01
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_2_I2C_ADDRESS          0x70
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_2_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_HUMIDITY
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_2_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_TEMP
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_2_RELATED_SENSOR_INDEX 0xFF
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_2_SENSITIVITY_DEFAULT  0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_2_FLAGS                0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG0_2_DEVICE_SELECT        0

#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_2_UUID_HIGH            0x0000000000000000ULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_2_UUID_LOW             0x0000000000000000ULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_2_OFF_TO_IDLE          10000
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_2_IDLE_TO_READY        10000
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_2_I2C_BUS              0x00
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_2_REG_GROUP_ID         0xffff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_2_CAL_PRI_GROUP_ID     0xffff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_2_GPIO1                0xffff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_2_GPIO2                0xffff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_2_SENSOR_ID            0xff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_2_I2C_ADDRESS          0x00
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_2_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_2_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_2_RELATED_SENSOR_INDEX 0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_2_SENSITIVITY_DEFAULT  SNS_REG_SSI_FLAG_NO_SENSITIVITY
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_2_FLAGS                0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG1_2_DEVICE_SELECT        0

#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_2_UUID_HIGH            0x0000000000000000ULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_2_UUID_LOW             0x0000000000000000ULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_2_OFF_TO_IDLE          10000
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_2_IDLE_TO_READY        10000
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_2_I2C_BUS              0x00
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_2_REG_GROUP_ID         0xffff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_2_CAL_PRI_GROUP_ID     0xffff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_2_GPIO1                0xffff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_2_GPIO2                0xffff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_2_SENSOR_ID            0xff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_2_I2C_ADDRESS          0x00
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_2_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_2_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_2_RELATED_SENSOR_INDEX 0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_2_SENSITIVITY_DEFAULT  SNS_REG_SSI_FLAG_NO_SENSITIVITY
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_2_FLAGS                0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG2_2_DEVICE_SELECT        0

#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_2_UUID_HIGH            0x0000000000000000ULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_2_UUID_LOW             0x0000000000000000ULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_2_OFF_TO_IDLE          10000
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_2_IDLE_TO_READY        10000
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_2_I2C_BUS              0x00
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_2_REG_GROUP_ID         0xffff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_2_CAL_PRI_GROUP_ID     0xffff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_2_GPIO1                0xffff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_2_GPIO2                0xffff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_2_SENSOR_ID            0xff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_2_I2C_ADDRESS          0x00
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_2_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_2_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_2_RELATED_SENSOR_INDEX 0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_2_SENSITIVITY_DEFAULT  SNS_REG_SSI_FLAG_NO_SENSITIVITY
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_2_FLAGS                0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG3_2_DEVICE_SELECT        0

#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_2_UUID_HIGH            0x0000000000000000ULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_2_UUID_LOW             0x0000000000000000ULL
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_2_OFF_TO_IDLE          10000
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_2_IDLE_TO_READY        10000
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_2_I2C_BUS              0x00
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_2_REG_GROUP_ID         0xffff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_2_CAL_PRI_GROUP_ID     0xffff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_2_GPIO1                0xffff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_2_GPIO2                0xffff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_2_SENSOR_ID            0xff
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_2_I2C_ADDRESS          0x00
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_2_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_2_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_2_RELATED_SENSOR_INDEX 0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_2_SENSITIVITY_DEFAULT  SNS_REG_SSI_FLAG_NO_SENSITIVITY
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_2_FLAGS                0
#define SNS_REG_DEF_ITEM_8974_SSI_SMGR_CFG4_2_DEVICE_SELECT        0

/*
 * SMGR CFG for 8x26
 */
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_UUID_HIGH            0xaf4644363f26965dULL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_UUID_LOW             0xc10ffaeed4057c96ULL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_OFF_TO_IDLE          2000
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_IDLE_TO_READY        100000
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_I2C_BUS              2
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_REG_GROUP_ID         SNS_REG_DRIVER_GROUP_ACCEL_V02
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_CAL_PRI_GROUP_ID     SNS_REG_SCM_GROUP_ACCEL_FAC_CAL_PARAMS_V02
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_GPIO1                63
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_GPIO2                0xFFFF
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_SENSOR_ID            SNS_SMGR_ID_ACCEL_V01
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_I2C_ADDRESS          0x18
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_ACCEL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_RELATED_SENSOR_INDEX 0xFF
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_SENSITIVITY_DEFAULT  1
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_FLAGS                SNS_REG_SSI_FLAG_NO_SENSITIVITY
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_DEVICE_SELECT        0

#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_UUID_HIGH            0xc546930e071dc819ULL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_UUID_LOW             0x1b810db85f93c082ULL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_OFF_TO_IDLE          150000
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_IDLE_TO_READY        100000
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_I2C_BUS              2
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_REG_GROUP_ID         SNS_REG_DRIVER_GROUP_GYRO_V02
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_CAL_PRI_GROUP_ID     SNS_REG_SCM_GROUP_GYRO_FAC_CAL_PARAMS_V02
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_GPIO1                66
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_GPIO2                0xFFFF
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_SENSOR_ID            SNS_SMGR_ID_GYRO_V01
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_I2C_ADDRESS          0x68
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_GYRO
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_TEMP
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_RELATED_SENSOR_INDEX 0xFF
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_SENSITIVITY_DEFAULT  2
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_FLAGS                SNS_REG_SSI_FLAG_NO_SENSITIVITY
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_DEVICE_SELECT        0

#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_UUID_HIGH            0xe1451a747fc17ad2ULL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_UUID_LOW             0x6b7b6b353051699eULL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_OFF_TO_IDLE          100000
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_IDLE_TO_READY        0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_I2C_BUS              2
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_REG_GROUP_ID         SNS_REG_DRIVER_GROUP_MAG_V02
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_CAL_PRI_GROUP_ID     SNS_REG_SCM_GROUP_MAG_FAC_CAL_PARAMS_V02
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_GPIO1                0xFFFF
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_GPIO2                0xFFFF
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_SENSOR_ID            SNS_SMGR_ID_MAG_V01
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_I2C_ADDRESS          0x0C
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_MAG
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_RELATED_SENSOR_INDEX 0xFF
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_SENSITIVITY_DEFAULT  0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_FLAGS                0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_DEVICE_SELECT        0

#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_UUID_HIGH            0x0LL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_UUID_LOW             0x0LL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_OFF_TO_IDLE          0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_IDLE_TO_READY        0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_I2C_BUS              0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_REG_GROUP_ID         0xFFFF
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_CAL_PRI_GROUP_ID     0xFFFF
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_GPIO1                0xFFFF
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_GPIO2                0xFFFF
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_SENSOR_ID            SNS_SMGR_ID_PRESSURE_V01
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_I2C_ADDRESS          0x0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_PRESSURE
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_TEMP
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_RELATED_SENSOR_INDEX 0xFF
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_SENSITIVITY_DEFAULT  0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_FLAGS                0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_DEVICE_SELECT        0

#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_UUID_HIGH            0x0ULL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_UUID_LOW             0x0ULL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_OFF_TO_IDLE          5000
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_IDLE_TO_READY        0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_I2C_BUS              2
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_REG_GROUP_ID         SNS_REG_DRIVER_GROUP_PROX_LIGHT_V02
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_CAL_PRI_GROUP_ID     0xFFFF
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_GPIO1                0xFFFF
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_GPIO2                0xFFFF
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_SENSOR_ID            SNS_SMGR_ID_PROX_LIGHT_V01
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_I2C_ADDRESS          0x39
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_PROXIMITY
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_AMBIENT
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_RELATED_SENSOR_INDEX 0xFF
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_SENSITIVITY_DEFAULT  0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_FLAGS                0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_DEVICE_SELECT        0

// CFG_2
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_2_UUID_HIGH            0x0000000000000000ULL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_2_UUID_LOW             0x0000000000000000ULL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_2_OFF_TO_IDLE          10000
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_2_IDLE_TO_READY        10000
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_2_I2C_BUS              0x00
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_2_REG_GROUP_ID         0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_2_CAL_PRI_GROUP_ID     0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_2_GPIO1                0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_2_GPIO2                0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_2_SENSOR_ID            0xff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_2_I2C_ADDRESS          0x00
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_2_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_2_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_2_RELATED_SENSOR_INDEX 0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_2_SENSITIVITY_DEFAULT  SNS_REG_SSI_FLAG_NO_SENSITIVITY
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_2_FLAGS                0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG0_2_DEVICE_SELECT        0

#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_2_UUID_HIGH            0x0000000000000000ULL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_2_UUID_LOW             0x0000000000000000ULL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_2_OFF_TO_IDLE          10000
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_2_IDLE_TO_READY        10000
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_2_I2C_BUS              0x00
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_2_REG_GROUP_ID         0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_2_CAL_PRI_GROUP_ID     0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_2_GPIO1                0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_2_GPIO2                0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_2_SENSOR_ID            0xff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_2_I2C_ADDRESS          0x00
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_2_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_2_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_2_RELATED_SENSOR_INDEX 0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_2_SENSITIVITY_DEFAULT  SNS_REG_SSI_FLAG_NO_SENSITIVITY
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_2_FLAGS                0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG1_2_DEVICE_SELECT        0

#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_2_UUID_HIGH            0x0000000000000000ULL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_2_UUID_LOW             0x0000000000000000ULL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_2_OFF_TO_IDLE          10000
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_2_IDLE_TO_READY        10000
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_2_I2C_BUS              0x00
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_2_REG_GROUP_ID         0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_2_CAL_PRI_GROUP_ID     0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_2_GPIO1                0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_2_GPIO2                0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_2_SENSOR_ID            0xff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_2_I2C_ADDRESS          0x00
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_2_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_2_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_2_RELATED_SENSOR_INDEX 0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_2_SENSITIVITY_DEFAULT  SNS_REG_SSI_FLAG_NO_SENSITIVITY
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_2_FLAGS                0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG2_2_DEVICE_SELECT        0

#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_2_UUID_HIGH            0x0000000000000000ULL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_2_UUID_LOW             0x0000000000000000ULL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_2_OFF_TO_IDLE          10000
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_2_IDLE_TO_READY        10000
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_2_I2C_BUS              0x00
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_2_REG_GROUP_ID         0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_2_CAL_PRI_GROUP_ID     0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_2_GPIO1                0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_2_GPIO2                0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_2_SENSOR_ID            0xff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_2_I2C_ADDRESS          0x00
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_2_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_2_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_2_RELATED_SENSOR_INDEX 0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_2_SENSITIVITY_DEFAULT  SNS_REG_SSI_FLAG_NO_SENSITIVITY
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_2_FLAGS                0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG3_2_DEVICE_SELECT        0

#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_2_UUID_HIGH            0x0000000000000000ULL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_2_UUID_LOW             0x0000000000000000ULL
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_2_OFF_TO_IDLE          10000
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_2_IDLE_TO_READY        10000
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_2_I2C_BUS              0x00
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_2_REG_GROUP_ID         0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_2_CAL_PRI_GROUP_ID     0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_2_GPIO1                0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_2_GPIO2                0xffff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_2_SENSOR_ID            0xff
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_2_I2C_ADDRESS          0x00
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_2_DATA_TYPE1           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_2_DATA_TYPE2           SNS_REG_SSI_DATA_TYPE_NONE
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_2_RELATED_SENSOR_INDEX 0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_2_SENSITIVITY_DEFAULT  SNS_REG_SSI_FLAG_NO_SENSITIVITY
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_2_FLAGS                0
#define SNS_REG_DEF_ITEM_8226_SSI_SMGR_CFG4_2_DEVICE_SELECT        0
 ...
 */
#define SNS_REG_QUATERNION_DEF_SENSOR_REPORT_RATE_Q16 SNS_SAM_FUSION_DEFAULT_REPORT_RATE_HZ_Q16
#define SNS_REG_QUATERNION_DEF_SAMP_RATE_HZ_Q16         SNS_SAM_FUSION_DEF_SAMP_RATE_HZ_Q16

/**
 * Default values for items in group SNS_REG_SAM_GROUP_ROTATION_VECTOR
 */
#define SNS_REG_ROTATION_VECTOR_DEF_SENSOR_REPORT_RATE_Q16 SNS_SAM_FUSION_DEFAULT_REPORT_RATE_HZ_Q16
#define SNS_REG_ROTATION_VECTOR_DEF_SAMP_RATE_HZ_Q16           SNS_SAM_FUSION_DEF_SAMP_RATE_HZ_Q16
 ...
 */
#define SNS_REG_GAME_ROT_VEC_DEF_SENSOR_REPORT_RATE_Q16     SNS_SAM_FUSION_DEFAULT_REPORT_RATE_HZ_Q16
#define SNS_REG_GAME_ROT_VEC_DEF_SAMP_RATE_HZ_Q16           (FX_CONV_Q16(25, 0))
 ...
 */
#define SNS_REG_GROUP_QMAG_CAL_DEF_SAMPLE_RATE              10 /* Default Sample rate in Hz */
...
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_ENABLE_ALGO         1
...
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM3              5
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM4              5
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM5              (0.08f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM6              (0.85f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM7              (0.0f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM8              (0.54f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM9              (0.76f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM10             (0.9f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM11             (0.0f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM12             (0.75*32.0f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM13             (0.8*48.0f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM14             (64.0f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM15             (0.03f*0.03f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM16             (0.10f*0.10f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM17             (0.28f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM18             (0.43f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM19             (2.5f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM20             (0.5f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM21             (1.25f*SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM20)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM22             (18.0f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM23             (0.25f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM24             (0.25f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM25             (0.25f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM26             (0.0003f)
#define SNS_REG_GROUP_QMAG_CAL_ALGO_DEF_PARAM27             (0.3253f)
/**
 * Default values for items in group SNS_REG_SAM_GROUP_SMD
 */
#define SNS_REG_SMD_DEF_VERSION                  01
...
#define SNS_REG_SMD_DEF_ACCEL_WINDOW_TIME        5      // accel window time in secs
...
#define SNS_REG_IOD_AUTOCAL_DEF_CONVERGENCE_STATUS          2     // Autocal convergence status
...
#define SNS_REG_MULTISHAKE_SLEEP_DEF                        (FX_FLTTOFIX_Q16(0.12))    // seconds, Q16
...
typedef PACK(struct)
{
  ...
  int32_t sensor_report_rate;/* Default sensor report rate in Hz (Q16) */
  q16_t def_samp_rate;/* Default sensor sampling rate in Hz (Q16) */
...
typedef PACK(struct)
{
  ...
  int32_t sensor_report_rate;/* Default sensor report rate in Hz (Q16) */
  q16_t def_samp_rate; /* Default sensor sample rate in Hz (Q16) */
...
typedef PACK(struct)
{
  uint32_t min_num_of_samples;      /* Minimum number of samples required to detect device motion state */
  uint32_t max_num_of_samples;      /* Maximum number of samples used to detect device motion state */
  uint32_t def_state_detect_thresh; /* Default motion detection threshold. Range: 0-100, in unit of percentage */
...
/**
 * Flag true if device supports a FIFO */
#define SNS_REG_SSI_FLAG_FIFO                    0x10
 ...
 */
#define REG_QMAG_CAL_CALIBRATION_HISTORY (5)
#define REG_QMAG_CAL_RADIUS_HISTORY (5)
#define REG_QMAG_CAL_COL (3)
typedef PACK(struct)
{
   uint32_t  version_no;
   uint8_t   enable_algo;
   ...
   float     radius_hi_buff[REG_QMAG_CAL_RADIUS_HISTORY];
   uint8_t   radius_hi_buff_count;
   float     offset_hi_buff[REG_QMAG_CAL_CALIBRATION_HISTORY][REG_QMAG_CAL_COL];
   uint8_t   offset_hi_buff_count;
   float     accuracy_hi_buff[REG_QMAG_CAL_CALIBRATION_HISTORY];
...
#define SNS_REG_DDF_SLPI_GPIO_CONFIG_MAX  30
...
typedef PACK(struct)
{
  ...
  uint16_t gpio_num; // If the gpio_num is invalid (0xFFFF), then ignore this group
                     // If version is 1, then interpret the gpio_num as follows:
                     //   If the upper byte of gpio_num (0xFF00 & gpio_num) is 1
                     //   then the GPIO is an SLPI GPIO, else the GPIO is a MSM GPIO
                     // Other version numbers may have different interpretations
