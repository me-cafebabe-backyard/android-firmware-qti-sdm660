...
Copyright (c) 1990-2009, 2015 Qualcomm Technologies, Inc. 
All Rights Reserved.
...
$Header: //components/rel/ssc.slpi/2.2/common/util/queue/src/sns_uimg_queue.c#1 $ $DateTime: 2017/04/17 22:20:39 $ $Author: pwbldsvc $

when       who    what, where, why
--------   ---    ----------------------------------------------------------
2016-12-05 qm     fix sns_q_check/last NULL ptr issue
2015-08-12 bd     added sns_q_check_probe and sns_q_last_check_probe
2015-07-13 bd     fixing insert after function
2015-03-26 ps     Updated license header
2014-06-05 vy     Added sns_q_get to uImage
...
/*===========================================================================
FUNCTION sns_q_check_probe

DESCRIPTION
  This function returns the pointer to the sns_q_link_s of the head
...
FUNCTION Q_LAST_CHECK_probe

DESCRIPTION
  This function returns sns_q_link_s of the item that was most recently enqueued
  in a queue.
