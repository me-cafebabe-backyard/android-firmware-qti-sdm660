...
$Header: //components/rel/ssc.slpi/2.2/debug/src/sns_debug_dsps.c#1 $


when         who     what, where, why
----------   ---     ---------------------------------------------------------
2016-09-08   pb      Remove deprecated SMD references
2016-04-20   bd      disable log mask for dragon board
2016-02-04   qmao    enable query log packet bit mask from diag directly
2015-09-10   hw      Register to PM with exit uimg callback function so that sending
                     out queued log packet whenever exiting uimg
...
/* Timeout timer for DIAG log pack bit mask requests during initialization */
...
)
{
  ...
  {
    //TODO deprecate SNS_DIAG_SET_LOG_MASK_REQ_V01, need to update sensor daemon side
