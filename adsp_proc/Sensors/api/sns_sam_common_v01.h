...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/ssc.slpi/2.2/api/sns_sam_common_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Mon Aug 24 2015 (Spin 0)
...
#define SNS_SAM_COMMON_V01_IDL_MINOR_VERS 0x04
...
/** @addtogroup sns_sam_common_qmi_enums
  ...
  */
typedef enum {
  SNS_SAM_BATCH_CONFIG_E_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  SNS_SAM_BATCH_ISLAND_V01 = -1, /**<  Non-numerical batching configurations; used in batch_period field.
  ...
  SNS_SAM_BATCH_SINGLE_V01 = -2, /**<  Non-numerical batching configurations; used in batch_period field.
       Batch until a single, full, batch indication message is available,
       then send that message.  */
  SNS_SAM_BATCH_INTERNAL_V01 = -3, /**<  Non-numerical batching configurations; used in batch period field.
       Allow SAM to determine how many samples to batch. Can be a very small number. */
  SNS_SAM_BATCH_CONFIG_E_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}sns_sam_batch_config_e_v01;
/**
    @}
  */
...
/** @addtogroup sns_sam_common_qmi_messages
    @{
  */
/** Request Message; This command requests the attributes of the algorithm service
