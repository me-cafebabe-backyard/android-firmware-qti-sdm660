...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/ssc.slpi/2.2/api/sns_sam_sensor_thresh_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
/* This file was generated with Tool version 6.14.2 
   It was generated on: Thu Dec  4 2014 (Spin 0)
...
#define SNS_SAM_SENSOR_THRESH_SVC_V01_IDL_MINOR_VERS 0x07
...
#define SNS_SAM_SENSOR_THRESH_MAX_ITEMS_IN_BATCH_V01 50
/**
    @}
  */
...
/** @addtogroup SNS_SAM_SENSOR_THRESH_SVC_qmi_messages
    @{
  */
/** Request Message; This command handles batch mode for the sensor-threshold algorithm. */
typedef struct {
  ...
  /**<   Specifies interval over which reports are to be batched in seconds, Q16.
    ...
    */
}sns_sam_sensor_thresh_batch_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup SNS_SAM_SENSOR_THRESH_SVC_qmi_messages
    @{
  */
/** Response Message; This command handles batch mode for the sensor-threshold algorithm. */
typedef struct {
...
}sns_sam_sensor_thresh_batch_resp_msg_v01;  /* Message */
/**
    @}
  */

/** @addtogroup SNS_SAM_SENSOR_THRESH_SVC_qmi_aggregates
    @{
  */
typedef struct {
  ...
  /**<   Output of the sensor threshold algorithm:
       ...
       The current sample values are reported in Q16 format.
  */
}sns_sam_sensor_thresh_batch_item_s_v01;  /* Type */
/**
    @}
  */
...
typedef struct {
  ...
  sns_sam_sensor_thresh_batch_item_s_v01 items[SNS_SAM_SENSOR_THRESH_MAX_ITEMS_IN_BATCH_V01];
  /**<   sensor-threshold algorithm output reports */
  ...
  /**<   Optional batch indication type
    ...
    */
}sns_sam_sensor_thresh_batch_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_SNS_SAM_SENSOR_THRESH_BATCH_V01 
//#define REMOVE_SNS_SAM_SENSOR_THRESH_BATCH_REPORT_V01 
...
#define SNS_SAM_SENSOR_THRESH_BATCH_REQ_V01 0x0021
#define SNS_SAM_SENSOR_THRESH_BATCH_RESP_V01 0x0021
#define SNS_SAM_SENSOR_THRESH_BATCH_IND_V01 0x0022
