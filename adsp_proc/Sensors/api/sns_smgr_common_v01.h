...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/ssc.slpi/2.2/api/sns_smgr_common_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
/* This file was generated with Tool version 6.14.7 
   It was generated on: Mon Sep 26 2016 (Spin 0)
...
#define SNS_SMGR_COMMON_V01_IDL_MINOR_VERS 0x07
...
/**  This pending request has been superceded and cancelled, due to a new
       request on this connection/report ID  */
#define SNS_SMGR_RESPONSE_NAK_CANCELLED_V01 11

/**  The combination of sensor and/or data types in this request are not
       allowed and/or cannot be supported  */
#define SNS_SMGR_RESPONSE_NAK_NOT_ALLOWED_V01 12
...
/**  Primary = Ultra-violet, Secondary = Ambient light */
#define SNS_SMGR_ID_ULTRA_VIOLET_V01 100

/**  Primary = Object-temperature, Secondary = (none)  */
#define SNS_SMGR_ID_OBJECT_TEMP_V01 110
...
/**  Embedded sensor: Primary = tilt-detect, Secondary = (none)   */
#define SNS_SMGR_ID_TILT_EVENT_V01 232

/**  Embedded sensor: Primary = orientation, Secondary = (none)   */
#define SNS_SMGR_ID_ORIENTATION_EVENT_V01 234
...
#define SNS_SMGR_SUID_ULTRA_VIOLET_1_V01 0x0e557777948ae3cc
#define SNS_SMGR_SUID_ULTRA_VIOLET_LIGHT_1_V01 0x6604e8c151bc7ca7
#define SNS_SMGR_SUID_OBJECT_TEMP_1_V01 0xdb798cea1344a2e5
#define SNS_SMGR_SUID_TILT_EVENT_1_V01 0x797db4dac67dd7b9
#define SNS_SMGR_SUID_ORIENTATION_EVENT_1_V01 0xbfa0a9292d9c0e59
#define SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_01_V01 0x68ce9b06e6cb0dd8
#define SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_01_V01 0xeced517995951b73
#define SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_02_V01 0x783113a4503216c7
#define SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_02_V01 0x4839c03ec8de33fb
#define SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_03_V01 0x52642cb7579cbc28
#define SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_03_V01 0x487b836f588c5e2c
#define SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_04_V01 0x4841ad94e29a562c
#define SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_04_V01 0xa4a9dab8d44dbb03
#define SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_05_V01 0xf167e90d15910200
#define SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_05_V01 0x83381ed9cecf51d1
#define SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_06_V01 0x2a60076f5f534c54
#define SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_06_V01 0xc6f5fccae009dc99
#define SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_07_V01 0x67c08172635fe240
#define SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_07_V01 0x7419e9e98b3fdab9
#define SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_08_V01 0xccc11a5bae00cc95
#define SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_08_V01 0x419d9d3cbb2ad338
#define SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_09_V01 0x8cdcd1257162acf1
#define SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_09_V01 0x708b6a4744d68d3c
#define SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_10_V01 0x4169c5d545fc9abd
#define SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_10_V01 0xbc350fdc12b43eff
...
/**  Identify the sensor test type.
 ...
 Error code used in sns_smgr_report_error_ind_msg
...
#define SNS_SMGR_BUFFERING_ACTION_FLUSH_V01 3
...
typedef enum {
  ...
  SNS_SMGR_OP_MODE_S4S_V01 = 3, /**<  sensor hardware supports S4S.  */
...
/** @addtogroup sns_smgr_common_qmi_enums
  ...
  */
typedef enum {
  SNS_SMGR_REPORT_ERROR_E_MIN_ENUM_VAL_V01 = -2147483647, /**< To force a 32 bit signed enum.  Do not change or use*/
  SNS_SMGR_REPORT_ERROR_NONE_V01 = 0, 
  SNS_SMGR_SENSOR_ERROR_GENERIC_V01 = 1, /**<  Generic error  */
  SNS_SMGR_REPORT_ERROR_DEVICE_V01 = 2, /**<  Device failed to stream data  */
  SNS_SMGR_REPORT_ERROR_NOMEM_V01 = 3, /**<  Out of memory  */
  SNS_SMGR_REPORT_ERROR_E_MAX_ENUM_VAL_V01 = 2147483647 /**< To force a 32 bit signed enum.  Do not change or use*/
}sns_smgr_report_error_e_v01;
/**
    @}
  */
...
typedef struct {
  ...
  /**<   Defines the sensor that this configuration pertains to. The sensor can be
    ...
    - 100 - SNS_SMGR_ID_ULTRA_VIOLET
    - 110 - SNS_SMGR_ID_OBJECT_TEMP
...
typedef struct {
  ...
  */
  ...
  /**<   For 3-axis items such as accelerometer, gyro, and magnetometer,
     ...
     - ULTRA_VIOLET: X = Total UV (or UV-A) mW/cm2, Y = UV-B mW/cm2 (optional),
                     Z = UV-index unitless (optional)
     - OBJECT_TEMP : X = Object  temperature in degrees Celsius in Q16,
                     Y = Human   temperature in degrees Celsius in Q16 (optional),
                     z = Ambient temperature in degrees Celsius in Q16 (optional),
...
typedef struct {
  ...
  /**<   Identifies the sensor to be sampled for data.  The valid sensors are:
    ...
    - SNS_SMGR_ID_ULTRA_VIOLET
    - SNS_SMGR_ID_OBJECT_TEMP
...
typedef struct {
  ...
  /**<   Each sample can have up to SNS_SMGR_SENSOR_DIMENSION words, each word
    ...
    respectively.  For others, only Data[0] has valid measurement.
     ...
     - IR_GESTURE             : (revision 10: Sensor ID defined, but not used)
     - ULTRA_VIOLET/PRIMARY   : 3 axis,
                                X = UV radiation in mW/cm2 in Q16 (if sensor supports UV-A then
                                report UV-A else report total UV radiation)
                                Y = UV-B radiation in mW/cm2 in Q16 (optional for parts that dont support UV-B)
                                Z = UV index in Q16 (optional for parts that dont support UV-B)
     - ULTRA_VIOLET/SECONDARY : 1 axis, in Lux
     - OBJECT_TEMP/PRIMARY    : 3 axis,
                                X = Object  temperature in degrees Celsius in Q16
                                Y = Human   temperature in degrees Celsius in Q16 (optional for parts that dont support Human   temperature)
                                Z = Ambient temperature in degrees Celsius in Q16 (optional for parts that dont support Ambient temperature)
                                   (NOTE : parts that don't support Y and Z MUST not use 0 value, as zero is a valid temperature.
                                    Recommended using 0x80000000 (-32768) for un-supported case)
     - DOUBLE-TAP/PRIMARY     :
