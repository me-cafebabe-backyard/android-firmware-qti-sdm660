...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/ssc.slpi/2.2/api/sns_sam_filtered_mag_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
#define SNS_SAM_FILTERED_MAG_SVC_V01_IDL_MINOR_VERS 0x05
...
/** @addtogroup SNS_SAM_FILTERED_MAG_SVC_qmi_consts 
    @{ 
  */
#define SNS_SAM_FILTERED_MAG_SUID_V01 0x1f26c853d60b4ab0

/**  Max number of reports in a batch indication -
     set based on max payload size supported by transport framework */
#define SNS_SAM_FILTERED_MAG_MAX_REPORTS_IN_BATCH_V01 98
/**
    @}
  */
...
/** @addtogroup SNS_SAM_FILTERED_MAG_SVC_qmi_messages
    @{
  */
/** Request Message; Enables a filtered magnetometer algorithm. */
typedef struct {
...
/** @addtogroup SNS_SAM_FILTERED_MAG_SVC_qmi_messages
    @{
  */
/** Response Message; Enables a filtered magnetometer algorithm. */
typedef struct {
...
/** @addtogroup SNS_SAM_FILTERED_MAG_SVC_qmi_messages
    @{
  */
/** Request Message; Disables a filtered magnetometer algorithm. */
typedef struct {
...
/** @addtogroup SNS_SAM_FILTERED_MAG_SVC_qmi_messages
    @{
  */
/** Response Message; Disables a filtered magnetometer algorithm. */
typedef struct {
...
/** @addtogroup SNS_SAM_FILTERED_MAG_SVC_qmi_messages
    @{
  */
/** Indication Message; Report containing the filtered mag algorithm output. */
typedef struct {
...
/** @addtogroup SNS_SAM_FILTERED_MAG_SVC_qmi_messages
    @{
  */
/** Request Message; Gets the latest report output of a filtered mag algorithm. */
typedef struct {
...
/** @addtogroup SNS_SAM_FILTERED_MAG_SVC_qmi_messages
    @{
  */
/** Response Message; Gets the latest report output of a filtered mag algorithm. */
typedef struct {
...
/** @addtogroup SNS_SAM_FILTERED_MAG_SVC_qmi_messages
    @{
  */
/** Indication Message; Asynchronous error indication for a filtered mag algorithm. */
typedef struct {
...
/** @addtogroup SNS_SAM_FILTERED_MAG_SVC_qmi_messages
    @{
  */
/** Request Message; This command handles batch mode for Filtered Magnetic Vector algorithm. */
typedef struct {
  ...
  /**<   Specifies interval over which reports are to be batched in seconds, Q16.
    ...
    */
}sns_sam_filtered_mag_batch_req_msg_v01;  /* Message */
/**
    @}
  */
...
/** @addtogroup SNS_SAM_FILTERED_MAG_SVC_qmi_messages
    @{
  */
/** Response Message; This command handles batch mode for Filtered Magnetic Vector algorithm. */
typedef struct {
...
}sns_sam_filtered_mag_batch_resp_msg_v01;  /* Message */
/**
    @}
  */
...
typedef struct {
  ...
  uint16_t timestamp_offsets[SNS_SAM_FILTERED_MAG_MAX_REPORTS_IN_BATCH_V01];
  /**<   Offsets from timestamp of previous report in batch */

  /* Mandatory */
  uint32_t reports_len;  /**< Must be set to # of elements in reports */
  sns_sam_filtered_mag_result_s_v01 reports[SNS_SAM_FILTERED_MAG_MAX_REPORTS_IN_BATCH_V01];
  ...
  /**<   Optional batch indication type
    ...
    */
}sns_sam_filtered_mag_batch_ind_msg_v01;  /* Message */
/**
    @}
  */
...
//#define REMOVE_SNS_SAM_FILTERED_MAG_BATCH_V01 
//#define REMOVE_SNS_SAM_FILTERED_MAG_BATCH_REPORT_V01 
//#define REMOVE_SNS_SAM_FILTERED_MAG_DISABLE_V01 
//#define REMOVE_SNS_SAM_FILTERED_MAG_ENABLE_V01 
//#define REMOVE_SNS_SAM_FILTERED_MAG_ERROR_V01 
//#define REMOVE_SNS_SAM_FILTERED_MAG_GET_REPORT_V01 
//#define REMOVE_SNS_SAM_FILTERED_MAG_REPORT_V01 
...
#define SNS_SAM_FILTERED_MAG_BATCH_REQ_V01 0x0021
#define SNS_SAM_FILTERED_MAG_BATCH_RESP_V01 0x0021
#define SNS_SAM_FILTERED_MAG_BATCH_IND_V01 0x0022
