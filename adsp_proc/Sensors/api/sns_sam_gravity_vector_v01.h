...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/ssc.slpi/2.2/api/sns_sam_gravity_vector_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
#define SNS_SAM_GRAVITY_VECTOR_SVC_V01_IDL_MINOR_VERS 0x09
...
/** @addtogroup SNS_SAM_GRAVITY_VECTOR_SVC_qmi_consts 
    @{ 
  */
#define SNS_SAM_GRAVITY_SUID_V01 0x26b72459ecee3cf6
...
typedef enum {
  ...
  SNS_SAM_GRAVITY_DEV_STATE_UNKNOWN_V01 = 0, /**<  Gravity device state is unknown.  */
  SNS_SAM_GRAVITY_DEV_ABS_REST_V01 = 1, /**<  Gravity device is in absolute rest.  */
  SNS_SAM_GRAVITY_DEV_REL_REST_V01 = 2, /**<  Gravity device is in relative rest.  */
  SNS_SAM_GRAVITY_DEV_MOTION_V01 = 3, /**<  Gravity device in motion.  */
...
/** @addtogroup SNS_SAM_GRAVITY_VECTOR_SVC_qmi_messages
    @{
  */
/** Indication Message; Report containing the Gravity algorithm output. */
typedef struct {
...
//#define REMOVE_SNS_SAM_GRAVITY_BATCH_V01 
//#define REMOVE_SNS_SAM_GRAVITY_BATCH_REPORT_V01 
//#define REMOVE_SNS_SAM_GRAVITY_DISABLE_V01 
//#define REMOVE_SNS_SAM_GRAVITY_ENABLE_V01 
//#define REMOVE_SNS_SAM_GRAVITY_ERROR_V01 
//#define REMOVE_SNS_SAM_GRAVITY_GET_REPORT_V01 
//#define REMOVE_SNS_SAM_GRAVITY_REPORT_V01 
//#define REMOVE_SNS_SAM_GRAV_UPDATE_BATCH_PERIOD_V01 
