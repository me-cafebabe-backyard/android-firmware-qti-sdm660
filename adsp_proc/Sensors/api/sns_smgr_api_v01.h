...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/ssc.slpi/2.2/api/sns_smgr_api_v01.h#2 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
#define SNS_SMGR_SVC_V01_IDL_MINOR_VERS 0x1C
...
/** 
 ...
 selftest Additional information.  */
#define ADDITIONAL_INFOLENGTH_V01 16
/**
    @}
  */
...
typedef struct {
  ...
  */
  ...
  /* Optional */
  uint8_t AdditionalInfo_valid;  /**< Must be set to true if AdditionalInfo is being passed */
  uint32_t AdditionalInfo_len;  /**< Must be set to # of elements in AdditionalInfo */
  int32_t AdditionalInfo[ADDITIONAL_INFOLENGTH_V01];
