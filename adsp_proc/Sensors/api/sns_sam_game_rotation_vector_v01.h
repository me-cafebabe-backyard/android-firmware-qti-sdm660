...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
  ...
  $Header: //components/rel/ssc.slpi/2.2/api/sns_sam_game_rotation_vector_v01.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====* 
...
#define SNS_SAM_GAME_ROTATION_VECTOR_SVC_V01_IDL_MINOR_VERS 0x06
...
/** @addtogroup SNS_SAM_GAME_ROTATION_VECTOR_SVC_qmi_consts 
    @{ 
  */
#define SNS_SAM_GAME_ROTATION_VECTOR_SUID_V01 0x71fa7ddfc96bf1f8
...
/** @addtogroup SNS_SAM_GAME_ROTATION_VECTOR_SVC_qmi_messages
    @{
  */
/** Indication Message; Report containing the game rotation vector algorithm output. */
typedef struct {
...
//#define REMOVE_SNS_SAM_GAME_ROTATION_VECTOR_BATCH_V01 
//#define REMOVE_SNS_SAM_GAME_ROTATION_VECTOR_BATCH_REPORT_V01 
//#define REMOVE_SNS_SAM_GAME_ROTATION_VECTOR_DISABLE_V01 
//#define REMOVE_SNS_SAM_GAME_ROTATION_VECTOR_ENABLE_V01 
//#define REMOVE_SNS_SAM_GAME_ROTATION_VECTOR_ERROR_V01 
//#define REMOVE_SNS_SAM_GAME_ROTATION_VECTOR_GET_REPORT_V01 
//#define REMOVE_SNS_SAM_GAME_ROTATION_VECTOR_REPORT_V01 
//#define REMOVE_SNS_SAM_GAME_RV_UPDATE_BATCH_PERIOD_V01 
