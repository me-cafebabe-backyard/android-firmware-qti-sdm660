...
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
 ...
 Confidential and Proprietary - Qualcomm Technologies, Inc.
  ...
  $Header: //components/rel/ssc.slpi/2.2/api/sns_sam_dpc_v02.h#1 $
 *====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
/*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*
...
typedef enum {
  ...
  SNS_SAM_DPC_DEV_UNKNOWN_V02 = 0,      // when algo cannot identify below states
  SNS_SAM_DPC_DEV_FLAT_STATIC_V02 = 1,  // Device stationary and display within +/-15 deg of horizontal plane
  SNS_SAM_DPC_DEV_HIDDEN_V02 = 2,       // Device is not in FLAT_STATIC state and prox close
  SNS_SAM_DPC_DEV_IN_HAND_V02 = 3,      // User pick_up the device
  SNS_SAM_DPC_DEV_FACING_V02 = 4,       // User hold the device and facing the display
