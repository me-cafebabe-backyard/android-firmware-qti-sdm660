...
/* $Header: //components/rel/ssc.slpi/2.2/smgr/src/sns_smgr_ddf_if_uimg.c#1 $ */
...
/*============================================================================
  ...
  ----------  ---  -----------------------------------------------------------
  2015-12-03  jtl  Added initial S4S implemenation
...
===========================================================================*/
 /**
     ...
     */
/*=========================================================================*/
SNS_SMGR_UIMAGE_CODE sns_ddf_status_e sns_smgr_set_attr(
  sns_smgr_sensor_s*   sensor_ptr,
  sns_ddf_sensor_e     sensor,
