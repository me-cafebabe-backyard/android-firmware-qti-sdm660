...
/* $Header: //components/rel/ssc.slpi/2.2/smgr/src/sns_rh_batchbuff.h#1 $ */
...
/*============================================================================
  ...
  ----------  ---  -----------------------------------------------------------
  2016-10-04  bd   Reserved samples for subHz items in indications
  2016-05-18  pn   Removed sns_rh_batchbuff_compute_num_avail_samples()
