...
/* $Header: //components/rel/ssc.slpi/2.2/smgr/src/sns_smgr_util.h#1 $ */
...
/*============================================================================
  ...
  ----------  ---   ----------------------------------------------------------
  2016-03-30  jtl   Added get_sched_intval_wm and estimated read time
...
extern uint32_t sns_smgr_get_sched_intval_wm(
  q16_t                         req_freq,
  int32_t                       watermark);
...
extern q16_t smgr_sensor_type_max_depot_data_rate(
  const sns_smgr_sensor_s* sensor_ptr);
...
extern bool sns_smgr_is_daf_active(void);

extern void sns_smgr_set_md_state(bool enable);

extern int32_t sns_smgr_get_estimated_read_time(
  const sns_smgr_ddf_sensor_s* ddf_sensor_ptr,
