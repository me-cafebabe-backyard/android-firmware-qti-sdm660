...
/* $Header: //components/rel/ssc.slpi/2.2/smgr/src/sns_smgr_priv.h#2 $ */
/* $DateTime: 2017/04/24 06:07:10 $ */
/* $Author: pwbldsvc $ */
...
/*============================================================================
  ...
  ----------  ---  -----------------------------------------------------------
  2016-11-16  sd   Added some macro
  2016-08-10  np   Added playback support.  
  2016-06-08  jtl  Add flag for first S4S synced sample
  2015-12-03  jtl  Added S4S support
...
#define SMGR_MAX_EIS_QUERY_REQUESTS       8
...
#define SMGR_LPF_DURATION(lpf_odr)          \
  ((lpf_odr==0)?0:TIMETICK_SCLK_FROM_US((1000000*SMGR_SENSOR_CLK_ACCURACY/(lpf_odr+4))))
...
#define SMGR_SENSOR_IS_SELF_SCHED(s) (((s)->const_ptr->flags & SNS_SMGR_DD_SELF_SCHED) \
                                      && !((s)->const_ptr->flags & SNS_SMGR_S4S) )
...
#define SMGR_SENSOR_IS_S4S(s) ((s)->const_ptr->flags & SNS_SMGR_S4S)
...
#define SNS_RH_ROLLOVERTICK_ALLOWED SMGR_MAX_EIS_QUERY_SAMPLES*32768
#define SNS_RH_32BIT_ROLLOVER_CHECK(a, b)  ( (a>b) && ((uint32_t)((int32_t)b-(int32_t)a)<SNS_RH_ROLLOVERTICK_ALLOWED) )
#define SNS_RH_32BIT_GREATER_EQ(a, b)  ((int32_t)((int32_t)a-(int32_t)b) >= 0 )
#define SNS_RH_32BIT_GREATER(a, b)  ((int32_t)((int32_t)a-(int32_t)b) >0 )
#define SNS_RH_32BIT_SAME_SIGNBIT(a, b) ((a>>31)==(b>>31))
...
#define SMGR_SENSOR_FLAGS_UPDATE_SAMPLING_NEEDED_B  0x0200 /* Sampling settings need refresh*/
#define SMGR_SENSOR_FLAGS_FIRST_SYNCED_S4S_SAMPLE_B 0x0400 /* first synced S4S sample rx-ed */
...
#ifdef FAST_PLAYBACK
extern void sns_smgr_init_single_sensor(smgr_sensor_id_e sensor_id,sns_ddf_odr_t odr);
#endif
