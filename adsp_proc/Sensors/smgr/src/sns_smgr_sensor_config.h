...
/* $Header: //components/rel/ssc.slpi/2.2/smgr/src/sns_smgr_sensor_config.h#1 $ */
...
/*============================================================================
  ...
  2015-10-12  jtl  Added S4S & latency flags
  2016-01-26  ps   configure accel/gyro in polling for 8998 virtio bringup
  2015-10-23  ps   support 8998 virtio bringup
...
#else
 #define SNS_SMGR_NUM_SENSORS_DEFINED         6
#endif
...
#define SNS_SMGR_S4S                                    0x04

#define SNS_SMGR_LTCY_ENABLE                            0x08
...
#define SNS_SMGR_DD_SELF_SCHED                          0x80
 ...
 #define SNS_SMGR_SENSOR_0_DD_FN_LIST_PTR            &sns_dd_lsm6ds3_if
 ...
 #define SNS_SMGR_SENSOR_0_FLAGS                     ( SNS_SMGR_NO_SENSITIVITY )
 #define SNS_SMGR_SENSOR_0_OFF_TO_IDLE               100000 /* usec */
 #define SNS_SMGR_SENSOR_0_IDLE_TO_READY             0 /* usec */
 ...
 #define SNS_SMGR_SENSOR_1_DD_FN_LIST_PTR            &sns_dd_lsm6ds3_if
 ...
 //#define SNS_SMGR_SENSOR_1_FLAGS                   ( SNS_SMGR_DD_SELF_SCHED | SNS_SMGR_NO_SENSITIVITY | SNS_SMGR_ENABLE_FIFO )
 #define SNS_SMGR_SENSOR_1_FLAGS                     ( SNS_SMGR_NO_SENSITIVITY )
 #define SNS_SMGR_SENSOR_1_OFF_TO_IDLE               150000
 #define SNS_SMGR_SENSOR_1_IDLE_TO_READY             0
