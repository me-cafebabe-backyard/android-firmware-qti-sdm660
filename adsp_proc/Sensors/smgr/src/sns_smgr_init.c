...
/* $Header: //components/rel/ssc.slpi/2.2/smgr/src/sns_smgr_init.c#2 $ */
/* $DateTime: 2017/04/28 05:13:43 $ */
/* $Author: pwbldsvc $ */
...
/*============================================================================
  ...
  ----------  ---  -----------------------------------------------------------
  2017-04-13  bd   Put sensor mutex into bimage
  2017-03-28  bd   Put sensor mutex into uimage
  2016-10-20  tc   Accel and gyro now actually support 800hz
  2016-08-10  np   Added playback support.  
  2016-08-08  sd   Accel and gyro now should support 800hz
  2016-08-04  pn   Enforces sensors max supported frequencies
  2016-03-30  jtl  Added S4S support to initialzation of ddf_sensor_ptrs
...
#define  SNS_SMGR_ENFORCED_MAX_FREQ_ACCEL         800 // TODO: 1600?
#define  SNS_SMGR_ENFORCED_MAX_FREQ_GYRO          800 // TODO: 1600?
#define  SNS_SMGR_ENFORCED_MAX_FREQ_MAG           100
#define  SNS_SMGR_ENFORCED_MAX_FREQ_PRESSURE       30
#define  SNS_SMGR_ENFORCED_MAX_FREQ_HUMIDITY        5
#define  SNS_SMGR_ENFORCED_MAX_FREQ_AMBIENT_TEMP    5
...
const smgr_sensor_depot_config_s smgr_sensor_depot_config[] =
{
  ...
  {SNS_SMGR_ID_OEM_SENSOR_01_V01,        SNS_SMGR_DATA_TYPE_PRIMARY_V01,   3, SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_01_V01},
  {SNS_SMGR_ID_OEM_SENSOR_01_V01,        SNS_SMGR_DATA_TYPE_SECONDARY_V01, 3, SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_01_V01},
  {SNS_SMGR_ID_OEM_SENSOR_02_V01,        SNS_SMGR_DATA_TYPE_PRIMARY_V01,   3, SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_02_V01},
  {SNS_SMGR_ID_OEM_SENSOR_02_V01,        SNS_SMGR_DATA_TYPE_SECONDARY_V01, 3, SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_02_V01},
  {SNS_SMGR_ID_OEM_SENSOR_03_V01,        SNS_SMGR_DATA_TYPE_PRIMARY_V01,   3, SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_03_V01},
  {SNS_SMGR_ID_OEM_SENSOR_03_V01,        SNS_SMGR_DATA_TYPE_SECONDARY_V01, 3, SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_03_V01},
  {SNS_SMGR_ID_OEM_SENSOR_04_V01,        SNS_SMGR_DATA_TYPE_PRIMARY_V01,   3, SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_04_V01},
  {SNS_SMGR_ID_OEM_SENSOR_04_V01,        SNS_SMGR_DATA_TYPE_SECONDARY_V01, 3, SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_04_V01},
  {SNS_SMGR_ID_OEM_SENSOR_05_V01,        SNS_SMGR_DATA_TYPE_PRIMARY_V01,   3, SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_05_V01},
  {SNS_SMGR_ID_OEM_SENSOR_05_V01,        SNS_SMGR_DATA_TYPE_SECONDARY_V01, 3, SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_05_V01},
  {SNS_SMGR_ID_OEM_SENSOR_06_V01,        SNS_SMGR_DATA_TYPE_PRIMARY_V01,   3, SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_06_V01},
  {SNS_SMGR_ID_OEM_SENSOR_06_V01,        SNS_SMGR_DATA_TYPE_SECONDARY_V01, 3, SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_06_V01},
  {SNS_SMGR_ID_OEM_SENSOR_07_V01,        SNS_SMGR_DATA_TYPE_PRIMARY_V01,   3, SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_07_V01},
  {SNS_SMGR_ID_OEM_SENSOR_07_V01,        SNS_SMGR_DATA_TYPE_SECONDARY_V01, 3, SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_07_V01},
  {SNS_SMGR_ID_OEM_SENSOR_08_V01,        SNS_SMGR_DATA_TYPE_PRIMARY_V01,   3, SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_08_V01},
  {SNS_SMGR_ID_OEM_SENSOR_08_V01,        SNS_SMGR_DATA_TYPE_SECONDARY_V01, 3, SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_08_V01},
  {SNS_SMGR_ID_OEM_SENSOR_09_V01,        SNS_SMGR_DATA_TYPE_PRIMARY_V01,   3, SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_09_V01},
  {SNS_SMGR_ID_OEM_SENSOR_09_V01,        SNS_SMGR_DATA_TYPE_SECONDARY_V01, 3, SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_09_V01},
  {SNS_SMGR_ID_OEM_SENSOR_10_V01,        SNS_SMGR_DATA_TYPE_PRIMARY_V01,   3, SNS_SMGR_SUID_OEM_SENSOR_PRIMARY_10_V01},
  {SNS_SMGR_ID_OEM_SENSOR_10_V01,        SNS_SMGR_DATA_TYPE_SECONDARY_V01, 3, SNS_SMGR_SUID_OEM_SENSOR_SECONDARY_10_V01},
};
#endif
...
SMGR_STATIC bool sns_smgr_allocate_depot_mem(void)
{
  ...
  else
  {
    ...
    {
      SNS_OS_FREE((void*)sns_smgr.uimg_depot_mem_ptr);
...
SMGR_STATIC void sns_smgr_init_odr_table(sns_smgr_sensor_s* sensor_ptr)
{
  ...
  else
  {
    ...
    for ( i=0; i<len; i++ )
    {
      SNS_SMGR_PRINTF2(LOW, "init_odr_tables - i=%u odr=%u", i, odr_list[i]);
    }
  }
...
SMGR_STATIC void sns_smgr_init_max_frequency(sns_smgr_sensor_s* sensor_ptr)
{
  ...
  for ( i=0; i<ARR_SIZE(sensor_ptr->const_ptr->data_types); i++ )
  {
    ...
    {
      uint32_t len;
      sns_ddf_sensor_e sensor_type = SMGR_SENSOR_TYPE(sensor_ptr, i);
      ...
      {
        q16_t max_freq = 0;
        q16_t enforced_max_freq;
        uint8_t j;
        for ( j=0; j<len; j++ )
        {
          max_freq = MAX(max_freq, FX_FLTTOFIX_Q16(resolution_adc_ptr[j].max_freq));
        }
        sns_ddf_memhandler_free_ex(&sensor_ptr->memhandler, sensor_ptr);
        ...
        case SNS_DDF_SENSOR_ACCEL:
          enforced_max_freq = FX_FLTTOFIX_Q16(SNS_SMGR_ENFORCED_MAX_FREQ_ACCEL);
          break;
        case SNS_DDF_SENSOR_GYRO:
          enforced_max_freq = FX_FLTTOFIX_Q16(SNS_SMGR_ENFORCED_MAX_FREQ_GYRO);
          break;
        case SNS_DDF_SENSOR_MAG:
          enforced_max_freq = FX_FLTTOFIX_Q16(SNS_SMGR_ENFORCED_MAX_FREQ_MAG);
          break;
        case SNS_DDF_SENSOR_PRESSURE:
          enforced_max_freq = FX_FLTTOFIX_Q16(SNS_SMGR_ENFORCED_MAX_FREQ_PRESSURE);
          break;
        case SNS_DDF_SENSOR_HUMIDITY:
          enforced_max_freq = FX_FLTTOFIX_Q16(SNS_SMGR_ENFORCED_MAX_FREQ_HUMIDITY);
          break;
        case SNS_DDF_SENSOR_AMBIENT_TEMP:
          enforced_max_freq = FX_FLTTOFIX_Q16(SNS_SMGR_ENFORCED_MAX_FREQ_AMBIENT_TEMP);
          break;
        default: /* uses DD's max */
          enforced_max_freq = max_freq;
          break;
        }

        SNS_SMGR_PRINTF3(
          LOW, "max_freq - ddf_sensor=%u max_freq=%u enforced_max_freq=%u", 
          sensor_type, max_freq>>16, enforced_max_freq>>16);

        sensor_ptr->ddf_sensor_ptr[i]->max_supported_freq_hz = 
          MIN(enforced_max_freq, max_freq);
      }
    }
  }
}
...
#if  defined(ADSP_STANDALONE) || defined(FAST_PLAYBACK)
...
#ifdef FAST_PLAYBACK
    sensor_cfg_ptr->first_gpio=0xFFFF;
    sensor_cfg_ptr->second_gpio=0xFFF;
