...
/* $Header: //components/rel/ssc.slpi/2.2/smgr/src/sns_rh_sol.h#1 $ */
...
/*============================================================================
  ...
  2016-09-30  sd   Added latest_sample_timestamp_ptr in sns_rh_rpt_item_s 
  2016-07-13  np   Removed sensor cal update status.  
...
#ifdef FAST_PLAYBACK
extern void sns_rh_sol_playback_update_item(
  sns_smgr_ddf_sensor_s *ddf_sensor_ptr,
  bool                  new_item_only);
#endif
...
extern void sns_rh_sol_update_assoc_reports(
  sns_smgr_ddf_sensor_s* ddf_sensor_ptr);
