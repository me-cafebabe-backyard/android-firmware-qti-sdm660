...
/* $Header: //components/rel/ssc.slpi/2.2/smgr/src/sns_rh_main_uimg.h#1 $ */
...
/*============================================================================
  ...
  ----------  ---  -----------------------------------------------------------
  2016-09-16  sd   Added extern sns_rh_link_lastest_sample_ts
...
extern void sns_rh_wait_for_smgr(void);
