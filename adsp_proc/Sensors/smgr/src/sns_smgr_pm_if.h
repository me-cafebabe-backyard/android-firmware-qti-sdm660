...
/* $Header: //components/rel/ssc.slpi/2.2/smgr/src/sns_smgr_pm_if.h#1 $ */
...
/*============================================================================
  ...
  ----------  ---  -----------------------------------------------------------
  2016-12-06  sd   Added sns_smgr_update_wakeup_intvl
...
typedef struct 
{
   ...
   uint32_t           mpps_reqd_est_smgr;
   uint32_t           mpps_reqd_est_rh;
...
sns_pm_err_code_e sns_smgr_update_wakeup_intvl
( 
   void
);
