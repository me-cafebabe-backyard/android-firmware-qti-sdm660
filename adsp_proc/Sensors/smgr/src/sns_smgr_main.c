...
/* $Header: //components/rel/ssc.slpi/2.2/smgr/src/sns_smgr_main.c#1 $ */
...
/*============================================================================
  ...
  2016-12-06  sd   update wakeupinterval vote when app is awake/sleep
  2016-08-10  np   Added playback support.  
  2016-07-19  bd   Release sns_init before registry reading
  2016-03-30  jtl  Added s4s schedule que
...
void sns_smgr_task(void* p_arg)
{
  ...
  /* Inform init code that SMGR init is done and continue with other modules */
  sns_init_done();
