...
/*==============================================================================
  ...
  $Header: //components/rel/ssc.slpi/2.2/ddf/inc/sns_ddf_util.h#1 $
  $DateTime: 2017/04/17 22:20:39 $

  when       who  what, where, why 
  ---------- ---  -----------------------------------------------------------
  2016-05-03 MW   Added new usec->tick and tick->usec APIs
...
/**
 * @brief Returns time in microseconds for input time in ticks.
 *  
 *  
 * @param[in] tick  Time in system ticks.
 *
