...
/*==============================================================================
  ...
  $Header: //components/rel/ssc.slpi/2.2/ddf/inc/sns_ddf_common.h#1 $
  $DateTime: 2017/04/17 22:20:39 $

  when       who  what, where, why 
  ---------- ---  -----------------------------------------------------------
  2016-03-30 jtl  Added SNS_DDF_VENDOR_CAPELLA
  2015-10-12 jtl  Added SNS_DDF_EVENT_DT_ABORT
  2016-01-18 MW   SNS_DDF_SENSOR_TILT_EVENT and SNS_DDF_SENSOR_ORIENTATION_EVENT
  2016-01-19 sc   Added SNS_DDF_ORIENTATION_EVENT sensor type
  2015-12-03 avd  SNS_DDF_SENSOR_TILT_EVENT sensor type added
...
typedef enum
{
    ...
    SNS_DDF_EDT_NOT_SENT,     /**< The driver did not send a DT when requested */
    SNS_DDF_EDT_ABORT,        /**< The driver sent a DT Abort */
    SNS_DDF_ELAST
} sns_ddf_status_e;
...
typedef enum
{
    ...
    SNS_DDF_EVENT_DAF_INACTIVE,          /**< The driver is done utilizing the sensor for all DAF requests
                                              available in SNS_DDF_DRIVER_VTBL_REVISION 0x3 and later */
    SNS_DDF_EVENT_DT_ABORT,              /**< Driver sent an abort DT
                                              available in SNS_DDF_DRIVER_VTBL_REVISION 0x4 and later */
    SNS_DDF_EVENT_LAST
} sns_ddf_event_e;
