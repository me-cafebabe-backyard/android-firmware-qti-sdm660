...
/* $Header: //components/rel/ssc.slpi/2.2/ddf/src/sns_ddf_comm_priv.h#1 $ */
...
/*==============================================================================
  ...
  2016-05-04 jtl  Added write time to internal transfer APIs
  2015-10-21 jtl  Added vector transfer commands
  2015-08-10 AH   DB specific change
...
#define SNS_DDF_DEFAULT_SPI_MAX_CLK_FRQ_HZ    (33*100*1000)
