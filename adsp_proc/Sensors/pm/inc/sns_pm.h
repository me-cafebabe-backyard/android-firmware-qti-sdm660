...
06-22-2016   qm      Added sns_pm_ap_wakeup_broadcast
05-26-2016   rai     Removing QFP client ID to PM framework
10-04-2015   nd      Added QFP client ID to PM framework
09-16-2015   rt      Added back uImage entry hysteresis timer
09-10-2015   hw      Add uimg exit callback mechanism
...
typedef struct sns_pm_client_info_s
{
  ...
  uint32 mpps; /* Million Packets Per Sec */
  uint32 bw;   /* Bytes / sec */
...
/*!
  ...
  @param[in] client_handle : handle of the client.
  @param[in] mpps          : mpps requirement of the client (packets/sec)

  @return
  SNS_PM_SUCCESS if successful.
  SNS_PM_NOT_ALLOWED if attempted to use in uimage mode.
  SNS_PM_ERR_FAILED if total_mpps becomes unexpected value
...
/*=======================================================================
  ...
  FUNCTION : sns_pm_ap_wakeup_broadcast

========================================================================*/
/*!
  @brief
  Client should call this function when it will wake up AP by sending QMI msg
  This function will broadcast AP wake up to all other clients
