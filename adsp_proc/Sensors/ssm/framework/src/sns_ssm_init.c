...
/* $Header: //components/rel/ssc.slpi/2.2/ssm/framework/src/sns_ssm_init.c#1 $  */
...
/*=============================================================================
  ...
  ----------  ---  ------------------------------------------------------------
  2016-08-22  bd   SSM init return earlier to release RCINIT
...
void ssm_init_thread( void * args)
{
   ...
   // Init done to release hold on RC init
   sns_init_done();
