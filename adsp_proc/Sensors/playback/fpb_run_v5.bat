...
echo %time%
hexagon-sim -mv5 LLVM_Debug/fast_playback_v50_LLVM -- ./ fast_playback_input.csv fast_playback_output.dlf algoqmiinput.csv sns.reg.rw fast_playback_diag_input.txt
echo %time%
