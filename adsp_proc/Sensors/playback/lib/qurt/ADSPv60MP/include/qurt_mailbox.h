...
#define   QURT_MAILBOX_ABORT_SIGNAL         -5
...
/**@ingroup qurt_mailbox_create
  ...
  None.
*/
unsigned int qurt_mailbox_create(char *name, qurt_mailbox_receiver_cfg_t recv_opt);
...
/**@ingroup qurt_mailbox_get_id
  ...
  None.
*/
unsigned int qurt_mailbox_get_id(char *name);
...
/**@ingroup qurt_mailbox_send
  ...
  None.
*/
int qurt_mailbox_send(unsigned int mailbox_id, qurt_mailbox_send_option_t send_opt, unsigned long long data);
...
/**@ingroup qurt_mailbox_receive
  ...
  QURT_MAILBOX_ABORT_SIGNAL           Abort signal. The mailbox is deleted during waiting, and the waiting thread is woken up.

  @dependencies
  None.
*/
int qurt_mailbox_receive(unsigned int mailbox_id, qurt_mailbox_recv_option_t recv_opt, unsigned long long *data);
...
/**@ingroup qurt_mailbox_delete
  ...
  None.
*/
int qurt_mailbox_delete(unsigned int mailbox_id);
