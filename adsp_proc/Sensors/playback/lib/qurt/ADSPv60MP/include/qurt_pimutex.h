...
/**@ingroup func_qurt_pimutex_init
  ...
  The mutex behavior (regular, recursive, or recursive with prioirity inheritance)
  is specified at system build time – it cannot be changed at runtime.
  ...
  This function works exactly same as qurt_mutex_init().
   ...
   @note1hang Each pimutex-based object has one or more kernel resources associated with it;
              to prevent resource leaks, be sure to call qurt_pimutex_destroy()
