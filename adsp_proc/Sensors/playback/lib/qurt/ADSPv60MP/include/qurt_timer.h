...
/**@ingroup func_qurt_timer_restart
   ...
   Timers become stopped after they have expired or after they are explicitly stopped with qurt_timer_stop().
   A restarted timer will expire after the specified duration, with the starting time being when the function is called.
...
/**@ingroup func_qurt_timer_get_attr
  ...
  @note1hang After a timer is created, the attributes assigned to it cannot be changed by the user.
