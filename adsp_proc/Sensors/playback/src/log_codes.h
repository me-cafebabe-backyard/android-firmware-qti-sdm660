...
$Header: //components/rel/ssc.slpi/2.2/playback/src/log_codes.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
03/23/16   as      Added new log codes
09/30/15   as      Added new log codes
...
#define LOG_1X_LAST_C                           ((0x990) + LOG_1X_BASE_C)
