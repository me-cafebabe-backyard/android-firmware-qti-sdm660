...
sns_err_code_e sns_reg_get_default( uint16_t item_id, void* data_ptr )
{
  switch( item_id )
  {
    ...
    /* comment out as default item values of SNS_REG_DRIVER_GROUP_GAME_RV are not defined in sns_reg_common.h
    ...
    */
    ...
    /* comment out as SNS_REG_CMC_DEF_SENSOR_VERTICAL_MIN_SPPED is not defined sns_reg_common.h
    ...
    */
    ...
    /* comment out as default item value of SNS_REG_DEFAULT_IR_GESTURE_DS is not defined in sns_reg_common.h
    ...
    */
	...
	/* comment out as default value for items are not defined in sns_reg_common.h
...
sns_err_code_e sns_group_data_init( uint16_t group_id, void* data_ptr )
{
  switch( group_id )
  {
    ...
    /* comment out as sns_reg_ir_ges_data_group_s is removed from sns_reg_common.h
...
*/
   case SNS_REG_SAM_GROUP_SMD_V02:
   {
      ...
      sns_reg_get_default( SNS_REG_ITEM_SMD_EIGEN_THRESH_V02,
        &(((sns_reg_smd_data_group_s*)data_ptr)->eigen_thresh));
      sns_reg_get_default( SNS_REG_ITEM_SMD_PCOUNT_THRESH_V02,
        &(((sns_reg_smd_data_group_s*)data_ptr)->step_count_thresh));
      sns_reg_get_default( SNS_REG_ITEM_SMD_PTIME_V02,
        &(((sns_reg_smd_data_group_s*)data_ptr)->step_window_time));
   ...
   */
   ...
   /* comment out as sns_reg_grv_driver_group_s is removed from sns_reg_common.h
   ...
   */
   ...
   /* comment out as sns_reg_pressure_group_s is removed from sns_reg_common.h
