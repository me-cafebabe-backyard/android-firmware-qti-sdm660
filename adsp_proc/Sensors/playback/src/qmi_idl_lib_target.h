...
/*===========================================================================
  ...
  QuRT OS Specific APIs for encode/decode library.
...
#define QMI_IDL_MEM_COPY(dst,dst_size,src,copy_len) memcpy(dst, src, copy_len)
//memscpy(dst,dst_size,src,copy_len)
