...
extern typeof(int []) QURTK_phys_island;
...
extern typeof(unsigned int) QURTK_IEL __attribute__((section(".data.ukernel.main")));





extern typeof(unsigned int) QURTK_IAHL __attribute__((section(".data.ukernel.main")));
...
extern typeof(int) qurt_tcm_utcb_from_stack;
...
extern typeof(unsigned int) const QURTK_max_spcbs;




extern typeof(typeof(struct { unsigned char a[32] __attribute__((aligned(8))); }) []) QURTK_secure_proc_ctrl_data;
...
extern typeof(unsigned int) const QURTK_island_type;
...
extern typeof(typeof(struct { unsigned char a[44] __attribute__((aligned(4))); }) []) QURTK_pcb_data;
