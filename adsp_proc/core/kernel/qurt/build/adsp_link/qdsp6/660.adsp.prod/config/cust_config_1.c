...
const struct tag_sender {
   ...
   EIP_BUILD_XML,
   "d\000\000\000<?xml version=\"1.0\" encoding=\"utf-8\"?><build_vars><ef"
   "fective_memsize value=\"30932992\"/></build_vars>"
};
...
#if 0XAA0 != 0
#define ACTUALQURTOSISLANDSTACKSIZE (0XAA0)
#else
...
SET_CONFIG_VALUE(qurtos_island_handle_count, 30);
SET_CONFIG_VALUE(qurtos_qdi_handle_count, 994);
...
CONFIG_SEC_VAR("Default USR value",
               ...
               0x90000);
SET_CONFIG_VALUE(qurtos_usr_default, 0x90000);
...
#define POOL_CONFIGS_INIT { \
    POOLSTART("DEFAULT_PHYSPOOL") \
        POOLREGION(0x92A00,0x1E00000) \
    POOLEND \
    POOLSTART("ADSP_DRIVER_POOL") \
        POOLREGION(0xC9A0,0x1000) \
        POOLREGION(0x15000,0xC00000) \
    POOLEND \
    POOLSTART("DRIVER_POOL") \
        POOLREGION(0x92A00,0x1000) \
        POOLREGION(0x15000,0x600000) \
        POOLREGION(0x15600,0x200000) \
    POOLEND \
    POOLSTART("TCM_PHYSPOOL") \
        POOLREGION(0x15C00,0x400000) \
    POOLEND \
    POOLSTART("lpass_reg_pool") \
        POOLREGION(0x15000,0x1000) \
    POOLEND \
    POOLSTART("qdsp6ss_reg_pool") \
        POOLREGION(0x15700,0x1000) \
    POOLEND \
    POOLSTART("smd_reg_pool") \
        POOLREGION(0x15785,0x1000) \
    POOLEND \
    POOLSTART("adsp_clk_reg_pool") \
        POOLREGION(0x15780,0x8000) \
    POOLEND \
    POOLSTART("sirc_reg_pool") \
        POOLREGION(0x15790,0x10000) \
    POOLEND \
    POOLSTART("saw_reg_pool") \
        POOLREGION(0x157B0,0x1000) \
    POOLEND \
    POOLSTART("smem_pool") \
    ...
    POOLEND \
    POOLSTART("QURTOS_ISLAND_POOL") \
        POOLREGION(0x1D80,0x80000) \
    POOLEND \
    POOLSTART("") \
    POOLEND \
}
...
#define MMAP_TABLE_INIT { \
   MEMORY_MAP(1, 0, 0x15700L, 1, 0, RW, 0x4, 16, MAIN, 0x15700L),\
   MEMORY_MAP(1, 0, 0x15d90L, 0, 0, RW, 0x4, 1, MAIN, 0x15d90L),\
   MEMORY_MAP(1, 0, 0x15dc0L, 1, 0, RWX, 0x4, 2, MAIN, 0x15dc0L),\
   ...
   MEMORY_MAP(1, 0, 0x14680L, 0, 0, RW, 0x4, 2, MAIN, 0x14680L),\
   MEMORY_MAP(1, 0, 0x15da0L, 0, 0, RW, 0x4, 4, MAIN, 0x15da0L),\
   MEMORY_MAP(1, 0, 0xee000L, 1, 0, RW, 0x4, 32, MAIN, 0x15000L),\
   MEMORY_MAP(1, 0, 0xee400L, 1, 0, RW, 0x4, 32, MAIN, 0x15400L),\
   MEMORY_MAP(1, 0, 0xee800L, 1, 0, RW, 0x4, 32, MAIN, 0x15800L),\
   MEMORY_MAP(1, 0, 0xe0000L, 0, 0, RW, 0x4, 16, MAIN, 0x100L),\
   MEMORY_MAP(1, 0, 0xe0100L, 0, 0, RW, 0x4, 16, MAIN, 0x200L),\
   MEMORY_MAP(1, 0, 0xe0220L, 0, 0, RW, 0x4, 4, MAIN, 0x620L),\
   MEMORY_MAP(1, 0, 0xe0370L, 0, 0, RW, 0x4, 4, MAIN, 0x770L),\
   MEMORY_MAP(1, 0, 0xe0480L, 0, 0, RW, 0x4, 4, MAIN, 0x780L),\
   MEMORY_MAP(1, 0, 0xe0590L, 0, 0, RW, 0x4, 4, MAIN, 0x790L),\
   MEMORY_MAP(1, 0, 0xe06a0L, 0, 0, RW, 0x4, 4, MAIN, 0x10a0L),\
   MEMORY_MAP(1, 0, 0xe0700L, 0, 0, RW, 0x4, 8, MAIN, 0x1500L),\
   MEMORY_MAP(1, 0, 0xe0820L, 0, 0, RW, 0x4, 4, MAIN, 0x1620L),\
   MEMORY_MAP(1, 0, 0xe0c00L, 0, 0, RW, 0x4, 32, MAIN, 0x1400L),\
   MEMORY_MAP(1, 0, 0xe1000L, 0, 0, RW, 0x4, 16, MAIN, 0x1f00L),\
   MEMORY_MAP(1, 0, 0xe2000L, 0, 0, RW, 0x4, 64, MAIN, 0x3000L),\
   MEMORY_MAP(1, 0, 0xe3000L, 0, 0, RW, 0x4, 64, MAIN, 0x6000L),\
   MEMORY_MAP(1, 0, 0xe4000L, 0, 0, RW, 0x4, 64, MAIN, 0x7000L),\
   MEMORY_MAP(1, 0, 0xe5000L, 0, 0, RW, 0x4, 64, MAIN, 0x8000L),\
   MEMORY_MAP(1, 0, 0xe6000L, 0, 0, RW, 0x4, 64, MAIN, 0x9000L),\
   MEMORY_MAP(1, 0, 0xe7000L, 0, 0, RW, 0x4, 64, MAIN, 0xa000L),\
   MEMORY_MAP(1, 0, 0xe8000L, 0, 0, RW, 0x4, 32, MAIN, 0xa800L),\
   MEMORY_MAP(1, 0, 0xe8400L, 0, 0, RW, 0x4, 2, MAIN, 0xc000L),\
   MEMORY_MAP(1, 0, 0xe8510L, 0, 0, RW, 0x4, 4, MAIN, 0xc010L),\
   MEMORY_MAP(1, 0, 0xe8680L, 0, 0, RW, 0x4, 8, MAIN, 0xc080L),\
   MEMORY_MAP(1, 0, 0xe87c0L, 0, 0, RW, 0x4, 8, MAIN, 0xc0c0L),\
   MEMORY_MAP(1, 0, 0xe8840L, 0, 0, RW, 0x4, 8, MAIN, 0xc140L), 0 }
...
#define PHYS_ISLAND_INIT { 0x01D80, 0x01DFF, (0x7)|0x10,  -1 }
CONFIG_SEC_VAR("Physical island address ranges",
               __attribute__((section(".data.qurtos"))),
              int [],
              QURTK_phys_island,
              PHYS_ISLAND_INIT);
...
CONFIG_RW_VAR("0xffffffff",
              unsigned int,
              QURTK_IEL __attribute__((section(".data.ukernel.main"))),
              0xffffffff);

/* 1 - Active High, 0 - Active Low. All bits are 1. Rising edge or active high */
CONFIG_RW_VAR("0xffffffff",
              unsigned int,
              QURTK_IAHL __attribute__((section(".data.ukernel.main"))),
              0xffffffff);
 ...
 */
#define L2TYPE_INIT {0xf267e7e3,0x3e1b6a8f,0xbb21ff21,0xf7ddc8fd,0x2803ffff,0xcc000000,0xf81797f2,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff}
...
#define ISR_INIT {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x832,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0}
...
#define PROGRAM_NAMES {"LPASS","ROOT_660.adsp.prodQ.pbn","AUDIO_660.adsp.prodQ.pbn","SENSOR_660.adsp.prodQ.pbn"}
...
CONFIG_ZI_SPACE("",
                ...
                ALIGNED_SPACE(32) [IDIM(2*DIVUP(0X180,32))],
                qurt_fastint_stack,
                CONFIG_DEFAULT);
...
CONFIG_RW_SPACE("",
                ...
                qurtos_heap,
                CACHEALIGNED,
                {ARRAY_INIT(ROUNDUP(0XC0000,4)) = 0xFF});
SET_CONFIG_VALUE(QURTOS_HEAP_SIZE, sizeof(qurtos_heap));

#if 548 || defined(GEN_CONFIG_HEADER)
...
CONFIG_RW_SPACE(
   ...
   CONFIG_DEFAULT,
   " \002\000\000<image><program_name_map name=\"LPASS\" number=\"0\"/><pr"
   "ogram_name_map name=\"ROOT_660.adsp.prodQ.pbn\" number=\"1\"/><prog"
   "ram_name_map name=\"AUDIO_660.adsp.prodQ.pbn\" number=\"2\"/><progr"
   "am_name_map name=\"SENSOR_660.adsp.prodQ.pbn\" number=\"3\"/><cache"
   "_policy name=\"l1_wb_l2_uncacheable\" value=\"0x0\"/><cache_policy "
   "name=\"writethrough\" value=\"0x1\"/><cache_policy name=\"l1_wt_l2_"
   "cacheable\" value=\"0x5\"/><cache_policy name=\"l1_wb_l2_cacheable"
   "\" value=\"0x7\"/><cache_policy name=\"uncached\" value=\"0x4\"/><c"
   "ache_policy name=\"uncache_shared\" value=\"0x6\"/></image>"
);

#endif /* 548 */

SET_CONFIG_VALUE(qurtos_island_heap_size, ROUNDUP(0X7000,4));
...
CONFIG_RO_VAR("max Secure processes",
              unsigned int,
              QURTK_max_spcbs,
              0X2);
...
CONFIG_ZI_SPACE("",
                ...
                KERNEL_SPCB [IDIM(0X2)],
                QURTK_secure_proc_ctrl_data,
                CONFIG_DEFAULT);

//  #endif // CONFIG_SECURE_PROCESS
...
INIT_FUNC_PROTO(qurtos_island_main_init);
INIT_FUNC_PROTO(qurtos_process_reaper_generic_init);
#endif

#define INIT_FUNCS { qurtos_user_client_init, qurtos_space_generic_init, qurtos_user_reaper_generic_init, qurtos_proxy_generic_init, qurtos_file_generic_init, qurtos_island_main_init, qurtos_process_reaper_generic_init, 0 }
...
#if 0X7000 > 0 || defined(GEN_CONFIG_HEADER)
CONFIG_RW_SPACE("",
                __attribute__((section(".data.island"))),
                unsigned char [],
                qurtos_island_heap,
                CACHEALIGNED,
                {ARRAY_INIT(ROUNDUP(0X7000,4)) = 0xFF});
#endif
CONFIG_RW_VAR("",
              int,
              QURTK_CONTEXT_SIZE,
...
CONFIG_RW_VAR("",
              ...
              30);
SET_CONFIG_VALUE(qurtos_max_threads_in_tcm, 30);
...
#define L2ISLAND_INIT {0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff,0xffff}
CONFIG_RW_VAR("island interrupts",
              unsigned short [],
              QURTK_int_island,
              L2ISLAND_INIT);

SET_CONFIG_VALUE(QURTK_max_island_int, 20);

CONFIG_ZI_SPACE("",
                SECTION(".data", "QURTK.INTERRUPT"),
                ALIGNED_SPACE(4) [IDIM(218+1)],
                QURTK_l2_int_idx_table,
                CONFIG_DEFAULT);

CONFIG_ZI_SPACE("",
                __attribute__((section(".bss.ukernel.QURTK_l2_island_interrupt_table.island"))),
                ALIGNED_SPACE(16) [IDIM(20)],
...
CONFIG_SEC_VAR("disabled=0, enabled=1",
              ...
              QURTK_int_privilege,
              1);
SET_CONFIG_VALUE(qurtos_int_privilege, (char)(1!=0));
...
#define L2ENABLE_INIT {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xffdc7bff,0xe7efd577,0x5cde00de,0xfc3f3703,0xdffcfeff,0x3fffffff,0x7fff9fd,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x32881800,0x2c8110,0x40c00000,0x10000000,0x0,0x0,0x1000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xf78000,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0}
...
#define PHYS_RELOC_INIT { &QURTK_phys_island[0], &QURTK_phys_island[1], &pool_configs[14].ranges[0].start, 0 }
...
#define GEN_RELOC_INIT { {&pool_configs[0].ranges[0].size,-524288}, {0} }
CONFIG_RO_VAR("Words in memory that should be offset at boot time"
