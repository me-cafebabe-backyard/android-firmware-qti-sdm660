...
if os.name == 'posix':
   ...
   sys.exit(0)
v5default=os.path.join(default_root,"8.0.04")
v55default=os.path.join(default_root,"8.0.04")
v55sim=os.path.join(default_root,"8.0.04")
v56default=os.path.join(default_root,"8.0.04")
v60default=os.path.join(default_root,"8.0.04")
v61default=os.path.join(default_root,"8.0.04")
v62default=os.path.join(default_root,"8.0.04")
v65default=os.path.join(default_root,"8.1")
v56wlandefault=os.path.join(default_root,"8.0.04")

toolsver_whitelist = ["3.1", "5.0", "5.1", "6.2", "6.4", "7.0", "7.1", "7.2", "7.3", "7.4", "8.0", "8.1"]
#------------------------------------------------------------------------------
...
#variable used by testcases/Sconscript
   ...
   if version_compare(hex_tools_ver, '8.1') >= 0 :
