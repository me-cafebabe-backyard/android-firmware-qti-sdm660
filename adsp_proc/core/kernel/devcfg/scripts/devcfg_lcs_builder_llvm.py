       ...
       for tag in devcfg_xml_list:
           for build_tag in environment.get('BUILD_TAGS'):
               if 'DAL_DEVCFG_OEM_HYP_IMG' == build_tag:
                   hyp_source_list = environment.get('DEVCFG').getFeature('DEVCFG_INFO_COLLECTOR').get(build_tag,{}).get('cc_'+tag,[])
               if 'DAL_DEVCFG_OEM_QSEE_IMG' == build_tag:
                   tz_source_list = environment.get('DEVCFG').getFeature('DEVCFG_INFO_COLLECTOR').get(build_tag,{}).get('cc_'+tag,[])
