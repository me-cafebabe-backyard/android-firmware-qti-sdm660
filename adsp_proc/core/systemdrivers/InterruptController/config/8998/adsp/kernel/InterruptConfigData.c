...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/InterruptController/config/8998/adsp/kernel/InterruptConfigData.c#1 $
...
static InterruptConfigType InterruptConfigs[] =
{
  ...
  {68 , "blsp1_qup_irq(4)" },
  {69 , "blsp1_qup_irq(5)" },
  {70, "dir_conn_irq_sensors_0"},
  {71, "dir_conn_irq_sensors_1"},
  ...
  {106, "ssc_qup_int"},
  {107, "bam_irq[0]"},
  {108, "processor_0_user_int"},
  {109, "processor_0_kernel_int"},
