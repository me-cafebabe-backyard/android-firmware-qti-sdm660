...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/InterruptController/src/qurt/kernel/DALInterruptControllerConfig.h#1 $ 
...
/*
  *  Invalid AON interrupt value for error checking
  */
#define NO_AON_INTERRUPT         0x7FFF
 ...
 *  nAONID            - AON interrupt ID if this is a wakeup source for the PMU
 *                      hardware.
