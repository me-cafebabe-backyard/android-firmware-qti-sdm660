...
/*==========================================================================
  ...
  $Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/clock/src/adsp_slpi/ClockBSP.h#1 $
 ...
 *    of resource.
 *  SOURCE_NOT_CONFIGURABLE - Indicates that the source type is not configurable.
...
#define CLOCK_FLAG_SOURCE_NOT_CONFIGURABLE      0x00040000
#define CLOCK_FLAG_STUB_HW_RUMI                 0x00080000
#define CLOCK_FLAG_DOMAIN_WAIT_FOR_ROOT_OFF     0x00100000
#define CLOCK_FLAG_DOMAIN_NON_MND_SWITCH        0x00200000
 ...
 *  pCalibrationFreqConfig - Pointer to array of calibration configurations.
