...
/*  
  ...
  ==================================================================== 
  $Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/clock/src/adsp_slpi/ClockVoltage.c#1 $
  $DateTime: 2020/02/10 01:57:30 $
  $Author: pwbldsvc $

  when       who     what, where, why
  --------   ---     -------------------------------------------------
  11/11/16   shm     Using VCS enums directly for creating clients
  10/04/15   shm     First version for core.qdsp6.1.0.
...
/*
 * Macros for creating a NPA client to the LPI_CX node.
 */
#define CLOCK_RESOURCE_VDD_LPI_CX  VCS_NPA_RESOURCE_VDD_LPI_CX
