#ifndef __CLOCKLPASSBSP_H__
#define __CLOCKLPASSBSP_H__
...
GENERAL DESCRIPTION
  ...
  DAL Clock Device Driver CPU data structures.
...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/clock/hw/sdm660/adsp_slpi/inc/ClockLPASSBSP.h#1 $
...
#define CLOCK_NPA_RESOURCE_CNOC_PERIPH            "/clk/cnoc_periph"
#define CLOCK_NPA_RESOURCE_SNOC                   "/clk/snoc"
#define CLOCK_NPA_RESOURCE_SNOC_HS                "/clk/snoc_hs"
...
/*
 * LPI voltage level to corner map type.
 */
typedef struct
{
