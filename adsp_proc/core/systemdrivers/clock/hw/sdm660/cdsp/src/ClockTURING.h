#ifndef CLOCKTURING_H
#define CLOCKTURING_H
/*
===========================================================================
*/
/**
  ...
  Internal header file for the clock device driver on the TURING image.
*/
/*  
  ====================================================================
  ...
  ==================================================================== 
  $Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/clock/hw/sdm660/cdsp/src/ClockTURING.h#1 $
 ...
 * the following error margin expressed in 
 * frequency, with a minimum error tolerance of 1 kHz.
 */
#define CLOCK_NPA_BIST_ERROR_MARGIN_PERCENT         1     /* Expressed in percent */
...
** =========================================================================*/
/**
  Trigger function to update QDSP6 TURING states.
 
  This function updates QDSP6 TURING states (frequencies) and then
