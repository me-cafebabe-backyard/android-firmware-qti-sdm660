...
/*
  ...
  $Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/icb/src/8x10/ABTimeout_HWIO.h#1 $
...
#define LPASS_AHBE_TIME_REG_BASE                                 (LPASS_BASE      + 0x00040000)
...
#define HWIO_TCSR_TIMEOUT_INTR_STATUS_RMSK                                                                                  0x7efdff
