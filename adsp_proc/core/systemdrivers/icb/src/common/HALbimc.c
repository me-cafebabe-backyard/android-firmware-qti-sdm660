...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/icb/src/common/HALbimc.c#1 $
...
*/
void HAL_bimc_EnableSlaveSegment
(
...
)
{
  ...
  bimc_EnableSlaveSegment( pInfo, uSlaveIdx, uSegmentIdx, bEnable );
}
