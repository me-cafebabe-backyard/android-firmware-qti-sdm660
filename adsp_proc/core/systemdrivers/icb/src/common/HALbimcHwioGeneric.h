...
/*
  ...
  $Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/icb/src/common/HALbimcHwioGeneric.h#1 $
...
#define BIMC_DT_AGG_REQ_CFG_n_ADDR(b,n)                                                    (BIMC_GLOBAL0_REG_BASE(b) + 0x00000900 + 0x4 * (n))
#define BIMC_DT_AGG_REQ_CFG_n_RMSK                                                                0xf73
#define BIMC_DT_AGG_REQ_CFG_n_MAXn                                                                    3
#define BIMC_DT_AGG_REQ_CFG_n_INI(b,n)        \
        in_dword_med(BIMC_DT_AGG_REQ_CFG_n_ADDR(b,n), BIMC_DT_AGG_REQ_CFG_n_RMSK)
#define BIMC_DT_AGG_REQ_CFG_n_INMI(b,n,m)    \
        in_dword_med(BIMC_DT_AGG_REQ_CFG_n_ADDR(b,n), m)
#define BIMC_DT_AGG_REQ_CFG_n_OUTI(b,n,v)    \
        out_dword(BIMC_DT_AGG_REQ_CFG_n_ADDR(b,n),v)
#define BIMC_DT_AGG_REQ_CFG_n_OUTMI(b,n,m,v) \
        out_dword_med_ns(BIMC_DT_AGG_REQ_CFG_n_ADDR(b,n),m,v,BIMC_DT_AGG_REQ_CFG_n_INI(b,n))
