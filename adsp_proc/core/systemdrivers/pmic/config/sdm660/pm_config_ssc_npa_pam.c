 ...
 *    PMIC code generation Locked Version: SSC_SDM660_0p3 - LOCKED
...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/pmic/config/sdm660/pm_config_ssc_npa_pam.c#1 $ 
...
pm_pam_sensor_vdd_b_ldo3 [] =
{
   ...
   // Mode: PMIC_NPA_MODE_ID_SENSOR_LPM
   {
      ...
      PM_NPA_KEY_CURRENT, 4, 0,  /**< [X mA] -> summed aggregation. */
      PM_NPA_KEY_HEAD_ROOM, 4, 125,  /**< [X uV] -> voltage headroom needed. */
      PM_NPA_KEY_BYPASS_ALLOWED_KEY, 4, PM_NPA_BYPASS_ALLOWED,  /**< [Allowed (default), Disallowed] */
      PM_NPA_KEY_CORNER_LEVEL_KEY, 4, PM_NPA_CORNER_MODE__NONE,  /**< [None, Level1 (Retention), Level2, Level3, Level4, Level5, Level6 (SuperTurbo), Not Used] */
      PM_NPA_KEY_ACTIVE_FLOOR, 4, PM_NPA_CORNER_MODE__NONE,  /**< [None, Level1 (Retention), Level2, Level3, Level4, Level5, Level6 (SuperTurbo), Not Used] */
   },
...
pm_pam_sensor_vdd_a_ldo14 [] =
{
   ...
   // Mode: PMIC_NPA_MODE_ID_SENSOR_LPM
   {
      ...
      PM_NPA_KEY_CURRENT, 4, 0,  /**< [X mA] -> summed aggregation. */
      PM_NPA_KEY_HEAD_ROOM, 4, 40,  /**< [X uV] -> voltage headroom needed. */
...
{
   {
      (void*)pm_pam_sensor_vdd_b_ldo3,
      PM_NPA_VREG_LDO
   },
   {
      (void*)pm_pam_sensor_vdd_a_ldo14,
      PM_NPA_VREG_LDO
   },
};
/* SENSOR_VDD_2 Client */
pm_npa_ldo_kvps
pm_pam_sensor_vdd_2_b_ldo3 [] =
{
   // Mode: PMIC_NPA_MODE_ID_SENSOR_POWER_OFF
   {
      PM_NPA_KEY_SOFTWARE_ENABLE, 4, PM_NPA_GENERIC_DISABLE,  /**< [Disable (default), Enable] -> max aggregation (left to right). */
...
{
   {
      (void*)pm_pam_sensor_vdd_2_b_ldo3,
      PM_NPA_VREG_LDO
   },
};
/* SENSOR_VDDIO Client */
...
{
   {
      (void*)pm_pam_sensor_vddio_a_ldo14,
      PM_NPA_VREG_LDO
   },
};
/* SENSOR_VDDIO_2 Client */
pm_npa_ldo_kvps
pm_pam_sensor_vddio_2_a_ldo14 [] =
{
   // Mode: PMIC_NPA_MODE_ID_SENSOR_POWER_OFF
   {
      PM_NPA_KEY_SOFTWARE_ENABLE, 4, PM_NPA_GENERIC_DISABLE,  /**< [Disable (default), Enable] -> max aggregation (left to right). */
...
{
   {
      (void*)pm_pam_sensor_vddio_2_a_ldo14,
      PM_NPA_VREG_LDO
   },
};
...
{
   // Mode: PMIC_NPA_MODE_ID_TOUCH_MODE_OFF
   {
      PM_NPA_KEY_SOFTWARE_ENABLE, 4, PM_NPA_GENERIC_DISABLE,  /**< [Disable (default), Enable] -> max aggregation (left to right). */
      PM_NPA_KEY_LDO_SOFTWARE_MODE, 4, PM_NPA_SW_MODE_LDO__IPEAK,  /**< [BYPASS, IPEAK (default), NPM] -> max aggregation (left to right). */
      PM_NPA_KEY_PIN_CTRL_ENABLE, 4, PM_NPA_PIN_CONTROL_ENABLE__NONE,  /**< [NONE, EN1, EN2, EN3, EN4] -> ORed value of list. */
   ...
   // Mode: PMIC_NPA_MODE_ID_TOUCH_MODE_LPM
   {
      PM_NPA_KEY_SOFTWARE_ENABLE, 4, PM_NPA_GENERIC_ENABLE,  /**< [Disable (default), Enable] -> max aggregation (left to right). */
      PM_NPA_KEY_LDO_SOFTWARE_MODE, 4, PM_NPA_SW_MODE_LDO__IPEAK,  /**< [BYPASS, IPEAK (default), NPM] -> max aggregation (left to right). */
      PM_NPA_KEY_PIN_CTRL_ENABLE, 4, PM_NPA_PIN_CONTROL_ENABLE__NONE,  /**< [NONE, EN1, EN2, EN3, EN4] -> ORed value of list. */
   ...
   // Mode: PMIC_NPA_MODE_ID_TOUCH_MODE_ACTIVE
   {
      PM_NPA_KEY_SOFTWARE_ENABLE, 4, PM_NPA_GENERIC_ENABLE,  /**< [Disable (default), Enable] -> max aggregation (left to right). */
      PM_NPA_KEY_LDO_SOFTWARE_MODE, 4, PM_NPA_SW_MODE_LDO__NPM,  /**< [BYPASS, IPEAK (default), NPM] -> max aggregation (left to right). */
      PM_NPA_KEY_PIN_CTRL_ENABLE, 4, PM_NPA_PIN_CONTROL_ENABLE__NONE,  /**< [NONE, EN1, EN2, EN3, EN4] -> ORed value of list. */
...
{
   {
      (void*)pm_pam_touch_screen_a_ldo13,
      PM_NPA_VREG_LDO
   },
};
...
{
   {
      (void*)pm_pam_touch_screen1_b_ldo3,
      PM_NPA_VREG_LDO
   },
};
...
#define PMIC_NPA_CLIENT_NODE_TOUCH_SCREEN "/node/pmic/client/tscreen"
#define PMIC_NPA_CLIENT_NODE_TOUCH_SCREEN1 "/node/pmic/client/tscreen1"
/*===========================================================================
...
{
   PMIC_NPA_NODE_DEP_LIST( B, ldo, 3 ),
...
/* TOUCH_SCREEN Client */
npa_node_dependency
pm_ssc_proc_client_dev_deps_touch_screen [] =
{
...
/* TOUCH_SCREEN1 Client */
npa_node_dependency
pm_ssc_proc_client_dev_deps_touch_screen1 [] =
{
   PMIC_NPA_NODE_DEP_LIST( B, ldo, 3 ),
};
...
pm_npa_ssc_pam_node_rsrcs [] =
{
   ...
   },
   {
      ...
      PMIC_NPA_MODE_ID_TOUCH_MODE_MAX - 1, // Maximum Value
      NPA_RESOURCE_SINGLE_CLIENT, // Resource Attribute
      (void*) pm_pam_touch_screen_rails_info, // Resource User Data
      PMIC_NPA_CLIENT_NODE_TOUCH_SCREEN, // Node Name
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_ssc_proc_client_dev_deps_touch_screen, // Node Dependency
      NPA_ARRAY_SIZE(pm_ssc_proc_client_dev_deps_touch_screen), // Deps Count & Deps Node Dependency Count
      PM_NPA_PLUGIN_TYPE_IDENTITY,                                // Use Identity here.
   },
   {
      ...
      NPA_NODE_DEFAULT, // Node Attributes
      NULL,
      pm_ssc_proc_client_dev_deps_touch_screen1, // Node Dependency
      NPA_ARRAY_SIZE(pm_ssc_proc_client_dev_deps_touch_screen1), // Deps Count & Deps Node Dependency Count
      PM_NPA_PLUGIN_TYPE_IDENTITY,                                // Use Identity here.
   },
};

uint32 num_of_pm_ssc_nodes [] = { 6 };
...
pmic_npa_ldo_remote_resources [] =
{
   ...
   { PMIC_DEV_RSRC_NAME_VEC_IN( B, ldo, 3), "ldob\x03\x00\x00\x00"    },
};
