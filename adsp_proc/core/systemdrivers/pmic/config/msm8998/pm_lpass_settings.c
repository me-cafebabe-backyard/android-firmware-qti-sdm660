...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/pmic/config/msm8998/pm_lpass_settings.c#1 $ 
...
{
    {RPM_SMPS_A_REQ, 2, &num_of_mx_corners, pm_mx_corners, PM_MODEM_MX_VREG }// data 1 is the size of the LUT, data 2 is the MX LUT, data3 is the RPM resource string 
};
