...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/pmic/config/stub/pm_lpass_proc_pam.c#1 $ 
...
unsigned pm8x41_num_of_pmic_lpass_nodes[] = { NPA_ARRAY_SIZE(pm8x41_npa_lpass_node_resources) };
...
pm_npa_remote_resource_type pm8x41_npa_remote_vs =
{
   ...
   NPA_ARRAY_SIZE(pmic_npa_vs_remote_resources)
};
