...
static DALResult 
Timetick_DalTimetick_SyncSSCTimer( DalDeviceHandle * h)
{
  return Timetick_SyncSSCTimer(((DalTimetickHandle *)h)->pClientCtxt);
}
static void 
Timetick_InitInterface(TimetickClientCtxt* pclientCtxt)
{
    static const DalTimetick vtbl = {
       {
        ...
        Timetick_DalTimetick_SyncSSCTimer
    };  
	/*--------------------------------------------------------------------------
    ...
    pclientCtxt->DalTimetickHandle.dwVtblen = 37;
