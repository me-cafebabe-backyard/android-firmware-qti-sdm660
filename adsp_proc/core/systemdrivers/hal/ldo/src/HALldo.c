...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/hal/ldo/src/HALldo.c#1 $
...
/* ===========================================================================
**  HAL_ldo_SetLDOAutoBypass
**
** ======================================================================== */

void HAL_ldo_SetLDOAutoBypass
(
  HAL_ldo_LDOType eLDO,
  boolean         bEnable
)
{
  if (eLDO < HAL_LDO_NUM_OF_LDOS &&
      HAL_ldo.aLDODesc[eLDO].pmControl != NULL &&
      HAL_ldo.aLDODesc[eLDO].pmControl->SetAutoBypass != NULL)
  {
    HAL_ldo.aLDODesc[eLDO].pmControl->SetAutoBypass(bEnable);
  }

} /* END HAL_ldo_SetLDOAutoBypass */
