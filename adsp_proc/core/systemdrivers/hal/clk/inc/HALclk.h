...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/hal/clk/inc/HALclk.h#1 $
...
typedef enum
{
  ...
  HAL_CLK_SOURCE_GPLL0_ODD,
  HAL_CLK_SOURCE_GPLL1,
  HAL_CLK_SOURCE_GPLL1_DIV2,
  HAL_CLK_SOURCE_GPLL1_EARLY,
  HAL_CLK_SOURCE_GPLL1_EVEN,
  HAL_CLK_SOURCE_GPLL1_ODD,
  HAL_CLK_SOURCE_GPLL2,
  HAL_CLK_SOURCE_GPLL2_DIV2,
  HAL_CLK_SOURCE_GPLL2_EARLY,
  HAL_CLK_SOURCE_GPLL2_EVEN,
  HAL_CLK_SOURCE_GPLL2_ODD,
  HAL_CLK_SOURCE_GPLL3,
  HAL_CLK_SOURCE_GPLL3_DIV2,
  HAL_CLK_SOURCE_GPLL3_EARLY,
  HAL_CLK_SOURCE_GPLL3_EVEN,
  HAL_CLK_SOURCE_GPLL3_ODD,
  HAL_CLK_SOURCE_GPLL4,
  HAL_CLK_SOURCE_GPLL4_DIV2,
  HAL_CLK_SOURCE_GPLL4_EARLY,
  HAL_CLK_SOURCE_GPLL4_EVEN,
  HAL_CLK_SOURCE_GPLL4_ODD,
  HAL_CLK_SOURCE_GPLL5,
  HAL_CLK_SOURCE_GPLL5_DIV2,
  HAL_CLK_SOURCE_GPLL5_EARLY,
  HAL_CLK_SOURCE_GPLL5_EVEN,
  HAL_CLK_SOURCE_GPLL5_ODD,
  
  HAL_CLK_SOURCE_LPAPLL0,
  HAL_CLK_SOURCE_LPAPLL0_DIV2,
  HAL_CLK_SOURCE_LPAPLL0_DIV5,
  HAL_CLK_SOURCE_LPAPLL0_EVEN,
  HAL_CLK_SOURCE_LPAPLL0_ODD,
  HAL_CLK_SOURCE_LPAPLL1,
  HAL_CLK_SOURCE_LPAPLL1_DIV2,
  HAL_CLK_SOURCE_LPAPLL1_DIV5,
  HAL_CLK_SOURCE_LPAPLL1_EVEN,
  HAL_CLK_SOURCE_LPAPLL1_ODD,
  HAL_CLK_SOURCE_LPAPLL2,
  HAL_CLK_SOURCE_LPAPLL2_DIV2,
  HAL_CLK_SOURCE_LPAPLL2_DIV5,
  HAL_CLK_SOURCE_LPAPLL2_EVEN,
  HAL_CLK_SOURCE_LPAPLL2_ODD,
  
  HAL_CLK_SOURCE_SCCPLL0,
  HAL_CLK_SOURCE_SCCPLL0_ODD,
  HAL_CLK_SOURCE_SCCPLL0_EVEN,
  HAL_CLK_SOURCE_SCCPLL1,
  HAL_CLK_SOURCE_SCCPLL1_ODD,
  HAL_CLK_SOURCE_SCCPLL1_EVEN,

  HAL_CLK_SOURCE_TURINGPLL0_DIV2,
  HAL_CLK_SOURCE_TURINGPLL0,
  HAL_CLK_SOURCE_TURINGPLL1,
  
  HAL_CLK_SOURCE_AUD_REF_CLK,
  HAL_CLK_SOURCE_AUDREF = HAL_CLK_SOURCE_AUD_REF_CLK,
 ...
 /*
  ...
  HAL_CLK_SOURCE_XO_DOUBLER,
  HAL_CLK_SOURCE_XO_DOUBLER_DCC,
...
typedef enum
{
  ...
  HAL_CLK_CONFIG_AUTOGATE_ENABLE              = 10,  /**< Enable autogating. */
  HAL_CLK_CONFIG_AUTOGATE_DISABLE             = 11,  /**< Disable autogating. */
...
boolean HAL_clk_IsClockDomainOn         ( HAL_clk_ClockDomainHandleType pClockDomainHandle );
boolean HAL_clk_IsClockDomainSupported  ( HAL_clk_ClockDomainHandleType pClockDomainHandle, HAL_clk_ClockDomainAPIType eAPI );
...
Description:
  Sets the voting bit to denote that the subsystem processor is switching to
  TURBO.

Return:
  boolean - TRUE if the vote was set
          - FALSE if setting the vote failed
...
Description:
  Clears the voting bit to denote that the subsystem processor is no longer at
  TURBO.
...
Return:
  boolean - TRUE if the vote was cleared
          - FALSE if clearing the vote failed
