...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/hal/clk/hw/msm8998/slpi/src/lpass/HALclkQUATERNARYPCM.c#1 $
...
{
  {
    /* .szClockName      = */ "lpass_audio_core_lpaif_quad_ibit_clk",
    /* .mRegisters       = */ { HWIO_OFFS(LPASS_AUDIO_CORE_LPAIF_QUAD_IBIT_CBCR), 0, {0, 0} },
    /* .pmControl        = */ &HAL_clk_mLpass_ClockControl_2,
    /* .nTestClock       = */ HAL_CLK_LPASS_TEST_LPASS_AUDIO_CORE_LPAIF_QUAD_IBIT_CLK
  },
};
...
{
  {
    /* .szClockName      = */ "lpass_audio_core_lpaif_quad_ebit_clk",
