...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/hal/clk/hw/msm8998/slpi/src/lpass/HALclkAUDIOCORELPAIFPCMDATAOE.c#1 $
...
{
  {
    /* .szClockName      = */ "lpass_audio_core_lpaif_pcm_data_oe_clk",
    /* .mRegisters       = */ { HWIO_OFFS(LPASS_AUDIO_CORE_LPAIF_PCM_DATA_OE_CBCR), 0, {0, 0} },
    /* .pmControl        = */ &HAL_clk_mGenericClockControl,
    /* .nTestClock       = */ HAL_CLK_LPASS_TEST_LPASS_AUDIO_CORE_LPAIF_PCM_DATA_OE_CLK
  },
};
