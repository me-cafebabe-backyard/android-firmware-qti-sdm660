...
DESCRIPTION:
   This file contains common clock HAL code for the Honey Badger family of chipsets.
...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/hal/clk/hw/v1/HALclkGeneric.c#1 $
 ...
 *
 * Read-only functions for common clock functions.
 */
 ...
 *
 * Read-only functions for common power domain functions.
 */
