...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/hal/clk/hw/sdm660/cdsp/src/turing/HALclkCAMSSSTREAMING0.c#1 $
...
{
  {
    ...
    /* .mRegisters       = */ { HWIO_OFFS(TURING_Q6SS_Q6_CAMSS_DSP_STREAMING_0_CBCR), 0, {0, 0} },
 ...
 */
HAL_clk_ClockDomainDescType HAL_clk_mTURINGICAMSSDSPSTREAMING0CLKClkDomain =
{
