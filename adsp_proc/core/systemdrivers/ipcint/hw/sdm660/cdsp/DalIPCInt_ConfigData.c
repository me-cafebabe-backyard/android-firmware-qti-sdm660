...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/ipcint/hw/sdm660/cdsp/DalIPCInt_ConfigData.c#1 $
...
IPCIntConfigType IPCIntConfigMap[DALIPCINT_NUM_PROCS] =
{
  ...
  { IPC_BASE,      IPC_BASE_OFFSET_R0,   8,  4 }, //DALIPCINT_PROC_ADSP
