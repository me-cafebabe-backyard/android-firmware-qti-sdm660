...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/GPIOInt/src/user/GPIOIntUser.h#1 $
...
#define GPIOINTF_UGPIOINT_CONFIG   0x0020
...
/*=============================================================================
  ...
  DESCRIPTION   This function is an extention of the function GPIOIntr_RegisterIsrEx
  It registers the isr routine to a given GPIO interrupt. It takes in flages for the uimage.
  Whenever an interrupt is fired the isr routine registered by the 
  user is called.
  ...
  uint32 param :               The uint32 parameter given to the isr routine 
                               when called.
  uint32 nFlags :
  GPIOINT_UIMAGE_MODE 1        The  interrupt is going to be used in the GPIOInt uImage
  GPIOINT_NORMAL_MODE 0        The  interrupt is going to be used in the normal full power image.
