...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/GPIOInt/src/kernel/uimage/uGPIOIntQDI.c#1 $
...
FUNCTION    uGPIOIntQDI_SetDirectConnectGPIOMapping
...
===========================================================================*/
int uGPIOIntQDI_SetDirectConnectGPIOMapping
(
  int hClientHandle,
  int nGPIO, 
  int nQurtInterruptID
)
{
  ...
  nResult = uGPIOInt_SetDirectConnectGPIOMapping((uint32)nGPIO,(uint32)nQurtInterruptID);
  return nResult;
 
} /* End uGPIOIntQDI_SetDirectConnectGPIOMapping */


/*===========================================================================

FUNCTION    uGPIOIntQDI_ClearDirectConnectGPIOMapping

DESCRIPTION
  Clears the interrupt ID in the kernel uGPIOInt table
...
===========================================================================*/
int uGPIOIntQDI_ClearDirectConnectGPIOMapping
(
  int hClientHandle,
  int nGPIO
)
{
  ...
  nResult = uGPIOInt_ClearDirectConnectGPIOMapping((uint32)nGPIO);
  return nResult;
 
} /* End uGPIOIntQDI_ClearDirectConnectGPIOMapping */
                          ...
                          qurt_qdi_arg_t a9)
{
  switch (method) 
  {
    ...
    case UGPIOINT_QDI_SET_DIR_CONN:
      return uGPIOIntQDI_SetDirectConnectGPIOMapping(hClientHandle,a1.num,a2.num);
    case UGPIOINT_QDI_CLEAR_DIR_CONN:
      return uGPIOIntQDI_ClearDirectConnectGPIOMapping(hClientHandle, a1.num);
