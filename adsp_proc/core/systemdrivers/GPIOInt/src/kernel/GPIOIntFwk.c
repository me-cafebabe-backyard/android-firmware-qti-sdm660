...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/GPIOInt/src/kernel/GPIOIntFwk.c#1 $
...
static DALResult 
GPIOInt_GPIOInt_RegisterInterrupt( DalDeviceHandle * h, uint32  gpio, GPIOIntTriggerType trigger, 
