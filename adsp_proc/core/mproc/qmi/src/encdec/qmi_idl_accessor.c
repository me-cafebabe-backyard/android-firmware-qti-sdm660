...
===========================================================================*/
ENCDEC_EXPORT int32_t qmi_idl_get_idl_version
(
  const qmi_idl_service_object_type p_service,
...
===========================================================================*/
ENCDEC_EXPORT int32_t qmi_idl_get_idl_minor_version
(
  const qmi_idl_service_object_type p_service,
  uint32_t *idl_version
)
...
*/
/*=========================================================================*/
ENCDEC_EXPORT int32_t qmi_idl_get_service_id
(
  const qmi_idl_service_object_type p_service,
  uint32_t *service_id
)
...
*/
/*=========================================================================*/
ENCDEC_EXPORT int32_t qmi_idl_get_max_service_len
(
  const qmi_idl_service_object_type p_service,
...
*/
/*=========================================================================*/
ENCDEC_EXPORT int32_t qmi_idl_get_max_message_len
(
  const qmi_idl_service_object_type p_service,
  qmi_idl_type_of_message_type message_type,
  uint16_t message_id,
...
*/
/*=========================================================================*/
ENCDEC_EXPORT int32_t qmi_idl_get_message_c_struct_len
(
  const qmi_idl_service_object_type p_service,
  qmi_idl_type_of_message_type message_type,
  uint16_t message_id,
...
*/
/*=========================================================================*/
ENCDEC_EXPORT int32_t qmi_idl_get_max_c_struct_len
(
  const qmi_idl_service_object_type p_service,
  uint32_t *c_struct_len
)
...
*/
/*=========================================================================*/
ENCDEC_EXPORT int32_t qmi_idl_inherit_service_object
(
...
*/
/*=========================================================================*/
ENCDEC_EXPORT qmi_idl_service_object_type qmi_idl_get_inherited_service_object
(
