...
$Header: //components/rel/core.qdsp6/1.0.c2/mproc/glink/core/inc/glink_transport_if.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
07/20/15   an      set minimal priority to really low value
