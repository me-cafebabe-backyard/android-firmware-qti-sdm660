...
$Header: //components/rel/core.qdsp6/1.0.c2/mproc/glink/core/inc/glink_core_intent.h#1 $
...
/*===========================================================================
  FUNCTION      glinki_free_intent_from_iid
===========================================================================*/
/**

  Finds matching intent and free that from queue

  @param[in]  intent_q_cs   mutex to protect the list.
  @param[in]  intent_q      smem_list intent queue.
  @param[in]  iid           Intent ID of intent.
  @param[in]  if_ptr        transport interface pointer in case of 
                            freeing local intent.
...
*/
/*=========================================================================*/
void glinki_free_intent_from_iid
(
