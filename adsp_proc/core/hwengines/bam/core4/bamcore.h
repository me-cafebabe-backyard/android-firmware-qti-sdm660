...
===============================================================================
 ...
 $Header: //components/rel/core.qdsp6/1.0.c2/hwengines/bam/core4/bamcore.h#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------
01/12/15   SS      Added istari and 64 bit support.
...
#define AUD_SB_BAM_PA          0x9184000
#define QCA_SB_BAM_PA          0x9204000
#define IS_REQ_BAM_PA(x)      (((x)==AUD_SB_BAM_PA) || ((x)==QCA_SB_BAM_PA))
#define IS_REQ_BAM_VERSION(x) (((x) & 0xFF)==0x19)
#define GET_SB_BAM_PIPE_MASK(x,y)    ((x)==AUD_SB_BAM_PA ? GET_AUD_SB_BAM_PIPE_MASK(y):((x)==QCA_SB_BAM_PA ? GET_QCA_SB_BAM_PIPE_MASK(y):0xFFFFFFFF))
#define GET_AUD_SB_BAM_PIPE_MASK(x) ((x)==0x0? 0x0fffff87:((x)==0x1? 0x70000018:((x)==0x2? 0x00000060:0x0)))
#define GET_QCA_SB_BAM_PIPE_MASK(x) ((x)==0x0? 0x0007ff87:((x)==0x1? 0x00000018:((x)==0x2? 0x00000060:0x0)))
