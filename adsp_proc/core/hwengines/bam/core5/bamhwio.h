...
===============================================================================
 ...
 This is the internal hardware IO layer for BAM (Bus Access Module) for the
 following blocks:
  - CRYPTO0_BAM
  - SSC_BLSP_BAM
  - QDSS_NDPBAM
...
===============================================================================
 ...
 $Header: //components/rel/core.qdsp6/1.0.c2/hwengines/bam/core5/bamhwio.h#1 $
...
/* for SW_VERSION greater than 1.7.3 */      
...
#define BAM_P_CNSMR_SDBNDn_BAM_P_NWD_TOGGLE_MASK                               0x2000000
#define BAM_P_CNSMR_SDBNDn_BAM_P_NWD_TOGGLE_SHFT                               0x19
