...
===============================================================================
 ...
 $Header: //components/rel/core.qdsp6/1.0.c2/hwengines/bam/stub/bam_stub.c#1 $
 ...
 *
 */
bam_status_type bam_pipe_transfer(bam_handle pipehandle, uint32 buf_pa, uint16 buf_size, uint16 xfer_opts, void *user_data)
{
    return BAM_FAILED;
}
