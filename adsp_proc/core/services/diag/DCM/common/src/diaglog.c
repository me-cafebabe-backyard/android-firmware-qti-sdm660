...
Copyright (c) 1990-2014, 2016 by QUALCOMM Technologies, Incorporated.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
$Header: //components/rel/core.qdsp6/1.0.c2/services/diag/DCM/common/src/diaglog.c#1 $
