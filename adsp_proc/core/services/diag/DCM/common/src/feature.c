...
Copyright (c) 1998-2018 by QUALCOMM Technologies, Incorporated.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
Notice that changes are listed in reverse chronological order.
 ...
 $Header: //components/rel/core.qdsp6/1.0.c2/services/diag/DCM/common/src/feature.c#1 $
...
05/12/14   rh      Removed PACK from void* pointers 
04/10/14   sr      Support for peripheral buffering mode  
04/01/14   rs      Added support for build mask centralization. 
07/24/13   sg      Req/rsp path separation 
02/26/13   sr      Added support to turn off HDLC encoding
09/21/12   is      Add suport for preset masks
03/02/12   sg      Fixed compiler errors
...
byte diag_feature_mask[FEATURE_MASK_LENGTH] = {
  ...
  #ifdef FEATURE_ID
  | ADD_BIT_TO_FEATURE_MASK(F_ID_BIT)
  #endif /* FEATURE_ID */
  ...
  | ADD_BIT_TO_FEATURE_MASK(F_MDR_DPT_MARKOV_BIT)
...
void diag_init_feature_mask( void )
{
  ...
  /* The peripheral supports buffering mode. */
  DIAG_INT_FEATURE_MASK_SET(F_DIAG_PERIPH_BUFFERING_SUPPORT);
    
    //Set the socket support bit in feature mask
  DIAG_INT_FEATURE_MASK_SET(F_DIAG_SOCKET_SUPPORT);
...
#endif
  /* Supports diagID */
  DIAG_INT_FEATURE_MASK_SET(F_DIAG_DIAGID_SUPPORT);

  DIAG_INT_FEATURE_MASK_SET(F_DIAG_TAGGING_HEADER_SUPPORT);

  DIAG_INT_FEATURE_MASK_SET(F_DIAG_PD_BUFFERING_SUPPORT);
