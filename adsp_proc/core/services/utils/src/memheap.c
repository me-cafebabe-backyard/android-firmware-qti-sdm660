...
Copyright (c) 1997-2017 by Qualcomm Technologies Incorporated.  All Rights Reserved.
============================================================================ */
...
$Header: //components/rel/core.qdsp6/1.0.c2/services/utils/src/memheap.c#1 $ $DateTime: 2020/02/10 01:57:30 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     ---------------------------------------------------------
03/24/17   nk      Known code review bugs propagation from SPSS PL
03/20/17   nk      Fixed issue in mem_memalign api to update guard bytes
02/28/17   nk      Added Used block integrity check in mem_free api
30/01/17   nk      Fixed issue with registering call backs with memheap
12/19/16   nk      Changes to support Remote heap
