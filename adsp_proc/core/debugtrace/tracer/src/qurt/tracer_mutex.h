...
===========================================================================*/
/* $Header: //components/rel/core.qdsp6/1.0.c2/debugtrace/tracer/src/qurt/tracer_mutex.h#1 $ */
...
*/
#define tracer_mutex_init() qurt_pimutex_init(&tracer_lock)

/**
  @brief Translator to target specific mutex destroy function.
*/
#define tracer_mutex_destroy() qurt_pimutex_destroy(&tracer_lock)

/**
  @brief Translator to target specific mutex lock function.
*/
#define tracer_mutex_lock() qurt_pimutex_lock(&tracer_lock)

/**
  @brief Translator to target specific mutex unlock function.
*/
#define tracer_mutex_unlock() qurt_pimutex_unlock(&tracer_lock)
