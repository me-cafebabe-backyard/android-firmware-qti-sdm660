...
===========================================================================*/
/* $Header: //components/rel/core.qdsp6/1.0.c2/debugtrace/tracer/src/tracer_portmgr.h#1 $ */
...
extern struct portMgr_s gPortMgr;
extern struct portMgr_s gPortMgrMicro;
...
extern boolean tracer_log_all_to_ssc_qdss;
