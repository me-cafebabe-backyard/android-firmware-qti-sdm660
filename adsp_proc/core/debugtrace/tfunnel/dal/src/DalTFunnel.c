/*=============================================================================
  Copyright (c) 2009 Qualcomm Technologies Incorporated.
           All Rights Reserved.
                  ...
                  $Header: //components/rel/core.qdsp6/1.0.c2/debugtrace/tfunnel/dal/src/DalTFunnel.c#1 $
=============================================================================*/
...
static DALResult
TFunnel_DeviceDisableAll(DalDeviceHandle *h)
{
   HAL_qdss_tfunnel_UnlockAccessAll();
   HAL_qdss_tfunnel_DisableAllPortsAllFunnels();
