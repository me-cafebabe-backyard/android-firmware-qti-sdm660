...
================================================================================
  $Header: //components/rel/core.qdsp6/1.0.c2/debugtrace/tmc/hal/inc/halqdss_etfetb.h#1 $
==============================================================================*/
...
void HAL_qdss_etfetb_SetFFCRETBDefault(uint8);
boolean  HAL_qdss_etfetb_IsEnabled(void);
void HAL_qdss_etfetb_StopOnFlush(uint8 bEnable);
void HAL_qdss_etfetb_WaitForTMCReady(void); 
