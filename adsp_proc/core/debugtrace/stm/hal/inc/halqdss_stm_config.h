...
/*========================================================================== 
 $Header: //components/rel/core.qdsp6/1.0.c2/debugtrace/stm/hal/inc/halqdss_stm_config.h#1 $
==========================================================================*/  
...
extern void HAL_qdss_stm_HWEventTriggerSetMask(uint32);
extern void HAL_qdss_stm_HWEventEnableMask(uint32);
