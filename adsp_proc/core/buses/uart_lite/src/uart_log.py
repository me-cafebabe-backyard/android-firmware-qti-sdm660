...
$Header: //components/rel/core.qdsp6/1.0.c2/buses/uart_lite/src/uart_log.py#1 $

when       who     what, where, why
--------   ---     --------------------------------------------------------
10/26/16   rc      Corrected the folder name
...
def parse_files(files):
    curr_dir = os.getcwd()
    par_dir = re.search(r"(.*)uart_lite\\",curr_dir).group(0)
