...
$Header: //components/rel/core.qdsp6/1.0.c2/power/qdsp_pm/src/driver/qdsp_pm_mgr/resource_mgr/requestmgr.c#1 $
*/
...
Adsppm_Status RM_TeardownClient(uint32 clientId)
{
    ...
    else
    {
        ...
        for(rscId = Adsppm_Rsc_Id_Power; rscId < Adsppm_Rsc_Id_Max; rscId++)
        {
