#ifndef __LPASS_CLOCKS_HWIO_8996_H__
#define __LPASS_CLOCKS_HWIO_8996_H__
/*
===========================================================================
*/
/**
  @file lpass_clocks_hwio_8996.h
...
/*
  ...
  $Header: //components/rel/core.qdsp6/1.0.c2/power/qdsp_pm/config/8996/lpass_clocks_hwio_8996.h#1 $
...
#define HWIO_LPASS_CSR_GP_CTL_RMSK                                                      0xffff000f
...
#define HWIO_LPASS_CSR_MEMTYPE_CTL_RMSK                                                   0xffffff
...
#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_CGCR_ADDR                               (LPASS_LPASS_CSR_REG_BASE      + 0x0001b000)
#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_CGCR_OFFS                               (LPASS_LPASS_CSR_REG_BASE_OFFS + 0x0001b000)
#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_CGCR_RMSK                                      0x3
#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_CGCR_IN          \
        in_dword_masked(HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_CGCR_ADDR, HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_CGCR_RMSK)
#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_CGCR_INM(m)      \
        in_dword_masked(HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_CGCR_ADDR, m)
#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_CGCR_OUT(v)      \
        out_dword(HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_CGCR_ADDR,v)
#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_CGCR_OUTM(m,v) \
        out_dword_masked_ns(HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_CGCR_ADDR,m,v,HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_CGCR_IN)
#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_CGCR_HW_CTL_BMSK                               0x2
#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_CGCR_HW_CTL_SHFT                               0x1
#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_CGCR_CLK_ENABLE_BMSK                           0x1
#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_CGCR_CLK_ENABLE_SHFT                           0x0

#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_HYSTERESIS_ADDR                         (LPASS_LPASS_CSR_REG_BASE      + 0x0001b004)
#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_HYSTERESIS_OFFS                         (LPASS_LPASS_CSR_REG_BASE_OFFS + 0x0001b004)
#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_HYSTERESIS_RMSK                                0x7
#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_HYSTERESIS_IN          \
        in_dword_masked(HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_HYSTERESIS_ADDR, HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_HYSTERESIS_RMSK)
#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_HYSTERESIS_INM(m)      \
        in_dword_masked(HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_HYSTERESIS_ADDR, m)
#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_HYSTERESIS_OUT(v)      \
        out_dword(HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_HYSTERESIS_ADDR,v)
#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_HYSTERESIS_OUTM(m,v) \
        out_dword_masked_ns(HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_HYSTERESIS_ADDR,m,v,HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_HYSTERESIS_IN)
#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_HYSTERESIS_ACTIVE_HYSTSEL_BMSK                 0x7
#define HWIO_LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_HYSTERESIS_ACTIVE_HYSTSEL_SHFT                 0x0


#endif /* __LPASS_CLOCKS_HWIO_8996_H__ */
