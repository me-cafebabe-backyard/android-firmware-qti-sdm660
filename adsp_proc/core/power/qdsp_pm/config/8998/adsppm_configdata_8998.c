...
$Header: //components/rel/core.qdsp6/1.0.c2/power/qdsp_pm/config/8998/adsppm_configdata_8998.c#1 $
*/
...
#include "icbid.h"
#include "DDIIPCInt.h"
#include "lpass_clocks_hwio_8998.h"
#include "msmhwiobase.h"
#include "limits.h"

AsicHwioRegRangeType lpassRegRange_8998 = {LPASS_BASE, LPASS_BASE_PHYS, LPASS_BASE_SIZE};
...
AsicHwioRegRangeType l2ConfigRegRange_8998 = {L2_CONFIG_BASE, L2_CONFIG_BASE, 0x1004 /* max expected offset needed by ADPSPM */};

/**
 * Array of 8998 Core Clocks per core. Arranged by to core ID
 */
const AdsppmClkIdType coreClocks_SlimBus_8998[] = {AdsppmClk_Slimbus_Core, AdsppmClk_Slimbus2_Core};
//const AdsppmClkIdType coreClocks_Midi_8998[]    = {AdsppmClk_Midi_Core};
const AdsppmClkIdType coreClocks_HwRsp_8998[]   = {AdsppmClk_HwRsp_Core};

/**
 * Array of 8998 Master Bus Ports per core. Arranged by to core ID
 */
const AdsppmBusPortIdType masterPorts_ADSP_8998[]    = {AdsppmBusPort_Adsp_Master};
const AdsppmBusPortIdType masterPorts_DML_8998[]     = {AdsppmBusPort_Dml_Master};
const AdsppmBusPortIdType masterPorts_AIF_8998[]     = {AdsppmBusPort_Aif_Master};
const AdsppmBusPortIdType masterPorts_SlimBus_8998[] = {AdsppmBusPort_Slimbus_Master, AdsppmBusPort_Slimbus2_Master};
//const AdsppmBusPortIdType masterPorts_Midi_8998[]    = {AdsppmBusPort_Midi_Master};
const AdsppmBusPortIdType masterPorts_HWRSMP_8998[]  = {AdsppmBusPort_HwRsmp_Master};
//const AdsppmBusPortIdType masterPorts_Spdif_8998[]   = {AdsppmBusPort_Spdif_Master};
//const AdsppmBusPortIdType masterPorts_Hdmirx_8998[]  = {AdsppmBusPort_Hdmirx_Master};
const AdsppmBusPortIdType masterPorts_Hdmitx_8998[]  = {AdsppmBusPort_Hdmitx_Master};
//const AdsppmBusPortIdType masterPorts_Sif_8998[]     = {AdsppmBusPort_Sif_Master};

/**
 * Array of 8998 Slave Bus Ports per core. Arranged by to core ID
 */
const AdsppmBusPortIdType slavePorts_ADSP_8998[]    = {AdsppmBusPort_Adsp_Slave};
const AdsppmBusPortIdType slavePorts_LPM_8998[]     = {AdsppmBusPort_Lpm_Slave};
const AdsppmBusPortIdType slavePorts_DML_8998[]     = {AdsppmBusPort_Dml_Slave};
const AdsppmBusPortIdType slavePorts_AIF_8998[]     = {AdsppmBusPort_Aif_Slave};
const AdsppmBusPortIdType slavePorts_SlimBus_8998[] = {AdsppmBusPort_Slimbus_Slave, AdsppmBusPort_Slimbus2_Slave};
//const AdsppmBusPortIdType slavePorts_Midi_8998[]    = {AdsppmBusPort_Midi_Slave};
const AdsppmBusPortIdType slavePorts_AVsync_8998[]  = {AdsppmBusPort_AvSync_Slave};
const AdsppmBusPortIdType slavePorts_HWRSMP_8998[]  = {AdsppmBusPort_HwRsmp_Slave};
//const AdsppmBusPortIdType slavePorts_SRam_8998[]    = {AdsppmBusPort_Sram_Slave};
//const AdsppmBusPortIdType slavePorts_DCodec_8998[]  = {AdsppmBusPort_Dcodec_Slave};
//const AdsppmBusPortIdType slavePorts_Spdif_8998[]   = {AdsppmBusPort_Spdif_Slave};
//const AdsppmBusPortIdType slavePorts_Hdmirx_8998[]  = {AdsppmBusPort_Hdmirx_Slave};
const AdsppmBusPortIdType slavePorts_Hdmitx_8998[]  = {AdsppmBusPort_Hdmitx_Slave};
//const AdsppmBusPortIdType slavePorts_Sif_8998[]     = {AdsppmBusPort_Sif_Slave};
//const AdsppmBusPortIdType slavePorts_BSTC_8998[]    = {AdsppmBusPort_Bstc_Slave};

/**
 * Array of 8998 core descriptors. Arranged according to core ID enum
 */
const AsicCoreDescType cores_array_8998[] =
{
        {   //Adsppm_Core_Id_None
        ...
        {   //Adsppm_Core_Id_ADSP
                ...
                {0, NULL}, //Core clock instances
                {ADSPPM_ARRAY(masterPorts_ADSP_8998)}, //Master port instances
                {ADSPPM_ARRAY(slavePorts_ADSP_8998)}, //Slave port instances
        ...
        {   //Adsppm_Core_Id_LPM
                ...
                {0, NULL}, //Core clock instances
                {0, NULL}, //Master port instances
                {ADSPPM_ARRAY(slavePorts_LPM_8998)}, //Slave port instances
                Adsppm_Instance_Id_0 //Number of core instances
        },
        {   //Adsppm_Core_Id_DML
                ...
                AsicPowerDomain_LpassCore, //Power Domain
                {0, NULL}, //Core clock instances
                {ADSPPM_ARRAY(masterPorts_DML_8998)}, //Master port instances
                {ADSPPM_ARRAY(slavePorts_DML_8998)}, //Slave port instances
                Adsppm_Instance_Id_0 //Number of core instances
        },
        {   //Adsppm_Core_Id_AIF
                ...
                AsicPowerDomain_LpassCore, //Power Domain
                {0, NULL}, //Core clock instances
                {ADSPPM_ARRAY(masterPorts_AIF_8998)}, //Master port instances
                {ADSPPM_ARRAY(slavePorts_AIF_8998)}, //Slave port instances
                Adsppm_Instance_Id_0 //Number of core instances
        },
        {   //Adsppm_Core_Id_SlimBus
                ...
                AsicPowerDomain_LpassCore, //Power Domain
                {ADSPPM_ARRAY(coreClocks_SlimBus_8998)}, //Core clock instances
                {ADSPPM_ARRAY(masterPorts_SlimBus_8998)}, //Master port instances
                {ADSPPM_ARRAY(slavePorts_SlimBus_8998)}, //Slave port instances
        ...
        {   //Adsppm_Core_Id_AVsync
                ...
                {0, NULL}, //Core clock instances
                {0, NULL}, //Master port instances
                {ADSPPM_ARRAY(slavePorts_AVsync_8998)}, //Slave port instances
                Adsppm_Instance_Id_0 //Number of core instances
        },
        {   //Adsppm_Core_Id_HWRSMP
                ...
                AsicPowerDomain_LpassCore, //Power Domain
                {ADSPPM_ARRAY(coreClocks_HwRsp_8998)}, //Core clock instances
                {ADSPPM_ARRAY(masterPorts_HWRSMP_8998)}, //Master port instances
                {ADSPPM_ARRAY(slavePorts_HWRSMP_8998)}, //Slave port instances
                Adsppm_Instance_Id_0 //Number of core instances
        },
        {   //Adsppm_Core_Id_SRam
                Adsppm_Core_Id_None, //Core ID
        ...
        {   //Adsppm_Core_Id_Hdmitx
                ...
                AsicPowerDomain_LpassCore, //Power Domain
                {0, NULL}, //Core clock instances
                {ADSPPM_ARRAY(masterPorts_Hdmitx_8998)}, //Master port instances
                {ADSPPM_ARRAY(slavePorts_Hdmitx_8998)}, //Slave port instances
                Adsppm_Instance_Id_0 //Number of core instances
        },
        {   //Adsppm_Core_Id_Sif
                Adsppm_Core_Id_None, //Core ID
...
AsicCoreDescriptorArrayType cores_8998 = {ADSPPM_ARRAY(cores_array_8998)};

const AsicMemDescriptorType memories_array_8998[] =
{
        {   //Adsppm_Mem_None
...
AsicMemDescriptorArrayType memories_8998 = {ADSPPM_ARRAY(memories_array_8998)};

/**
 * Array of 8998 core clock descriptors. Arranged by core clock ID
 */
const AsicClkDescriptorType clocks_array_8998[AdsppmClk_EnumMax] =
{
        {
        ...
        // LPASS_AUDIO_CORE_SYSNOC_MPORT_CORE_CGCR doesn't exist on 8998
        {
                AdsppmClk_None, //Clk ID
                AsicClk_TypeNone, //Clk Type
                AsicClk_CntlNone, //Cntl Type
        ...
        },
        {
                ...
                AsicClk_CntlSW, //Cntl Type
                AsicClk_MemCntlNone, //MemCtrl Type
                .clkInfo.clkName = "lpass_audio_core_peripheral_smmu_client_core_clk", //Name
                AdsppmClk_Ahb_Root, //Source
                Adsppm_Mem_None //Memory ID
        },
        {
        ...
        },
        {
                ...
                AsicClk_CntlAlwaysON, //Cntl Type
                AsicClk_MemCntlNone, //MemCtrl Type
                .clkInfo.clkName = "lpass_audio_wrapper_mpu_cfg_aon_clk", //Name
                AdsppmClk_AhbE_Hclk, //Source
                Adsppm_Mem_None //Memory ID
        },
        {
                ...
                AsicClk_CntlAlwaysON, //Cntl Type
                AsicClk_MemCntlNone, //MemCtrl Type
                .clkInfo.clkName = "lpass_audio_wrapper_q6_ahbm_mpu_aon_clk", //Name
                AdsppmClk_AhbE_Hclk, //Source
                Adsppm_Mem_None //Memory ID
        },
        {
...
AsicClockDescriptorArrayType clocks_8998 = {ADSPPM_ARRAY(clocks_array_8998)};

/**
 * Arrays of 8998 register programming clocks
 */
const AdsppmClkIdType regProgClocks_Dml_8998[]      = {AdsppmClk_Dml_Hclk};
const AdsppmClkIdType regProgClocks_Aif_8998[]      = {AdsppmClk_Aif_Csr_Hclk};
const AdsppmClkIdType regProgClocks_Slimbus_8998[]  = {AdsppmClk_Slimbus_Hclk};
const AdsppmClkIdType regProgClocks_Slimbus2_8998[] = {AdsppmClk_Slimbus2_Hclk};
//const AdsppmClkIdType regProgClocks_Midi_8998[]     = {AdsppmClk_Midi_Hclk};
const AdsppmClkIdType regProgClocks_HwRsmp_8998[]   = {AdsppmClk_HwRsp_Hclk};
const AdsppmClkIdType regProgClocks_AvSync_8998[]   = {AdsppmClk_AvSync_Hclk};
const AdsppmClkIdType regProgClocks_Lpm_8998[]      = {AdsppmClk_Lpm_Hclk};
const AdsppmClkIdType regProgClocks_Sram_8998[]     = {AdsppmClk_Sram_Hclk};
//const AdsppmClkIdType regProgClocks_Spdif_8998[]    = {AdsppmClk_Spdif_Hsclk};
//const AdsppmClkIdType regProgClocks_Hdmirx_8998[]   = {AdsppmClk_Hdmirx_Hclk};
const AdsppmClkIdType regProgClocks_Hdmitx_8998[]   = {AdsppmClk_Hdmitx_Hclk};
//const AdsppmClkIdType regProgClocks_Sif_8998[]      = {AdsppmClk_Sif_Hclk};
//const AdsppmClkIdType regProgClocks_Bstc_8998[]     = {AdsppmClk_Bstc_Hclk};
//const AdsppmClkIdType regProgClocks_Dcodec_8998[]   = {AdsppmClk_Dcodec_Hclk};
const AdsppmClkIdType regProgClocks_Adsp_8998[]     = {AdsppmClk_Adsp_Hmclk, AdsppmClk_Adsp_Hsclk};

/**
 * Array of 8998 Bus port descriptors arranged by Bus port ID
 */
const AsicBusPortDescriptorType busPorts_array_8998[] =
{
        {
        ...
        },
        {
                ...
                AdsppmClk_Dml_Hclk, //Bus clock
                {ADSPPM_ARRAY(regProgClocks_Dml_8998)}, //Array of reg prog clocks
        ...
        },
        {
                ...
                {ADSPPM_ARRAY(regProgClocks_Aif_8998)}, //Array of reg prog clocks
                {.icbarbSlave = ICBID_SLAVE_LPASS}, //icbarb ID
                AdsppmBusPort_Ext_Ahb_Slave //Access port
        },
        {
                ...
                AsicBusPort_AhbI_S, //Connection
                AdsppmClk_Slimbus_Hclk, //Bus clock
                {ADSPPM_ARRAY(regProgClocks_Slimbus_8998)}, //Array of reg prog clocks
                {.icbarbSlave = ICBID_SLAVE_LPASS}, //icbarb ID
                AdsppmBusPort_Ext_Ahb_Slave //Access port
        },
        {
                ...
                AsicBusPort_AhbI_S, //Connection
                AdsppmClk_Slimbus2_Hclk, //Bus clock
                {ADSPPM_ARRAY(regProgClocks_Slimbus2_8998)}, //Array of reg prog clocks
                {.icbarbSlave = ICBID_SLAVE_LPASS}, //icbarb ID
                AdsppmBusPort_Ext_Ahb_Slave //Access port
        },
        {
        ...
        },
        {
                ...
                AsicBusPort_AhbI_S, //Connection
                AdsppmClk_HwRsp_Hclk, //Bus clock
                {ADSPPM_ARRAY(regProgClocks_HwRsmp_8998)}, //Array of reg prog clocks
                {.icbarbSlave = ICBID_SLAVE_LPASS}, //icbarb ID
                AdsppmBusPort_Ext_Ahb_Slave //Access port
        },
        {
                ...
                {ADSPPM_ARRAY(regProgClocks_AvSync_8998)}, //Array of reg prog clocks
                {.icbarbSlave = ICBID_SLAVE_LPASS}, //icbarb ID
                AdsppmBusPort_Ext_Ahb_Slave //Access port
        },
        {
                ...
                {ADSPPM_ARRAY(regProgClocks_Lpm_8998)}, //Array of reg prog clocks
                {.icbarbSlave = ICBID_SLAVE_LPASS}, //icbarb ID
                AdsppmBusPort_Ext_Ahb_Slave //Access port
        },
        {
        ...
        },
        {
                ...
                AsicBusPort_AhbI_S, //Connection
                AdsppmClk_Hdmitx_Hclk, //Bus clock
                {ADSPPM_ARRAY(regProgClocks_Hdmitx_8998)}, //Array of reg prog clocks
                {.icbarbSlave = ICBID_SLAVE_LPASS}, //icbarb ID
                AdsppmBusPort_Ext_Ahb_Slave //Access port
        },
        {
        ...
        },
        {
                ...
                {ADSPPM_ARRAY(regProgClocks_Adsp_8998)}, //Array of reg prog clocks
                {.icbarbSlave = ICBID_SLAVE_LPASS}, //icbarb ID
                AdsppmBusPort_Adsp_Master //Access port
        }
};

AsicBusPortDescriptorArrayType busPorts_8998 = {ADSPPM_ARRAY(busPorts_array_8998)};

/**
 * List of supported external bus routes
 */
const AdsppmBusRouteType extBusRoutes_array_8998[] =
{
        {
...
AsicBusRouteArrayType extBusRoutes_8998 = {ADSPPM_ARRAY(extBusRoutes_array_8998)};

const AdsppmBusRouteType mipsBwRoutes_array_8998[] =
{
        {
...
AsicBusRouteArrayType mipsBwRoutes_8998 = {ADSPPM_ARRAY(mipsBwRoutes_array_8998)};

/**
* Array of register programming speeds in byte/sec
*/
const uint64 regProgSpeeds_array_8998[] =
{
...
AsicRegProgSpeedArrayType regProgSpeeds_8998 = {ADSPPM_ARRAY(regProgSpeeds_array_8998)};

/**
 * Array of power domain descriptors
 */
const AsicPowerDomainDescriptorType pwrDomains_array_8998[] =
{
        {
...
AsicPwrDescriptorArrayType pwrDomains_8998 = {ADSPPM_ARRAY(pwrDomains_array_8998)};
 ...
 */
const AsicCompensatedDdrBwTableEntryType compensatedDdrBw_array_8998[] = {
...
AsicCompensatedDdrBwTableType compensatedDdrBwTable_8998 = {ADSPPM_ARRAY(compensatedDdrBw_array_8998)};

const AsicCompensatedAhbBwTableEntryType compensatedAhbBw_array_8998[] = {
    // bwThreshold,            bwVote
...
AsicCompensatedAhbBwTableType compensatedAhbBwTable_8998 = {ADSPPM_ARRAY(compensatedAhbBw_array_8998)};

const AsicThreadLoadingInfoType threadLoadingData_array_8998[] =
{
...
AsicThreadLoadingInfoTableType threadLoadingData_8998 = {ADSPPM_ARRAY(threadLoadingData_array_8998)};

const uint32 audioVoiceCppFactors_array_8998[] =
{
...
AsicAudioVoiceCppTrendFactorsType audioVoiceCppFactors_8998 = {
        ADSPPM_ARRAY(audioVoiceCppFactors_array_8998)};
...
const AsicCachePartitionConfigType cachePartitionConfig_array_8998[] = {
...
AsicCachePartitionConfigTableType cachePartitionConfigTable_8998 =
    { ADSPPM_ARRAY(cachePartitionConfig_array_8998) };

const AsicBwConcurrencySettingsType bwConcurrencySettings_8998 =
{
...
const AsicAdspToAhbeFreqTableEntry adspToAhbeFreq_array_8998v1[] = {
...
AsicAdspToAhbeFreqTableType adspToAhbeFreqTable_8998v1 = 
    { ADSPPM_ARRAY(adspToAhbeFreq_array_8998v1) };

//Table to lookup MPPS threshold values for different client classes
//Class Name, Threshold value
const AsicAdspCacheSizeMPPSThresholdTableEntry adspcachesizeMPPSThreshold_array_8998[] = {
    {   MMPM_AUDIO_CLIENT_CLASS,  100  },

};

AsicAdspCacheSizeMPPSThresholdTableType  adspCacheSizeMPPSThreshold_8998 = {ADSPPM_ARRAY(adspcachesizeMPPSThreshold_array_8998)};

const AsicAdspCacheSizeBWScalingTableEntry adspcachesizebwscaling_array_8998[] = {
    {   FULL_SIZE,             67  },
    {   THREE_QUARTER_SIZE,   100  },
    {   HALF_SIZE,            100  },    
};

AsicAdspCacheSizeBWScalingTableType  adspcachesizebwscaling_8998 = {ADSPPM_ARRAY(adspcachesizebwscaling_array_8998)};
	
const AsicFeatureDescType features_8998 [AsicFeatureId_enum_max] =
{
