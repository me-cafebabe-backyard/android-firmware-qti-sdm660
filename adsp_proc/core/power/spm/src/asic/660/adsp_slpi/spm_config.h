...
================================================================================
$Header: //components/rel/core.qdsp6/1.0.c2/power/spm/src/asic/660/adsp_slpi/spm_config.h#1 $
...
/*       Command            Index     Mask register
  ...
  QDSP6_PLL_RESET,          /* 7      SPMCTL_EN_PLL (RESET)           
                                      SPMCTL_EN_EXT                   */
  ...
  QDSP6_AON_HS,             /* 12     SPMCTL_EN_EXT[9]  (LPASS only)  */  // EXT shutdown request
  QDSP6_SMMU_PD_VOTE,       /* 13     SPMCTL_EN_EXT[10] (ComputeSS only) */
  ...
  QDSP6_PLL_FREEZE,         /* 18     SPMCTL_EN_PLL (N/A in Nazgul)   */
  ...
  QDSP6_COPROC_BHS_OFF      /* 31     SPMCTH_EN_BHS (ComputeSS only)  */
