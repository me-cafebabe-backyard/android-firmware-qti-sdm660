...
===============================================================================
$Header: //components/rel/core.qdsp6/1.0.c2/power/mpm/src/vmpm_internal.h#1 $
...
{
  mpm_retrigger_gpio_fcn_type   gpio_retrigger;  /* Function for GPIO retrigger */
  mpm_retrigger_int_fcn_type    int_retrigger;   /* Function for INT retrigger */
  mpm_retrigger_log_fcn_type    log_message;     /* uLog function */
 ...
 *  
 * @return Returns a pointer to the message ram for the processor's specific 
 *         area.  Returns zero if vMPM driver is not properly
