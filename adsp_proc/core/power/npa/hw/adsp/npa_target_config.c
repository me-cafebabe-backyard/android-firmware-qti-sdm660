...
$Header: //components/rel/core.qdsp6/1.0.c2/power/npa/hw/adsp/npa_target_config.c#1 $
============================================================================*/
...
const npa_scheduler_config npa_scheduler_config_data = {
  ...
  20,        /* LPR overhead enter latency - TTICKS */
  20,        /* LPR overhead exit latency - TTICKS */
