...
===========================================================================
                             Edit History
$Header: //components/rel/core.qdsp6/1.0.c2/api/systemdrivers/DDITimetick.h#1 $

when       who     what, where, why
--------   ---     --------------------------------------------------------
11/03/16   shm     First version for core.qdsp6.1.0
...
struct DalTimetick {
  ...
  DALResult (*SyncSSCTimer)(DalDeviceHandle * _h);
...
{
  return DAL_StringDeviceAttach(pSystemTimer, phDalHandle);
...
/* ============================================================================
**  Function : DalTimetick_SyncSSCTimer
** ============================================================================
*/
/*!
    @brief
    Synchronizes PMU timer with the MPM QTimer
...
static __inline DALResult
DalTimetick_SyncSSCTimer
(
   DalDeviceHandle * _h 
) 
{
  return((DalTimetickHandle *)_h)->pVtbl->SyncSSCTimer( _h);
}
