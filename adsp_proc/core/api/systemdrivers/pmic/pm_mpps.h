...
$Header: //components/rel/core.qdsp6/1.0.c2/api/systemdrivers/pmic/pm_mpps.h#1 $
...
typedef enum
{
  ...
  PM_MPP__DLOGIC__LVL_USIM = 0,
  PM_MPP__DLOGIC__LVL_XO_OUT,
  PM_MPP__DLOGIC__LVL_SDCC1,
  PM_MPP__DLOGIC__LVL_RFA,
  PM_MPP__DLOGIC__LVL_WLAN1,
  PM_MPP__DLOGIC__LVL_VDD,
  PM_MPP__DLOGIC__LVL_MSME,
  PM_MPP__DLOGIC__LVL_MSMP,
  PM_MPP__DLOGIC__LVL_RUIM,
  PM_MPP__DLOGIC__LVL_MMC,
  PM_MPP__DLOGIC__LVL_MPLL
...
typedef enum
{
  ...
  PM_MPP__DLOGIC_INOUT__PUP_3K = PM_MPP__DLOGIC_INOUT__PUP_OPEN,  /* PULL UP = 3  K Ohms*/
