...
$Header: //components/rel/core.qdsp6/1.0.c2/api/systemdrivers/pmic/pmic.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
02/08/11   hw      Merging changes from the PMIC Distributed Driver Arch branch
06/28/10   wra     Main include for WM HLOS. Redirects to PMIC library main
                    header file "pm_qc_pmic.h"
