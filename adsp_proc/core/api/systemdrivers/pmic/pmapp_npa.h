...
$Header: //components/rel/core.qdsp6/1.0.c2/api/systemdrivers/pmic/pmapp_npa.h#1 $
...
#define PMIC_NPA_GROUP_ID_QFPROM1 "/pmic/client/qfprom1"
...
#define PMIC_NPA_GROUP_ID_SENSOR_DSP_PROXY "/pmic/client/sensor_dsp_proxy"
#define PMIC_NPA_GROUP_ID_SENSOR_DSP_VDD_MODE "/pmic/client/sensor_dsp_vdd_mode"
...
enum
{
   PMIC_NPA_MODE_ID_TOUCH_MODE_OFF = 0,
   PMIC_NPA_MODE_ID_TOUCH_MODE_LPM = 1,
   PMIC_NPA_MODE_ID_TOUCH_MODE_ACTIVE = 2,
   PMIC_NPA_MODE_ID_TOUCH_MODE_MAX = 3,
};
