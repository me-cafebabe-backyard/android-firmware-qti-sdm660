...
$Header: //components/rel/core.qdsp6/1.0.c2/api/debugtools/task.h#1 $
...
typedef unsigned short TASK_NHLOS_PRI_ACCESSOR TASK_DEPRECATED_INTERFACE;
...
#define TASK_PRIORITY(x) (x) // NHLOS Priority Mapping (Obsolete)
...
// REX_MAX_PRIO remediation: remove reference to task.h, include from kernel provided API
#define REX_MAX_PRIO ((TASK_NHLOS_PRI_ACCESSOR)255)

// REX_APC_THREAD_PRI remediation: remove reference to task.h, include from kernel provided API
#define REX_APC_THREAD_PRI ((TASK_NHLOS_PRI_ACCESSOR)243)

// AMSS_RESTART_TASK_PRI remediation: remove reference to task.h, include from kernel provided API
#define AMSS_RESTART_TASK_PRI ((TASK_NHLOS_PRI_ACCESSOR)242)

// AMSS_MAX_TASK_PRI remediation: remove reference to task.h, include from kernel provided API
#define AMSS_MAX_TASK_PRI ((TASK_NHLOS_PRI_ACCESSOR)240)
