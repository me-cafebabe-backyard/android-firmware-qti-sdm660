...
$Header: //components/rel/core.qdsp6/1.0.c2/api/mproc/qmi_idl_lib.h#1 $

when       who     what, where, why
--------   ---     ---------------------------------------------------------- 
01/10/11   al      Removed TLV_RESP_ERROR error code, decode no longer returns 
                   an error unless there was an error decoding the message. 
12/17/10   al      Moved error code definitions from qmi.h into qmi_idl_lib.h 
                   to break dependency 
11/02/10   fr      Changes to accomodate split of encode/decode library and
                   new function to get the max c struct length.
