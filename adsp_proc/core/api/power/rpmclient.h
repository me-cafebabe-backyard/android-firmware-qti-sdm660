...
//This is to be used by the DDR rentry from uImage code only. It's purpose is to
//clear acks that haven't been handled in the DDR code from the previous 
//DDR active cycle. They will have been handled in uBSP, but the DDR based
//RPM driver structures won't have been updated until this function is called.
void rpm_clear_pending_acks(void);

//Mask/unmask the RPM->Master ACK interrupt
