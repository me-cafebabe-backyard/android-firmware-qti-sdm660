...
/*===========================================================================
  Copyright (c) 2014-16 Qualcomm Technologies, Inc.  All Rights Reserved.
...
--------   ---      ------------------------------------
10/19/16   ska      Added suppport for max SPI Devices
...
/*
 * For the device specified by device_id, if ctrl is TRUE (or non-zero)
 * turn on BLSP AHB clock and SPI apps clk. Set SPI clk to frequency specified
 * by freq_in_hz. If ctrl is false, turn off AHB and SPI apps clk.
 * Note that SPI apps clk (clk that goes out to the slave is gated - i.e. it only
 * toggles during an actual SPI transfer.
 * Note: The spi_full_duplex / write / read APIs can also set the SPI Apps frequency. 
*/
