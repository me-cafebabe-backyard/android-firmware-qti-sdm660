...
$Header: //components/rel/core.qdsp6/1.0.c2/api/buses/ddislimbus.h#1 $
...
struct DalSlimBus
{
   ...
   DALResult (*SetBatchBufferSize)(DalDeviceHandle *_h, uint32 uMaxBufferSize);
   DALResult (*SendBatchedMessages)(DalDeviceHandle *_h);
   DALResult (*AllocMasterPortWithEndPoints)(DalDeviceHandle * _h, uint32 uMinNumEndPoints, uint32  uMinFifoBytes, SlimBusResourceHandle *phPort);
   DALResult (*GetMaxEndPointsSupported)(DalDeviceHandle * _h, uint32 *puMaxEP);
   DALResult (*RegisterClockGearEvent)(DalDeviceHandle * _h, DALSYSEventHandle  hEvent);
...
{
  return ((DalSlimBusHandle *)_h)->pVtbl->GetMaxEndPointsSupported( _h, puMaxEP);
}
...
{
  return ((DalSlimBusHandle *)_h)->pVtbl->AllocMasterPortWithEndPoints( _h, uMinNumEndPoints, uMinFifoBytes, phPort);
}
...
{
   return ((DalSlimBusHandle *)_h)->pVtbl->SetBatchBufferSize( _h, uMaxBufferSize);
}
...
{
   return ((DalSlimBusHandle *)_h)->pVtbl->SendBatchedMessages( _h);
}
...
{
   return ((DalSlimBusHandle *)_h)->pVtbl->RegisterClockGearEvent( _h, hEvent);
}
