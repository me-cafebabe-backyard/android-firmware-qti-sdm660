...
===========================================================================*/
/*
Copyright (c) 1997-2016 Qualcomm Technologies Incorporated.
All rights reserved.
...
$Header: //components/rel/core.qdsp6/1.0.c2/api/services/memheap.h#1 $ $DateTime: 2020/02/10 01:57:30 $ $Author: pwbldsvc $

when       who     what, where, why
--------   ---     --------------------------------------------------------
12/19/16   nk      Changes to support Remote heap
04/29/16   ps      Align mutex memory used in memheap structure
