...
Copyright (c) 1991-2017 by QUALCOMM Technologies, Inc.  All Rights Reserved.
===========================================================================*/
...
$Header: //components/rel/core.qdsp6/1.0.c2/api/services/log_codes.h#1 $
...
04/08/16   as      Added new log codes
03/17/15   xy      Added new log codes
...
05/28/14   xy      Added new log codes
...
08/01/13   sr      Added new log codes
05/01/13   sr      Added new log codes
04/01/13   sr      Added new log codes
...
#define LOG_1X_LAST_C                                    ((0xA02) + LOG_1X_BASE_C)
