...
$Header: //components/rel/core.qdsp6/1.0.c2/api/services/qw.h#1 $ $DateTime: 2020/02/10 01:57:30 $ $Author: pwbldsvc $
...
/**
  ...
  @note1hang This macro must be used if either or both of the quadwords 
