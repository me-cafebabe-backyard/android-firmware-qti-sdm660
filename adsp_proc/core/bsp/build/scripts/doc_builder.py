...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/core.qdsp6/1.0.c2/bsp/build/scripts/doc_builder.py#1 $
...
def exists(env):
   ...
   if path is None:
       raise_error(env, "PDFLatex was not detected. Please install MikTex 2.8 and add the "\
