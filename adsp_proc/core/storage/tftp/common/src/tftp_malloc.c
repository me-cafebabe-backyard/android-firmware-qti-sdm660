...
/*===========================================================================
  ...
  $Header: //components/rel/core.qdsp6/1.0.c2/storage/tftp/common/src/tftp_malloc.c#1 $ $DateTime: 2020/02/10 01:57:30 $ $Author: pwbldsvc $
...
#include <stdlib.h>
  ...
  tftp_malloc_init (void)
  {
    ...
    tftp_malloc_stats_inst.is_inited = 1;
    tftp_malloc_stats_inst.min_heap_used = (uint32) ~(0);
  }
