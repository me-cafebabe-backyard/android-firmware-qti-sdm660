...
/*===========================================================================
  ...
  $Header: //components/rel/core.qdsp6/1.0.c2/storage/tftp/common/src/tftp_log.c#1 $ $DateTime: 2020/02/10 01:57:30 $ $Author: pwbldsvc $
...
#ifdef TFTP_LOG_CONFIG_ENABLE_PKT_LOGGING
  tftp_log_config_inst.enable_pkt_logging = 1;
#endif
              ...
              const char *msg_format, ...)
{
  ...
  str_len = tftp_strlen (line_buffer);
                       ...
                       const char *msg_format, ...)
{
  ...
  if (tftp_log_config_inst.enable_pkt_logging == 0)
  {
    return;
  }
