...
/*===========================================================================
  ...
  $Header: //components/rel/core.qdsp6/1.0.c2/storage/tftp/common/src/tftp_protocol.c#1 $ $DateTime: 2020/02/10 01:57:30 $ $Author: pwbldsvc $
...
tftp_protocol_wait_pkt_is_timeout (struct tftp_protocol_info *proto)
{
  ...
  {
    proto->remaining_timeout_ms -= (uint32)elapsed_time_ms;
  }
  else
  {
