...
/*=============================================================================
Edit History
$Header: //components/rel/core.qdsp6/1.0.c2/debugtools/api/tms_rcevt.h#1 $
...
#define RCECB_CALLBACK_MAX_TIME     2000                                         // maximum allocated callback execution time before ERR_FATAL
