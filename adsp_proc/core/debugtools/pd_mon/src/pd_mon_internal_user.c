...
/*=============================================================================
Edit History
$Header: //components/rel/core.qdsp6/1.0.c2/debugtools/pd_mon/src/pd_mon_internal_user.c#1 $
...
pd_mon_internal_user_t pd_mon_internal_user;
