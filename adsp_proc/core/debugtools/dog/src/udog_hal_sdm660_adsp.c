...
/*=============================================================================
Edit History
$Header: //components/rel/core.qdsp6/1.0.c2/debugtools/dog/src/udog_hal_sdm660_adsp.c#1 $
...
void HAL_dogForceBite(void)
{
   if(dog_hal_disable_for_bringup != TRUE)
   {
      ...
      // DISABLE NMI
      HWIO_LPASS_QDSP6SS_WDOG_CTL_OUTM(HWIO_LPASS_QDSP6SS_WDOG_CTL_WDOG_TO_NMI_EN_BMSK, 0 << HWIO_LPASS_QDSP6SS_WDOG_CTL_WDOG_TO_NMI_EN_SHFT);
