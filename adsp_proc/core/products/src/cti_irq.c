...
================================================================================
$Header: //components/rel/core.qdsp6/1.0.c2/products/src/cti_irq.c#1 $
...
void cti_irq_init(void)
{
    ...
    else if (cpuFam == DALCHIPINFO_FAMILY_MSM8997) IMEM_Base = CTI_IMEM_BASE_8997;
    else if (cpuFam == DALCHIPINFO_FAMILY_MSM8992) IMEM_Base = CTI_IMEM_BASE_8992;
    else if (cpuFam == DALCHIPINFO_FAMILY_SDM660) IMEM_Base = CTI_IMEM_BASE_660;
    else if (cpuFam == DALCHIPINFO_FAMILY_SDM630) IMEM_Base = CTI_IMEM_BASE_660;
