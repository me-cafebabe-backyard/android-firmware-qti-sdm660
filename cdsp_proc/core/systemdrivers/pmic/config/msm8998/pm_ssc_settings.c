...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/pmic/config/msm8998/pm_ssc_settings.c#1 $ 
...
static char PM_MODEM_CX_VREG[50] = "/pmic/device/ldo/A/ldo26/vec";

static unsigned num_of_mx_corners = 6;
static unsigned pm_mx_corners[6] = 
{675000, 950000, 950000, 950000, 1050000, 1050000};
static char PM_MODEM_MX_VREG[50] = "/pmic/device/ldo/A/ldo31/vec";

PwrResourceInfoType MX_Info[1] = 
{
    {RPM_LDO_A_REQ, 31, &num_of_mx_corners, pm_mx_corners, PM_MODEM_MX_VREG }// data 1 is the size of the LUT, data 2 is the MX LUT, data3 is the RPM resource string 
};
PwrResourceInfoType CX_Info[1] = 
{
    {RPM_LDO_A_REQ, 26, &num_of_cx_corners, pm_cx_corners, PM_MODEM_CX_VREG }// data 1 is the size of the LUT, data 2 is the CX LUT, data3 is the RPM resource string.
};
