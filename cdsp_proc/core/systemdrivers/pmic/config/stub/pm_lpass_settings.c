...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/pmic/config/stub/pm_lpass_settings.c#1 $ 
...
static char PM_MODEM_CX_VREG[50] = "/pmic/device/smps/B/smps2/vec";

static unsigned num_of_mx_corners = 6;
static unsigned pm_mx_corners[6] = 
{675000, 950000, 950000, 950000, 1050000, 1050000};
static char PM_MODEM_MX_VREG[50] = "/pmic/device/smps/B/smps1/vec";

PwrResourceInfoType pm8x41_MX_Info[1] = 
{
    {RPM_SMPS_B_REQ, 1, &num_of_mx_corners, pm_mx_corners, PM_MODEM_MX_VREG }// data 1 is the size of the LUT, data 2 is the MX LUT, data3 is the RPM resource string 
};
PwrResourceInfoType pm8x41_CX_Info[1] = 
{
    {RPM_SMPS_B_REQ, 2, &num_of_cx_corners, pm_cx_corners, PM_MODEM_CX_VREG }// data 1 is the size of the LUT, data 2 is the CX LUT, data3 is the RPM resource string.
};
