#ifndef PM_SSC_PROC_NPA_H
#define PM_SSC_PROC_NPA_H

/*! \file
 *  
 *  \brief  pm_ssc_proc_npa.h ----This file contains prototype definitions processor npa layer
...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/pmic/npa/inc/pm_ssc_proc_npa.h#1 $ 
...
===========================================================================*/
void pm_ssc_proc_npa_init(void);


#endif //PM_SSC_PROC_NPA_H
