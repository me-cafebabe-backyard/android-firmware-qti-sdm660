...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/icb/src/8996/ul_data.c#1 $ 
...
$Change: 22511909 $
 ...
 ----------   ---     -----------------------------------------------------------
 2015/05/12 Autogen  Autogenerated version
...
{
  {NOC_QOS_ALLOWED_MODE_BYPASS | NOC_QOS_ALLOWED_MODE_FIXED}, /* cr_virt_a1noc */
...
{
  ICBID_SLAVE_CRVIRT_A1NOC, /* slaveId */
  &cr_virt_bus, /* pBus */
  1, /* Number of ports */
  cfg_slave_cr_virt_a1noc_ports, /* pPortIds */
  false, /* remote node? */
  3, /* Number of slave segments */
  NULL, /* pDefaults */
  1, /* Number of ports for aggregation purposes */
...
{
  ICBID_MASTER_CRVIRT_A1NOC, /* master id */
  &a1noc_bus, /* pBus */
  1, /* Number of ports */
  cfg_master_cr_virt_a1noc_ports, /* pPortIds */
  cfg_master_cr_virt_a1noc_qos_ports, /* pQosPortIds */
  true, /* remote node? */ 
  0, /* default window size */
  NULL, /* pDefaults */
  NULL, /* pHaltPorts */
...
static ul_master_data_type  master_cr_virt_a1noc =
{
  ...
  ICBID_MASTER_CRVIRT_A1NOC,                /* External Master ID */
  8,
  1,
...
static ul_slave_data_type  slave_cr_virt_a1noc =
{
  ...
  ICBID_SLAVE_CRVIRT_A1NOC,                /* External Slave ID */
  8,
  {
    0,                                       /* Current Ib value */
    0,                                       /* Current Ib value */
...
static ul_treeNodeType route_0x1700000022L_crypto_c0_sdcc_4_node =
{
  0x1700000022ULL,                        /* KEY: MASTER_ID:SLAVE_ID */
...
static ul_treeNodeType route_0x1700000023L_crypto_c0_tsif_node =
{
  0x1700000023ULL,                        /* KEY: MASTER_ID:SLAVE_ID */
...
static ul_treeNodeType route_0x1700000025L_crypto_c0_blsp_2_node =
{
  0x1700000025ULL,                        /* KEY: MASTER_ID:SLAVE_ID */
...
static ul_treeNodeType route_0x170000003bL_crypto_c0_pmic_arb_node =
{
  0x170000003bULL,                        /* KEY: MASTER_ID:SLAVE_ID */
...
static ul_treeNodeType route_0x170000004aL_crypto_c0_rpm_node =
{
  0x170000004aULL,                        /* KEY: MASTER_ID:SLAVE_ID */
...
static ul_treeNodeType route_0x24000000a0L_sdcc_4_hmss_l3_node =
{
  0x24000000a0ULL,                        /* KEY: MASTER_ID:SLAVE_ID */
...
static ul_treeNodeType route_0x25000000a0L_tsif_hmss_l3_node =
{
  0x25000000a0ULL,                        /* KEY: MASTER_ID:SLAVE_ID */
...
static ul_treeNodeType route_0x2a000000a0L_usb_hs_hmss_l3_node =
{
  0x2a000000a0ULL,                        /* KEY: MASTER_ID:SLAVE_ID */
...
static ul_treeNodeType route_0x2a000000a6L_usb_hs_pimem_node =
{
  0x2a000000a6ULL,                        /* KEY: MASTER_ID:SLAVE_ID */
