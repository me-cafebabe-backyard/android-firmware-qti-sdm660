...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/icb/src/9x25/ABT_data.c#1 $ 
...
#define ABT_LPASS0_BMSK   HWIO_TCSR_TIMEOUT_INTR_PENDING_LPASS_IRQ_OUT_AHB_TIMEOUT_0_SHFT
#define ABT_LPASS1_BMSK   HWIO_TCSR_TIMEOUT_INTR_PENDING_LPASS_IRQ_OUT_AHB_TIMEOUT_1_SHFT
...
#define ABT_TIMEOUT_INTR_PENDING        HWIO_TCSR_TIMEOUT_INTR_PENDING_ADDR 
...
static ABT_platform_info_type ABT_platform_info =
{
    ...
    (void*)ABT_TIMEOUT_INTR_PENDING,       /* INTR PENDING Register address */
