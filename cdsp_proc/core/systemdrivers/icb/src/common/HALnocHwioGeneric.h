...
/*
  ...
  $Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/icb/src/common/HALnocHwioGeneric.h#1 $
...
/*------------------------------ QOS_EXTCONTROLn ------------------------------*/
#define NOC_QOS_EXTCONTROLn_ADDR(b,o,s,n)              (NOC_QOS_REG_BASE(b,o) + 0x18 + (s) * (n))
#define NOC_QOS_EXTCONTROLn_RMSK                                                        0xf
#define NOC_QOS_EXTCONTROLn_INI(b,o,s,n) \
        in_dword_masked(NOC_QOS_EXTCONTROLn_ADDR(b,o,s,n), NOC_QOS_EXTCONTROLn_RMSK)
#define NOC_QOS_EXTCONTROLn_INMI(b,o,s,n,m)     \
        in_dword_masked(NOC_QOS_EXTCONTROLn_ADDR(b,o,s,n), m)
#define NOC_QOS_EXTCONTROLn_OUTI(b,o,s,n,v)     \
        out_dword(NOC_QOS_EXTCONTROLn_ADDR(b,o,s,n),v)
#define NOC_QOS_EXTCONTROLn_OUTMI(b,o,s,n,m,v)  \
        out_dword_masked_ns(NOC_QOS_EXTCONTROLn_ADDR(b,o,s,n),m,v,NOC_QOS_EXTCONTROLn_INI(b,o,s,n))
#define NOC_QOS_EXTCONTROLn_EXTLIMITEN_BMSK                                             0x8
#define NOC_QOS_EXTCONTROLn_EXTLIMITEN_SHFT                                             0x3
#define NOC_QOS_EXTCONTROLn_INTCLKEN_BMSK                                               0x4
#define NOC_QOS_EXTCONTROLn_INTCLKEN_SHFT                                               0x2
#define NOC_QOS_EXTCONTROLn_EXTTHREN_BMSK                                               0x2
#define NOC_QOS_EXTCONTROLn_EXTTHREN_SHFT                                               0x1
#define NOC_QOS_EXTCONTROLn_SOCKETQOSEN_BMSK                                            0x1
#define NOC_QOS_EXTCONTROLn_SOCKETQOSEN_SHFT                                            0x0
