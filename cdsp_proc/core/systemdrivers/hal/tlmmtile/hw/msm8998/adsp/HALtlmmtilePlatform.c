...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/hal/tlmmtile/hw/msm8998/adsp/HALtlmmtilePlatform.c#1 $
...
{
  HWIO_TLMM_EAST_DIR_CONN_INTRn_CFG_LPA_DSP_ADDR(0),
  HWIO_TLMM_NORTH_DIR_CONN_INTRn_CFG_LPA_DSP_ADDR(0),
  HWIO_TLMM_WEST_DIR_CONN_INTRn_CFG_LPA_DSP_ADDR(0)
};
...
void HAL_tlmmtile_PlatformInit (HalTlmmGpioDescriptionType *pDesc)
{
  ...
  pDesc->DirConnIntrCfg.nOffset                   = (uint32)( HWIO_TLMM_EAST_DIR_CONN_INTRn_CFG_LPA_DSP_ADDR(1) - HWIO_TLMM_EAST_DIR_CONN_INTRn_CFG_LPA_DSP_ADDR(0) ); 
  pDesc->DirConnIntrCfg.nMax                      = (uint32)( HWIO_TLMM_EAST_DIR_CONN_INTRn_CFG_LPA_DSP_MAXn ); 
  pDesc->DirConnIntrCfg.nDirConnIntrCfgSelShift   = (uint32)( HWIO_TLMM_EAST_DIR_CONN_INTRn_CFG_LPA_DSP_GPIO_SEL_SHFT ); 
  pDesc->DirConnIntrCfg.nDirConnIntrCfgSelBmsk    = (uint32)( HWIO_TLMM_EAST_DIR_CONN_INTRn_CFG_LPA_DSP_GPIO_SEL_BMSK ); 
  pDesc->DirConnIntrCfg.nDirConnIntrCfgPolShift   = (uint32)( HWIO_TLMM_EAST_DIR_CONN_INTRn_CFG_LPA_DSP_POLARITY_SHFT ); 
  pDesc->DirConnIntrCfg.nDirConnIntrCfgPolBmsk    = (uint32)( HWIO_TLMM_EAST_DIR_CONN_INTRn_CFG_LPA_DSP_POLARITY_BMSK ); 
