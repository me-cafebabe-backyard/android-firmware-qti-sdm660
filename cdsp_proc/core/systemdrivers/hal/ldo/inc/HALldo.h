...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/hal/ldo/inc/HALldo.h#1 $
...
/*=========================================================================
**  Function : HAL_ldo_SetLDOAutoBypass
** =========================================================================*/
/**
  Set the LDO autobypass mode usage.

  @param bEnable [in] boolean to set/clear the autobypass mode.
