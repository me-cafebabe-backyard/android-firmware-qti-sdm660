...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/hal/clk/hw/sdm660/cdsp/inc/HALclkTest.h#1 $
 ...
 * TURING debug clocks
 */
#define HAL_CLK_TURING_TEST                                              (7  << 0x10)

#define HAL_CLK_TURING_TEST_Q6SS_CLK_SRC                            (HAL_CLK_TURING_TEST | 0x001)
#define HAL_CLK_TURING_TEST_SLEEP_CLK_SRC                           (HAL_CLK_TURING_TEST | 0x00A)
#define HAL_CLK_TURING_TEST_AON_CLK_SRC                             (HAL_CLK_TURING_TEST | 0x016)
#define HAL_CLK_TURING_TEST_XO_CLK_SRC                              (HAL_CLK_TURING_TEST | 0x01D)
#define HAL_CLK_TURING_TEST_QOS_FIXED_LAT_COUNTER_SRC               (HAL_CLK_TURING_TEST | 0x022)
#define HAL_CLK_TURING_TEST_AUDIO_CORE_GDSC_XO_CLK                  (HAL_CLK_TURING_TEST | 0x023)
#define HAL_CLK_TURING_TEST_AUDIO_CORE_BCR_SLP_CLK                  (HAL_CLK_TURING_TEST | 0x040)
#define HAL_CLK_TURING_TEST_TURING_WRAPPER_SYSNOC_SWAY_SNOC_CLK     (HAL_CLK_TURING_TEST | 0x043)
#define HAL_CLK_TURING_TEST_TURING_WRAPPER_AON_CLK                  (HAL_CLK_TURING_TEST | 0x044)
#define HAL_CLK_TURING_TEST_TURING_WRAPPER_QOS_AHBS_AON_CLK         (HAL_CLK_TURING_TEST | 0x045)
#define HAL_CLK_TURING_TEST_TURING_WRAPPER_SYSNOC_SWAY_AON_CLK      (HAL_CLK_TURING_TEST | 0x049)
#define HAL_CLK_TURING_TEST_Q6SS_AHBM_AON_CLK                       (HAL_CLK_TURING_TEST | 0x04A)
#define HAL_CLK_TURING_TEST_Q6SS_BCR_SLP_CLK                        (HAL_CLK_TURING_TEST | 0x04B)
#define HAL_CLK_TURING_TEST_TURING_WRAPPER_Q6_SMMU_GDSC_XO_CLK      (HAL_CLK_TURING_TEST | 0x04C)
#define HAL_CLK_TURING_TEST_TURING_WRAPPER_MPU_CFG_AON_CLK          (HAL_CLK_TURING_TEST | 0x04E)
#define HAL_CLK_TURING_TEST_TURING_WRAPPER_Q6_AHBM_MPU_AON_CLK      (HAL_CLK_TURING_TEST | 0x04F)
#define HAL_CLK_TURING_TEST_Q6SS_AHBS_AON_CLK                       (HAL_CLK_TURING_TEST | 0x050)
#define HAL_CLK_TURING_TEST_TURING_WRAPPER_QOS_XO_LAT_COUNTER_CLK     (HAL_CLK_TURING_TEST | 0x051)
#define HAL_CLK_TURING_TEST_TURING_WRAPPER_QOS_DMONITOR_FIXED_LAT_COUNTER_CLK     (HAL_CLK_TURING_TEST | 0x052)
#define HAL_CLK_TURING_TEST_TURING_WRAPPER_QOS_DANGER_FIXED_LAT_COUNTER_CLK     (HAL_CLK_TURING_TEST | 0x053)
#define HAL_CLK_TURING_TEST_TURING_WRAPPER_BUS_TIMEOUT_AON_CLK      (HAL_CLK_TURING_TEST | 0x056)

/*
 * MSS Q6 core debug clocks (manually added)
 */
#define HAL_CLK_TURING_Q6_TEST                                          (8  << 0x10)

#define HAL_CLK_TURING_TEST_CLK_Q6                                      (HAL_CLK_TURING_Q6_TEST | 0x001)
