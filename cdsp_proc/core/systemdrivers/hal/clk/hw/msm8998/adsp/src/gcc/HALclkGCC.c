...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/hal/clk/hw/msm8998/adsp/src/gcc/HALclkGCC.c#1 $
...
{
  {
    /* .szClockName      = */ "gcc_aggre1_noc_xo_clk",
    /* .mRegisters       = */ { HWIO_OFFS(GCC_AGGRE1_NOC_XO_CBCR), HWIO_OFFS(GCC_AGGRE1_NOC_BCR), {0, 0} },
    /* .pmControl        = */ &HAL_clk_mGenericClockControl,
    /* .nTestClock       = */ HAL_CLK_GCC_TEST_GCC_AGGRE1_NOC_XO_CLK
  },
#if 0 /* not present on lpass */
  ...
  {
    /* .szClockName      = */ "gcc_cfg_noc_east_dcd_xo_clk",
    /* .mRegisters       = */ { HWIO_OFFS(GCC_CFG_NOC_EAST_DCD_XO_CBCR), HWIO_OFFS(GCC_CONFIG_NOC_BCR), {0, 0} },
    /* .pmControl        = */ &HAL_clk_mGenericClockControl,
    /* .nTestClock       = */ HAL_CLK_GCC_TEST_GCC_CFG_NOC_EAST_DCD_XO_CLK
  },
  {
  ...
  {
    /* .szClockName      = */ "gcc_cfg_noc_west_dcd_xo_clk",
    /* .mRegisters       = */ { HWIO_OFFS(GCC_CFG_NOC_WEST_DCD_XO_CBCR), HWIO_OFFS(GCC_CONFIG_NOC_BCR), {0, 0} },
    /* .pmControl        = */ &HAL_clk_mGenericClockControl,
    /* .nTestClock       = */ HAL_CLK_GCC_TEST_GCC_CFG_NOC_WEST_DCD_XO_CLK
  },
#if 0 /* not present on lpass */
  ...
  {
    /* .szClockName      = */ "gcc_spss_xo_clk",
    /* .mRegisters       = */ { HWIO_OFFS(GCC_SPSS_XO_CBCR), HWIO_OFFS(GCC_SPSS_BCR), {0, 0} },
    /* .pmControl        = */ &HAL_clk_mGenericClockControl,
    /* .nTestClock       = */ HAL_CLK_GCC_TEST_GCC_SPSS_XO_CLK
  },
#if 0 /* not present on lpass */
  ...
  {
    /* .szClockName      = */ "gcc_ssc_xo_clk",
    /* .mRegisters       = */ { HWIO_OFFS(GCC_SSC_XO_CBCR), HWIO_OFFS(GCC_SSC_BCR), {0, 0} },
    /* .pmControl        = */ &HAL_clk_mGenericClockControl,
    /* .nTestClock       = */ HAL_CLK_GCC_TEST_GCC_SSC_XO_CLK
  },
#endif
