...
/**
  ...
  Internal header file for the clock device driver on the SSC image.
*/
/*  
  ====================================================================
  ...
  ==================================================================== 
  $Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/clock/hw/msm8998/slpi/inc/ClockSSC.h#1 $
 ...
 *  bTestCPU      - Flag for testing CPU frequencies.
 */
typedef struct
{
...
** =========================================================================*/
/**
  Trigger function to update QDSP6 SSC states.
 
  This function updates QDSP6 SSC states (frequencies) and then
