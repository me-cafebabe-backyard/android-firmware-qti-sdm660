...
/**
  ...
  Low Power Audio Subsystem processor for SDM660.
*/
/*
  ====================================================================
  ...
  ==================================================================== 
  $Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/clock/hw/sdm660/adsp_slpi/src/ClockLPASSXO.c#1 $
...
/*
 * kvp for keeping the CXO resource en/disabled' in the sleep set
 */
