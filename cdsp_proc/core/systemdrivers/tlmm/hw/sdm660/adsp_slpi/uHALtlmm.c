...
=================================================================================
           ...
           M I C R O  T O P  L E V E L  M O D E  M U X  ( u T L M M )
...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/tlmm/hw/sdm660/adsp_slpi/uHALtlmm.c#1 $
...
{
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG0),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT0)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG1),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT1)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG2),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT2)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG3),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT3)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG4),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT4)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG5),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT5)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG6),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT6)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG7),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT7)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG8),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT8)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG9),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT9)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG10),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT10)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG11),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT11)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG12),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT12)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG13),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT13)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG14),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT14)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG15),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT15)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG16),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT16)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG17),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT17)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG18),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT18)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG19),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT19)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG20),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT20)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG21),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT21)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG22),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT22)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG23),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT23)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG24),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT24)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG25),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT25)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG26),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT26)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG27),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT27)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG28),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT28)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG29),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT29)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG30),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT30)
  },
  {
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_CFG31),
    HWIO_ADDR(LPASS_TLMM_GPIO_ISLAND_IN_OUT31)
  }
};
...
void uHAL_tlmm_SetPull( uint32 nGpioNumber, uHAL_tlmm_PullType ePull )
{
  ...
  if( (nGpioNumber < HAL_TLMM_TOTAL_GPIO) && uHAL_tlmm_Configs[nGpioNumber].nCfgAddr )
  {
    ...
    nValue &= ~(HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_PULL_BMSK << HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_PULL_SHFT);
    nValue |= (ePull << HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_PULL_SHFT);
...
)
{
  if( (nGpioNumber < HAL_TLMM_TOTAL_GPIO) && uHAL_tlmm_Configs[nGpioNumber].nCfgAddr )
  {
    ...
    nValue &= ~(HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_OE_BMSK << HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_OE_SHFT);
    nValue |= (eDirection << HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_OE_SHFT);
...
)
{
  if( (nGpioNumber < HAL_TLMM_TOTAL_GPIO) && uHAL_tlmm_Configs[nGpioNumber].nCfgAddr )
  {
    ...
    nValue &= ~(HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_HDRIVE_BMSK << HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_HDRIVE_SHFT);
    nValue |= (eDrive << HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_HDRIVE_SHFT);
...
)
{
  if( (nGpioNumber < HAL_TLMM_TOTAL_GPIO) && uHAL_tlmm_Configs[nGpioNumber].nCfgAddr )
  {
    ...
    nValue &= ~(HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_FUNC_SEL_BMSK << HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_FUNC_SEL_SHFT);
    nValue |= (nFuncVal << HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_FUNC_SEL_SHFT);
...
)
{
  if( (nGpioNumber < HAL_TLMM_TOTAL_GPIO) && uHAL_tlmm_Configs[nGpioNumber].nCfgAddr )
  {
    ...
    tGpio->nFunc =  ((nTempConfig & HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_FUNC_SEL_BMSK) >> HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_FUNC_SEL_SHFT);
    tGpio->nDir =   ((nTempConfig & HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_OE_BMSK) >> HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_OE_SHFT);
    tGpio->nPull =  ((nTempConfig & HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_PULL_BMSK) >> HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_PULL_SHFT);
    tGpio->nDrive = ((nTempConfig & HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_HDRIVE_BMSK) >> HWIO_LPASS_TLMM_GPIO_ISLAND_CFG0_GPIO_HDRIVE_SHFT);
  }
}
