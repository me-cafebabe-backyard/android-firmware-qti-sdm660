...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/tlmm/hw/msm8998/slpi/uHALtlmm.c#1 $
...
{
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG0),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT0)
  },
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG1),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT1)
  },
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG2),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT2)
  },
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG3),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT3)
  },
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG4),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT4)
  },
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG5),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT5)
  },
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG6),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT6)
  },
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG7),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT7)
  },
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG8),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT8)
  },
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG9),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT9)
  },
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG10),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT10)
  },
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG11),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT11)
  },
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG12),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT12)
  },
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG13),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT13)
  },
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG14),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT14)
  },
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG15),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT15)
  },
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG16),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT16)
  },
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG17),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT17)
  },
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG18),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT18)
  },
  {
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_CFG19),
    HWIO_ADDR(SSC_TLMM_GPIO_ISLAND_IN_OUT19)
  }
};
...
void uHAL_tlmm_SetPull( uint32 nGpioNumber, uHAL_tlmm_PullType ePull )
{
  ...
  if( (nGpioNumber < HAL_TLMM_TOTAL_GPIO) && uHAL_tlmm_Configs[nGpioNumber].nCfgAddr )
  {
    ...
    nValue &= ~(HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_PULL_BMSK << HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_PULL_SHFT);
    nValue |= (ePull << HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_PULL_SHFT);
...
)
{
  if( (nGpioNumber < HAL_TLMM_TOTAL_GPIO) && uHAL_tlmm_Configs[nGpioNumber].nCfgAddr )
  {
    ...
    nValue &= ~(HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_OE_BMSK << HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_OE_SHFT);
    nValue |= (eDirection << HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_OE_SHFT);
...
)
{
  if( (nGpioNumber < HAL_TLMM_TOTAL_GPIO) && uHAL_tlmm_Configs[nGpioNumber].nCfgAddr )
  {
    ...
    nValue &= ~(HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_HDRIVE_BMSK << HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_HDRIVE_SHFT);
    nValue |= (eDrive << HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_HDRIVE_SHFT);
...
)
{
  if( (nGpioNumber < HAL_TLMM_TOTAL_GPIO) && uHAL_tlmm_Configs[nGpioNumber].nCfgAddr )
  {
    ...
    nValue &= ~(HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_FUNC_SEL_BMSK << HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_FUNC_SEL_SHFT);
    nValue |= (nFuncVal << HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_FUNC_SEL_SHFT);
...
)
{
  if( (nGpioNumber < HAL_TLMM_TOTAL_GPIO) && uHAL_tlmm_Configs[nGpioNumber].nCfgAddr )
  {
    ...
    tGpio->nFunc =  ((nTempConfig & HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_FUNC_SEL_BMSK) >> HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_FUNC_SEL_SHFT);
    tGpio->nDir =   ((nTempConfig & HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_OE_BMSK) >> HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_OE_SHFT);
    tGpio->nPull =  ((nTempConfig & HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_PULL_BMSK) >> HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_PULL_SHFT);
    tGpio->nDrive = ((nTempConfig & HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_HDRIVE_BMSK) >> HWIO_SSC_TLMM_GPIO_ISLAND_CFG0_GPIO_HDRIVE_SHFT);
  }
}
