...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/ipcint/hw/msm8998/slpi/DalIPCInt_ConfigData.c#1 $
...
#define IPC_BASE            0x05C80000
#define IPC_BASE_OFFSET         0x5000
...
IPCIntConfigType IPCIntConfigMap[DALIPCINT_NUM_PROCS] =
{
  ...
  { IPC_BASE,      IPC_BASE_OFFSET,      8,  4 }, //DALIPCINT_PROC_ADSP
