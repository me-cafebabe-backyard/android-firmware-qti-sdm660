...
============================================================================
  $Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/ipcint/src/msm8998/slpi/DalIPCInt.c#1 $ $DateTime: 2020/02/10 01:57:30 $ $Author: pwbldsvc $
============================================================================*/
...
) 
{
  ...
  switch(eTarget)
  {
    case DALIPCINT_PROC_SPS:
      switch (eInterrupt)
      {
        case DALIPCINT_GP_0:
          int_mask <<= SSC_IPC_GP_0_IRQ;
          break;
        case DALIPCINT_GP_1:
          int_mask <<= SSC_IPC_GP_1_IRQ;
          break;
        case DALIPCINT_GP_2:
          int_mask <<= SSC_IPC_GP_2_IRQ;
          break;
        case DALIPCINT_GP_3:
          int_mask <<= SSC_IPC_GP_3_IRQ;
          break;
        default:
          result = DAL_ERROR;
          break;
    ...
    case DALIPCINT_PROC_SPSS:
      switch (eInterrupt)
      {
        case DALIPCINT_GP_0:
          int_mask <<= SPSS_IPC_GP_0_IRQ;
          break;
        case DALIPCINT_GP_1:
          int_mask <<= SPSS_IPC_GP_1_IRQ;
          break;
        case DALIPCINT_GP_2:
          int_mask <<= SPSS_IPC_GP_2_IRQ;
          break;
        case DALIPCINT_GP_3:
          int_mask <<= SPSS_IPC_GP_3_IRQ;
          break;
        default:
          result = DAL_ERROR;
          break;
    ...
    case DALIPCINT_PROC_MDSPSW: //MDSP and MCPU are the same
