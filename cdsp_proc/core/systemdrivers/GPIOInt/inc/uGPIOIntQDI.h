...
$Header: //components/rel/core.qdsp6/1.0.c2/systemdrivers/GPIOInt/inc/uGPIOIntQDI.h#1 $
...
#define UGPIOINT_QDI_SET_DIR_CONN                 (4+QDI_PRIVATE)
#define UGPIOINT_QDI_CLEAR_DIR_CONN               (5+QDI_PRIVATE)
