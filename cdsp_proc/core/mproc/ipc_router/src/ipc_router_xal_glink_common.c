...
$Header: //components/rel/core.qdsp6/1.0.c2/mproc/ipc_router/src/ipc_router_xal_glink_common.c#1 $
...
)
{
  ...
  //Trigger TX event since there is tx_done which means there can be some fifo free case
  ipc_router_xal_glink_set_event(port, IPC_ROUTER_XAL_GLINK_EVENT_TX);
}
