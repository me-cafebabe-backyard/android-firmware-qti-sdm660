...
$Header: //components/rel/core.qdsp6/1.0.c2/mproc/ipc_router/src/ipc_router_log.h#1 $ $DateTime: 2020/02/10 01:57:30 $ $Author: pwbldsvc $
...
/*===========================================================================
FUNCTION      ipc_router_log_init

DESCRIPTION   Initialize ULOG for IPC Router.
