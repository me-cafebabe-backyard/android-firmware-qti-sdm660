...
$Header: //components/rel/core.qdsp6/1.0.c2/mproc/ipc_router/src/ipc_router_qdi_user.c#1 $
...
#define WORKER_STACK_SIZE (2048 * 2)
...
===========================================================================*/
DLL_API_GLOBAL void ipc_router_qdi_init(void)
{
