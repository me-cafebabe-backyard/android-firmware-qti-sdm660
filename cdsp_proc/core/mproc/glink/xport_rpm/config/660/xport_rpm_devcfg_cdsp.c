...
{
  "cdsp",                           /* Local processor name     */
  SMEM_CDSP,                        /* Local processor host id  */
...
const xport_rpm_config_type xport_rpm_devcfg_remote_procs[] =
{
  /* CDSP->Rpm */
  {
    ...
    XPORT_RPM_CD2R_ID,    /* Tx FIFO ID in RPM ToC   */
    XPORT_RPM_R2CD_ID,    /* Rx FIFO ID in RPM ToC   */
    {                     /* Outgoing interrupt      */
      DALIPCINT_PROC_RPM,
      DALIPCINT_GP_0
    },
    33                    /* Incoming interrupt      */
  },
