...
//                             Edit History
//
// $Header: //components/rel/core.qdsp6/1.0.c2/debugtrace/tfunnel/dal/inc/DDITFunnel.h#1 $
//
...
struct DalTFunnel
{
   ...
   DALResult (*DisableAll)(DalDeviceHandle * _h);
...
{
   return ((DalTFunnelHandle *)_h)->pVtbl->DisableAll(_h);
}
