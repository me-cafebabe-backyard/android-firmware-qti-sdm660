...
$Header: //components/rel/core.qdsp6/1.0.c2/debugtrace/tfunnel/config/adsp_slpi/sdm660/tfunnel_config.c#1 $
...
TFunnelPortEnableConfig tfunnel_dlct[]={
   {QATB_FUN,3,tfunnel_qatb}
};

TFunnelPortEnableConfig tfunnel_port_ssc[]={
   {DLCT_FUN,1,tfunnel_dlct}
};
