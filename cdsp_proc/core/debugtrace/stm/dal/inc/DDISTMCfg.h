...
//                             Edit History
//
// $Header: //components/rel/core.qdsp6/1.0.c2/debugtrace/stm/dal/inc/DDISTMCfg.h#1 $
//
...
struct DalSTMCfg
{
   ...
   DALResult (*STMStatus)(DalDeviceHandle * _h, STMControlType  uCtrl, uint32  *puVal);
...
{
   return ((DalSTMCfgHandle *)_h)->pVtbl->STMStatus( _h, uCtrl, puVal);
}
