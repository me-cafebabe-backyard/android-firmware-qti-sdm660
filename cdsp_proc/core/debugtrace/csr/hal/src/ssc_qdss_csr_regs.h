...
/*
  ...
  $Header: //components/rel/core.qdsp6/1.0.c2/debugtrace/csr/hal/src/ssc_qdss_csr_regs.h#1 $
...
#define HWIO_LPASS_SCSR_TS_LOW_POWER_HANDSHAKE_OUTM(x,m,v) \
        out_dword_masked_ns(HWIO_LPASS_SCSR_TS_LOW_POWER_HANDSHAKE_ADDR(x),m,v,HWIO_LPASS_SCSR_TS_LOW_POWER_HANDSHAKE_IN)
