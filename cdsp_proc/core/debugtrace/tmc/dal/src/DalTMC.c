...
$Header: //components/rel/core.qdsp6/1.0.c2/debugtrace/tmc/dal/src/DalTMC.c#1 $
=============================================================================*/
...
------------------------------------------------------------------------------*/
static  DALResult
TMC_GetMode(DalDeviceHandle * _h, uint8 *pMode)
{
...
static  DALResult TMC_SetMode(DalDeviceHandle * _h,uint8 mode)
{
...
static DALResult
TMC_GetParam( DalDeviceHandle * h, uint32  param, uint32  *puVal)
{
   return DAL_ERROR_NOT_SUPPORTED;
}
...
static DALResult
TMC_SetParam( DalDeviceHandle * h, uint32  param, uint32  uVal)
{
   return DAL_ERROR_NOT_SUPPORTED;
}
...
static DALResult
TMC_SaveRegisters(DalDeviceHandle * h, byte * buf, uint32  nBufLen)
{
   TMCDevCtxt *pDevCtxt = (TMCDevCtxt *)((DALClientCtxt *)(h->pClientCtxt))->pDALDevCtxt;
