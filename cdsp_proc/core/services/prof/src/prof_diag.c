...
** ========================================================================= */
   ...
   #define DIAG_QURT_PERFMON_F          0x0504
   #define DIAG_PERFMETER_F             0x0503
   #define DIAG_TASKPROFILE_F           0x0502
   #define DIAG_BLAST_PERFMON_F         0x0501 /* support legacy log packet */
