...
$Header: //components/rel/core.qdsp6/1.0.c2/services/utimers/src/utimer_client.c#1 $ 
...
*/
utimer_timetick_type utimer_get_first_non_deferrable_timer_expiry( void ) 
{
   utimer_timetick_type first_non_def_tick;
   utimer_invoke_get_first_non_deferrable_timer_expiry(utimer_client_qdi_handle, &first_non_def_tick);
