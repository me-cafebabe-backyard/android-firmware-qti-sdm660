...
$Header: //components/rel/core.qdsp6/1.0.c2/services/diag/LSM/qurt/src/Diag_LSM_Pkt.c#1 $
...
boolean Diag_LSM_Pkt_DeInit(void)
{
  ...
  diag_lsm_ioctl(DIAG_IOCTL_COMMAND_DEREG, (byte*)&client_id, sizeof(client_id), NULL, 0, NULL);
