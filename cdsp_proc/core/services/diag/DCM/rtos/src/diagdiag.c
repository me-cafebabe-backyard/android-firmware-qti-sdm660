...
$Header: //components/rel/core.qdsp6/1.0.c2/services/diag/DCM/rtos/src/diagdiag.c#1 $
...
===========================================================================*/
void * diagdiag_get_guid
(
  void * req_pkt, /* pointer to request packet  */
...
============================================================================*/
void *
diagdiag_listener_pkt (void * req_pkt, uint16 pkt_len)
{
