...
Copyright (c) 1998-2014, 2017-2018 by QUALCOMM Technologies, Incorporated.  All Rights Reserved.
===========================================================================*/
...
Notice that changes are listed in reverse chronological order.
      ...
      $Header: //components/rel/core.qdsp6/1.0.c2/services/diag/DCM/common/src/feature.h#1 $
...
typedef enum { 
  ...
  F_DIAG_SOCKET_SUPPORT = 13,
  F_DIAG_DIAGID_SUPPORT = 15,  
  F_DIAG_TAGGING_HEADER_SUPPORT = 16,
  F_DIAG_PD_BUFFERING_SUPPORT = 17,
