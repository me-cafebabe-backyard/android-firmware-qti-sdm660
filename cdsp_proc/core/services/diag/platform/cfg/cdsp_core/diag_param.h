...
/*===========================================================================
      ...
      $Header: //components/rel/core.qdsp6/1.0.c2/services/diag/platform/cfg/cdsp_core/diag_param.h#1 $
...
#define DIAGDIAG_GET_CMD_REG_TBL DIAGDIAG_GET_CMD_REG_TBL_CDSP

#define DIAGDIAG_START_STRESS_TEST_F DIAGDIAG_START_STRESS_TEST_CDSP_F
#define DIAGDIAG_STRESS_TEST_SUBSYS_LOOPBACK DIAGDIAG_STRESS_TEST_SUBSYS_LOOPBACK_CDSP

#define DIAGDIAG_GET_ALLOC_COUNT_LOG DIAGDIAG_GET_ALLOC_COUNT_LOG_CDSP
#define DIAGDIAG_GET_ALLOC_COUNT_F3 DIAGDIAG_GET_ALLOC_COUNT_F3_CDSP
#define DIAGDIAG_GET_ALLOC_COUNT_EVENT DIAGDIAG_GET_ALLOC_COUNT_EVENT_CDSP
#define DIAGDIAG_GET_ALLOC_COUNT_DELAY DIAGDIAG_GET_ALLOC_COUNT_DELAY_CDSP

#define DIAGDIAG_GET_DROP_COUNT_LOG DIAGDIAG_GET_DROP_COUNT_LOG_CDSP
#define DIAGDIAG_GET_DROP_COUNT_F3 DIAGDIAG_GET_DROP_COUNT_F3_CDSP
#define DIAGDIAG_GET_DROP_COUNT_EVENT DIAGDIAG_GET_DROP_COUNT_EVENT_CDSP
#define DIAGDIAG_GET_DROP_COUNT_DELAY DIAGDIAG_GET_DROP_COUNT_DELAY_CDSP

#define DIAGDIAG_RESET_DROP_COUNT_LOG DIAGDIAG_RESET_DROP_COUNT_LOG_CDSP
#define DIAGDIAG_RESET_DROP_COUNT_F3 DIAGDIAG_RESET_DROP_COUNT_F3_CDSP
#define DIAGDIAG_RESET_DROP_COUNT_EVENT DIAGDIAG_RESET_DROP_COUNT_EVENT_CDSP
#define DIAGDIAG_RESET_DROP_COUNT_DELAY DIAGDIAG_RESET_DROP_COUNT_DELAY_CDSP

#define DIAGDIAG_LOG_MASK_RETRIEVAL DIAGDIAG_LOG_MASK_RETRIEVAL_CDSP
#define DIAGDIAG_MSG_MASK_RETRIEVAL DIAGDIAG_MSG_MASK_RETRIEVAL_CDSP
#define DIAGDIAG_EVENT_MASK_RETRIEVAL DIAGDIAG_EVENT_MASK_RETRIEVAL_CDSP
#define DIAGDIAG_RETRIEVE_SSID_RANGE DIAGDIAG_RETRIEVE_SSID_RANGE_CDSP
#define DIAGDIAG_RETRIEVE_EQUIP_ID_RANGE DIAGDIAG_RETRIEVE_EQUIP_ID_RANGE_CDSP

#define DIAGDIAG_GET_FLOW_CTRL_COUNT DIAGDIAG_GET_FLOW_CTRL_COUNT_CDSP
#define DIAGDIAG_RESET_FLOW_CTRL_COUNT DIAGDIAG_RESET_FLOW_CTRL_COUNT_CDSP
#define DIAGDIAG_GET_TIME_API DIAGDIAG_GET_TIME_API_CDSP

#define DIAG_MY_PROC_ID DIAG_CDSP_PROC
#define DIAG_CTRL_MY_PROC_ID DIAG_CTRL_CDSP_PROC
#define DIAGDIAG_STRESS_TEST_DELAYED_RSP DIAGDIAG_STRESS_TEST_DELAYED_RSP_CDSP
#define DIAGDIAG_TX_MODE_CONFIG DIAGDIAG_TX_MODE_CONFIG_CDSP

#define DIAG_F3_TRACE_SET_CONFIG DIAG_F3_TRACE_SET_CONFIG_CDSP
...
#define DIAG_F3_TRACE_BUFFER_SIZE      65536
#endif
...
#define DIAG_INST_ID_BASE 256 //CDSP sockets will range from 256-320
...
/*
Send buffer count is based on DIAG ID instances.Each diagID need not be 
associated with a unique send buffer. CDSP doesn't have a user PD, so only 
1 buffer is needed.
*/
#define DIAG_SEND_BUF_CNT 1
