...
int qurt_i_vtlb_entry_probe(void *vaddr, unsigned *tlbinfo, unsigned *pIndex);
...
int qurt_i_vtlb_set_special(int index, unsigned vaddr, unsigned asid, unsigned size);

//int qurt_i_vtlb_queue_ppage(unsigned pageno, unsigned vtlb_index);
//int qurtos_reclaim_stack_pages(unsigned thread_id, unsigned candidate_sp, 
//                               unsigned starting_vpage, unsigned pagecount, unsigned reserved);
