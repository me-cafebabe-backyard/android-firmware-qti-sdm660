...
/*=============================================================================
Edit History
$Header: //components/rel/core.qdsp6/1.0.c2/api/debugtools/rcesn.h#1 $
...
@param[in] Opaque handle of the event
@return
unsigned long -- Count of specific event
*/
//DLL_API_WARN_UNUSED_RESULT 
//DLL_API_EXPORT_RCINIT unsigned long rcesn_getcount_handle(RCESN_HANDLE const handle);
