...
==========================================================================*/
/*==========================================================================
 $Header: //components/rel/core.qdsp6/1.0.c2/api/debugtrace/qdss.h#1 $
==========================================================================*/
...
/**
 * This function saves a snapshot of the SSC QDSS timestamp counter and 
 * th always-on-counter. 
 *
 * To be called before SLPI enters retention mode.
 */
void QDSS_RetentionEnter(void);

/**
 * 
 * This function restores the SSC QDSS timestamp counter based on the 
 * always-on counter.
 *
 * To be called before SLPI exits retention mode.
 */
