...
/*
Copyright (c) 1993-2016 by QUALCOMM Technologies, Incorporated.  All Rights Reserved.
*/
...
$Header: //components/rel/core.qdsp6/1.0.c2/api/services/diagcmd.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
04/08/16   as      Added new subsystem IDs
...
04/01/13   sr      Added subsys IDs: DIAG_SUBSYS_CXM, DIAG_SUBSYS_GNSS_SOC, 
                   DIAG_SUBSYS_TTLITE, DIAG_SUBSYS_FTM_ANT, DIAG_SUBSYS_MLOG, 
                   DIAG_SUBSYS_LIMITSMGR,DIAG_SUBSYS_EFSMONITOR
01/31/13   sg      Removed OEM reference
12/06/12   rs      Removed Obsolete command DIAG_RPC_F (100). 
10/12/12   ph      Removed the references of peek and poke code.
10/11/12   is      Remove support for DIAG_EXT_LOGMASK_F
...
10/21/11   rh      Added CMAPI subsystem id 
