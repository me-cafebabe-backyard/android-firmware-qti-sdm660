...
$Header: //components/rel/core.qdsp6/1.0.c2/api/mproc/smem_type.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
11/11/16   rv      SMEM Version 0x000C0000 update
08/09/16   vr      Using reserved smem host ID for CDSP processor
                   Added smem item for SMP2P in CDSP
07/26/16   vr      Added SMEM_WLAN_CONFIG by duplicating
                   SMEM_RESERVED_SMEM_SLOW_CLOCK_SYNC
06/16/16   vr      Added SMEM_CHARGER_BATTERY_INFO by duplicating
                   SMEM_RESERVED_SMEM_STATIC_LOG_EVENTS
03/23/16   na      Adding SMEM_XBL_LOADER_CORE_INFO by duplicating 
