...
$Header: //components/rel/core.qdsp6/1.0.c2/api/mproc/qmi_idl_lib_internal.h#1 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
08/18/11   al      Added macros for lengthless TLVs
08/05/11   al      Added macros for len field offsets 
01/14/11   fr      Added new argument to the qmi_idl_find_msg
11/02/10   fr      Macro cleanup.
...
#define QMI_IDL_LIB_ENCDEC_VERSION 6
...
//#define QMI_IDL_TLV_FLAGS_FOR_FUTURE_USE      0x30
