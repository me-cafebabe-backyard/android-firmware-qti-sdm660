...
============================================================================
                             Edit History
  $Header: //components/rel/core.qdsp6/1.0.c2/api/systemdrivers/DDIChipInfo.h#1 $ 
  $DateTime: 2020/02/10 01:57:30 $ 
  $Author: pwbldsvc $

when       who     what, where, why
--------   ---     --------------------------------------------------------
10/13/16   shm     Added SDM660/630 chip IDs.
...
typedef enum
{
  ...
  DALCHIPINFO_FAMILY_SDM845      = 79,
  DALCHIPINFO_FAMILY_IPQ807x     = 80,
  DALCHIPINFO_FAMILY_SDM830      = 81,
  DALCHIPINFO_FAMILY_SDX50M      = 82,
  DALCHIPINFO_FAMILY_QCA6290     = 83,
  DALCHIPINFO_FAMILY_SDX24       = 84,
  DALCHIPINFO_FAMILY_SDM670      = 85,
  DALCHIPINFO_FAMILY_SDM855      = 86,
  DALCHIPINFO_FAMILY_SDM1000     = 87,
  DALCHIPINFO_FAMILY_SDX20M      = DALCHIPINFO_FAMILY_MDM9x65,
