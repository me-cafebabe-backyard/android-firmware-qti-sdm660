...
/* =======================================================================
  ...
  $Header: //components/rel/core.qdsp6/1.0.c2/api/systemdrivers/pmic/pm_vreg.h#1 $
...
/*****************************************************************************/
//TODO does this type need to be updated?
typedef enum
{
  PM_VREG_MODE__AUTO_SLEEP ,
  PM_VREG_MODE__SLEEP_B , /* Follow TCXO_EN */
  PM_VREG_MODE__LPM ,     /* LPM for SMPS means that we are using PFM technique */
  PM_VREG_MODE__HPM ,     /* HPM for SMPS means that we are using PWM technique */
  PM_VREG_MODE__PIN_CTRLED ,
  PM_VREG_MODE__INVALID
} pm_vreg_mode_type ;
 ...
 * @return pm_err_flag_type
 */
pm_err_flag_type pm_dev_pwr_mode_status(unsigned pmic_device_index, uint8 resourceIndex, pm_vreg_mode_type* mode); 
