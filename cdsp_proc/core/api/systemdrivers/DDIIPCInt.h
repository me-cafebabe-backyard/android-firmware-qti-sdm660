...
/*  
  ...
  ==================================================================== 
  $Header: //components/rel/core.qdsp6/1.0.c2/api/systemdrivers/DDIIPCInt.h#1 $ $DateTime: 2020/02/10 01:57:30 $ $Author: pwbldsvc $
  ====================================================================
*/ 
...
typedef enum
{
  ...
  DALIPCINT_PROC_SPSS       = 13, /**< Secure Processor */
  DALIPCINT_PROC_CDSP       = 14, /**< Compute DSP Processor */
  /** @cond */
  DALIPCINT_NUM_PROCS       = 15,
