...
===============================================================================
$Header: //components/rel/core.qdsp6/1.0.c2/power/mpm/inc/dal/DDImpm.h#1 $
...
struct DalmpmHandle 
{
  ...
  const Dalmpm * pVtbl;
  void * pClientCtxt;
  uint32 dwVtblLen;           /* Vtable length pointed by pVtbl above - It is
                               * not next to pVtbl due to DAL FW's offset based 
                               * accesses for this field */
};
