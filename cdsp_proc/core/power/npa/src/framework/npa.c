...
$Header: //components/rel/core.qdsp6/1.0.c2/power/npa/src/framework/npa.c#1 $
============================================================================*/
...
{
  /* This routine must only be invoked on targets where NPA scheduled
     requests (and thus NAS) are supported */
  CORE_UNIMPLEMENTED();
}
