...
/*
@file: asic_func_8974.c
@brief: Contains ASIC specific functions for the Config Manager.

$Header: //components/rel/core.qdsp6/1.0.c2/power/qdsp_pm/src/driver/qdsp_pm_mgr/request_mgr/asic_func_8974.c#1 $
*/
...
Adsppm_Status getBWFromMips_8974(AdsppmMIPSToBWAggregateType *pMipsAggregateData)
{
    ...
    if(NULL != pMipsAggregateData)
    {
        ...
        uint64 bwVal = scale64(maxMips, 1000000 * INSTRUCTION_WIDTH_8974, 8);
