...
#endif
#ifdef ADSPPM_TEST_660
    gAdsppmTestContex.testTarget = ADSPPM_660;
    ADSPPMTEST_LOG_PRINTF_0(ADSPPMTEST_LOG_LEVEL_RESULT, "Target detected: SDM660");
#endif
