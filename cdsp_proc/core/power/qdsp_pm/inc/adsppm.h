...
$Header: //components/rel/core.qdsp6/1.0.c2/power/qdsp_pm/inc/adsppm.h#1 $
*/
...
typedef enum
{
    ...
    Adsppm_State_CoreUSLEEPInit = 0x2000000,
...
//!< AON Bus Clocks END
//!< Aon_SSC Clocks in ADSP start    
    AdsppmClk_Scc_Cfg_Ahb_Clk,
    AdsppmClk_Scc_Crif_Clk,
    AdsppmClk_Scc_Csr_Hclk,
    AdsppmClk_Scc_Data_Hclk,
    AdsppmClk_Scc_Qdsp_Sway_Clk,
//!< AON SSC Clocks in ADSP End
//!< Core Clocks Start
...
typedef enum
{
    ...
    AdsppmBusPort_Adsp_Master = AdsppmBusPort_Q6DSP_Master,	//!< AdsppmBusMaster_Adsp
