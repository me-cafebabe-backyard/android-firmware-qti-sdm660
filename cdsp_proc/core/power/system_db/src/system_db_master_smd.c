...
$Header: //components/rel/core.qdsp6/1.0.c2/power/system_db/src/system_db_master_smd.c#1 $
$Date: 2020/02/10 $
============================================================================*/
...
{
  uint32 read_data[SYSTEMDB_READ_SIZE];
...
void RPM_system_db_write( SYSTEMDB_EVENT_TYPE	event_type,
                          ...
                          SYSTEMDB_ADDR_TYPE addr_type )
{
  uint32 write_data[SYSTEMDB_WRITE_SIZE];
  //Need an RPMMessageHeader b/c it is checked on the RPM
  RPMMessageHeader header;
