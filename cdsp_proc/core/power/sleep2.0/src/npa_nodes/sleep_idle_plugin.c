...
================================================================================
$Header: //components/rel/core.qdsp6/1.0.c2/power/sleep2.0/src/npa_nodes/sleep_idle_plugin.c#1 $
...
#if !defined (FEATURE_SLEEP_NO_IDLE_PLUGIN)
#include <stdint.h>
#include "sleep_osi.h"
...
{ 
  {  
    SLEEP_IDLE_PLUGIN_NODE_NAME,              /* Name */
    "plugin_type",                            /* Units */
...
#else /* FEATURE_SLEEP_NO_IDLE_PLUGIN */
...
#endif /* FEATURE_SLEEP_NO_IDLE_PLUGIN */
