...
================================================================================
$Header: //components/rel/core.qdsp6/1.0.c2/power/sleep2.0/src/npa_nodes/sleep_lpr.c#1 $
...
)
{
  ...
  switch(query_id)
  {
    case SLEEP_LPR_REGISTER:
    {
      ...
      lprInfo = (lpr_registration_info *)(query_result->data.reference);
