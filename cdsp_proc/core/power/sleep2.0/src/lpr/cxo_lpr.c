...
================================================================================
$Header: //components/rel/core.qdsp6/1.0.c2/power/sleep2.0/src/lpr/cxo_lpr.c#1 $
...
{
  // ToDO: Find out a way to enable vmpm_TriggerInterrupts for CDSP since vMPM driver will not be requeired.
  //       Commenting this for now to resolve crash seen on CDSP.
#ifdef ADSP_BUILD
