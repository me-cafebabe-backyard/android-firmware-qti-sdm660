...
const struct tag_sender {
   ...
   EIP_BUILD_XML,
   "c\000\000\000<?xml version=\"1.0\" encoding=\"utf-8\"?><build_vars><ef"
   "fective_memsize value=\"6291456\"/></build_vars>"
};
...
static unsigned char qurtos_app_heap[ROUNDUP(0x100000L,4)] CACHEALIGNED __attribute__((section(".bss.qurtos")));
#endif
#define QURTOSAPPHEAPINIT { QURTOS_CONFIG_HEAP_STATIC, qurtos_app_heap, sizeof(qurtos_app_heap) }
#elif 0 == 1
#define QURTOSAPPHEAPINIT { QURTOS_CONFIG_HEAP_DYNAMIC, 0, ROUNDUP(0x100000L,0x1000) }
#elif 0 == 2
#define QURTOSAPPHEAPINIT { QURTOS_CONFIG_HEAP_ASLR, 0, ROUNDUP(0x100000L,0x1000) }
#elif 0 == 3
#define QURTOSAPPHEAPINIT { QURTOS_CONFIG_HEAP_APPREGION, 0, ROUNDUP(0x100000L,0x1000) }
#endif
...
#define POOL_CONFIGS_INIT { \
    POOLSTART("DEFAULT_PHYSPOOL") \
        POOLREGION(0x94800,0x600000) \
    POOLEND \
    POOLSTART("CDSP_DRIVER_POOL") \
        POOLREGION(0x1A000,0x800000) \
    POOLEND \
    POOLSTART("DRIVER_POOL") \
        POOLREGION(0x94800,0x1000) \
        POOLREGION(0x1A000,0x400000) \
    POOLEND \
    POOLSTART("TCM_PHYSPOOL") \
        POOLREGION(0x1A400,0x400000) \
    POOLEND \
    POOLSTART("cdsp_reg_pool") \
        POOLREGION(0x1A000,0x1000) \
    POOLEND \
    POOLSTART("qdsp6ss_reg_pool") \
        POOLREGION(0x1A300,0x1000) \
    POOLEND \
    POOLSTART("smd_reg_pool") \
        POOLREGION(0x1A385,0x1000) \
    POOLEND \
    POOLSTART("cdsp_clk_reg_pool") \
        POOLREGION(0x1A380,0x8000) \
    POOLEND \
    POOLSTART("sirc_reg_pool") \
        POOLREGION(0x1A390,0x10000) \
    POOLEND \
    POOLSTART("saw_reg_pool") \
        POOLREGION(0x1A3B0,0x1000) \
    POOLEND \
    POOLSTART("smem_pool") \
...
#define MMAP_TABLE_INIT { \
   MEMORY_MAP(1, 0, 0x1a300L, 1, 0, RW, 0x4, 16, MAIN, 0x1a300L),\
   MEMORY_MAP(1, 0, 0x1a590L, 0, 0, RW, 0x4, 1, MAIN, 0x1a590L),\
   ...
   MEMORY_MAP(1, 0, 0x1a5a0L, 0, 0, RW, 0x4, 4, MAIN, 0x1a5a0L),\
   MEMORY_MAP(1, 0, 0x1fe5L, 0, 0, RW, 0x4, 1, MAIN, 0x1fe5L),\
   MEMORY_MAP(1, 0, 0xe8000L, 0, 0, RW, 0x4, 16, MAIN, 0x1a000L),\
   MEMORY_MAP(1, 0, 0xe8100L, 0, 0, RW, 0x4, 16, MAIN, 0x1a100L),\
   MEMORY_MAP(1, 0, 0xe8200L, 0, 0, RW, 0x4, 16, MAIN, 0x1a200L),\
   MEMORY_MAP(1, 0, 0xe8300L, 0, 0, RW, 0x4, 16, MAIN, 0x1a300L),\
   MEMORY_MAP(1, 0, 0xe8400L, 0, 0, RW, 0x4, 16, MAIN, 0x1a400L),\
   MEMORY_MAP(1, 0, 0xe8500L, 0, 0, RW, 0x4, 16, MAIN, 0x1a500L),\
   MEMORY_MAP(1, 0, 0xa0000L, 0, 0, RW, 0x4, 16, MAIN, 0x100L),\
   MEMORY_MAP(1, 0, 0xa0100L, 0, 0, RW, 0x4, 16, MAIN, 0x200L),\
   MEMORY_MAP(1, 0, 0xa0220L, 0, 0, RW, 0x4, 4, MAIN, 0x620L),\
   MEMORY_MAP(1, 0, 0xa0370L, 0, 0, RW, 0x4, 4, MAIN, 0x770L),\
   MEMORY_MAP(1, 0, 0xa0480L, 0, 0, RW, 0x4, 4, MAIN, 0x780L),\
   MEMORY_MAP(1, 0, 0xa0590L, 0, 0, RW, 0x4, 4, MAIN, 0x790L),\
   MEMORY_MAP(1, 0, 0xa1000L, 0, 0, RW, 0x4, 64, MAIN, 0x0L),\
   MEMORY_MAP(1, 0, 0xa2000L, 0, 0, RW, 0x4, 64, MAIN, 0x1000L),\
   MEMORY_MAP(1, 0, 0xa30a0L, 0, 0, RW, 0x4, 4, MAIN, 0x10a0L),\
   MEMORY_MAP(1, 0, 0xa3100L, 0, 0, RW, 0x4, 8, MAIN, 0x1500L),\
   MEMORY_MAP(1, 0, 0xa3220L, 0, 0, RW, 0x4, 4, MAIN, 0x1620L),\
   MEMORY_MAP(1, 0, 0xa3300L, 0, 0, RW, 0x4, 16, MAIN, 0x1f00L),\
   MEMORY_MAP(1, 0, 0xa4000L, 0, 0, RW, 0x4, 64, MAIN, 0x3000L),\
   MEMORY_MAP(1, 0, 0xa5000L, 0, 0, RW, 0x4, 64, MAIN, 0x6000L),\
   MEMORY_MAP(1, 0, 0xa6000L, 0, 0, RW, 0x4, 64, MAIN, 0x7000L),\
   MEMORY_MAP(1, 0, 0xa7000L, 0, 0, RW, 0x4, 64, MAIN, 0x8000L),\
   MEMORY_MAP(1, 0, 0xa8000L, 0, 0, RW, 0x4, 64, MAIN, 0x9000L),\
   MEMORY_MAP(1, 0, 0xa9000L, 0, 0, RW, 0x4, 64, MAIN, 0xa000L),\
   MEMORY_MAP(1, 0, 0xaa000L, 0, 0, RW, 0x4, 32, MAIN, 0xa800L),\
   MEMORY_MAP(1, 0, 0xaa400L, 0, 0, RW, 0x4, 2, MAIN, 0xc000L),\
   MEMORY_MAP(1, 0, 0xaa510L, 0, 0, RW, 0x4, 4, MAIN, 0xc010L),\
   MEMORY_MAP(1, 0, 0xaa680L, 0, 0, RW, 0x4, 8, MAIN, 0xc080L),\
   MEMORY_MAP(1, 0, 0xaa7c0L, 0, 0, RW, 0x4, 8, MAIN, 0xc0c0L),\
   MEMORY_MAP(1, 0, 0xaa840L, 0, 0, RW, 0x4, 8, MAIN, 0xc140L), 0 }
 ...
 */
#define L2TYPE_INIT {0xdeeeeee3,0xffffbfff,0x85feffa6,0xf7e785ff,0xfffbf733,0xfbffff,0xfffffe00,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff,0xffffffff}
...
#define ISR_INIT {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0}
...
#define PROGRAM_NAMES {"CDSP","ROOT_660.cdsp.prodQ.pbn"}
...
CONFIG_RW_SPACE("",
                ...
                qurtos_heap,
                CACHEALIGNED,
                {ARRAY_INIT(ROUNDUP(0X57800,4)) = 0xFF});
SET_CONFIG_VALUE(QURTOS_HEAP_SIZE, sizeof(qurtos_heap));

#if 422 || defined(GEN_CONFIG_HEADER)
...
CONFIG_RW_SPACE(
   ...
   CONFIG_DEFAULT,
   "\242\001\000\000<image><program_name_map name=\"CDSP\" number=\"0\"/><"
   "program_name_map name=\"ROOT_660.cdsp.prodQ.pbn\" number=\"1\"/><ca"
   "che_policy name=\"l1_wb_l2_uncacheable\" value=\"0x0\"/><cache_poli"
   "cy name=\"writethrough\" value=\"0x1\"/><cache_policy name=\"l1_wt_"
   "l2_cacheable\" value=\"0x5\"/><cache_policy name=\"l1_wb_l2_cacheab"
   "le\" value=\"0x7\"/><cache_policy name=\"uncached\" value=\"0x4\"/>"
   "<cache_policy name=\"uncache_shared\" value=\"0x6\"/></image>"
);
...
#define L2ENABLE_INIT {0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0xa511113f,0x1d0d518f,0x7a99015b,0xef87b00,0xff84fbcc,0xff040ffb,0x1ff,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0}
