...
static void test_spi_duplex_core(int data)
{
   ...
   for (j = 0; j < LoopCount; j++)
   {
      ...
      spi_open(SPI_DEVICE_1);

      // Perform a full duplex transfer
      spi_full_duplex(SPI_DEVICE_1, &test_spi_config, &write_transaction_info, &read_transaction_info);
