...
$Header: //components/rel/core.qdsp6/1.0.c2/buses/uart/mdd/inc/uart_event_queue.h#1 $
...
void
uart_event_queue_remove_all_items( uart_event_queue_type* q_ptr, uint32* item, int* num_items,size_t des_size );
