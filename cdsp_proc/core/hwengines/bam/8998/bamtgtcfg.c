...
===============================================================================
 ...
 $Header: //components/rel/core.qdsp6/1.0.c2/hwengines/bam/8998/bamtgtcfg.c#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------
01/12/15   SS      Optimize scons header inclusion for bam config 
12/06/12   SS      Added dynamic bam_num_configs & tgt_cgf support for binary compatiblility
