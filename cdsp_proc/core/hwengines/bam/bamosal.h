...
===============================================================================
 ...
 $Header: //components/rel/core.qdsp6/1.0.c2/hwengines/bam/bamosal.h#1 $

when       who     what, where, why
--------   ---     ------------------------------------------------------------
01/12/15   SS      Optimize for 64bit suppport
...
/**
  ...
  @param[in]      size    Size of the memory to be allocated.
  @param[in]  map_op      maaping type of Device or memory region.
