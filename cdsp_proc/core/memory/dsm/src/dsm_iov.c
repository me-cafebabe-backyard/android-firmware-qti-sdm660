...
/*===========================================================================
  ...
  $Header: //components/rel/core.qdsp6/1.0.c2/memory/dsm/src/dsm_iov.c#1 $
...
)
{
  ...
  while(pkt_head_ptr != NULL && index < *vector_length)
  {
    ...
    {
      MSG(MSG_SSID_DFLT, MSG_LEGACY_ERROR,"Copying from a duplicate item, or a duplicated item");
    }
