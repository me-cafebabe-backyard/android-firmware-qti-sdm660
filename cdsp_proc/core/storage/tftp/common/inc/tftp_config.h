...
/*===========================================================================
  ...
  $Header: //components/rel/core.qdsp6/1.0.c2/storage/tftp/common/inc/tftp_config.h#1 $ $DateTime: 2020/02/10 01:57:30 $ $Author: pwbldsvc $
...
/* IPCR pkt size is 8k. Leaving space for IPCR header keep tftp blk at 7.5K */
...
#ifndef TFTP_SERVER_MIN_TIMEOUT_IN_MS
  #define TFTP_SERVER_MIN_TIMEOUT_IN_MS         50
#endif

#ifndef TFTP_SERVER_DEFAULT_TIMEOUT_IN_MS
  #define TFTP_SERVER_DEFAULT_TIMEOUT_IN_MS    150
#endif

#ifndef TFTP_MAX_TIMEOUT_IN_MS
  #define TFTP_MAX_TIMEOUT_IN_MS               2500
#endif

#ifndef TFTP_CLIENT_TIMEOUT_IN_MS
  #define TFTP_CLIENT_TIMEOUT_IN_MS            200
#endif
  ...
  #define TFTP_MAX_PKT_RETRY_COUNT             4
#endif
