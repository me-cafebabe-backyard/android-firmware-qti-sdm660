...
/*===========================================================================
  ...
  $Header: //components/rel/core.qdsp6/1.0.c2/storage/tftp/os/inc/tftp_assert.h#1 $ $DateTime: 2020/02/10 01:57:30 $ $Author: pwbldsvc $
...
#elif defined (TFTP_LA_BUILD) || defined (TFTP_WINDOWS_BUILD)
