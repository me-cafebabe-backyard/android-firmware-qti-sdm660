...
/*===========================================================================
  ...
  $Header: //components/rel/core.qdsp6/1.0.c2/storage/tftp/os/inc/tftp_string.h#1 $ $DateTime: 2020/02/10 01:57:30 $ $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2015-07-30   mj    Added tftp_strlen function prototype.
...
/**
  tftp_strlen - Get the lenght of an string.
  ...
  None.
*/
uint32 tftp_strlen (const char *str);
