...
/*===========================================================================
  ...
  $Header: //components/rel/core.qdsp6/1.0.c2/storage/fs_osal/src/fs_os_qurt.c#1 $ $DateTime: 2020/02/10 01:57:30 $ $Author: pwbldsvc $

when         who   what, where, why
----------   ---   ---------------------------------------------------------
2016-11-08   as    Migrate qurt mutex and qurt rmutex APIs to qurt pimutex APIS.
...
fs_os_mutex_init (fs_os_mutex_t *hdl_ptr)
{
  ...
  qurt_pimutex_init ((qurt_pimutex_t *)hdl_ptr);
}
...
{
  FS_OS_ASSERT (hdl_ptr != NULL);
  qurt_pimutex_lock ((qurt_pimutex_t *)hdl_ptr);
}
...
{
  FS_OS_ASSERT (hdl_ptr != NULL);
  qurt_pimutex_unlock ((qurt_pimutex_t *)hdl_ptr);
}
