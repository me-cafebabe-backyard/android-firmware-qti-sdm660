...
Copyright (c) 2007 - 2016 by Qualcomm Technologies, Inc.  All Rights Reserved.
*====*====*====*====*====*====*====*====*====*====*====*====*====*====*====*/
...
/*===========================================================================
  ...
  $Header: //components/rel/core.qdsp6/1.0.c2/debugtools/err/src/err_pd_exception_task.c#1 $
...
void bootstrap_exception_handler(void)
{
   ...
   {
     TMS_MSG_ERROR("Failed to copy task name in err_task_name ");
   }
