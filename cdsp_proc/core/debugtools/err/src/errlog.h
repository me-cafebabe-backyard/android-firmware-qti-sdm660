...
$Header: //components/rel/core.qdsp6/1.0.c2/debugtools/err/src/errlog.h#1 $
...
typedef struct
{
  ...
  err_cb_external_type              err_cb[ERR_CB_MAX];
  void*                             err_cb_current;
