...
$Header: //components/rel/core.qdsp6/1.0.c2/debugtools/err/src/err_qdi.c#1 $ 
...
extern void servreg_loc_send_pfr(char *pfr, int pfr_len);
...
)
{
  ...
  else
  {
    ...
    servreg_loc_send_pfr(dataobj->pfr, strlen(dataobj->pfr));
