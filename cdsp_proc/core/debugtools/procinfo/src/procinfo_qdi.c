...
$Header: //components/rel/core.qdsp6/1.0.c2/debugtools/procinfo/src/procinfo_qdi.c#1 $ 
  ...
  case QDI_CLOSE:
    {
      ...
      {
        TMS_MSG_HIGH("Close failed for procinfo");
      }
      ret = qurt_qdi_method_default(client_handle, pobj, method, a1, a2, a3, a4, a5, a6, a7, a8, a9);
      TMS_MSG_HIGH_1("Closed QDI instance for procinfo: %d", ret);
      break;
    }
  ...
  default:
    {
      ...
      TMS_MSG_ERROR_1("Incorrect QDI method invocation: %d", ret);
      break;
    }
  }
...
void procinfo_qdi_init(void)
{
  ...
  if (ret == 0)
  {
    TMS_MSG_HIGH("device = /dev/procinfo registered successfully");
  }
  else
  {
