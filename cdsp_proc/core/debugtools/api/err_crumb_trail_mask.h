...
$Header: //components/rel/core.qdsp6/1.0.c2/debugtools/api/err_crumb_trail_mask.h#1 $
...
#define ERR_CRUMB_TRAIL_BMSK_PD_EXIT                          (1<<25)
#define ERR_CRUMB_TRAIL_BMSK_NOT_PD_EXIT                      (1<<26)
