...
/*=============================================================================
Edit History
$Header: //components/rel/core.qdsp6/1.0.c2/debugtools/dog/src/dog_hal_sdm660_cdsp.c#1 $
...
#define DOG_ISR                             58             // q6ss_wdog_irq
...
static void HAL_dogWakeupTimerCb(timer_cb_data_type unused)
{
   ...
   //TMS_MSG_HIGH_1("HWIO_TURING_QDSP6SS_WDOG_STATUS_ADDR = ​0x%08X", *(volatile unsigned int*)HWIO_TURING_QDSP6SS_WDOG_STATUS_ADDR);
}
...
void HAL_dogEnable(void)
{
   ...
   {
      // SET NMI TIMEOUT
      HWIO_TURING_QDSP6SS_WDOG_NMI_TIME_OUTM(HWIO_TURING_QDSP6SS_WDOG_NMI_TIME_DATA_BMSK, DOG_NMI_ENABLE_TIMEOUT_SLCK);
      ...
      // SET BITE TIMEOUT
      HWIO_TURING_QDSP6SS_WDOG_BITE_TIME_OUTM(HWIO_TURING_QDSP6SS_WDOG_BITE_TIME_DATA_BMSK, DOG_BITE_ENABLE_TIMEOUT_SLCK);
...
void HAL_dogDisable(void)
{
   ...
   {
      // DISABLE WDOG
      HWIO_TURING_QDSP6SS_WDOG_CTL_OUTM(HWIO_TURING_QDSP6SS_WDOG_CTL_ENABLE_BMSK, 0 << HWIO_TURING_QDSP6SS_WDOG_CTL_ENABLE_SHFT);
   }
}
...
{
   // SET BARK TIMEOUT
   HWIO_TURING_QDSP6SS_WDOG_BARK_TIME_OUTM(HWIO_TURING_QDSP6SS_WDOG_BARK_TIME_DATA_BMSK, DOG_BARK_ENABLE_TIMEOUT_SLCK);
}
...
void HAL_dogIsAutokicking(unsigned int* status)
{
   if (NULL != status)
   {
      if (0 != (HWIO_TURING_QDSP6SS_WDOG_CTL_INM(HWIO_TURING_QDSP6SS_WDOG_CTL_ENABLE_BMSK) & HWIO_TURING_QDSP6SS_WDOG_CTL_ENABLE_BMSK))
      {
