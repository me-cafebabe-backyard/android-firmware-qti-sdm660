...
/*=============================================================================
Edit History
$Header: //components/rel/core.qdsp6/1.0.c2/debugtools/version/src/image_version.h#1 $
...
typedef enum
{
   ...
   IMAGE_INDEX_MPSS = 11,
   IMAGE_INDEX_ADSP = 12,
   IMAGE_INDEX_WCNS = 13,                 // aka CNSS
   IMAGE_INDEX_VENUS = 14,
   IMAGE_INDEX_DSPS = 15,                 // aka SLPI
   IMAGE_INDEX_CDSP = 16,
