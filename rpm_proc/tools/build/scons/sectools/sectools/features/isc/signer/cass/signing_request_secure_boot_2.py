...
class SecureBoot2SigningRequest(BaseCASSSigningRequest):
    ...
    def get_supported_capabilities(cls):
        return ["qsee_production_nazgul_debugpolicy", "qsee_test_nazgul", "spss_test_nazgul", "xblsec_nazgul", "xblsec_prod_debug_serial", "qsee_test_debug_serial", "qsee_prod_debug_serial", "spss_test_debug_serial"]
