...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/rpm.bf/1.8/tools/build/scons/scripts/config.py#1 $
...
def init_build_config(env, target_files=True):
   ...
   if len(image_tools) > 0:
      ...
      env.LoadToolScript("${COREBSP_ROOT}/bsp/build/scripts/mbn_builder.py")
      env.LoadToolScript("${COREBSP_ROOT}/bsp/build/scripts/bin_builder.py")
      env.LoadToolScript("${COREBSP_ROOT}/bsp/build/scripts/hex_builder.py")
      env.LoadToolScript("${COREBSP_ROOT}/bsp/build/scripts/kernel_builders.py")
      env.LoadToolScript("${COREBSP_ROOT}/bsp/build/scripts/scl_builder.py")
