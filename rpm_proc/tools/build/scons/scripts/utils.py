...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/rpm.bf/1.8/tools/build/scons/scripts/utils.py#1 $
...
def add_bin_library (env, targets, library, sources, **kargs):
   return add_library (env, targets, library, sources, pack=True, **kargs)
...
def add_bin_object (env, targets, sources, **kargs):
   return add_object (env, targets, sources, pack=True, **kargs)
...
'''   
   banner_single_str = "*** DO NOT EDIT - AUTO GENERATED FILE ($DATE), Name:"\
      "$FILE_NAME, Description:$DESCRIPTION, Copyright (c) $YEAR by QUALCOMM, "\
      "Incorporated.  All Rights Reserved."
   
   banner_json_str = "{' ***':'DO NOT EDIT - AUTO GENERATED FILE','Name':'$FILE_NAME',"\
      "'Description':'$DESCRIPTION','Generated':'$DATE',"\
      "'Copyright':'Copyright (c) $YEAR by QUALCOMM, Incorporated.  All Rights Reserved.'}"
