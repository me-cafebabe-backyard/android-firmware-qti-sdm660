...
#-------------------------------------------------------------------------------
#
#  $Header: //components/rel/rpm.bf/1.8/tools/build/scons/scripts/cmdline.py#1 $
...
def generate(env):
   ...
   # add interposer option
   SCons.Script.AddOption('--interposer',
           dest='interposer',
           action="store_true",
           default=False,
           help='Support 8994 interposer (8974 + 8994 pmic)')
