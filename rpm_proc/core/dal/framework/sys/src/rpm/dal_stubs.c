    ...
    case DALIPCINT_GP_HIGH:
      switch(eTarget)
      {
        ...
        case DALIPCINT_PROC_SPS:
          HWIO_OUT(RPM_IPC, (1 << 24));
          return DAL_SUCCESS;

        case DALIPCINT_PROC_TZ:
#if 0 // CR 1030212: TZ has to use polling, and RPM should not send interrupt to avoid race condition in TZ.
          HWIO_OUT(RPM_IPC, (1 << 20));
#endif
          return DAL_SUCCESS;
        ...
        case DALIPCINT_PROC_CDSP:
          HWIO_OUT(RPM_IPC, (1 << 0));
          return DAL_SUCCESS;
		default:
          break;
      }
