/*==============================================================================
  ...
  $Header: //components/rel/rpm.bf/1.8/core/power/npa/src/npa.c#1 $
...
static void npa_issue_sync_request_unconditional_first(
  npa_client_handle client,
  int new_request )
{
  /* Unconiditionally issue the first vote from a client as new. */
  npa_issue_sync_request( client, 1 );

  /* Reset the request function pointer to the conditional version. */
...
__attribute__((section("npa_dram_reclaim_pool")))
...

{
  ...
  client = npa_new_client( resource_name, 
                           ...
                           client_value,
                           client_ref,
                           npa_issue_sync_request_unconditional_first );
