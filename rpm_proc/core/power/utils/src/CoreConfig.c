...
/*=============================================================================
 ...
 OVERVIEW:     This file provides an abstraction layer for reading a
                section/key pair from a configuration area (file,
                registry, etc.).
 
                Copyright (c) 2010 Qualcomm Technologies Incorporated.
                All Rights Reserved.
                Qualcomm Confidential and Proprietary
  $Header: //components/rel/rpm.bf/1.8/core/power/utils/src/CoreConfig.c#1 $
=============================================================================*/
