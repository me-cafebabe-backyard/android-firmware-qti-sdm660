#ifndef __SECURITY_HWIO_H__
#define __SECURITY_HWIO_H__
/*
===========================================================================
*/
/**
  @file security_hwio.h
...
/*
  ...
  $Header: //components/rel/rpm.bf/1.8/core/power/rpm/inc/target/660/security_hwio.h#2 $
...
#define HWIO_QFPROM_RAW_QC_SPARE_REGn_LSB_OFFS(n)                                                (SECURITY_CONTROL_CORE_REG_BASE_OFFS + 0x00000310 + 0x8 * (n))
...
#define HWIO_QFPROM_RAW_QC_SPARE_REGn_MSB_OFFS(n)                                                (SECURITY_CONTROL_CORE_REG_BASE_OFFS + 0x00000314 + 0x8 * (n))
...
#define HWIO_QFPROM_RAW_OEM_SPARE_REGn_ROW0_LSB_OFFS(n)                                          (SECURITY_CONTROL_CORE_REG_BASE_OFFS + 0x00000596 + 0x10 * (n))
...
#define HWIO_QFPROM_RAW_OEM_SPARE_REGn_ROW0_MSB_OFFS(n)                                          (SECURITY_CONTROL_CORE_REG_BASE_OFFS + 0x0000059a + 0x10 * (n))
...
#define HWIO_QFPROM_RAW_OEM_SPARE_REGn_ROW1_LSB_OFFS(n)                                          (SECURITY_CONTROL_CORE_REG_BASE_OFFS + 0x0000059e + 0x10 * (n))
...
#define HWIO_QFPROM_RAW_OEM_SPARE_REGn_ROW1_MSB_OFFS(n)                                          (SECURITY_CONTROL_CORE_REG_BASE_OFFS + 0x000005a2 + 0x10 * (n))
...
#define HWIO_QFPROM_CORR_QC_SPARE_REGn_LSB_OFFS(n)                                               (SECURITY_CONTROL_CORE_REG_BASE_OFFS + 0x00004310 + 0x8 * (n))
...
#define HWIO_QFPROM_CORR_QC_SPARE_REGn_MSB_OFFS(n)                                               (SECURITY_CONTROL_CORE_REG_BASE_OFFS + 0x00004314 + 0x8 * (n))
...
#define HWIO_QFPROM_CORR_OEM_SPARE_REGn_ROW0_LSB_OFFS(n)                                         (SECURITY_CONTROL_CORE_REG_BASE_OFFS + 0x00004596 + 0x10 * (n))
...
#define HWIO_QFPROM_CORR_OEM_SPARE_REGn_ROW0_MSB_OFFS(n)                                         (SECURITY_CONTROL_CORE_REG_BASE_OFFS + 0x0000459a + 0x10 * (n))
...
#define HWIO_QFPROM_CORR_OEM_SPARE_REGn_ROW1_LSB_OFFS(n)                                         (SECURITY_CONTROL_CORE_REG_BASE_OFFS + 0x0000459e + 0x10 * (n))
...
#define HWIO_QFPROM_CORR_OEM_SPARE_REGn_ROW1_MSB_OFFS(n)                                         (SECURITY_CONTROL_CORE_REG_BASE_OFFS + 0x000045a2 + 0x10 * (n))
