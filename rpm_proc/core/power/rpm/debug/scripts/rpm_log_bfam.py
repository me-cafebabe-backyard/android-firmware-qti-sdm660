...
if __name__ == '__main__':
    ...
    if store_branch(options.branch):
        print 'Error: unable to parse branch, defaulting to RPM.BF.1.0-00000'
        store_branch("RPM.BF.1.0-00000")
    ...
    for line in loglines:
        ...
        try:
            ...
            print 'Error parsing log message with timestamp = %s, id = %i, and data = %s -- %s %s' % (timestamp, id, data, sys.exc_info()[0], traceback.print_exc())
