 ...
 *
 * THIS IS AUTO-GENERATED CPR CONFIG FILE FOR 660.
 *
...
static const char voltage_plan_hash_value[] = "B27918542C0EFE8D25C9C53A62DAB469";
...
static const cpr_margin_cfg margins_175510 = {
    .count = 1,
    .data = (const cpr_margin_data[]) { { .cprRevMin = 0, .cprRevMax = 255, .openLoop =       0, .closedLoop =   35000, .maxFloorToCeil =      0 } }
};
...
static const cpr_margin_cfg margins_265510 = {
    .count = 1,
    .data = (const cpr_margin_data[]) { { .cprRevMin = 0, .cprRevMax = 255, .openLoop =       0, .closedLoop =   53000, .maxFloorToCeil =      0 } }
};


static const cpr_margin_cfg margins_280510 = {
    .count = 1,
    .data = (const cpr_margin_data[]) { { .cprRevMin = 0, .cprRevMax = 255, .openLoop =       0, .closedLoop =   56000, .maxFloorToCeil =      0 } }
};
...
static const cpr_margin_cfg margins_345510 = {
    .count = 1,
    .data = (const cpr_margin_data[]) { { .cprRevMin = 0, .cprRevMax = 255, .openLoop =       0, .closedLoop =   69000, .maxFloorToCeil =      0 } }
};


static const cpr_margin_cfg margins_205510 = {
    .count = 1,
    .data = (const cpr_margin_data[]) { { .cprRevMin = 0, .cprRevMax = 255, .openLoop =       0, .closedLoop =   41000, .maxFloorToCeil =      0 } }
};
...
static const cpr_margin_cfg margins_210510 = {
    .count = 1,
    .data = (const cpr_margin_data[]) { { .cprRevMin = 0, .cprRevMax = 255, .openLoop =       0, .closedLoop =   42000, .maxFloorToCeil =      0 } }
};


static const cpr_margin_cfg margins_260510 = {
    .count = 1,
    .data = (const cpr_margin_data[]) { { .cprRevMin = 0, .cprRevMax = 255, .openLoop =       0, .closedLoop =   52000, .maxFloorToCeil =      0 } }
};
 ...
 * LPI_CX Voltage Plan
 */
static cpr_voltage_plan voltage_plan_16405275418 =
{
    .modesCount      = 7,
    .tempAdjCfg      = NULL,
    .kvCfg           = &kvs_8132522154,
    ...
    .modes           = (struct cpr_voltage_data[]) {
        // MIN_SVS
        {.fref = 584000, .freqDelta =       0, .fuses = &fuses_1525307024, .quotients = &quotients_10149653726, .margins = &margins_175510,
         .marginTempBands = {0},
         .subModesCount   = 1,
         .subModes        = (const cpr_freq_data[]){ {.ceiling =  584000, .floor =  504000, .freq =       0, .interplEnabled = false} } },

        // LOW_SVS
        {.fref = 648000, .freqDelta =       0, .fuses = &fuses_1525307024, .quotients = &quotients_9419384043, .margins = &margins_265510,
         .marginTempBands = {0},
         .subModesCount   = 1,
         .subModes        = (const cpr_freq_data[]){ {.ceiling =  648000, .floor =  504000, .freq =       0, .interplEnabled = false} } },

        // SVS
        {.fref = 720000, .freqDelta =       0, .fuses = &fuses_1335669278, .quotients = &quotients_13528529687, .margins = &margins_280510,
         .marginTempBands = {0},
         .subModesCount   = 1,
         .subModes        = (const cpr_freq_data[]){ {.ceiling =  720000, .floor =  592000, .freq =       0, .interplEnabled = false} } },

        // SVS_L1
        {.fref = 792000, .freqDelta =       0, .fuses = &fuses_1335669278, .quotients = &quotients_14902452412, .margins = &margins_345510,
         .marginTempBands = {0},
         .subModesCount   = 1,
         .subModes        = (const cpr_freq_data[]){ {.ceiling =  792000, .floor =  648000, .freq =       0, .interplEnabled = false} } },

        // NOMINAL
        {.fref = 864000, .freqDelta =       0, .fuses = &fuses_2888268017, .quotients = &quotients_12386205346, .margins = &margins_205510,
         .marginTempBands = {0},
         .subModesCount   = 1,
         .subModes        = (const cpr_freq_data[]){ {.ceiling =  864000, .floor =  712000, .freq =       0, .interplEnabled = false} } },

        // NOMINAL_L1
        {.fref = 920000, .freqDelta =       0, .fuses = &fuses_2888268017, .quotients = &quotients_14294275849, .margins = &margins_210510,
         .marginTempBands = {0},
         .subModesCount   = 1,
         .subModes        = (const cpr_freq_data[]){ {.ceiling =  920000, .floor =  744000, .freq =       0, .interplEnabled = false} } },

        // TURBO
        {.fref = 992000, .freqDelta =       0, .fuses = &fuses_94616107, .quotients = &quotients_15780032753, .margins = &margins_260510,
         .marginTempBands = {0},
         .subModesCount   = 1,
...
static const cpr_versioned_voltage_plan lpi_cx_vvp = {
    ...
    .list     = (struct voltage_plan_list[]) {
        { .version = &ver_ANY_1_0_1_255, .cfg = &voltage_plan_16405275418 },
     },
    .count    = 1,
    .agingCfg = NULL
};
...
static const cpr_hal_controller_cfg mx_cpr3_controller_cfg = {
    ...
    .stepQuotMax         = 14,
    .sensorsTotal        = 22,
    .bypassSensors       = (const uint8[]){ 2,3,4,5,6,7,8,9,10,13,14,15 },
    .bypassSensorsCount  = 12,
...
const cpr_settings cpr_settings_660 =
{
