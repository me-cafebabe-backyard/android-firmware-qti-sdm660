 ...
 * $Header: //components/rel/rpm.bf/1.8/core/power/cpr/common/src/cpr.c#1 $
 * $Change: 11690628 $
 */
#include "cpr.h"
#include "cpr_logs.h"
...
static void init_cpr_config(void)
{
    ...
    SWEVENT( CPR_EVT_INIT, cpr_info.chipVersion, cpr_info.foundry, cpr_info.cprRev );
...
void cpr_init()
{
    ...
    // image specific init not related to CPR rail
    cpr_image_init();
...
#if 0 /* 8998 RPM does not receive thermal event. Disable this to save memory */
    /*
