...
Copyright (c) 2009-2015 Qualcomm Technologies, Inc. All Rights 
...
/* =======================================================================
  ...
  $Header: //components/rel/rpm.bf/1.8/core/api/pmic/pm/pm_ldo.h#1 $
...
/** Returns the VREG_READY status of LDOs which includes VREG_OK
    ...
    SUCCESS or Error -- See #pm_err_flag_type.
 */
pm_err_flag_type pm_ldo_vreg_ready_status
(uint8 pmic_chip, uint8 ldo_peripheral_index, boolean* vreg_ready);
