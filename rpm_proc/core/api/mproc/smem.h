...
/*===========================================================================
Copyright (c) 2006-2013, 2015-2016 Qualcomm Technologies Inc.
All Rights Reserved.
...
$Header: //components/rel/rpm.bf/1.8/core/api/mproc/smem.h#2 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
04/07/15   rs      Changed function signature for setting SMEM partition 
                   protections
...
06/12/13   pa      Added smem_tz_set_partitions.
