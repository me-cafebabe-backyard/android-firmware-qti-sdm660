...
/*
  ...
  $Header: //components/rel/rpm.bf/1.8/core/api/systemdrivers/ClockDefs.h#2 $
  $DateTime: 2017/02/14 04:26:43 $
  $Author: pwbldsvc $
...
typedef enum
{
  ...
  CLOCK_QDSS_LEVEL_HSDEBUG,   /* clock set to NOMINAL speed */
  CLOCK_QDSS_LEVEL_LOW,       /* clock set to SVS speed */
  CLOCK_QDSS_LEVEL_LOW_MINUS, /* clock set to SVS2 speed */
  CLOCK_QDSS_LEVEL_MAX_LEVEL = CLOCK_QDSS_LEVEL_LOW_MINUS,
...
typedef enum
{
  ...
  CLOCK_VREG_LEVEL_NOMINAL_PLUS = RAILWAY_NOMINAL_HIGH,
  CLOCK_VREG_LEVEL_HIGH         = RAILWAY_TURBO,
...
/*
 * ClockDDRMode - GCC or DDRCC mode
 */
typedef enum
{
  CLOCK_DDR_MODE_GCC,
