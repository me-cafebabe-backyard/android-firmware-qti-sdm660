...
/*  
  ...
  ==================================================================== 
  $Header: //components/rel/rpm.bf/1.8/core/api/systemdrivers/DDIHWIO.h#1 $ $DateTime: 2016/11/03 00:13:13 $ $Author: pwbldsvc $
  ====================================================================
*/ 
...
// the RPM has a 1:1 physical memory mapping, so we provide a specialty
// implementation of this function without pulling the entire DalHWIO.
DALResult DalHWIO_MapRegion
(
  DalDeviceHandle *_h,
  const char      *szBase,
  uint8          **ppAddress
...
/**
  ...
  @param *_h           [in] -- Handle to the HWIO DAL device.
  @param *pPhysAddress [in] -- Physical address of the base to map.
  @param **ppAddress   [out] -- Pointer to fill in with the virtual address.
