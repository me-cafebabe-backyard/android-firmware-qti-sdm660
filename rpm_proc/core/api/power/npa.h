...
============================================================================*/
/* $Header: //components/rel/rpm.bf/1.8/core/api/power/npa.h#1 $ */
...
typedef enum
{
  ...
  NPA_CLIENT_SUPPRESSIBLE = (1 << 11), /* Suppressible Scalar
                                        * request */
  NPA_CLIENT_SUPPRESSIBLE_VECTOR = (1 << 12), /* Suppressible Vector
                                               * request */
} npa_client_type;
...
/**
   @brief npa_issue_scalar_request - Issue s scalar client work
   request
...
/**
   @brief npa_issue_suppressible_request - Issue the SUPPRESSIBLE
   client work request
...
/**
   @brief npa_issue_required_vector_request - Issue the VECTOR client
   work request
...
/**
   @brief npa_issue_suppressible_vector_request - Issue s SUPPRESSIBLE
   VECTOR client work request
...
/**
   @brief npa_create_event_cb - Create an NPA event handler with
   the given resource
...
/** 
  @brief npa_set_event_thresholds - set the absolute thresholds for
