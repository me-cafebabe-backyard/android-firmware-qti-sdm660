...
typedef enum
{
  ...
  ROB_EVENT_RPM_CPR_UPDATE_START,
  ROB_EVENT_RPM_CPR_UPDATE_END,
...
// Duration is a function of the cpu_mode_id that the RPM was running when the
// observation was made.
uint64_t rob_get_duration (rob_duration_type d, cpu_mode_id speed);

// Set the cpu_mode_id that an observation run should associate with the timings.
