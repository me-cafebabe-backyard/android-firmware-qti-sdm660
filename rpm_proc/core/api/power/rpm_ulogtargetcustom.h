...
============================================================================*/
/* $Header: //components/rel/rpm.bf/1.8/core/api/power/rpm_ulogtargetcustom.h#2 $ */
#ifndef TRUE
#define TRUE   1
#endif
...
#include "stdio.h"
//#include "stringl.h"
#include "../kernel/libstd/stringl/stringl.h" //Weiming: scons should set -I core/api/kernel/..
