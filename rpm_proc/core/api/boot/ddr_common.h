...
$Header: //components/rel/rpm.bf/1.8/core/api/boot/ddr_common.h#1 $ 
...
typedef enum
{
  SDRAM_INTERFACE_NONE = 0x0,       /**< Interface none */
...
typedef enum
{
  ...
  DDR_TYPE_PCDDR4 = 8,           /**< Personal computer DDR4. */

  DDR_TYPE_RESERVED = 9,         /**< Reserved for future use. */
