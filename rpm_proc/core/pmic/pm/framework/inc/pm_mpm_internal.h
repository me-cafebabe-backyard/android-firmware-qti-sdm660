...
/*
  ...
  $Header: //components/rel/rpm.bf/1.8/core/pmic/pm/framework/inc/pm_mpm_internal.h#1 $
...
typedef struct
{
  pm_mpm_cfg_type **sleep_cfg;
  pm_mpm_cfg_type **active_cfg;
  /* SPMI sequence index. */
  pm_mpm_cmd_index_type **cmd_index_ptr;
  /* PM MPM Rails info. */
  pm_mpm_rails_info_type **pm_mpm_rails;
}pm_mpm_debug_info_type; 
