...
$Header: //components/rel/rpm.bf/1.8/core/pmic/pm/npa/inc/pm_rpm_smps_trans_apply.h#2 $

when       who     what, where, why
--------   ---     ----------------------------------------------------------
03/15/17   as      Increasing Min and Max Freq bit to 6 (CR#2019064)
...
typedef struct 
{
    unsigned        LpHpCurrentThreshold:11; // in mA
    ...
    unsigned        MinFreq:6;               // 1 - 9.6M, 2 - 6.4M, 3 - 4.8M, 5 - 3.2M, etc
    unsigned        MaxFreq:6;               // 1 - 9.6M, 2 - 6.4M, 3 - 4.8M, 5 - 3.2M, etc
