...
/* =======================================================================
  ...
  $Header: //components/rel/rpm.bf/1.8/core/pmic/pm/drivers/pwr/src/pm_pwr_alg.h#2 $
...
typedef struct 
{
    ...
    pm_register_address_type    OUTPUT_VOLTAGE_PIN; // OUTPUT_VOLTAGE_PIN 0x42, VOUT_EXT_CTRL1_LB 0x4A
