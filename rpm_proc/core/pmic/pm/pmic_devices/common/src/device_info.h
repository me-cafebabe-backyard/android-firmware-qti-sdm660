...
$Header: //components/rel/rpm.bf/1.8/core/pmic/pm/pmic_devices/common/src/device_info.h#1 $
$Author: pwbldsvc $
...
/**
 * @name pm_is_stub_enabled
 *
 * @brief This function gives the status if pm_init stub is enabled or not.
 *
 * @param None.
 *
