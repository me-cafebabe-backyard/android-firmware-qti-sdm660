...
/**
  ...
  This file contains HWIO register definitions for the following modules:
    QDSS_QDSS_ETFETB_ETFETB_CXTMC_F128W64K
...
/*
  ...
  $Header: //components/rel/rpm.bf/1.8/core/debugtrace/tmc/hal/src/qdss_etfetb_regs.h#2 $
...
/*----------------------------------------------------------------------------
 * MODULE: QDSS_QDSS_ETFETB_ETFETB_CXTMC_F128W64K
 *--------------------------------------------------------------------------*/
...
#define HWIO_QDSS_ETFETB_FFCR_FLUSHMAN_BMSK                                  0x40
#define HWIO_QDSS_ETFETB_FFCR_FLUSHMAN_SHFT                                   0x6
...
#define HWIO_QDSS_ETFETB_CLAIMSET_CLAIMSET_BMSK                               0xf
#define HWIO_QDSS_ETFETB_CLAIMSET_CLAIMSET_SHFT                               0x0
...
#define HWIO_QDSS_ETFETB_CLAIMCLR_CLAIMCLR_BMSK                               0xf
#define HWIO_QDSS_ETFETB_CLAIMCLR_CLAIMCLR_SHFT                               0x0
