...
$Header: //components/rel/rpm.bf/1.8/core/boot/ddr/platform/sdm660/params/v4/ddr_params.h#1 $
$DateTime: 2016/11/03 00:13:13 $
$Author: pwbldsvc $
================================================================================
when       who     what, where, why
--------   ---     -------------------------------------------------------------
05/20/14   tw      renamed lp4_shared_data to ddrsns_shared_data for better 
...
extern DDR_STRUCT *ddrsns_share_data;
