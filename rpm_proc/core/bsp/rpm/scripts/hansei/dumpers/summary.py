...
def dump(debug_data): #dump_path, memory, debug_info, base_address):
    ...
    print("#        {0:70}#".format("QC_IMAGE_VERSION_STRING : %s" % QC_IMAGE_VERSION))
    print("#        {0:70}#".format("IMAGE_VARIANT_STRING    : %s" % find_version_info("IMAGE_VARIANT_STRING=",version_address_start, version_address_end, memory)))
    print("#        {0:70}#".format("OEM_IMAGE_VERSION_STRING: %s" % find_version_info("OEM_IMAGE_VERSION_STRING=",version_address_start, version_address_end, memory)))
    print("#        {0:70}#".format("Build Date              : %s" % pointer_to_str(rpm_build_date)))
    print("#        {0:70}#".format("Build Time              : %s" % pointer_to_str(rpm_build_time)))
