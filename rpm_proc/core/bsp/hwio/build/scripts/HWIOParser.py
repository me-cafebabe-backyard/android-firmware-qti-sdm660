...
#  ===========================================================================
#
#  $Header: //components/rel/rpm.bf/1.8/core/bsp/hwio/build/scripts/HWIOParser.py#1 $
...
class HWIORegister(object):
  ...
  def SetResetValue (self, m, line_number):
    ...
    try:
      ...
      reset_mask = '0x' + ''.join(['0' if r in ['x', 'X'] else 'F' for r in m.group(2)[2:]])
      self.reset_mask = int(reset_mask, 0)
    except:
