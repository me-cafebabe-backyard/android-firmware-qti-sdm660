...
$Header: //components/rel/rpm.bf/1.8/core/mproc/glink/os/inc/glink_os_utils.h#2 $
...
/*===========================================================================
  FUNCTION  glink_os_copy_mem_32b
===========================================================================*/
/**
  Copies the source buffer into the destination buffer with 4 bytes aligned 
  access.
...
*/
/*==========================================================================*/
void glink_os_copy_mem_32b(void *dst, const void *src, uint32 size);
