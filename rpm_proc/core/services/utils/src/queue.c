...
$Header: //components/rel/rpm.bf/1.8/core/services/utils/src/queue.c#1 $ $DateTime: 2016/11/03 00:13:13 $ $Author: pwbldsvc $
...
SIDE EFFECTS
   None.
============================================================================= */
static inline void q_lock( q_type *q_ptr )
{
  #ifdef USE_MUTEX
...
SIDE EFFECTS
   None.
============================================================================= */
static inline void q_unlock( q_type *q_ptr )
{
  #ifdef USE_MUTEX
