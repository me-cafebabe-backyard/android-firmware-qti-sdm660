#ifndef __QTIMERHWIO_H__
#define __QTIMERHWIO_H__
/*
===========================================================================
*/
/**
  @file QTimerHWIO.h
  @brief QTimer HWIO interface include file.
*/
/*
  ===========================================================================
  ...
  $Header: //components/rel/rpm.bf/1.8/core/systemdrivers/timetick/inc/QTimerHWIO.h#1 $
