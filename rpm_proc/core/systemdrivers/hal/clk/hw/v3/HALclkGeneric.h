...
$Header: //components/rel/rpm.bf/1.8/core/systemdrivers/hal/clk/hw/v3/HALclkGeneric.h#1 $
...
void               HAL_clk_GenericNoRootConfigMux ( HAL_clk_ClockDomainDescType *pmClockDomainDesc, const HAL_clk_ClockMuxConfigType * );
 ...
 */
void    HAL_clk_GenericPowerDomainEnable     ( HAL_clk_PowerDomainDescType *pmPowerDomainDesc, boolean bAsync );
