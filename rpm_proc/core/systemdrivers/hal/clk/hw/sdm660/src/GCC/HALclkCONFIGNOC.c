...
$Header: //components/rel/rpm.bf/1.8/core/systemdrivers/hal/clk/hw/sdm660/src/GCC/HALclkCONFIGNOC.c#1 $
...
#if 0 /*Directly enabling this clock along with IPA clock*/
  {
