...
$Header: //components/rel/rpm.bf/1.8/core/systemdrivers/hal/clk/hw/sdm660/src/GCC/HALclkSYSTEMNOC.c#3 $
...
extern HAL_clk_ClockDomainControlType HAL_clk_mGCCSystemNocClockDomainControl;
...
HAL_clk_ClockDomainDescType HAL_clk_mGCCSYSTEMNOCClkDomain =
{
  ...
  /* .pmControl            = */ &HAL_clk_mGCCSystemNocClockDomainControl,
  /* .pmNextClockDomain    = */ NULL
};
